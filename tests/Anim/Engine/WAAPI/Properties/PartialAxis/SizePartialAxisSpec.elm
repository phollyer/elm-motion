module Anim.Engine.WAAPI.Properties.PartialAxis.SizePartialAxisSpec exposing (suite)
...
suite : Test
suite =
    describe "Anim.Engine.WAAPI size partial-axis payload"
...
encodeAnimateAfterSizeHistory :
    (Builder.AnimBuilder Builder.ForWAAPI -> Builder.AnimBuilder Builder.ForWAAPI)
    -> (Builder.AnimBuilder Builder.ForWAAPI -> Builder.AnimBuilder Builder.ForWAAPI)
    -> String
encodeAnimateAfterSizeHistory first second =
    let
        firstBuilder =
            Builder.init [ first ]
        ...
        secondProcessed =
            afterFirst
                ...
                |> Builder.process
    in
    Encoder.encode AnimGroups.init secondProcessed
        |> Encode.encode 0
