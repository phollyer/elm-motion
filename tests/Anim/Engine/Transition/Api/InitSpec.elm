...
renderedAttributes : String -> Transition.AnimState -> Query.Single msg
renderedAttributes groupName state =
    Html.div (Transition.attributes groupName state) []
        |> Query.fromHtml


additionalContractTests : List Test
additionalContractTests =
    [ test "composed init writes translate + opacity and combines will-change" <|
        \_ ->
            Transition.init
                ...
                |> Query.has
                    ...
                    , Selector.style "translate" "10px 0px 0px"
                    , Selector.style "will-change" "opacity, translate"
                    ]
                        ...
                        Expect.all
                            [ \_ ->
                                renderedAttributes animGroup state
                                    |> Query.has [ Selector.style "translate" "10em 0px 0px" ]
                            , \_ ->
                                renderedAttributes otherAnimGroup state
                                    |> Query.has [ Selector.style "translate" "10px 0px 0px" ]
                            ]
                            ()
                   )
...
type alias TestCase =
    { description : String
    , initAxis : TransitionBuilderFunction
...
sizeTestData =
    [ { description = "Size.initH writes height, and materializes default width"
      , initAxis = Size.initH animGroup 10
      , expectedHeight = Just "10px"
      , expectedWidth = Just "0px"
      , willChange = "width, height"
      }
    , { description = "Size.initW writes width, and materializes default height"
      , initAxis = Size.initW animGroup 20
      , expectedHeight = Just "0px"
    ...
    , { description = "Size.initH with custom CSS unit writes height, and materializes default width"
      , initAxis =
            Size.initH animGroup 10
                >> Size.initCssUnitH Em
    ...
    , { description = "Size.initW with custom CSS unit writes width, and materializes default height"
      , initAxis =
...
translateTestData =
    ...
    , testCases =
        ...
        , { description = "Translate.initY with custom CSS unit writes Y, and omits untouched XZ"
          ...
          , expected = ( "translate", "0px 20em 0px" )
          }
        , { description = "Translate.initZ with custom CSS unit writes Z, and omits untouched XY"
          ...
          , expected = ( "translate", "0px 0px 30em" )
          }
        , { description = "Translate.initXY with custom CSS unit writes XY and omits untouched Z"
          , initAxis =
                Translate.initXY animGroup 10 20
                    >> Translate.initCssUnitX Em
                    >> Translate.initCssUnitY Em
          , expected = ( "translate", "10em 20em 0px" )
          }
        , { description = "Translate.initXZ with custom CSS unit writes XZ and omits untouched Y"
          , initAxis =
                Translate.initXZ animGroup 10 30
                    >> Translate.initCssUnitX Em
                    >> Translate.initCssUnitZ Em
          , expected = ( "translate", "10em 0px 30em" )
          }
        , { description = "Translate.initYZ with custom CSS unit writes YZ and omits untouched X"
          , initAxis =
                Translate.initYZ animGroup 20 30
                    >> Translate.initCssUnitY Em
                    >> Translate.initCssUnitZ Em
          , expected = ( "translate", "0px 20em 30em" )
          }
        , { description = "Translate.initXYZ with custom CSS unit writes XYZ"
          , initAxis =
                Translate.initXYZ animGroup 10 20 30
                    >> Translate.initCssUnit Em
          , expected = ( "translate", "10em 20em 30em" )
          }
        , { description = "Translate.initX prefers axis-specific unit when applied after global unit"
          ...
          , expected = ( "translate", "10px 0em 0em" )
          }
