...
{
	if (region.bp.bl === region.p.bl)
	{
		return 'on line ' + region.bp.bl;
	}
	return 'on lines ' + region.bp.bl + ' through ' + region.p.bl;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ew: 'hidden', dY: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ew: 'mozHidden', dY: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ew: 'msHidden', dY: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ew: 'webkitHidden', dY: 'webkitvisibilitychange' }
		: { ew: 'hidden', dY: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cI: fragment, cN: host, c3: path, c5: port_, c9: protocol, da: query};
	});
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'offset',
						$elm$json$Json$Encode$float(sample.cX)),
						_Utils_Tuple2(
						'value',
		...
		switch (property.$) {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bJ, config.bo))))))));
			case 1:
				var cssName = property.a;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bp));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bp));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bp));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bp));
			...
			default:
				var config = property.a;
				var _v12 = $author$project$Anim$Internal$Property$Translate$toTriple(config.p);
				var endX = _v12.a;
				var endY = _v12.b;
				var endZ = _v12.c;
				return $elm$json$Json$Encode$object(
...
var $author$project$Anim$Internal$Builder$getAnimTarget = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.q.br);
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.x.au));
	});
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {dJ: rgba_.dJ, es: rgba_.es, e7: rgba_.e7};
		case 3:
			var hsl_ = color.a;
		...
		default:
			...
			return {
				dJ: $elm$core$Basics$round(rgba_.b6 * 255),
				es: $elm$core$Basics$round(rgba_.cd * 255),
				e7: $elm$core$Basics$round(rgba_.cn * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.e7 - rgb1.e7;
		var dg = rgb2.es - rgb1.es;
		var db = rgb2.dJ - rgb1.dJ;
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Rotate$default, Z: $author$project$Anim$Internal$Property$Rotate$distance, _: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Rotate$speed, ak: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Scale$default, Z: $author$project$Anim$Internal$Property$Scale$distance, _: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Scale$speed, ak: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Skew$default, Z: $author$project$Anim$Internal$Property$Skew$distance, _: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Skew$speed, ak: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
		...
		function (_v0) {
			...
			return _Utils_Tuple2(
				...
				$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(
					...
					$elm$core$Maybe$Just(emitProgress))(config.l)(config.d)(config.e)(config.f)($elm$core$Dict$empty)(playback.u)(playback.z)(config.t));
		},
		$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.ce));
...
var $author$project$Anim$Internal$Builder$initAnimation = {B: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aO: $author$project$Anim$Internal$Builder$CssUnitStore$empty, s: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bu: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, U: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aC: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, b$: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {z: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bk: false, u: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bA: $elm$core$Maybe$Nothing, h: false, bX: $elm$core$Maybe$Nothing, br: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, m: $elm$core$Maybe$Nothing, n: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, O: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = function () {
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aG: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return A2(
		$elm$core$List$foldl,
		runInitEntry,
		{a: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: false, b: $author$project$Anim$Internal$Builder$initPlayback, q: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, x: $author$project$Anim$Internal$Builder$initState, l: 0});
}();
...
var $author$project$Animation$ViewTimeline$Main$cards = _List_fromArray(
	[
		{cy: 'view-card-1', aw: 'Each card uses a ViewTimeline tied to itself as the scroll subject. As the card enters the viewport, it fades in and slides upward.', ax: '#6366f1', aE: '01', aK: 'Enter from below'},
		{cy: 'view-card-2', aw: 'Every card has its own ViewTimeline. Animations are fully independent - each one triggers only when that specific card enters the viewport.', ax: '#8b5cf6', aE: '02', aK: 'Independent timelines'},
		{cy: 'view-card-3', aw: 'The rangeStart and rangeEnd functions define exactly when during the card\u0027s lifecycle the animation plays - entry, cover, contain, or exit.', ax: '#a78bfa', aE: '03', aK: 'Range control'},
		{cy: 'view-card-4', aw: 'View timeline animations are fire-and-forget. No AnimState required - just trigger in your init and the browser handles the rest.', ax: '#7c3aed', aE: '04', aK: 'Fire and forget'},
		{cy: 'view-card-5', aw: 'Combine opacity and translate in a single pipeline to create polished reveal effects with minimal code.', ax: '#5b21b6', aE: '05', aK: 'Composable builders'},
		{cy: 'view-card-6', aw: 'All animations run via the Web Animations API on the compositor thread - no JavaScript timers, no Elm subscriptions, maximum performance.', ax: '#4c1d95', aE: '06', aK: 'WAAPI powered'}
	]);
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {C: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cb: 0, bJ: $elm$core$Maybe$Nothing, p: defaultEnd, M: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.O);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.bU);
	});
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cb: A2($author$project$Anim$Internal$Property$Opacity$distance, startForDistance, clampedEnd),
						p: clampedEnd,
						bp: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cb: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						p: clampedEnd,
						bp: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cb: A2(calcDistance, startVal, end),
						p: end
					});
			}
		}
	...
	function (endPos, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					cb: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					p: endPos,
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cb: A2(distanceFn, startVal, newEnd),
				p: newEnd,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								$author$project$Animation$ViewTimeline$Main$revealCard(card.cy)))));
			},
...
var $author$project$Animation$ViewTimeline$Main$cardView = function (card) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			$author$project$Anim$Engine$ViewTimeline$attributes(card.cy),
			_List_fromArray(
				[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', card.ax),
...
var $author$project$Animation$ViewTimeline$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$ViewTimeline$Main$view
	});
