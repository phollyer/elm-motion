	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{du: x0, dK: (v0 + ((zeta * omega0) * x0)) / omegaD, ad: omega0, bN: omegaD, by: zeta});
		} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.N, dimensions.g);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bJ, config.bp))))))));
			case 1:
				var cssName = property.a;
...
var $author$project$Anim$Internal$Property$Size$default = {g: 0, N: 0};
...
var $author$project$Anim$Internal$Builder$initAnimation = {B: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aO: $author$project$Anim$Internal$Builder$CssUnitStore$empty, s: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bf: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, U: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aC: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, b$: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bA: $elm$core$Maybe$Nothing, h: false, bX: $elm$core$Maybe$Nothing, bs: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, m: $elm$core$Maybe$Nothing, n: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ao: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, O: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.S));
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {C: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cc: 0, bJ: $elm$core$Maybe$Nothing, p: defaultEnd, M: $author$project$Anim$Internal$Builder$Animate, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.O);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.bU);
	});
