...
{
	if (region.bq.bm === region.p.bm)
	{
		return 'on line ' + region.bq.bm;
	}
	return 'on lines ' + region.bq.bm + ' through ' + region.p.bm;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ex: 'hidden', dZ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ex: 'mozHidden', dZ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ex: 'msHidden', dZ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ex: 'webkitHidden', dZ: 'webkitvisibilitychange' }
		: { ex: 'hidden', dZ: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cJ: fragment, cO: host, c4: path, c6: port_, da: protocol, db: query};
	});
...
var $author$project$Motion$Easing$BounceInOut = {$: 5};
var $author$project$Anim$Engine$ViewTimeline$Cover = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Anim$Engine$ViewTimeline$Entry = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Anim$Engine$ViewTimeline$Perc = 0;
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'offset',
						$elm$json$Json$Encode$float(sample.cY)),
						_Utils_Tuple2(
						'value',
...
var $author$project$Anim$Internal$Property$Rotate$default = {al: 0, am: 0, an: 0};
var $author$project$Anim$Internal$Property$Rotate$support = {
	dw: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {al: a.al + b.al, am: a.am + b.am, an: a.an + b.an};
		}),
	...
	bW: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {al: angles.al * factor, am: angles.am * factor, an: angles.an * factor};
		}),
	fw: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.fO(coord);
		return _Utils_Tuple3(record.al, record.am, record.an);
	});
...
var $author$project$Anim$Internal$Property$Scale$default = {al: 1.0, am: 1.0, an: 1.0};
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bW: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {al: coords.al * factor, am: coords.am * factor, an: coords.an * factor};
		}),
	fw: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Translate$default = {al: 0, am: 0, an: 0};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.O, dimensions.g);
};
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.al, values.am);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'endValue',
												$elm$json$Json$Encode$float(config.p)),
												_Utils_Tuple2(
												'duration',
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bK, config.bp))))))));
			case 1:
				var cssName = property.a;
								...
								_Utils_ap(
									_List_fromArray(
										[
											...
											'endColor',
											$elm$json$Json$Encode$string(
												$author$project$Anim$Internal$Extra$Color$toCssString(config.p))),
											_Utils_Tuple2(
											'duration',
											$elm$json$Json$Encode$int(config.y)),
											_Utils_Tuple2(
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bq));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
								...
								_List_fromArray(
									[
										...
										$elm$json$Json$Encode$float(
											$author$project$Anim$Internal$Property$Opacity$toFloat(config.p))),
										_Utils_Tuple2(
										'duration',
										$elm$json$Json$Encode$int(config.y)),
										_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bq));
				var startX = _v1.a;
				var startY = _v1.b;
				var _v2 = $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple(config.p);
				var endX = _v2.a;
				var endY = _v2.b;
				return $elm$json$Json$Encode$object(
					A2(
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										'unitX',
										$elm$json$Json$Encode$string(
											$author$project$Anim$Internal$Unit$toCssSuffix(config.C.al))),
										_Utils_Tuple2(
										'unitY',
										$elm$json$Json$Encode$string(
											$author$project$Anim$Internal$Unit$toCssSuffix(config.C.am))),
										_Utils_Tuple2(
										'duration',
										$elm$json$Json$Encode$int(config.y)),
										_Utils_Tuple2(
			...
			case 5:
				var config = property.a;
				var _v3 = $author$project$Anim$Internal$Property$Scale$toTriple(config.p);
				var endX = _v3.a;
				var endY = _v3.b;
				var endZ = _v3.c;
				return $elm$json$Json$Encode$object(
			...
			case 4:
				var config = property.a;
				var _v4 = $author$project$Anim$Internal$Property$Rotate$toTriple(config.p);
				var endX = _v4.a;
				var endY = _v4.b;
				var endZ = _v4.c;
				return $elm$json$Json$Encode$object(
			...
			case 7:
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bq));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
				...
				var _v5 = $author$project$Anim$Internal$Property$Skew$toTuple(config.p);
				var endX = _v5.a;
				var endY = _v5.b;
				return $elm$json$Json$Encode$object(
					A2(
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bq));
				var startWidth = _v10.a;
				var startHeight = _v10.b;
				var _v11 = $author$project$Anim$Internal$Property$Size$toTuple(config.p);
				var endWidth = _v11.a;
			...
			default:
				var config = property.a;
				var _v14 = $author$project$Anim$Internal$Property$Translate$toTriple(config.p);
				var endX = _v14.a;
				var endY = _v14.b;
				var endZ = _v14.c;
				return $elm$json$Json$Encode$object(
								...
								_Utils_ap(
									_List_fromArray(
										[
											...
											'unitZ',
											$elm$json$Json$Encode$string(
												$author$project$Anim$Internal$Unit$toCssSuffix(config.C.an))),
											_Utils_Tuple2(
											'duration',
											$elm$json$Json$Encode$int(config.y)),
											_Utils_Tuple2(
...
var $author$project$Anim$Internal$Builder$getAnimTarget = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.q.bs);
	});
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.B);
	});
var $author$project$Anim$Internal$Builder$getScrollEmitProgressFor = F2(
	function (animGroupName, builder) {
		var data = builder;
		var globalEnabled = data.q.h;
...
var $author$project$Anim$Internal$Builder$getViewRangeEnd = function (_v0) {
	var data = _v0;
	return data.q.m;
};
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.v.ao));
	});
var $author$project$Anim$Internal$Builder$getViewRangeEndFor = F2(
	function (animGroupName, builder) {
		var data = builder;
		var fromHistory = A2(
			$elm$core$Maybe$andThen,
		...
		var fromCurrentConfig = A2(
			...
			A2($author$project$Anim$Internal$Builder$getAnimGroupConfig, animGroupName, builder));
		if (!fromHistory.$) {
			var viewRangeEnd = fromHistory.a;
			return $elm$core$Maybe$Just(viewRangeEnd);
		} else {
			if (!fromCurrentConfig.$) {
				var viewRangeEnd = fromCurrentConfig.a;
				return $elm$core$Maybe$Just(viewRangeEnd);
			} else {
				return data.q.m;
			}
...
var $author$project$Anim$Internal$Builder$getViewRangeStart = function (_v0) {
	var data = _v0;
	return data.q.n;
};
var $author$project$Anim$Internal$Builder$getViewRangeStartFor = F2(
	function (animGroupName, builder) {
		var data = builder;
		var fromHistory = A2(
			$elm$core$Maybe$andThen,
		...
		var fromCurrentConfig = A2(
			...
			A2($author$project$Anim$Internal$Builder$getAnimGroupConfig, animGroupName, builder));
		if (!fromHistory.$) {
			var viewRangeStart = fromHistory.a;
			return $elm$core$Maybe$Just(viewRangeStart);
		} else {
			if (!fromCurrentConfig.$) {
				var viewRangeStart = fromCurrentConfig.a;
				return $elm$core$Maybe$Just(viewRangeStart);
			} else {
				return data.q.n;
			}
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$default = {al: 50, am: 50};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {g: 0, O: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {al: 0, am: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.k / 100;
	var l = hslValue.j / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.g / 60, 2) - 1));
	var _v0 = (hslValue.g < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.g < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.g < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.g < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.g < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {dK: rgba_.dK, et: rgba_.et, e8: rgba_.e8};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{g: hsla_.g, j: hsla_.j, k: hsla_.k});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				dK: $elm$core$Basics$round(rgba_.b6 * 255),
				et: $elm$core$Basics$round(rgba_.ce * 255),
				e8: $elm$core$Basics$round(rgba_.co * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.e8 - rgb1.e8;
		var dg = rgb2.et - rgb1.et;
		var db = rgb2.dK - rgb1.dK;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fO(coord2);
		var record1 = support.fO(coord1);
		var dz = $elm$core$Basics$abs(record2.an - record1.an);
		var dy = $elm$core$Basics$abs(record2.am - record1.am);
		var dx = $elm$core$Basics$abs(record2.al - record1.al);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Size$distance = F2(
	function (_v0, _v1) {
		var start = _v0;
		var end = _v1;
		var dw = end.O - start.O;
		var dh = end.g - start.g;
...
var $author$project$Anim$Internal$Builder$perspectiveOriginStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			...
			animGroupName,
			{al: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginX, am: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginY, an: ''},
			defaults.K);
	});
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var distance_ = A2(distanceFn, start, config.p);
	...
	return wrapper(
		{
			C: A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, config.C, globalCssUnit, defaultCssUnit),
			w: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.w, globalData.as, 0),
			cc: distance_,
...
var $author$project$Anim$Internal$Builder$sizeStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{al: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, am: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, an: ''},
			defaults.K);
	});
...
var $author$project$Anim$Internal$Builder$translateStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{al: $author$project$Anim$Internal$Builder$CssUnitStore$translateX, am: $author$project$Anim$Internal$Builder$CssUnitStore$translateY, an: $author$project$Anim$Internal$Builder$CssUnitStore$translateZ},
			defaults.K);
	});
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.i,
							aa: globalData,
							ai: $author$project$Shared$TimeSpec$speed,
							ak: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
				var config = property.b;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.i,
							aa: globalData,
							ai: $author$project$Anim$Internal$Extra$Color$speed,
							ak: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.i,
							aa: globalData,
							ai: $author$project$Anim$Internal$Property$Opacity$speed,
							ak: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.i,
							aa: globalData,
							ai: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed,
							ak: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig
						}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Rotate$default, Z: $author$project$Anim$Internal$Property$Rotate$distance, _: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Rotate$speed, ak: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Scale$default, Z: $author$project$Anim$Internal$Property$Scale$distance, _: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Scale$speed, ak: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.V,
							aa: globalData,
							ai: $author$project$Anim$Internal$Property$Size$speed,
							ak: $author$project$Anim$Internal$Builder$ProcessedSizeConfig
						}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Skew$default, Z: $author$project$Anim$Internal$Property$Skew$distance, _: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, aa: globalData, ai: $author$project$Anim$Internal$Property$Skew$speed, ak: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							i: globalData.i,
							aa: globalData,
							ai: $author$project$Anim$Internal$Property$Translate$speed,
							ak: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig
						}));
		}
	});
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.v.ao);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.F.b8);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.aq, history.aT));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.T)));
	};
					...
					return {
						...
						r: function () {
							...
							if (!_v4.$) {
								...
								return groupDefaults.aD;
							}
						}(),
						l: A2($elm$core$Maybe$withDefault, data.l, group.l),
						m: group.m,
						n: group.n
					};
				}),
...
var $author$project$Anim$Internal$Builder$resolvePlayback = F3(
	function (globalIterations, globalDirection, maybePlayback) {
		if (maybePlayback.$ === 1) {
			return {z: globalDirection, u: globalIterations};
		} else {
			var playback = maybePlayback.a;
			return {
				z: A2($elm$core$Maybe$withDefault, globalDirection, playback.z),
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeView = function (builder) {
	var rangeFields = A2(
		$elm$core$List$filterMap,
		$elm$core$Basics$identity,
		_List_fromArray(
			[
				...
				$author$project$Anim$Internal$Builder$getViewRangeStart(builder)),
				A2(
				$elm$core$Maybe$map,
				function (r) {
					return _Utils_Tuple2(
				...
				$author$project$Anim$Internal$Builder$getViewRangeEnd(builder))
			]));
	...
	var elements = A2(
		...
		function (_v0) {
			...
			var config = _v0.b;
			var playback = A3($author$project$Anim$Internal$Builder$resolvePlayback, processed.u, processed.z, config.b);
			var emitProgress = A2(
				$elm$core$Maybe$withDefault,
			...
			return _Utils_Tuple2(
				...
				$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(
					A2(
						$elm$core$Maybe$withDefault,
						animGroupName,
						A2($author$project$Anim$Internal$Builder$getAnimTarget, animGroupName, builder)))($elm$core$Maybe$Nothing)(config.r)($elm$core$Maybe$Nothing)(
					A2($author$project$Anim$Internal$Builder$getViewRangeStartFor, animGroupName, builder))(
					A2($author$project$Anim$Internal$Builder$getViewRangeEndFor, animGroupName, builder))(
					$elm$core$Maybe$Just(emitProgress))(config.l)(config.d)(config.e)(config.f)(config.b8)(config.b8)(playback.u)(playback.z)(config.t));
		},
		$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cf));
	...
	var timelineBase = _List_fromArray(
		[
			_Utils_Tuple2(
			'type',
			$elm$json$Json$Encode$string('view')),
			_Utils_Tuple2(
			'axis',
		...
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'type',
					$elm$json$Json$Encode$string('viewDriven')),
					_Utils_Tuple2(
					'timeline',
					$elm$json$Json$Encode$object(
						_Utils_ap(timelineBase, rangeFields))),
					_Utils_Tuple2(
					'elements',
					...
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.z)),
					_Utils_Tuple2(
					'emitProgress',
					$elm$json$Json$Encode$bool(
...
var $author$project$Anim$Internal$Builder$initAnimation = {B: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aO: $author$project$Anim$Internal$Builder$CssUnitStore$empty, s: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, T: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bf: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Unit$emptyCssUnitAxes = {al: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initDefaults = {K: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, V: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aC: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, bv: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {z: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bl: false, u: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bB: $elm$core$Maybe$Nothing, h: false, bY: $elm$core$Maybe$Nothing, bs: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, m: $elm$core$Maybe$Nothing, n: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ao: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = function () {
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aG: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return A2(
		$elm$core$List$foldl,
		runInitEntry,
		{a: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: false, b: $author$project$Anim$Internal$Builder$initPlayback, q: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, v: $author$project$Anim$Internal$Builder$initState, l: 0});
}();
var $author$project$Anim$Internal$Engine$ViewTimeline$animate = F2(
	function (sendToPort, pipeline) {
		return sendToPort(
			$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeView(
				$author$project$Anim$Internal$Builder$init(
					_List_fromArray(
						[pipeline]))));
	});
var $author$project$Anim$Engine$ViewTimeline$animate = $author$project$Anim$Internal$Engine$ViewTimeline$animate;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Animation$ViewTimeline$Main$cards = _List_fromArray(
	[
		{cz: 'view-card-1', ay: 'Each card uses a ViewTimeline tied to itself as the scroll subject. As the card enters the viewport, it fades in and slides upward.', az: '#6366f1', aE: '01', aK: 'Enter from below'},
		{cz: 'view-card-2', ay: 'Every card has its own ViewTimeline. Animations are fully independent - each one triggers only when that specific card enters the viewport.', az: '#8b5cf6', aE: '02', aK: 'Independent timelines'},
		{cz: 'view-card-3', ay: 'The rangeStart and rangeEnd functions define exactly when during the card\u0027s lifecycle the animation plays - entry, cover, contain, or exit.', az: '#a78bfa', aE: '03', aK: 'Range control'},
		{cz: 'view-card-4', ay: 'View timeline animations are fire-and-forget. No AnimState required - just trigger in your init and the browser handles the rest.', az: '#7c3aed', aE: '04', aK: 'Fire and forget'},
		{cz: 'view-card-5', ay: 'Combine opacity and translate in a single pipeline to create polished reveal effects with minimal code.', az: '#5b21b6', aE: '05', aK: 'Composable builders'},
		{cz: 'view-card-6', ay: 'All animations run via the Web Animations API on the compositor thread - no JavaScript timers, no Elm subscriptions, maximum performance.', az: '#4c1d95', aE: '06', aK: 'WAAPI powered'}
	]);
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.T));
...
var $author$project$Anim$Engine$ViewTimeline$easing = $author$project$Anim$Internal$Builder$easing;
var $author$project$Animation$ViewTimeline$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
	...
	function (config, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var mergedConfig = function () {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animKey, anim.B);
				if (!_v2.$) {
					var existing = _v2.a;
					var mergedOrder = function () {
						var _v15 = configWithDiscreteSnapshot.r;
						if (!_v15.$) {
							return configWithDiscreteSnapshot.r;
						} else {
							return existing.r;
						}
					}();
					...
					return _Utils_update(
						existing,
						{
								...
								if (!_v7.b.$) {
									if (!_v7.a.$) {
										...
										return $elm$core$Maybe$Just(
											{
												z: function () {
													var _v8 = incomingPlayback.z;
													if (!_v8.$) {
														return incomingPlayback.z;
													} else {
														return existingPlayback.z;
													}
												}(),
												u: function () {
							...
							r: mergedOrder,
							l: function () {
								var _v12 = configWithDiscreteSnapshot.l;
								if (!_v12.$) {
							...
							m: function () {
								var _v13 = configWithDiscreteSnapshot.m;
								if (!_v13.$) {
									return configWithDiscreteSnapshot.m;
								} else {
									return existing.m;
								}
							}(),
							n: function () {
								var _v14 = configWithDiscreteSnapshot.n;
								if (!_v14.$) {
									return configWithDiscreteSnapshot.n;
								} else {
									return existing.n;
								}
							}()
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{
							B: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animKey, mergedConfig, anim.B),
							T: A3(
...
var $author$project$Anim$Internal$Builder$setViewRangeEnd = F2(
	function (range, _v0) {
		var data = _v0;
		var _v1 = data.a.s;
		if (_v1.$ === 1) {
...
var $author$project$Anim$Internal$Engine$ViewTimeline$rangeEnd = $author$project$Anim$Internal$Builder$setViewRangeEnd;
var $author$project$Anim$Engine$ViewTimeline$unitToString = function (unit) {
	if (!unit) {
		return '%';
	} else {
		return 'px';
...
var $author$project$Anim$Engine$ViewTimeline$rangeToString = function (range) {
	switch (range.$) {
		case 0:
			var n = range.a;
			var u = range.b;
			return 'cover ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		case 1:
			var n = range.a;
			var u = range.b;
			return 'contain ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		case 2:
			var n = range.a;
			var u = range.b;
			return 'entry ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		case 3:
			var n = range.a;
			var u = range.b;
			return 'entry-crossing ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		case 4:
			var n = range.a;
			var u = range.b;
			return 'exit ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		case 5:
			var n = range.a;
			var u = range.b;
			return 'exit-crossing ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
		default:
			var n = range.a;
			var u = range.b;
			return 'scroll ' + ($elm$core$String$fromFloat(n) + $author$project$Anim$Engine$ViewTimeline$unitToString(u));
	}
};
var $author$project$Anim$Engine$ViewTimeline$rangeEnd = function (range) {
	return $author$project$Anim$Internal$Engine$ViewTimeline$rangeEnd(
		$author$project$Anim$Engine$ViewTimeline$rangeToString(range));
};
var $author$project$Anim$Internal$Builder$setViewRangeStart = F2(
	function (range, _v0) {
		var data = _v0;
		var _v1 = data.a.s;
		if (_v1.$ === 1) {
...
var $author$project$Anim$Internal$Engine$ViewTimeline$rangeStart = $author$project$Anim$Internal$Builder$setViewRangeStart;
var $author$project$Anim$Engine$ViewTimeline$rangeStart = function (range) {
	return $author$project$Anim$Internal$Engine$ViewTimeline$rangeStart(
		$author$project$Anim$Engine$ViewTimeline$rangeToString(range));
};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {C: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cc: 0, bK: $elm$core$Maybe$Nothing, p: defaultEnd, N: $author$project$Anim$Internal$Builder$Animate, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.T));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.P);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.bV);
	});
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				var clampedEnd = clampValue(config.p);
	...
	if (_v1.$ === 1) {
		...
		return A2(
			...
			A2(
						...
						config,
						{
							...
							l: function () {
								...
								if (!_v6.$) {
									...
									return $elm$core$Maybe$Just(data.l);
								}
							}(),
							m: function () {
								var _v7 = config.m;
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.B)));
	}
};
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var endRecord = toRec(config.p);
				var end = fromRec(
					{
						al: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.al : endRecord.al,
						am: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.am : endRecord.am,
						an: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.an : endRecord.an
					});
				return _Utils_update(
					config,
					{
...
var $author$project$Anim$Engine$ViewTimeline$for = $author$project$Anim$Internal$Builder$for;
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bq: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bq);
		return A4(
...
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bq);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					...
					p: endPos,
					bq: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Translate$toY = F2(
	function (y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Property$Translate$getZ(config.p);
		var x = $author$project$Anim$Internal$Property$Translate$getX(config.p);
...
var $author$project$Animation$ViewTimeline$Main$revealCard = function (animGroupName) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$ViewTimeline$for(animGroupName),
		A2(
			$elm$core$Basics$composeR,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Property$Translate$fromY(100),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Translate$toY(0),
									$author$project$Anim$Property$Translate$end))))))));
};
var $author$project$Animation$ViewTimeline$Main$init = _Utils_Tuple2(
	0,
	$elm$core$Platform$Cmd$batch(
		A2(
			...
			function (card) {
				return A2(
					$author$project$Anim$Engine$ViewTimeline$animate,
					$author$project$Animation$ViewTimeline$Main$motionCmd,
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$ViewTimeline$rangeStart(
							A2($author$project$Anim$Engine$ViewTimeline$Entry, 10, 0)),
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$ViewTimeline$rangeEnd(
								A2($author$project$Anim$Engine$ViewTimeline$Cover, 30, 0)),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$ViewTimeline$easing($author$project$Motion$Easing$BounceInOut),
								$author$project$Animation$ViewTimeline$Main$revealCard(card.cz)))));
			},
			$author$project$Animation$ViewTimeline$Main$cards)));
...
var $author$project$Anim$Internal$Engine$ViewTimeline$attributes = function (animGroupName) {
	return _List_fromArray(
		[
			A2($elm$html$Html$Attributes$attribute, 'data-anim-target', animGroupName)
		]);
};
var $author$project$Anim$Engine$ViewTimeline$attributes = $author$project$Anim$Internal$Engine$ViewTimeline$attributes;
...
var $author$project$Animation$ViewTimeline$Main$cardView = function (card) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			$author$project$Anim$Engine$ViewTimeline$attributes(card.cz),
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'padding', 'clamp(18px, 4vmin, 32px)'),
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', card.az),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(card.ay)
					]))
			]));
};
var $author$project$Animation$ViewTimeline$Main$view = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background', '#f9fafb')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'padding', '80px 40px 60px'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('View Timeline')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Scroll down - each card animates as it enters the viewport.')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'padding', 'clamp(24px, 6vmin, 60px) clamp(16px, 4.5vmin, 40px)'),
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
						A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
						A2($elm$html$Html$Attributes$style, 'gap', 'clamp(28px, 6vmin, 60px)')
					]),
				A2($elm$core$List$map, $author$project$Animation$ViewTimeline$Main$cardView, $author$project$Animation$ViewTimeline$Main$cards))
			]));
};
var $author$project$Animation$ViewTimeline$Main$main = $elm$browser$Browser$element(
	{
		eE: function (_v0) {
			return $author$project$Animation$ViewTimeline$Main$init;
		},
		...
		fW: $author$project$Animation$ViewTimeline$Main$view
	});
_Platform_export({'Animation':{'ViewTimeline':{'Main':{'init':$author$project$Animation$ViewTimeline$Main$main(
