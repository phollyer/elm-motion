		...
		return A4(
			...
			_Utils_update(
				config,
				{
					...
					m: endValue,
					bm: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$BorderRadius$Main$animGroup, model.ar),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$BorderRadius$Main$update,
		f$: $author$project$Animation$Keyframe$BorderRadius$Main$view
	});
