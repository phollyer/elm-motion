...
var $author$project$Anim$Property$Custom$BorderRadius = function (a) {
	return {$: 4, a: a};
};
var $author$project$Anim$Unit$Px = 30;
var $author$project$Animation$Keyframe$BorderRadius$Main$animGroup = 'boxAnim';
...
var $author$project$Anim$Internal$Builder$CustomPropertyConfig = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
...
var $author$project$Anim$Internal$Property$Custom$applyClamps = F3(
	function (cssName, builder, config) {
		var _v0 = $author$project$Anim$Internal$Builder$getCurrentAnimGroupName(builder);
		if (_v0.$ === 1) {
			return config;
		} else {
			var animGroupName = _v0.a;
			var _v1 = A4($author$project$Anim$Internal$Builder$getClamp, animGroupName, 'custom:' + cssName, 'value', builder);
			if (_v1.$ === 1) {
				return config;
			} else {
				var _v2 = _v1.a;
				...
				var clampedStart = A2(
					$elm$core$Maybe$map,
					A2($elm$core$Basics$clamp, lo, hi),
					config.bn);
				var startForDistance = A2($elm$core$Maybe$withDefault, 0, clampedStart);
				var clampedEnd = A3($elm$core$Basics$clamp, lo, hi, config.m);
				return _Utils_update(
					config,
					{
						ce: $elm$core$Basics$abs(clampedEnd - startForDistance),
						m: clampedEnd,
						bn: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Property$Custom$build = function (_v0) {
	var cssName = _v0.a;
	var unit = _v0.b;
	var config = _v0.c;
	var builder = _v0.d;
	var clampedConfig = A3($author$project$Anim$Internal$Property$Custom$applyClamps, cssName, builder, config);
	return A2(
		$author$project$Anim$Internal$Builder$Property$upsert,
		A3($author$project$Anim$Internal$Builder$CustomPropertyConfig, cssName, unit, clampedConfig),
		builder);
};
var $author$project$Anim$Internal$Property$Custom$Builder = F4(
	function (a, b, c, d) {
		return {$: 0, a: a, b: b, c: c, d: d};
	});
...
var $author$project$Anim$Internal$Property$Custom$defaultConfig = $author$project$Anim$Internal$Builder$Property$defaultConfig(0);
...
var $author$project$Anim$Internal$Property$Custom$for = F4(
	function (animGroupName, cssPropertyName, unit, builder) {
		var extractExisting = function (propertyConfig) {
			if (!propertyConfig.$) {
				var name = propertyConfig.a;
				var cfg = propertyConfig.c;
		...
		var config = A6(
			...
			animGroupName,
			'custom:' + cssPropertyName,
			$author$project$Anim$Internal$Builder$PropertyBaselines$getCustomProperty(cssPropertyName),
			extractExisting,
			$author$project$Anim$Internal$Property$Custom$defaultConfig,
			builder);
		return A4(
			$author$project$Anim$Internal$Property$Custom$Builder,
			cssPropertyName,
			unit,
			config,
			A2($author$project$Anim$Internal$Builder$for, animGroupName, builder));
	});
var $author$project$Anim$Internal$Property$Custom$from = F2(
	function (value, _v0) {
		var cssName = _v0.a;
		var unit = _v0.b;
		var config = _v0.c;
...
var $author$project$Anim$Internal$Property$Custom$to = F2(
	function (endValue, _v0) {
		var cssName = _v0.a;
		var unit = _v0.b;
		var config = _v0.c;
		var builder = _v0.d;
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					ce: $elm$core$Basics$abs(endValue - startValue),
					m: endValue,
					bn: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
var $author$project$Anim$Property$Custom$toCssArgs = function (cssProperty) {
	switch (cssProperty.$) {
		case 0:
			var unit = cssProperty.a;
			return _Utils_Tuple2(
				'border-bottom-left-radius',
				$author$project$Anim$Internal$Unit$toCssSuffix(unit));
		case 1:
			var unit = cssProperty.a;
			return _Utils_Tuple2(
		...
		case 42:
			...
			return _Utils_Tuple2(
				...
				$author$project$Anim$Internal$Unit$toCssSuffix(unit));
		case 43:
			return _Utils_Tuple2('flex-grow', '');
		case 44:
			return _Utils_Tuple2('flex-shrink', '');
		case 45:
			return _Utils_Tuple2('cx', '');
		case 46:
			return _Utils_Tuple2('cy', '');
		case 47:
			return _Utils_Tuple2('r', '');
		case 48:
			return _Utils_Tuple2('rx', '');
		case 49:
			return _Utils_Tuple2('ry', '');
		case 50:
			return _Utils_Tuple2('stroke-dashoffset', '');
		case 51:
			return _Utils_Tuple2('stroke-width', '');
		default:
			var name = cssProperty.a;
			var unit = cssProperty.b;
			return _Utils_Tuple2(name, unit);
	}
};
var $author$project$Anim$Property$Custom$init = F4(
	function (animGroupName, cssProperty, value, animBuilder) {
		var _v0 = $author$project$Anim$Property$Custom$toCssArgs(cssProperty);
		var name = _v0.a;
		var unit = _v0.b;
		return $author$project$Anim$Internal$Property$Custom$build(
			A2(
				$author$project$Anim$Internal$Property$Custom$to,
				value,
				A2(
					$author$project$Anim$Internal$Property$Custom$from,
					value,
					A4($author$project$Anim$Internal$Property$Custom$for, animGroupName, name, unit, animBuilder))));
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$Keyframe$BorderRadius$Main$init = _Utils_Tuple2(
	{
		au: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A3(
					$author$project$Anim$Property$Custom$init,
					$author$project$Animation$Keyframe$BorderRadius$Main$animGroup,
					$author$project$Anim$Property$Custom$BorderRadius(30),
					0)
				]))
	},
...
var $author$project$Anim$Property$Custom$begin = F2(
	function (cssProperty, animBuilder) {
		var _v0 = $author$project$Anim$Property$Custom$toCssArgs(cssProperty);
		var name = _v0.a;
		var unit = _v0.b;
		var _v1 = $author$project$Anim$Internal$Builder$getCurrentAnimGroupName(animBuilder);
		if (!_v1.$) {
			var animGroupName = _v1.a;
			return A4($author$project$Anim$Internal$Property$Custom$for, animGroupName, name, unit, animBuilder);
		} else {
			return A4($author$project$Anim$Internal$Property$Custom$for, '', name, unit, animBuilder);
		}
	});
var $author$project$Anim$Property$Custom$end = $author$project$Anim$Internal$Property$Custom$build;
var $author$project$Motion$Easing$CubicInOut = {$: 12};
...
var $author$project$Anim$Internal$Property$Custom$duration = F2(
	function (dur, _v0) {
		var cssName = _v0.a;
		var unit = _v0.b;
		var config = _v0.c;
...
var $author$project$Anim$Property$Custom$duration = $author$project$Anim$Internal$Property$Custom$duration;
...
var $author$project$Anim$Internal$Property$Custom$easing = F2(
	function (ease, _v0) {
		var cssName = _v0.a;
		var unit = _v0.b;
		var config = _v0.c;
...
var $author$project$Anim$Property$Custom$easing = $author$project$Anim$Internal$Property$Custom$easing;
var $author$project$Animation$Keyframe$BorderRadius$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Custom$duration(800),
	$author$project$Anim$Property$Custom$easing($author$project$Motion$Easing$CubicInOut));
var $author$project$Anim$Property$Custom$to = $author$project$Anim$Internal$Property$Custom$to;
var $author$project$Animation$Keyframe$BorderRadius$Main$roundCorners = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Custom$begin(
		$author$project$Anim$Property$Custom$BorderRadius(30)),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Custom$to(48),
		A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$BorderRadius$Main$standardTiming, $author$project$Anim$Property$Custom$end)));
var $author$project$Animation$Keyframe$BorderRadius$Main$squareCorners = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Custom$begin(
		$author$project$Anim$Property$Custom$BorderRadius(30)),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Custom$to(0),
		A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$BorderRadius$Main$standardTiming, $author$project$Anim$Property$Custom$end)));
var $author$project$Animation$Keyframe$BorderRadius$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$BorderRadius$Main$animGroup),
								$author$project$Animation$Keyframe$BorderRadius$Main$roundCorners))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
					...
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$BorderRadius$Main$animGroup),
								$author$project$Animation$Keyframe$BorderRadius$Main$squareCorners))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$BorderRadius$Main$TriggerRound = 0;
var $author$project$Animation$Keyframe$BorderRadius$Main$TriggerSquare = 1;
...
var $author$project$Animation$Keyframe$BorderRadius$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$BorderRadius$Main$animGroup, model.au),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$BorderRadius$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$BorderRadius$Main$update,
		f0: $author$project$Animation$Keyframe$BorderRadius$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'BorderRadius':{'Main':{'init':$author$project$Animation$Keyframe$BorderRadius$Main$main(
