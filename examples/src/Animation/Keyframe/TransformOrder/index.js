...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bb: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ar: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, b$: $elm$core$Set$empty, av: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {by: $elm$core$Maybe$Nothing, g: false, bX: $elm$core$Maybe$Nothing, bq: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {an: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						b0: A2($author$project$Anim$Internal$Property$Translate$toCssString, config.z, config.m)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bS: '', bV: '', bW: '', b0: ''};
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b0, transformParts.bS, transformParts.bW, transformParts.bV]);
				} else {
...
var $author$project$Anim$Internal$Property$Size$default = {cW: 0, K: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ad: omega0, bN: omegaD, bw: zeta});
		} else {
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cW: start.cW + ((endSize.cW - start.cW) * t), K: start.K + ((endSize.K - start.K) * t)};
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cd: $elm$core$Dict$empty, ce: $elm$core$Dict$empty, bj: 0, bM: $elm$core$Maybe$Nothing, aU: 0, cw: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cD: ''};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.K, dimensions.cW);
};
			...
			return _Utils_update(
				data,
				{
					...
					c: _Utils_update(
						defs,
						{
							W: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defs.W)
						})
				});
		}
	});
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cf: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.Q));
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							S: A2($elm$core$List$member, perm, model.S) ? model.S : A2($elm$core$List$cons, perm, model.S)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							L: A2(
								...
								A3(
									...
									$elm$core$Basics$identity,
									$author$project$Animation$Keyframe$TransformOrder$Main$allPermutations)),
							S: $author$project$Animation$Keyframe$TransformOrder$Main$allPermutations
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Keyframe$TransformOrder$Main$animationArea(model.L)
			]));
};
