...
{
	if (region.bo.bk === region.m.bk)
	{
		return 'on line ' + region.bo.bk;
	}
	return 'on lines ' + region.bo.bk + ' through ' + region.m.bk;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eG: 'hidden', d8: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eG: 'mozHidden', d8: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eG: 'msHidden', d8: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eG: 'webkitHidden', d8: 'webkitvisibilitychange' }
		: { eG: 'hidden', d8: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cT: fragment, c_: host, dg: path, di: port_, dl: protocol, dm: query};
	});
...
var $author$project$Animation$Keyframe$TransformOrder$Main$RSkTS = 5;
var $author$project$Animation$Keyframe$TransformOrder$Main$RTSkS = 2;
var $author$project$Animation$Keyframe$TransformOrder$Main$STRSk = 4;
var $author$project$Animation$Keyframe$TransformOrder$Main$SkTRS = 3;
var $author$project$Animation$Keyframe$TransformOrder$Main$TRSkS = 0;
var $author$project$Animation$Keyframe$TransformOrder$Main$TSkRS = 1;
var $author$project$Animation$Keyframe$TransformOrder$Main$allPermutations = _List_fromArray(
	[0, 1, 2, 3, 4, 5]);
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bb: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bT: '', bW: '', bX: '', b0: ''};
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'rotateX(' + ($elm$core$String$fromFloat(angles.ak) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.al)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.al) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.am)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.am) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'skewX(' + ($elm$core$String$fromFloat(values.ak) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.al)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.al) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = F2(
	function (axes, _v0) {
		var coords = _v0;
		return 'translate3d(' + ($elm$core$String$fromFloat(coords.ak) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ak) + (', ' + ($elm$core$String$fromFloat(coords.al) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.al) + (', ' + ($elm$core$String$fromFloat(coords.am) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.am) + ')'))))))));
	});
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {ak: 0, al: 0, am: 0};
var $author$project$Anim$Internal$Property$Translate$support = {
	dH: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {ak: a.ak + b.ak, al: a.al + b.al, am: a.am + b.am};
		}),
	em: $author$project$Anim$Internal$Property$Translate$default,
	eC: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {ak: coords.ak * factor, al: coords.al * factor, am: coords.am * factor};
		}),
	fC: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss = F3(
	function (maybeControlledAxes, cssUnitAxes, value) {
		...
		if (!_v0.$) {
			var axes = _v0.a;
			var zSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.am);
			var ySuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.al);
			var xSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.ak);
				...
				A2(
					...
					_List_fromArray(
						[
							...
							'translateX(' + ($elm$core$String$fromFloat(coords.ak) + (xSuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasY ? $elm$core$Maybe$Just(
							'translateY(' + ($elm$core$String$fromFloat(coords.al) + (ySuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasZ ? $elm$core$Maybe$Just(
							'translateZ(' + ($elm$core$String$fromFloat(coords.am) + (zSuffix + ')'))) : $elm$core$Maybe$Nothing
						])));
					...
					switch (property.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									b0: A3($author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss, maybeControlledAxes, config.z, config.m)
								});
						case 4:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bT: $author$project$Anim$Internal$Property$Rotate$toCssString(config.m)
								});
						case 7:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bX: $author$project$Anim$Internal$Property$Skew$toCssString(config.m)
								});
						case 5:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bW: $author$project$Anim$Internal$Property$Scale$toCssString(config.m)
								});
						default:
							return acc;
					}
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b0, transformParts.bT, transformParts.bX, transformParts.bW]);
				} else {
					...
					return A2(
						...
						function (o) {
							var part = function () {
								switch (o) {
									case 0:
										return transformParts.b0;
									case 1:
										return transformParts.bT;
									case 2:
										return transformParts.bX;
									default:
			...
			return {
				...
				b0: A3(
					...
					A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							{ak: $author$project$Anim$Internal$Unit$default, al: $author$project$Anim$Internal$Unit$default, am: $author$project$Anim$Internal$Unit$default},
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.cW),
			$author$project$Anim$Internal$Unit$toCssSuffix(axes.al));
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString = F2(
	function (axes, _v0) {
		var y = _v0.al;
		var x = _v0.ak;
		return $elm$core$String$fromFloat(x) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ak) + (' ' + ($elm$core$String$fromFloat(y) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.al))));
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$default = {ak: 50, al: 50};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cW: 0, L: 0};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var k = A2($elm$core$Basics$max, 0, spring.aX);
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.bo);
		...
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					{
						bJ: 0,
						bn: $author$project$Motion$Internal$Spring$unwrap(s),
						b$: 1
					},
					linearProgress * cfg.v);
			} else {
				return A2($author$project$Shared$Easing$toFunction, cfg.bI, linearProgress);
			}
		}();
		return toCssString(
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cJ: rgba_.cJ, cV: rgba_.cV, dn: rgba_.dn};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cW: hsla_.cW, c3: hsla_.c3, dq: hsla_.dq});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cJ: $elm$core$Basics$round(rgba_.b7 * 255),
				cV: $elm$core$Basics$round(rgba_.cj * 255),
				dn: $elm$core$Basics$round(rgba_.cv * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cW: hslaValue.cW, c3: hslaValue.c3, dq: hslaValue.dq};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cF: 1.0, cW: hslValue.cW, c3: hslValue.c3, dq: hslValue.dq};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cF: alpha_, cJ: rgb_.cJ, cV: rgb_.cV, dn: rgb_.dn};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cW: hslaValue.cW, c3: hslaValue.c3, dq: hslaValue.dq});
	return {cF: hslaValue.cF, cJ: rgb_.cJ, cV: rgb_.cV, dn: rgb_.dn};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cF: 1.0, cJ: rgb_.cJ, cV: rgb_.cV, dn: rgb_.dn};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var b = $elm$core$Basics$round(startRgb.cJ + ((endRgb.cJ - startRgb.cJ) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cJ: b, cV: g, dn: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var b = $elm$core$Basics$round(startRgba.cJ + ((endRgba.cJ - startRgba.cJ) * t));
							var a = startRgba.cF + ((endRgba.cF - startRgba.cF) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var l = startHsl.c3 + ((endHsl.c3 - startHsl.c3) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var l = startHsla.c3 + ((endHsla.c3 - startHsla.c3) * t);
							var h = startHsla.cW + ((endHsla.cW - startHsla.cW) * t);
							var a = startHsla.cF + ((endHsla.cF - startHsla.cF) * t);
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate = F3(
	function (t, start, end) {
		...
		var ex = _v1.a;
		var ey = _v1.b;
		return {ak: sx + ((ex - sx) * t), al: sy + ((ey - sy) * t)};
	});
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cW: start.cW + ((endSize.cW - start.cW) * t), L: start.L + ((endSize.L - start.L) * t)};
	});
...
var $author$project$Anim$Internal$Property$Rotate$default = {ak: 0, al: 0, am: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {ak: 1.0, al: 1.0, am: 1.0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {ak: 0, al: 0};
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.fW(start);
		var endRecord = support.fW(end);
		return support.eC(
			{ak: startRecord.ak + ((endRecord.ak - startRecord.ak) * t), al: startRecord.al + ((endRecord.al - startRecord.al) * t), am: startRecord.am + ((endRecord.am - startRecord.am) * t)});
	});
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	em: $author$project$Anim$Internal$Property$Rotate$default,
	eC: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {ak: angles.ak * factor, al: angles.al * factor, am: angles.am * factor};
		}),
	fC: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	em: $author$project$Anim$Internal$Property$Scale$default,
	eC: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.ak, values.al);
};
					...
					switch (p.$) {
						...
						case 4:
							...
							return _Utils_update(
								acc,
								{
									bT: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Rotate$default, $author$project$Anim$Internal$Property$Rotate$interpolate, $author$project$Anim$Internal$Property$Rotate$toCssString, cfg)
								});
						case 5:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bW: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Scale$default, $author$project$Anim$Internal$Property$Scale$interpolate, $author$project$Anim$Internal$Property$Scale$toCssString, cfg)
								});
						case 7:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bX: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$interpolate, $author$project$Anim$Internal$Property$Skew$toCssString, cfg)
								});
						default:
							return acc;
					}
	...
	function (controlledAxes, maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.ci));
			var entryStyles = $elm$core$Dict$toList(discrete.ch);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cd: $elm$core$Dict$empty, ce: $elm$core$Dict$empty, bj: 0, bN: $elm$core$Maybe$Nothing, aU: 0, cw: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cD: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b6: '', cc: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, co: ''};
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							a2: A2($elm$core$List$cons, prop, acc.a2)
						});
				case 1:
					return _Utils_update(
						acc,
						{
							a9: A2($elm$core$List$cons, prop, acc.a9)
						});
				default:
					return acc;
			}
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setAnimation = F2(
	function (animation, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				bN: $elm$core$Maybe$Just(animation)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F9(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, controlledAxes, properties) {
		var animated = $author$project$Anim$Internal$Builder$partitionByMode(properties).a2;
		return function (animGroup) {
			if ($elm$core$List$isEmpty(animated) && ($elm$core$Dict$isEmpty(discrete.ch) && $elm$core$Dict$isEmpty(discrete.ci))) {
				return animGroup;
			} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cW);
};
var $author$project$Anim$Internal$Property$Size$toCssString = F2(
	function (axes, size) {
		...
		var width = _v0.a;
		var height = _v0.b;
		return 'width: ' + ($elm$core$String$fromFloat(width) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ak) + ('; height: ' + ($elm$core$String$fromFloat(height) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.al)))));
	});
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
			...
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.v) + ('-' + ($elm$core$String$fromInt(cfg.t) + ('-' + (toCssString(cfg.m) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.bo))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.ch),
				stringifyExitDict(discrete.ci));
		}();
...
var $author$project$Anim$Internal$Unit$emptyCssUnitAxes = {ak: $elm$core$Maybe$Nothing, al: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ar: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, U: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, bt: $elm$core$Set$empty, av: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bi: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bz: $elm$core$Maybe$Nothing, g: false, bY: $elm$core$Maybe$Nothing, bq: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {an: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, N: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, av: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Builder$perspectiveOriginStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			...
			animGroupName,
			{ak: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginX, al: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginY, am: ''},
			defaults.H);
	});
...
var $author$project$Anim$Internal$Builder$sizeStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{ak: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, al: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, am: ''},
			defaults.H);
	});
...
var $author$project$Anim$Internal$Builder$translateStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{ak: $author$project$Anim$Internal$Builder$CssUnitStore$translateX, al: $author$project$Anim$Internal$Builder$CssUnitStore$translateY, am: $author$project$Anim$Internal$Builder$CssUnitStore$translateZ},
			defaults.H);
	});
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.U, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fW(coord2);
		var record1 = support.fW(coord1);
		var dz = $elm$core$Basics$abs(record2.am - record1.am);
		var dy = $elm$core$Basics$abs(record2.al - record1.al);
		var dx = $elm$core$Basics$abs(record2.ak - record1.ak);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var wrapper = _v0.aj;
	var speedFn = _v0.ah;
	var durationFn = _v0._;
	var distanceFn = _v0.Z;
	var defaultCssUnit = _v0.X;
	var defaultStart = _v0.Y;
	var globalCssUnit = _v0.h;
	var globalData = _v0.aa;
	var config = _v0.C;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bo);
	...
	return wrapper(
		{
			...
			t: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.t, globalData.ar, 0),
			cf: distance_,
			v: $elm$core$Basics$round(duration_),
			bI: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bI, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			K: config.K,
			du: speed_,
			bn: resolvedSpring,
			...
			case 0:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							X: $author$project$Anim$Internal$Unit$default,
							Y: 0,
							Z: F2(
								function (a, b) {
									return $elm$core$Basics$abs(b - a);
								}),
							_: $author$project$Shared$TimeSpec$duration,
							h: globalData.h,
							aa: globalData,
							ah: $author$project$Shared$TimeSpec$speed,
							aj: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							X: $author$project$Anim$Internal$Unit$default,
							Y: $author$project$Anim$Internal$Extra$Color$transparent,
							Z: $author$project$Anim$Internal$Extra$Color$distance,
							_: $author$project$Anim$Internal$Extra$Color$duration,
							h: globalData.h,
							aa: globalData,
							ah: $author$project$Anim$Internal$Extra$Color$speed,
							aj: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							X: $author$project$Anim$Internal$Unit$default,
							Y: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							Z: $author$project$Anim$Internal$Property$Opacity$distance,
							_: $author$project$Anim$Internal$Property$Opacity$duration,
							h: globalData.h,
							aa: globalData,
							ah: $author$project$Anim$Internal$Property$Opacity$speed,
							aj: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							X: 28,
							Y: $author$project$Anim$Internal$Property$PerspectiveOrigin$default,
							Z: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance,
							_: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration,
							h: globalData.h,
							aa: globalData,
							ah: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed,
							aj: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig
						}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Rotate$default, Z: $author$project$Anim$Internal$Property$Rotate$distance, _: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Rotate$speed, aj: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Scale$default, Z: $author$project$Anim$Internal$Property$Scale$distance, _: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Scale$speed, aj: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: mergeSize(config),
							X: $author$project$Anim$Internal$Unit$default,
							Y: $author$project$Anim$Internal$Property$Size$default,
							Z: $author$project$Anim$Internal$Property$Size$distance,
							_: $author$project$Anim$Internal$Property$Size$duration,
							h: globalData.U,
							aa: globalData,
							ah: $author$project$Anim$Internal$Property$Size$speed,
							aj: $author$project$Anim$Internal$Builder$ProcessedSizeConfig
						}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Skew$default, Z: $author$project$Anim$Internal$Property$Skew$distance, _: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Skew$speed, aj: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							X: $author$project$Anim$Internal$Unit$default,
							Y: $author$project$Anim$Internal$Property$Translate$default,
							Z: $author$project$Anim$Internal$Property$Translate$distance,
							_: $author$project$Anim$Internal$Property$Translate$duration,
							h: globalData.h,
							aa: globalData,
							ah: $author$project$Anim$Internal$Property$Translate$speed,
							aj: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig
						}));
		}
	});
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.s.an);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.C.b9);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.ap, history.aP));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Engine$Keyframe$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				W: $author$project$Anim$Internal$Builder$init(_List_Nil)
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
	} else {
		...
		var initGroup = F2(
			function (name, config) {
				var playback = A3(
					...
					config.b);
				var discrete = {
					ch: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, name, builder),
					ci: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, name, builder)
				};
				return A7($author$project$Anim$Internal$Engine$Keyframe$Generator$generateAnimation, config.o, playback.r, playback.w, discrete, name, config.b9, config.q);
			});
		var processedGroups = $author$project$Anim$Internal$Builder$process(builder).ck;
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				W: $author$project$Anim$Internal$Builder$clearAnimData(
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						animation,
						{
							aK: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, animation.aK)
						}),
					c: updateDefaultsCssUnits(defs)
				});
		}
	});
var $author$project$Anim$Internal$Builder$setTranslateInitCssUnitX = F2(
	function (unit, builder) {
		var data = builder;
		return A4(
			$author$project$Anim$Internal$Builder$writeCssUnitForGroup,
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.av),
			$author$project$Anim$Internal$Builder$CssUnitStore$translateX,
			unit,
			builder);
	});
var $author$project$Anim$Property$Translate$initCssUnitX = $author$project$Anim$Internal$Builder$setTranslateInitCssUnitX;
...
var $author$project$Anim$Internal$Builder$SkewConfig = function (a) {
	return {$: 7, a: a};
};
...
var $author$project$Anim$Internal$Builder$Skew$applyClamps = F2(
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			var animGroupName = _v0.a;
			var cy = A4($author$project$Anim$Internal$Builder$getClamp, animGroupName, 'skew', 'y', builder);
			var cx = A4($author$project$Anim$Internal$Builder$getClamp, animGroupName, 'skew', 'x', builder);
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				return config;
			} else {
					...
					return $author$project$Anim$Internal$Property$Skew$fromTuple(
						_Utils_Tuple2(
							A2(
								...
								cx,
								$author$project$Anim$Internal$Property$Skew$getX(value)),
							A2(
								$author$project$Anim$Internal$Builder$Property$clampAxis,
								cy,
								$author$project$Anim$Internal$Property$Skew$getY(value))));
				};
				var clampedEnd = clampValue(config.m);
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bo);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, clampedStart);
				return _Utils_update(
					config,
					{
						cf: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Skew$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	return A2(
		$author$project$Anim$Internal$Builder$Property$upsert,
		$author$project$Anim$Internal$Builder$SkewConfig(
			A2($author$project$Anim$Internal$Builder$Skew$applyClamps, builder, config)),
		builder);
};
var $author$project$Anim$Internal$Builder$Skew$SkewBuilder = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Anim$Internal$Builder$Skew$default = 0.0;
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cf: 0, bI: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Builder$Skew$defaultConfig = $author$project$Anim$Internal$Builder$Property$defaultConfig(
	$author$project$Anim$Internal$Property$Skew$fromTuple(
		_Utils_Tuple2($author$project$Anim$Internal$Builder$Skew$default, $author$project$Anim$Internal$Builder$Skew$default)));
...
var $author$project$Anim$Internal$Builder$getEasing = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).as;
};
var $author$project$Anim$Internal$Builder$getSpring = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).az;
};
var $author$project$Anim$Internal$Builder$getTimeSpec = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).ab;
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.bV);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bo: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bo: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Skew$for = F2(
	function (animGroupName, builder) {
		...
		var config = A6($author$project$Anim$Internal$Builder$Property$for, animGroupName, 'skew', $author$project$Anim$Internal$Builder$PropertyBaselines$getSkew, extractExisting, $author$project$Anim$Internal$Builder$Skew$defaultConfig, builder);
		return A2(
			$author$project$Anim$Internal$Builder$Skew$SkewBuilder,
			config,
			A2($author$project$Anim$Internal$Builder$for, animGroupName, builder));
	});
var $author$project$Anim$Internal$Builder$Skew$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Skew$fromXY = $author$project$Anim$Internal$Builder$Skew$fromXY;
...
var $author$project$Anim$Internal$Builder$Skew$markAxes = F2(
	function (axes, builder) {
		return A3($author$project$Anim$Internal$Builder$markAxes, 'skew', axes, builder);
	});
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bo);
		return _Utils_update(
			config,
			{
				cf: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bo: $elm$core$Maybe$Just(startVal)
			});
	});
var $author$project$Anim$Internal$Builder$Skew$setEnd = F2(
	function (newEnd, config) {
		return A4($author$project$Anim$Internal$Builder$Property$setEnd, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$distance, newEnd, config);
	});
var $author$project$Anim$Internal$Builder$Skew$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
			$author$project$Anim$Internal$Builder$Skew$SkewBuilder,
			A2($author$project$Anim$Internal$Builder$Skew$setEnd, value, config),
			A2(
				$author$project$Anim$Internal$Builder$Skew$markAxes,
				_List_fromArray(
					['x', 'y']),
				builder));
	});
var $author$project$Anim$Internal$Builder$Skew$toXY = F2(
	function (x, y) {
		return $author$project$Anim$Internal$Builder$Skew$to(
			$author$project$Anim$Internal$Property$Skew$fromTuple(
				_Utils_Tuple2(x, y)));
	});
var $author$project$Anim$Property$Skew$toXY = $author$project$Anim$Internal$Builder$Skew$toXY;
var $author$project$Anim$Property$Skew$initXY = F4(
	function (animationKey, x, y, animBuilder) {
		return $author$project$Anim$Internal$Builder$Skew$build(
			A3(
				$author$project$Anim$Property$Skew$toXY,
				x,
				y,
				A3(
					$author$project$Anim$Property$Skew$fromXY,
					x,
					y,
					A2($author$project$Anim$Internal$Builder$Skew$for, animationKey, animBuilder))));
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cf: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						ak: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.ak : endRecord.ak,
						al: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.al : endRecord.al,
						am: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.am : endRecord.am
					});
				return _Utils_update(
					config,
					{
						cf: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bo);
		return A4(
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.av, slots, builder);
	});
...
var $author$project$Anim$Property$Translate$initXY = F4(
	function (animationKey, x, y, animBuilder) {
		return A2(
			...
			_List_fromArray(
				[$author$project$Anim$Internal$Builder$CssUnitStore$translateX, $author$project$Anim$Internal$Builder$CssUnitStore$translateY]),
...
var $author$project$Animation$Keyframe$TransformOrder$Main$permutationKey = function (perm) {
	switch (perm) {
		case 0:
			return 't-r-sk-s';
		case 1:
...
var $author$project$Animation$Keyframe$TransformOrder$Main$init = _Utils_Tuple2(
	{
				...
				function (perm) {
					return _List_fromArray(
						[
							...
							$elm$core$Basics$composeR,
							A3(
								$author$project$Anim$Property$Translate$initXY,
								$author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm),
								0,
								0),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Property$Translate$initCssUnitX(8),
								$author$project$Anim$Property$Translate$initCssUnitY(4))),
							A3(
							$author$project$Anim$Property$Skew$initXY,
							$author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm),
							0,
							0)
						]);
				},
				$author$project$Animation$Keyframe$TransformOrder$Main$allPermutations)),
		T: _List_Nil
	},
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {C: groupConfig, cp: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.an);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ap: newEntry, aP: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ap: newEntry,
								aP: A2($elm$core$List$cons, existing.ap, existing.aP)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							s: _Utils_update(
								state,
								{
									an: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.an)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$addStyle = F3(
	function (key, value, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				aG: A3($author$project$Anim$Internal$Engine$CSS$Styles$insert, key, value, animGroup.aG)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$mergeStyles = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			_new,
			{
				aG: A2($author$project$Anim$Internal$Engine$CSS$Styles$merge, _new.aG, existing.aG)
			});
	});
	...
	function (finaliseBuilder, _v0, transform) {
		...
		var hasAnimateTiming = function (config) {
			return A2(
				...
				$author$project$Anim$Internal$Builder$partitionByMode(config.q).a2);
		};
		var builder = transform(state.W);
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var discrete = {
					ch: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, builder),
					ci: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, builder)
				};
		...
		var initialPlayStateFor = function (animGroupName) {
			return A2(
				...
				A2(
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, processedAnimData.ck)));
		};
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				W: A2(finaliseBuilder, builder, processedAnimData)
			},
			A2(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
				F2(
				...
				A3(
					...
					insertAnimGroup,
					animGroups,
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processedAnimData.ck))));
	});
...
var $author$project$Anim$Internal$Unit$setCssUnitX = F2(
	function (unit, axes) {
		return _Utils_update(
			axes,
			{
				ak: $elm$core$Maybe$Just(unit)
			});
	});
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.R));
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{R: updatedGroupDefaults})
				});
		}
	});
var $author$project$Anim$Internal$Builder$cssUnitX = F2(
	function (unit, _v0) {
		var data = _v0;
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						h: A2($author$project$Anim$Internal$Unit$setCssUnitX, unit, defs.h)
					});
			},
			data);
	});
var $author$project$Anim$Engine$Keyframe$cssUnitX = $author$project$Anim$Internal$Builder$cssUnitX;
var $author$project$Anim$Internal$Unit$setCssUnitY = F2(
	function (unit, axes) {
		return _Utils_update(
			axes,
			{
				al: $elm$core$Maybe$Just(unit)
			});
	});
var $author$project$Anim$Internal$Builder$cssUnitY = F2(
	function (unit, _v0) {
		var data = _v0;
		return A2(
			$author$project$Anim$Internal$Builder$updateScopedDefaults,
			function (defs) {
				return _Utils_update(
					defs,
					{
						h: A2($author$project$Anim$Internal$Unit$setCssUnitY, unit, defs.h)
					});
			},
			data);
	});
var $author$project$Anim$Engine$Keyframe$cssUnitY = $author$project$Anim$Internal$Builder$cssUnitY;
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						as: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$Keyframe$TransformOrder$Main$permutationOrder = function (perm) {
	switch (perm) {
		case 0:
			return _List_fromArray(
				[0, 1, 2, 3]);
...
var $author$project$Anim$Internal$Builder$normalizeTransformOrder = function (order) {
	var removeDuplicates = F2(
		function (seen, remaining) {
			removeDuplicates:
			while (true) {
				if (!remaining.b) {
					return $elm$core$List$reverse(seen);
				} else {
					var x = remaining.a;
					var xs = remaining.b;
					if (A2($elm$core$List$member, x, seen)) {
						var $temp$seen = seen,
							$temp$remaining = xs;
						seen = $temp$seen;
						...
						var $temp$seen = A2($elm$core$List$cons, x, seen),
							$temp$remaining = xs;
						seen = $temp$seen;
						remaining = $temp$remaining;
						continue removeDuplicates;
	...
	var defaultOrder = _List_fromArray(
		[0, 1, 2, 3]);
	var deduped = A2(removeDuplicates, _List_Nil, order);
	var missing = A2(
		$elm$core$List$filter,
		function (t) {
			return !A2($elm$core$List$member, t, deduped);
		},
		defaultOrder);
	return _Utils_ap(deduped, missing);
};
var $author$project$Anim$Internal$Builder$transformOrder = F2(
	function (order, builder) {
		var data = builder;
		var normalizedOrder = $elm$core$Maybe$Just(
			$author$project$Anim$Internal$Builder$normalizeTransformOrder(order));
		var _v0 = data.a.p;
		if (!_v0.$) {
			var animGroupName = _v0.a;
			var nextConfig = function () {
				var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.y);
				if (!_v1.$) {
					var existing = _v1.a;
					return _Utils_update(
						existing,
					...
					return {e: $elm$core$Maybe$Nothing, f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, d: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, q: _List_Nil, o: normalizedOrder, i: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
				}
			}();
			return A2($author$project$Anim$Internal$Builder$updateCurrentConfig, nextConfig, builder);
		} else {
			var defs = data.c;
			return _Utils_update(
				data,
...
var $author$project$Anim$Internal$Engine$Keyframe$transformOrder = $author$project$Anim$Internal$Builder$transformOrder;
var $author$project$Anim$Engine$Keyframe$transformOrder = $author$project$Anim$Internal$Engine$Keyframe$transformOrder;
var $author$project$Animation$Keyframe$TransformOrder$Main$engineDefaults = function (perm) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Keyframe$for(
			$author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm)),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Keyframe$transformOrder(
				$author$project$Animation$Keyframe$TransformOrder$Main$permutationOrder(perm)),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Keyframe$duration(2000),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Keyframe$easing($author$project$Motion$Easing$EaseInOut),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$Keyframe$cssUnitX(8),
						$author$project$Anim$Engine$Keyframe$cssUnitY(4))))));
};
...
var $author$project$Anim$Property$Skew$begin = function (animBuilder) {
	var _v0 = $author$project$Anim$Internal$Builder$getCurrentAnimGroupName(animBuilder);
	if (!_v0.$) {
		var animGroupName = _v0.a;
		return A2($author$project$Anim$Internal$Builder$Skew$for, animGroupName, animBuilder);
	} else {
		return A2($author$project$Anim$Internal$Builder$Skew$for, '', animBuilder);
	}
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cf: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cf: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
...
var $author$project$Anim$Property$Skew$end = $author$project$Anim$Internal$Builder$Skew$build;
...
var $author$project$Anim$Internal$Builder$Scale$toXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
...
var $author$project$Anim$Property$Scale$toXY = $author$project$Anim$Internal$Builder$Scale$toXY;
var $author$project$Anim$Property$Translate$toXY = $author$project$Anim$Internal$Builder$Translate$toXY;
...
var $author$project$Animation$Keyframe$TransformOrder$Main$moveOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, 24, 10),
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Rotate$toZ(45),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Property$Rotate$end,
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Property$Skew$begin,
							A2(
								$elm$core$Basics$composeR,
								A2($author$project$Anim$Property$Skew$toXY, 15, 9),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Skew$end,
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Property$Scale$begin,
										A2(
											$elm$core$Basics$composeR,
											A2($author$project$Anim$Property$Scale$toXY, 1.5, 0.8),
											$author$project$Anim$Property$Scale$end)))))))))));
var $author$project$Animation$Keyframe$TransformOrder$Main$reset = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$end,
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Rotate$toZ(0),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Property$Rotate$end,
						A2(
							...
							A2(
								$elm$core$Basics$composeR,
								A2($author$project$Anim$Property$Skew$toXY, 0, 0),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Skew$end,
									A2(
										...
										A2(
											$elm$core$Basics$composeR,
											A2($author$project$Anim$Property$Scale$toXY, 1, 1),
											$author$project$Anim$Property$Scale$end)))))))))));
var $author$project$Animation$Keyframe$TransformOrder$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var perm = msg.a;
					...
					_Utils_update(
						model,
						{
							M: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Keyframe$TransformOrder$Main$engineDefaults(perm),
									$author$project$Animation$Keyframe$TransformOrder$Main$moveOut)),
							T: A2($elm$core$List$member, perm, model.T) ? model.T : A2($elm$core$List$cons, perm, model.T)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							M: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Keyframe$TransformOrder$Main$engineDefaults(perm),
									$author$project$Animation$Keyframe$TransformOrder$Main$reset)),
							T: A2(
								$elm$core$List$filter,
								$elm$core$Basics$neq(perm),
								model.T)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
									...
									F2(
										function (perm, acc) {
											return A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Keyframe$TransformOrder$Main$engineDefaults(perm),
												A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$TransformOrder$Main$moveOut, acc));
										}),
									$elm$core$Basics$identity,
									$author$project$Animation$Keyframe$TransformOrder$Main$allPermutations)),
							T: $author$project$Animation$Keyframe$TransformOrder$Main$allPermutations
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
									...
									F2(
										function (perm, acc) {
											return A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Keyframe$TransformOrder$Main$engineDefaults(perm),
												A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$TransformOrder$Main$reset, acc));
										}),
									$elm$core$Basics$identity,
									model.T)),
							T: _List_Nil
...
var $author$project$Animation$Keyframe$TransformOrder$Main$AnimateAll = {$: 2};
var $author$project$Animation$Keyframe$TransformOrder$Main$ResetAll = {$: 3};
...
var $author$project$Animation$Keyframe$TransformOrder$Main$actionButton = F3(
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isComplete = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(animGroup.aU);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$toCssString = function (_v0) {
	...
	return animation.b6 + (' ' + ($elm$core$String$fromInt(animation.v) + ('ms linear 0ms ' + (iterationString + (' ' + (directionString + ' forwards'))))));
};
...
var $author$project$Animation$Keyframe$TransformOrder$Main$boxSize = 16;
var $author$project$Animation$Keyframe$TransformOrder$Main$boxSizeCss = $elm$core$String$fromFloat($author$project$Animation$Keyframe$TransformOrder$Main$boxSize) + 'cqmin';
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Animation$Keyframe$TransformOrder$Main$permutationColor = function (perm) {
	switch (perm) {
		case 0:
			return '59, 130, 246';
		case 1:
...
var $author$project$Animation$Keyframe$TransformOrder$Main$permutationLabel = function (perm) {
	switch (perm) {
		case 0:
			return 'T → R → Sk → S';
		case 1:
...
var $author$project$Animation$Keyframe$TransformOrder$Main$animatedBox = F2(
	function (animState, perm) {
		var rgb = $author$project$Animation$Keyframe$TransformOrder$Main$permutationColor(perm);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					A2($elm$html$Html$Attributes$style, 'top', 'clamp(10px, 2vmin, 16px)'),
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						A2(
							$author$project$Anim$Engine$Keyframe$attributes,
							$author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm),
							animState),
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$Keyframe$TransformOrder$Main$boxSizeCss),
								A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$Keyframe$TransformOrder$Main$boxSizeCss),
								A2($elm$html$Html$Attributes$style, 'background-color', 'rgba(' + (rgb + ', 0.25)')),
								A2($elm$html$Html$Attributes$style, 'border-radius', '1.6cqmin'),
								A2($elm$html$Html$Attributes$style, 'border', '0.4cqmin solid rgb(' + (rgb + ')')),
								A2($elm$html$Html$Attributes$style, 'font-size', '2.2cqmin'),
								A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
								A2($elm$html$Html$Attributes$style, 'color', 'rgb(' + (rgb + ')')),
								A2($elm$html$Html$Attributes$style, 'padding', '0.8cqmin'),
								A2($elm$html$Html$Attributes$style, 'box-sizing', 'border-box')
							])),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Animation$Keyframe$TransformOrder$Main$permutationLabel(perm))
						]))
				]));
	});
...
var $author$project$Animation$Keyframe$TransformOrder$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('example-canvas'),
		...
		A2(
			$elm$core$List$map,
			$author$project$Animation$Keyframe$TransformOrder$Main$animatedBox(animState),
			$author$project$Animation$Keyframe$TransformOrder$Main$allPermutations));
};
var $author$project$Animation$Keyframe$TransformOrder$Main$Animate = function (a) {
	return {$: 0, a: a};
};
var $author$project$Animation$Keyframe$TransformOrder$Main$permButton = function (perm) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Animation$Keyframe$TransformOrder$Main$Animate(perm)),
				A2($elm$html$Html$Attributes$style, 'padding', '6px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2(
				...
				'background-color',
				'rgb(' + ($author$project$Animation$Keyframe$TransformOrder$Main$permutationColor(perm) + ')')),
				A2($elm$html$Html$Attributes$style, 'color', 'white'),
				A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
				A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
				A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
...
var $author$project$Animation$Keyframe$TransformOrder$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Animation$Keyframe$TransformOrder$Main$permButton, $author$project$Animation$Keyframe$TransformOrder$Main$allPermutations)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A3($author$project$Animation$Keyframe$TransformOrder$Main$actionButton, '▶️ All', $author$project$Animation$Keyframe$TransformOrder$Main$AnimateAll, '#16a34a'),
						A3($author$project$Animation$Keyframe$TransformOrder$Main$actionButton, '⏮️ Reset All', $author$project$Animation$Keyframe$TransformOrder$Main$ResetAll, '#d97706')
					])),
				$author$project$Animation$Keyframe$TransformOrder$Main$animationArea(model.M)
			]));
};
var $author$project$Animation$Keyframe$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Keyframe$TransformOrder$Main$init;
		},
		fB: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		f0: $author$project$Animation$Keyframe$TransformOrder$Main$update,
		f1: $author$project$Animation$Keyframe$TransformOrder$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'TransformOrder':{'Main':{'init':$author$project$Animation$Keyframe$TransformOrder$Main$main(
