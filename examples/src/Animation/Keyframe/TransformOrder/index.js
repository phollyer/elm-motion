...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bs: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, ap: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, b$: $elm$core$Set$empty, as: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cI: $elm$core$Basics$round(rgba_.b7 * 255),
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bi: 0, bM: $elm$core$Maybe$Nothing, aT: 0, cv: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b6: '', cb: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, cn: ''};
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Rotate$default, Z: $author$project$Anim$Internal$Property$Rotate$distance, _: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Rotate$speed, aj: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Scale$default, Z: $author$project$Anim$Internal$Property$Scale$distance, _: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Scale$speed, aj: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Skew$default, Z: $author$project$Anim$Internal$Property$Skew$distance, _: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Skew$speed, aj: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$setTranslateInitCssUnitX = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.as),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				...
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, ce: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.bU);
	});
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.as, slots, builder);
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					...
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.at);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ax: newEntry, a5: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ax: newEntry,
								a5: A2($elm$core$List$cons, existing.ax, existing.a5)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							u: _Utils_update(
								state,
								{
									at: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.at)
								})
						});
				}),
			data,
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						ap: $elm$core$Maybe$Just(easingValue),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
...
var $author$project$Animation$Keyframe$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		f$: $author$project$Animation$Keyframe$TransformOrder$Main$update,
		f0: $author$project$Animation$Keyframe$TransformOrder$Main$view
	});
