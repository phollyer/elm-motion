...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (initGroup, propertyInitializers) {
		if (!propertyInitializers.b) {
			return A2(
				...
				{
					T: $author$project$Anim$Internal$Builder$init(_List_Nil)
				},
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
		} else {
			...
			return A2(
				$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
				{
					T: $author$project$Anim$Internal$Builder$clearAnimData(
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cE: x0, cI: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bM: omegaD, bv: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$runPipeline = F3(
	function (finaliseBuilder, _v0, transform) {
		...
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				T: A2(finaliseBuilder, builder, processedAnimData)
			},
			A2(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
				F2(
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.P));
...
var $author$project$Animation$Keyframe$Sequencing$Main$globalConfig = {t: 1000, bG: $author$project$Motion$Easing$BounceOut, dt: 50};
...
var $author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig = {t: 0, bG: $author$project$Motion$Easing$BackOut, dt: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig = {t: 500, bG: $author$project$Motion$Easing$QuadInOut, dt: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig = {t: 250, bG: $author$project$Motion$Easing$ElasticOut, dt: 75};
...
var $author$project$Animation$Keyframe$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.bG),
				A2(
					$elm$core$Basics$composeR,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.bG),
									A2(
										$elm$core$Basics$composeR,
										...
										A2(
											...
											A2(
												...
												A2(
													...
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.bG),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX),
															A2(
																...
																A2(
																	...
																	A2(
																		...
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.bG),
																			A2(
																				$elm$core$Basics$composeR,
																				$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX),
																				A2(
