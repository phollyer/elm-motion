...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, aq: $elm$core$Maybe$Nothing};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Rotate$default, X: $author$project$Anim$Internal$Property$Rotate$distance, Y: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Rotate$speed, ah: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Scale$default, X: $author$project$Anim$Internal$Property$Scale$distance, Y: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Scale$speed, ah: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Skew$default, X: $author$project$Anim$Internal$Property$Skew$distance, Y: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Skew$speed, ah: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.aq, slots, builder);
	});
...
var $author$project$Animation$Keyframe$Sequencing$Main$init = _Utils_Tuple2(
	{
		ar: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						an: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$Keyframe$Sequencing$Main$globalConfig = {s: 1000, bG: $author$project$Motion$Easing$BounceOut, ds: 50};
...
var $author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig = {s: 0, bG: $author$project$Motion$Easing$BackOut, ds: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig = {s: 500, bG: $author$project$Motion$Easing$QuadInOut, ds: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig = {s: 250, bG: $author$project$Motion$Easing$ElasticOut, ds: 75};
...
var $author$project$Animation$Keyframe$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.s),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.ds),
			A2(
				$elm$core$Basics$composeR,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.s),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.ds),
								A2(
									$elm$core$Basics$composeR,
									...
									A2(
										...
										A2(
											...
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.s),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.ds),
													A2(
														$elm$core$Basics$composeR,
														...
														A2(
															...
															A2(
																...
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.s),
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.ds),
																		A2(
																			$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Sequencing$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			var _v1 = A2($author$project$Anim$Engine$Keyframe$update, keyframeMsg, model.ar);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$Keyframe$attributes, groupName, model.ar),
								_Utils_ap(
...
var $author$project$Animation$Keyframe$Sequencing$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.ar),
				A2(
...
var $author$project$Animation$Keyframe$Sequencing$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$Sequencing$Main$update,
		f$: $author$project$Animation$Keyframe$Sequencing$Main$view
	});
