...
var $author$project$Anim$Internal$Property$Rotate$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!angles.ai)) ? $elm$core$Maybe$Just(
				'rotateX(' + ($elm$core$String$fromFloat(angles.ai) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.aj)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.aj) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.ak)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.ak) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
...
var $author$project$Anim$Internal$Property$Skew$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!values.ai)) ? $elm$core$Maybe$Just(
				'skewX(' + ($elm$core$String$fromFloat(values.ai) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.aj)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.aj) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = F2(
	function (axes, _v0) {
		var coords = _v0;
		return 'translate3d(' + ($elm$core$String$fromFloat(coords.ai) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ai) + (', ' + ($elm$core$String$fromFloat(coords.aj) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aj) + (', ' + ($elm$core$String$fromFloat(coords.ak) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ak) + ')'))))))));
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss = F3(
	function (maybeControlledAxes, cssUnitAxes, value) {
		...
		if (!_v0.$) {
			var axes = _v0.a;
			var zSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.ak);
			var ySuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.aj);
			var xSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.ai);
				...
				A2(
					...
					_List_fromArray(
						[
							...
							'translateX(' + ($elm$core$String$fromFloat(coords.ai) + (xSuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasY ? $elm$core$Maybe$Just(
							'translateY(' + ($elm$core$String$fromFloat(coords.aj) + (ySuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasZ ? $elm$core$Maybe$Just(
							'translateZ(' + ($elm$core$String$fromFloat(coords.ak) + (zSuffix + ')'))) : $elm$core$Maybe$Nothing
						])));
			...
			return {
				...
				b$: A3(
					...
					A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							{ai: $author$project$Anim$Internal$Unit$default, aj: $author$project$Anim$Internal$Unit$default, ak: $author$project$Anim$Internal$Unit$default},
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString = F2(
	function (axes, _v0) {
		var y = _v0.aj;
		var x = _v0.ai;
		return $elm$core$String$fromFloat(x) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ai) + (' ' + ($elm$core$String$fromFloat(y) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.aj))));
	});
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		...
		return _Utils_ap(
			...
			$author$project$Anim$Internal$Unit$toCssSuffix(axes.ai));
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate = F3(
	function (t, start, end) {
		...
		var ex = _v1.a;
		var ey = _v1.b;
		return {ai: sx + ((ex - sx) * t), aj: sy + ((ey - sy) * t)};
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		...
		return support.eB(
			{ai: startRecord.ai + ((endRecord.ai - startRecord.ai) * t), aj: startRecord.aj + ((endRecord.aj - startRecord.aj) * t), ak: startRecord.ak + ((endRecord.ak - startRecord.ak) * t)});
	});
...
var $author$project$Anim$Internal$Property$Size$toCssString = F2(
	function (axes, size) {
		...
		var width = _v0.a;
		var height = _v0.b;
		return 'width: ' + ($elm$core$String$fromFloat(width) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ai) + ('; height: ' + ($elm$core$String$fromFloat(height) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.aj)))));
	});
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, bs: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var wrapper = _v0.ah;
	var speedFn = _v0.af;
	var durationFn = _v0.Y;
	var distanceFn = _v0.X;
	var defaultCssUnit = _v0.V;
	var defaultStart = _v0.W;
	var globalCssUnit = _v0.h;
	var globalData = _v0.Z;
	var config = _v0.C;
	...
	return wrapper(
		{
			...
			t: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.t, globalData.ap, 0),
			ce: distance_,
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			case 0:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							V: $author$project$Anim$Internal$Unit$default,
							W: 0,
							X: F2(
								function (a, b) {
									return $elm$core$Basics$abs(b - a);
								}),
							Y: $author$project$Shared$TimeSpec$duration,
							h: globalData.h,
							Z: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							V: $author$project$Anim$Internal$Unit$default,
							W: $author$project$Anim$Internal$Extra$Color$transparent,
							X: $author$project$Anim$Internal$Extra$Color$distance,
							Y: $author$project$Anim$Internal$Extra$Color$duration,
							h: globalData.h,
							Z: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							V: $author$project$Anim$Internal$Unit$default,
							W: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							X: $author$project$Anim$Internal$Property$Opacity$distance,
							Y: $author$project$Anim$Internal$Property$Opacity$duration,
							h: globalData.h,
							Z: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							V: 28,
							W: $author$project$Anim$Internal$Property$PerspectiveOrigin$default,
							X: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance,
							Y: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration,
							h: globalData.h,
							Z: globalData,
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Rotate$default, X: $author$project$Anim$Internal$Property$Rotate$distance, Y: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Rotate$speed, ah: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Scale$default, X: $author$project$Anim$Internal$Property$Scale$distance, Y: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Scale$speed, ah: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: mergeSize(config),
							V: $author$project$Anim$Internal$Unit$default,
							W: $author$project$Anim$Internal$Property$Size$default,
							X: $author$project$Anim$Internal$Property$Size$distance,
							Y: $author$project$Anim$Internal$Property$Size$duration,
							h: globalData.S,
							Z: globalData,
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, V: $author$project$Anim$Internal$Unit$default, W: $author$project$Anim$Internal$Property$Skew$default, X: $author$project$Anim$Internal$Property$Skew$distance, Y: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, Z: globalData, af: $author$project$Anim$Internal$Property$Skew$speed, ah: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							V: $author$project$Anim$Internal$Unit$default,
							W: $author$project$Anim$Internal$Property$Translate$default,
							X: $author$project$Anim$Internal$Property$Translate$distance,
							Y: $author$project$Anim$Internal$Property$Translate$duration,
							h: globalData.h,
							Z: globalData,
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.s.al);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.an, history.aO));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Builder$getDelay = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).ap;
};
...
var $author$project$Anim$Internal$Builder$getTimeSpec = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data)._;
};
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.at, slots, builder);
	});
...
var $author$project$Animation$Keyframe$Sequencing$Main$rowFour = 'rowFour';
var $author$project$Animation$Keyframe$Sequencing$Main$rowOne = 'rowOne';
var $author$project$Animation$Keyframe$Sequencing$Main$rowThree = 'rowThree';
var $author$project$Animation$Keyframe$Sequencing$Main$rowTwo = 'rowTwo';
var $author$project$Animation$Keyframe$Sequencing$Main$init = _Utils_Tuple2(
	{
		au: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Sequencing$Main$rowOne, 0),
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Sequencing$Main$rowTwo, 0),
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Sequencing$Main$rowThree, 0),
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Sequencing$Main$rowFour, 0)
				])),
...
var $author$project$Animation$Keyframe$Sequencing$Main$Backward = 1;
var $author$project$Animation$Keyframe$Sequencing$Main$Forward = 0;
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					...
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.al);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {an: newEntry, aO: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								an: newEntry,
								aO: A2($elm$core$List$cons, existing.an, existing.aO)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							s: _Utils_update(
								state,
								{
									al: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.al)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Builder$delay = F2(
	function (ms, _v0) {
		var data = _v0;
		return A2(
			$author$project$Anim$Internal$Builder$updateScopedDefaults,
			function (defs) {
				return _Utils_update(
					defs,
					{
						ap: $elm$core$Maybe$Just(ms)
					});
			},
			data);
	});
var $author$project$Anim$Engine$Keyframe$delay = $author$project$Anim$Internal$Builder$delay;
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						aq: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$Keyframe$Sequencing$Main$globalConfig = {t: 1000, bH: $author$project$Motion$Easing$BounceOut, dt: 50};
...
var $author$project$Animation$Keyframe$Sequencing$Main$moveTo = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Motion$Easing$BackOut = {$: 1};
var $author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig = {t: 0, bH: $author$project$Motion$Easing$BackOut, dt: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig = {t: 500, bH: $author$project$Motion$Easing$QuadInOut, dt: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig = {t: 250, bH: $author$project$Motion$Easing$ElasticOut, dt: 75};
var $author$project$Shared$TimeSpec$Speed = function (a) {
	return {$: 1, a: a};
};
var $author$project$Anim$Internal$Builder$speed = F2(
	function (value, _v0) {
		var data = _v0;
		return A2(
			$author$project$Anim$Internal$Builder$updateScopedDefaults,
...
var $author$project$Anim$Engine$Keyframe$speed = $author$project$Anim$Internal$Builder$speed;
var $author$project$Animation$Keyframe$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.t),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.dt),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$globalConfig.bH),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Keyframe$cssUnitX(8),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Sequencing$Main$rowOne),
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.t),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.dt),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowOneConfig.bH),
									A2(
										$elm$core$Basics$composeR,
										$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Sequencing$Main$rowTwo),
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.t),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.dt),
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowTwoConfig.bH),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX),
															A2(
																$elm$core$Basics$composeR,
																$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Sequencing$Main$rowThree),
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.t),
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$Keyframe$speed($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.dt),
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Engine$Keyframe$easing($author$project$Animation$Keyframe$Sequencing$Main$rowThreeConfig.bH),
																			A2(
																				$elm$core$Basics$composeR,
																				$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX),
																				A2(
																					$elm$core$Basics$composeR,
																					$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Sequencing$Main$rowFour),
																					$author$project$Animation$Keyframe$Sequencing$Main$moveTo(targetX)))))))))))))))))))));
};
...
var $author$project$Animation$Keyframe$Sequencing$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var keyframeMsg = msg.a;
			var _v1 = A2($author$project$Anim$Engine$Keyframe$update, keyframeMsg, model.au);
				...
				_Utils_update(
					model,
					{
						au: A2(
							...
							model.au,
							$author$project$Animation$Keyframe$Sequencing$Main$animateRows(targetX)),
						cb: direction
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$Sequencing$Main$Toggle = {$: 1};
...
var $author$project$Animation$Keyframe$Sequencing$Main$GotKeyframeMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Keyframe$Sequencing$Main$rowView = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'border', '1px solid #d4d4d8'),
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$Keyframe$attributes, groupName, model.au),
								_Utils_ap(
									$author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$Sequencing$Main$GotKeyframeMsg),
									_List_fromArray(
										[
											A2($elm$html$Html$Attributes$style, 'width', '10cqw'),
											A2($elm$html$Html$Attributes$style, 'height', '100%'),
											A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
											A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(135deg, #0ea5e9 0%, #22c55e 100%)')
										]))),
							_List_Nil)
						]))
				]));
	});
var $author$project$Animation$Keyframe$Sequencing$Main$rows = _List_fromArray(
	[$author$project$Animation$Keyframe$Sequencing$Main$rowOne, $author$project$Animation$Keyframe$Sequencing$Main$rowTwo, $author$project$Animation$Keyframe$Sequencing$Main$rowThree, $author$project$Animation$Keyframe$Sequencing$Main$rowFour]);
...
var $author$project$Animation$Keyframe$Sequencing$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.au),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('ui-action-button primary'),
						$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$Sequencing$Main$Toggle)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Animate Pipeline')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Keyframe$Sequencing$Main$rowView(model),
					$author$project$Animation$Keyframe$Sequencing$Main$rows))
			]));
};
var $author$project$Animation$Keyframe$Sequencing$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$Sequencing$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$Sequencing$Main$update,
		f0: $author$project$Animation$Keyframe$Sequencing$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'Sequencing':{'Main':{'init':$author$project$Animation$Keyframe$Sequencing$Main$main(
