...
var $author$project$Animation$Keyframe$HelloText$Main$dotOne = 'dotOne';
var $author$project$Animation$Keyframe$HelloText$Main$dotThree = 'dotThree';
var $author$project$Animation$Keyframe$HelloText$Main$dotTwo = 'dotTwo';
var $author$project$Animation$Keyframe$HelloText$Main$duration = 500;
...
var $author$project$Animation$Keyframe$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Opacity$duration($author$project$Animation$Keyframe$HelloText$Main$duration),
...
var $author$project$Animation$Keyframe$HelloText$Main$textLineOne = 'textLineOne';
var $author$project$Animation$Keyframe$HelloText$Main$textLineTwo = 'textLineTwo';
var $author$project$Animation$Keyframe$HelloText$Main$init = function () {
	var animState = $author$project$Anim$Engine$Keyframe$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$textLineOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$dotOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$dotTwo, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$dotThree, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$textLineTwo, 0)
			]));
	return _Utils_Tuple2(
		{
			au: A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$HelloText$Main$textLineOne),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$Keyframe$HelloText$Main$fadeIn,
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$HelloText$Main$dotOne),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$HelloText$Main$duration),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Keyframe$HelloText$Main$fadeIn,
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$HelloText$Main$dotTwo),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$HelloText$Main$duration * 2),
											A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Keyframe$HelloText$Main$fadeIn,
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$HelloText$Main$dotThree),
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$HelloText$Main$duration * 3),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$Keyframe$HelloText$Main$fadeIn,
															A2(
																$elm$core$Basics$composeR,
																$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$HelloText$Main$textLineTwo),
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Keyframe$delay($author$project$Animation$Keyframe$HelloText$Main$duration * 4),
																	$author$project$Animation$Keyframe$HelloText$Main$fadeIn))))))))))))))
		},
...
var $author$project$Animation$Keyframe$HelloText$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('example-stage'),
				A2($elm$html$Html$Attributes$style, 'font-size', 'clamp(22px, 7vw, 40px)'),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$textLineOne, model.au),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('Elm Motion says')
							])),
						A2(
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotOne, model.au),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotTwo, model.au),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotThree, model.au),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$textLineTwo, model.au),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$HelloText$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$HelloText$Main$init;
		},
		...
		f0: $author$project$Animation$Keyframe$HelloText$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'HelloText':{'Main':{'init':$author$project$Animation$Keyframe$HelloText$Main$main(
