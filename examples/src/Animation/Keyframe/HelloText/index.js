			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$textLineOne, model.ar),
							_List_Nil),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotOne, model.ar),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotTwo, model.ar),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$dotThree, model.ar),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$textLineTwo, model.ar),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		f$: $author$project$Animation$Keyframe$HelloText$Main$view
	});
