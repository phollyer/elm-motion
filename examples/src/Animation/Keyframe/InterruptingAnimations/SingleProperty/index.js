...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName = 'movingBox';
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$init = _Utils_Tuple2(
	{
		H: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$colorBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor1 = $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color1));
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor2 = $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color2));
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor3 = $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color3));
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor4 = $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color4));
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
					...
					_Utils_update(
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor1))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor2))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor3))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$toColor4))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color1 = {$: 1};
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color2 = {$: 2};
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color3 = {$: 3};
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color4 = {$: 4};
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$view = function (model) {
	var button = F3(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						'background-color',
						$author$project$Anim$Extra$Color$toHex(bgColor))
					]),
				_List_fromArray(
					[
	...
	var color1Button = A3(button, $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color1, 'Color 1', $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color1);
	var color2Button = A3(button, $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color2, 'Color 2', $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color2);
	var color3Button = A3(button, $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color3, 'Color 3', $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color3);
	var color4Button = A3(button, $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$color4, 'Color 4', $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$Color4);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$animGroupName, model.H),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$update,
		f0: $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'InterruptingAnimations':{'SingleProperty':{'Main':{'init':$author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$main(
