...
var $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$update,
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$SingleProperty$Main$view
	});
