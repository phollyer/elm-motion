...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$update,
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$view
	});
