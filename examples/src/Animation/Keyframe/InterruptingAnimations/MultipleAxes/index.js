...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$XCenter = 1;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$YCenter = 1;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName = 'movingBox';
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxPct = 12;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return (100 - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
		default:
			return 100 - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxPct;
	}
};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetY = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$init = _Utils_Tuple2(
	{
		H: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3(
						...
						$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName,
						$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetX(1),
						$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetY(1)),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$XLeft = 0;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$XRight = 2;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$YBottom = 2;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$YTop = 0;
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$easing($author$project$Motion$Easing$QuintOut),
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxX = function (x) {
	return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxY = function (y) {
	return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(y));
};
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animationMsg, model.H);
					...
					_Utils_update(
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetX(0))))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetX(2))))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetY(0))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							H: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$targetY(2))))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveDown = {$: 4};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveLeft = {$: 1};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveRight = {$: 2};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveUp = {$: 3};
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	var button = F3(
	...
	var moveDownButton = A3(button, '#FFC107', 'Move Down', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveDown);
	var moveLeftButton = A3(button, '#007BFF', 'Move Left', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveLeft);
	var moveRightButton = A3(button, '#28A745', 'Move Right', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveRight);
	var moveUpButton = A3(button, '#6F42C1', 'Move Up', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$MoveUp);
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName, model.H),
			_Utils_ap(
				$author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqw'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqh'),
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.H),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$init;
		},
		fA: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$update,
		f0: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'InterruptingAnimations':{'MultipleAxes':{'Main':{'init':$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$main(
