...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bx: $elm$core$Maybe$Nothing, g: false, bW: $elm$core$Maybe$Nothing, bp: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.S, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Builder$mergeBaselines = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			defaults,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation.Q));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			M: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.M),
	...
	function (initGroup, propertyInitializers) {
		if (!propertyInitializers.b) {
			return A2(
				...
				{
					U: $author$project$Anim$Internal$Builder$init(_List_Nil)
				},
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
		} else {
			...
			return A2(
				$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
				{
					U: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						b$: A2($author$project$Anim$Internal$Property$Translate$toCssString, config.z, config.m)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bR: $author$project$Anim$Internal$Property$Rotate$toCssString(config.m)
					});
			case 7:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bV: $author$project$Anim$Internal$Property$Skew$toCssString(config.m)
					});
			case 5:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bU: $author$project$Anim$Internal$Property$Scale$toCssString(config.m)
					});
			default:
				return acc;
		}
	});
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bR: '', bU: '', bV: '', b$: ''};
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b$, transformParts.bR, transformParts.bV, transformParts.bU]);
				} else {
						...
						function (o) {
							var part = function () {
								switch (o) {
									...
									case 1:
										return transformParts.bR;
									case 2:
										return transformParts.bV;
									default:
										return transformParts.bU;
								}
							}();
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.K),
...
var $author$project$Anim$Internal$Property$Size$default = {cV: 0, K: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cE: x0, cI: (v0 + ((zeta * omega0) * x0)) / omegaD, ac: omega0, bM: omegaD, bv: zeta});
		} else {
	...
	function (totalTime, _default, interpolate, toCssString, cfg) {
		...
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2($author$project$Shared$Easing$toFunction, cfg.bG, linearProgress);
			}
		}();
		return toCssString(
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cV: start.cV + ((endSize.cV - start.cV) * t), K: start.K + ((endSize.K - start.K) * t)};
	});
					...
					switch (p.$) {
						...
						case 4:
							...
							return _Utils_update(
								acc,
								{
									bR: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Rotate$default, $author$project$Anim$Internal$Property$Rotate$interpolate, $author$project$Anim$Internal$Property$Rotate$toCssString, cfg)
								});
						case 5:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bU: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Scale$default, $author$project$Anim$Internal$Property$Scale$interpolate, $author$project$Anim$Internal$Property$Scale$toCssString, cfg)
								});
						case 7:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bV: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$interpolate, $author$project$Anim$Internal$Property$Skew$toCssString, cfg)
								});
						default:
							return acc;
					}
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bi: 0, bL: $elm$core$Maybe$Nothing, aT: 0, cv: 0, aF: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setAnimation = F2(
	function (animation, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				bL: $elm$core$Maybe$Just(animation)
			});
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.K, dimensions.cV);
};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.Q));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.M);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.bT);
	});
			...
			return _Utils_update(
				data,
				{
					...
					c: _Utils_update(
						defs,
						{
							V: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defs.V)
						})
				});
		}
	});
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$init = _Utils_Tuple2(
	{
		L: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.Q));
	};
...
var $author$project$Anim$Internal$Engine$Keyframe$runPipeline = F3(
	function (finaliseBuilder, _v0, transform) {
		...
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				U: A2(finaliseBuilder, builder, processedAnimData)
			},
			A2(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
				F2(
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bG: $elm$core$Maybe$Just(easing_),
				bm: $elm$core$Maybe$Nothing
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animationMsg, model.L);
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.L),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.L),
							_Utils_ap(
