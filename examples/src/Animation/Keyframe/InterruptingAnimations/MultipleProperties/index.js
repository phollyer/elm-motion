...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eE: 'hidden', d6: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eE: 'mozHidden', d6: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eE: 'msHidden', d6: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eE: 'webkitHidden', d6: 'webkitvisibilitychange' }
		: { eE: 'hidden', d6: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cR: fragment, cY: host, de: path, dg: port_, dj: protocol, dk: query};
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, br: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, ar: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bg: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bx: $elm$core$Maybe$Nothing, g: false, bW: $elm$core$Maybe$Nothing, bo: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aT: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.cU),
			...
			default:
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(
						'width',
						A2($author$project$Anim$Internal$Property$Size$widthToCssString, config.z, config.m)),
						_Utils_Tuple2(
						'height',
						A2($author$project$Anim$Internal$Property$Size$heightToCssString, config.z, config.m))
					]);
		}
	});
...
var $author$project$Anim$Internal$Property$Size$default = {cU: 0, K: 0};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.a5;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.aO);
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.bm);
		var linearProgress = function () {
			if (_Utils_cmp(totalTime, cfg.s) < 0) {
				return 0;
			} else {
				if (!cfg.v) {
					return 1.0;
				} else {
					var animationTime = totalTime - cfg.s;
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cU: hNormalized, c1: l * 100, $7: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cH: rgba_.cH, cT: rgba_.cT, dl: rgba_.dl};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cD: rgba_.cD, cU: hsla_.cU, c1: hsla_.c1, $7: hsla_.$7};
};
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.$7 / 100;
	var l = hslValue.c1 / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cU / 60, 2) - 1));
	var _v0 = (hslValue.cU < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cU < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cU < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cU < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cU < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cH: rgba_.cH, cT: rgba_.cT, dl: rgba_.dl};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cU: hsla_.cU, c1: hsla_.c1, $7: hsla_.$7});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cH: $elm$core$Basics$round(rgba_.b6 * 255),
				cT: $elm$core$Basics$round(rgba_.ch * 255),
				dl: $elm$core$Basics$round(rgba_.ct * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cU: hslaValue.cU, c1: hslaValue.c1, $7: hslaValue.$7};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cD: 1.0, cU: hslValue.cU, c1: hslValue.c1, $7: hslValue.$7};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cD: alpha_, cH: rgb_.cH, cT: rgb_.cT, dl: rgb_.dl};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cU: hslaValue.cU, c1: hslaValue.c1, $7: hslaValue.$7});
	return {cD: hslaValue.cD, cH: rgb_.cH, cT: rgb_.cT, dl: rgb_.dl};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cD: 1.0, cH: rgb_.cH, cT: rgb_.cT, dl: rgb_.dl};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cT + ((endRgb.cT - startRgb.cT) * t));
							var r = $elm$core$Basics$round(startRgb.dl + ((endRgb.dl - startRgb.dl) * t));
							var b = $elm$core$Basics$round(startRgb.cH + ((endRgb.cH - startRgb.cH) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cH: b, cT: g, dl: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dl + ((endRgba.dl - startRgba.dl) * t));
							var g = $elm$core$Basics$round(startRgba.cT + ((endRgba.cT - startRgba.cT) * t));
							var b = $elm$core$Basics$round(startRgba.cH + ((endRgba.cH - startRgba.cH) * t));
							var a = startRgba.cD + ((endRgba.cD - startRgba.cD) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.$7 + ((endHsl.$7 - startHsl.$7) * t);
							var l = startHsl.c1 + ((endHsl.c1 - startHsl.c1) * t);
							var h = startHsl.cU + ((endHsl.cU - startHsl.cU) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.$7 + ((endHsla.$7 - startHsla.$7) * t);
							var l = startHsla.c1 + ((endHsla.c1 - startHsla.c1) * t);
							var h = startHsla.cU + ((endHsla.cU - startHsla.cU) * t);
							var a = startHsla.cD + ((endHsla.cD - startHsla.cD) * t);
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cU: start.cU + ((endSize.cU - start.cU) * t), K: start.K + ((endSize.K - start.K) * t)};
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.fU(start);
		var endRecord = support.fU(end);
		return support.eA(
	...
	function (maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.cg));
			var entryStyles = $elm$core$Dict$toList(discrete.cf);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cb: $elm$core$Dict$empty, cc: $elm$core$Dict$empty, bh: 0, bL: $elm$core$Maybe$Nothing, aS: 0, cu: 0, aF: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cB: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b5: '', ca: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, cm: ''};
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							a0: A2($elm$core$List$cons, prop, acc.a0)
						});
				case 1:
					return _Utils_update(
						acc,
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F8(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, properties) {
		var animated = $author$project$Anim$Internal$Builder$partitionByMode(properties).a0;
		return function (animGroup) {
			if ($elm$core$List$isEmpty(animated) && ($elm$core$Dict$isEmpty(discrete.cf) && $elm$core$Dict$isEmpty(discrete.cg))) {
				return animGroup;
			} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.K, dimensions.cU);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
		var stringifyConfig = function (p) {
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.v) + ('-' + ($elm$core$String$fromInt(cfg.s) + ('-' + (toCssString(cfg.m) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.bm))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.cf),
				stringifyExitDict(discrete.cg));
		}();
...
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dl - rgb1.dl;
		var dg = rgb2.cT - rgb1.cT;
		var db = rgb2.cH - rgb1.cH;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fU(coord2);
		var record1 = support.fU(coord1);
...
var $author$project$Anim$Internal$Engine$Keyframe$init = function () {
	var initGroup = F3(
		function (builder, name, config) {
			...
			var discrete = {
				cf: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, name, builder),
				cg: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, name, builder)
			};
			var playback = A3(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.M);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.bT);
	});
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cD: startAlpha, cH: rgb_.cH, cT: rgb_.cT, dl: rgb_.dl});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				var hsl_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cD: startAlpha, cU: hsl_.cU, c1: hsl_.c1, $7: hsl_.$7});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					cd: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
...
var $author$project$Anim$Internal$Builder$setTranslateInitCssUnit = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.ar),
			_List_fromArray(
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cd: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bm: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cd: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bm);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bm);
		return A4(
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.ar, slots, builder);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cd: A2(distanceFn, startVal, newEnd),
				m: newEnd,
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {D: groupConfig, cn: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.as);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aw: newEntry, a4: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aw: newEntry,
								a4: A2($elm$core$List$cons, existing.aw, existing.a4)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							u: _Utils_update(
								state,
								{
									as: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.as)
								})
						});
				}),
			data,
	...
	function (finaliseBuilder, _v0, transform) {
		...
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var discrete = {
					cf: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, builder),
					cg: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, builder)
				};
		...
		return A2(
			...
			A2(
				...
				A3(
					...
					insertAnimGroup,
					animGroups,
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processedAnimData.ci))));
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isRunning = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(animGroup.aS);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$update = F2(
	function (animMsg, animState) {
		switch (animMsg.$) {
			...
			case 0:
				var animGroupName = animMsg.a;
				var targetId = animMsg.b.fB;
				var currentTargetId = animMsg.b.eg;
				return _Utils_Tuple2(
					A3(
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isComplete = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(animGroup.aS);
};
...
var $author$project$Anim$Internal$Engine$CSS$CSS$SourceEventData = F2(
	function (targetId, currentTargetId) {
		return {eg: currentTargetId, fB: targetId};
	});
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$update,
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$view
	});
