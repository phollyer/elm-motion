...
{
	if (region.bn.bj === region.m.bj)
	{
		return 'on line ' + region.bn.bj;
	}
	return 'on lines ' + region.bn.bj + ' through ' + region.m.bj;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cS: fragment, cZ: host, df: path, dh: port_, dk: protocol, dl: query};
	});
...
var $author$project$Anim$Unit$Cqw = 8;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName = 'movingBox';
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct = 12;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$centerXCqw = (100 - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct) / 2;
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bS: '', bV: '', bW: '', b$: ''};
...
var $author$project$Anim$Internal$Property$Rotate$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!angles.aj)) ? $elm$core$Maybe$Just(
				'rotateX(' + ($elm$core$String$fromFloat(angles.aj) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.ak)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.ak) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.al)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.al) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
...
var $author$project$Anim$Internal$Property$Skew$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!values.aj)) ? $elm$core$Maybe$Just(
				'skewX(' + ($elm$core$String$fromFloat(values.aj) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.ak)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.ak) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = F2(
	function (axes, _v0) {
		var coords = _v0;
		return 'translate3d(' + ($elm$core$String$fromFloat(coords.aj) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aj) + (', ' + ($elm$core$String$fromFloat(coords.ak) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ak) + (', ' + ($elm$core$String$fromFloat(coords.al) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.al) + ')'))))))));
	});
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {aj: 0, ak: 0, al: 0};
var $author$project$Anim$Internal$Property$Translate$support = {
	dG: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {aj: a.aj + b.aj, ak: a.ak + b.ak, al: a.al + b.al};
		}),
	el: $author$project$Anim$Internal$Property$Translate$default,
	eB: $elm$core$Basics$identity,
	bV: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {aj: coords.aj * factor, ak: coords.ak * factor, al: coords.al * factor};
		}),
	fB: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss = F3(
	function (maybeControlledAxes, cssUnitAxes, value) {
		...
		if (!_v0.$) {
			var axes = _v0.a;
			var zSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.al);
			var ySuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.ak);
			var xSuffix = $author$project$Anim$Internal$Unit$toCssSuffix(cssUnitAxes.aj);
				...
				A2(
					...
					_List_fromArray(
						[
							...
							'translateX(' + ($elm$core$String$fromFloat(coords.aj) + (xSuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasY ? $elm$core$Maybe$Just(
							'translateY(' + ($elm$core$String$fromFloat(coords.ak) + (ySuffix + ')'))) : $elm$core$Maybe$Nothing,
							hasZ ? $elm$core$Maybe$Just(
							'translateZ(' + ($elm$core$String$fromFloat(coords.al) + (zSuffix + ')'))) : $elm$core$Maybe$Nothing
						])));
					...
					switch (property.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									b$: A3($author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss, maybeControlledAxes, config.z, config.m)
								});
						case 4:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bS: $author$project$Anim$Internal$Property$Rotate$toCssString(config.m)
								});
						case 7:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bW: $author$project$Anim$Internal$Property$Skew$toCssString(config.m)
								});
						case 5:
							var config = property.a;
							return _Utils_update(
								acc,
								{
									bV: $author$project$Anim$Internal$Property$Scale$toCssString(config.m)
								});
						default:
							return acc;
					}
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b$, transformParts.bS, transformParts.bW, transformParts.bV]);
				} else {
					...
					return A2(
						...
						function (o) {
							var part = function () {
								switch (o) {
									case 0:
										return transformParts.b$;
									case 1:
										return transformParts.bS;
									case 2:
			...
			return {
				...
				b$: A3(
					...
					A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							{aj: $author$project$Anim$Internal$Unit$default, ak: $author$project$Anim$Internal$Unit$default, al: $author$project$Anim$Internal$Unit$default},
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.cV),
			$author$project$Anim$Internal$Unit$toCssSuffix(axes.ak));
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString = F2(
	function (axes, _v0) {
		var y = _v0.ak;
		var x = _v0.aj;
		return $elm$core$String$fromFloat(x) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aj) + (' ' + ($elm$core$String$fromFloat(y) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.ak))));
	});
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.L),
			$author$project$Anim$Internal$Unit$toCssSuffix(axes.aj));
	});
				...
				case 3:
					...
					return _List_fromArray(
						[
							_Utils_Tuple2(
							'perspective-origin',
							A2($author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString, config.z, config.m))
						]);
				default:
					var config = prop.a;
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
									'width',
									A2($author$project$Anim$Internal$Property$Size$widthToCssString, config.z, config.m))) : $elm$core$Maybe$Nothing,
								controls('height') ? $elm$core$Maybe$Just(
								_Utils_Tuple2(
									'height',
									A2($author$project$Anim$Internal$Property$Size$heightToCssString, config.z, config.m))) : $elm$core$Maybe$Nothing
							]));
			}
		});
};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$default = {aj: 50, ak: 50};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cV: 0, L: 0};
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.bn);
		var linearProgress = function () {
			if (_Utils_cmp(totalTime, cfg.t) < 0) {
				return 0;
			} else {
				if (!cfg.v) {
					return 1.0;
				} else {
					var animationTime = totalTime - cfg.t;
					return A3($elm$core$Basics$clamp, 0, 1, animationTime / cfg.v);
				}
			}
		}();
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					{
						bI: 0,
						bm: $author$project$Motion$Internal$Spring$unwrap(s),
						b_: 1
					},
					linearProgress * cfg.v);
			} else {
				return A2($author$project$Shared$Easing$toFunction, cfg.bH, linearProgress);
			}
		}();
		return toCssString(
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cV: hNormalized, c2: l * 100, dp: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cI: rgba_.cI, cU: rgba_.cU, dm: rgba_.dm};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cE: rgba_.cE, cV: hsla_.cV, c2: hsla_.c2, dp: hsla_.dp};
};
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dp / 100;
	var l = hslValue.c2 / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cV / 60, 2) - 1));
	var _v0 = (hslValue.cV < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cV < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cV < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cV < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cV < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cI: rgba_.cI, cU: rgba_.cU, dm: rgba_.dm};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cV: hsla_.cV, c2: hsla_.c2, dp: hsla_.dp});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cI: $elm$core$Basics$round(rgba_.b6 * 255),
				cU: $elm$core$Basics$round(rgba_.ci * 255),
				dm: $elm$core$Basics$round(rgba_.cu * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cV: hslaValue.cV, c2: hslaValue.c2, dp: hslaValue.dp};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cE: 1.0, cV: hslValue.cV, c2: hslValue.c2, dp: hslValue.dp};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cE: alpha_, cI: rgb_.cI, cU: rgb_.cU, dm: rgb_.dm};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cV: hslaValue.cV, c2: hslaValue.c2, dp: hslaValue.dp});
	return {cE: hslaValue.cE, cI: rgb_.cI, cU: rgb_.cU, dm: rgb_.dm};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cE: 1.0, cI: rgb_.cI, cU: rgb_.cU, dm: rgb_.dm};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cU + ((endRgb.cU - startRgb.cU) * t));
							var r = $elm$core$Basics$round(startRgb.dm + ((endRgb.dm - startRgb.dm) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dm + ((endRgba.dm - startRgba.dm) * t));
							var g = $elm$core$Basics$round(startRgba.cU + ((endRgba.cU - startRgba.cU) * t));
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dp + ((endHsl.dp - startHsl.dp) * t);
							var l = startHsl.c2 + ((endHsl.c2 - startHsl.c2) * t);
							var h = startHsl.cV + ((endHsl.cV - startHsl.cV) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dp + ((endHsla.dp - startHsla.dp) * t);
							var l = startHsla.c2 + ((endHsla.c2 - startHsla.c2) * t);
							var h = startHsla.cV + ((endHsla.cV - startHsla.cV) * t);
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate = F3(
	function (t, start, end) {
		...
		var ex = _v1.a;
		var ey = _v1.b;
		return {aj: sx + ((ex - sx) * t), ak: sy + ((ey - sy) * t)};
	});
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cV: start.cV + ((endSize.cV - start.cV) * t), L: start.L + ((endSize.L - start.L) * t)};
	});
					...
					case 3:
						...
						return _List_fromArray(
							[
								...
								$author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString(cfg.z),
								cfg)
							]);
					case 6:
						var cfg = p.a;
							...
							_List_fromArray(
								[
									...
									A5(
										...
										$author$project$Anim$Internal$Property$Size$widthToCssString(cfg.z),
									...
									A5(
										...
										$author$project$Anim$Internal$Property$Size$default,
										$author$project$Anim$Internal$Property$Size$interpolate,
										$author$project$Anim$Internal$Property$Size$heightToCssString(cfg.z),
										cfg)) : $elm$core$Maybe$Nothing
								]));
					case 4:
						return _List_Nil;
...
var $author$project$Anim$Internal$Property$Rotate$default = {aj: 0, ak: 0, al: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {aj: 1.0, ak: 1.0, al: 1.0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {aj: 0, ak: 0};
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.fV(start);
		var endRecord = support.fV(end);
		return support.eB(
			{aj: startRecord.aj + ((endRecord.aj - startRecord.aj) * t), ak: startRecord.ak + ((endRecord.ak - startRecord.ak) * t), al: startRecord.al + ((endRecord.al - startRecord.al) * t)});
	});
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	el: $author$project$Anim$Internal$Property$Rotate$default,
	eB: $elm$core$Basics$identity,
	bV: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {aj: angles.aj * factor, ak: angles.ak * factor, al: angles.al * factor};
		}),
	fB: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	el: $author$project$Anim$Internal$Property$Scale$default,
	eB: $elm$core$Basics$identity,
	bV: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.aj, values.ak);
};
					...
					switch (p.$) {
						...
						case 4:
							...
							return _Utils_update(
								acc,
								{
									bS: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Rotate$default, $author$project$Anim$Internal$Property$Rotate$interpolate, $author$project$Anim$Internal$Property$Rotate$toCssString, cfg)
								});
						case 5:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bV: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Scale$default, $author$project$Anim$Internal$Property$Scale$interpolate, $author$project$Anim$Internal$Property$Scale$toCssString, cfg)
								});
						case 7:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bW: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$interpolate, $author$project$Anim$Internal$Property$Skew$toCssString, cfg)
								});
						default:
							return acc;
					}
	...
	function (controlledAxes, maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.ch));
			var entryStyles = $elm$core$Dict$toList(discrete.cg);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bi: 0, bM: $elm$core$Maybe$Nothing, aT: 0, cv: 0, aF: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b5: '', cb: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, cn: ''};
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							a1: A2($elm$core$List$cons, prop, acc.a1)
						});
				case 1:
					return _Utils_update(
						acc,
						{
							a8: A2($elm$core$List$cons, prop, acc.a8)
						});
				default:
					return acc;
			}
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setAnimation = F2(
	function (animation, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				bM: $elm$core$Maybe$Just(animation)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F9(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, controlledAxes, properties) {
		var animated = $author$project$Anim$Internal$Builder$partitionByMode(properties).a1;
		return function (animGroup) {
			if ($elm$core$List$isEmpty(animated) && ($elm$core$Dict$isEmpty(discrete.cg) && $elm$core$Dict$isEmpty(discrete.ch))) {
				return animGroup;
			} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cV);
};
var $author$project$Anim$Internal$Property$Size$toCssString = F2(
	function (axes, size) {
		...
		var width = _v0.a;
		var height = _v0.b;
		return 'width: ' + ($elm$core$String$fromFloat(width) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aj) + ('; height: ' + ($elm$core$String$fromFloat(height) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.ak)))));
	});
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
		var stringifyConfig = function (p) {
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.v) + ('-' + ($elm$core$String$fromInt(cfg.t) + ('-' + (toCssString(cfg.m) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.bn))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
				...
				case 6:
					...
					return A3(
						s,
						'size-',
						$author$project$Anim$Internal$Property$Size$toCssString(cfg.z),
						cfg);
				case 7:
					var cfg = p.a;
				...
				default:
					...
					return A3(
						s,
						'pos-',
						$author$project$Anim$Internal$Property$Translate$toCssString(cfg.z),
						cfg);
			}
		};
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.cg),
				stringifyExitDict(discrete.ch));
		}();
...
var $author$project$Anim$Internal$Unit$emptyCssUnitAxes = {aj: $elm$core$Maybe$Nothing, ak: $elm$core$Maybe$Nothing, al: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, bs: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {by: $elm$core$Maybe$Nothing, g: false, bX: $elm$core$Maybe$Nothing, bp: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, N: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = function () {
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return A2(
		$elm$core$List$foldl,
		runInitEntry,
		{a: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, g: false, b: $author$project$Anim$Internal$Builder$initPlayback, n: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, s: $author$project$Anim$Internal$Builder$initState, i: 0});
}();
	...
	function (maybeBaseline, axes) {
		if (maybeBaseline.$ === 1) {
			...
			return {
				...
				al: A2($author$project$Anim$Internal$Unit$orMaybe, axes.al, baseline.al)
			};
		}
	});
...
var $author$project$Anim$Internal$Builder$CssUnitStore$getAxes = F3(
	function (group, slots, store) {
		return {
			...
			al: A3($author$project$Anim$Internal$Builder$CssUnitStore$get, group, slots.al, store)
		};
	});
...
var $author$project$Anim$Internal$Builder$perspectiveOriginStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			...
			animGroupName,
			{aj: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginX, ak: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginY, al: ''},
			defaults.H);
	});
...
var $author$project$Anim$Internal$Unit$resolveCssUnitAxes = F3(
	function (local, global, default_) {
		return {
			...
			al: A3($author$project$Anim$Internal$Unit$pickAxis, local.al, global.al, default_)
		};
	});
...
var $author$project$Anim$Internal$Builder$sizeStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{aj: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, ak: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, al: ''},
			defaults.H);
	});
...
var $author$project$Anim$Internal$Builder$translateStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{aj: $author$project$Anim$Internal$Builder$CssUnitStore$translateX, ak: $author$project$Anim$Internal$Builder$CssUnitStore$translateY, al: $author$project$Anim$Internal$Builder$CssUnitStore$translateZ},
			defaults.H);
	});
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.T, $author$project$Anim$Internal$Unit$default),
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation.R)));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			N: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.N),
...
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dm - rgb1.dm;
		var dg = rgb2.cU - rgb1.cU;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		...
		var dz = $elm$core$Basics$abs(record2.al - record1.al);
		var dy = $elm$core$Basics$abs(record2.ak - record1.ak);
		var dx = $elm$core$Basics$abs(record2.aj - record1.aj);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Size$distance = F2(
	function (_v0, _v1) {
		var start = _v0;
		var end = _v1;
		var dw = end.L - start.L;
		var dh = end.cV - start.cV;
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var wrapper = _v0.ai;
	var speedFn = _v0.ag;
	var durationFn = _v0.Z;
	var distanceFn = _v0.Y;
	var defaultCssUnit = _v0.W;
	var defaultStart = _v0.X;
	var globalCssUnit = _v0.h;
	var globalData = _v0._;
	var config = _v0.C;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bn);
	...
	return wrapper(
		{
			...
			t: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.t, globalData.aq, 0),
			ce: distance_,
			v: $elm$core$Basics$round(duration_),
			bH: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bH, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			K: config.K,
			dt: speed_,
			bm: resolvedSpring,
			...
			case 0:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							W: $author$project$Anim$Internal$Unit$default,
							X: 0,
							Y: F2(
								function (a, b) {
									return $elm$core$Basics$abs(b - a);
								}),
							Z: $author$project$Shared$TimeSpec$duration,
							h: globalData.h,
							_: globalData,
							ag: $author$project$Shared$TimeSpec$speed,
							ai: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							W: $author$project$Anim$Internal$Unit$default,
							X: $author$project$Anim$Internal$Extra$Color$transparent,
							Y: $author$project$Anim$Internal$Extra$Color$distance,
							Z: $author$project$Anim$Internal$Extra$Color$duration,
							h: globalData.h,
							_: globalData,
							ag: $author$project$Anim$Internal$Extra$Color$speed,
							ai: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: config,
							W: $author$project$Anim$Internal$Unit$default,
							X: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							Y: $author$project$Anim$Internal$Property$Opacity$distance,
							Z: $author$project$Anim$Internal$Property$Opacity$duration,
							h: globalData.h,
							_: globalData,
							ag: $author$project$Anim$Internal$Property$Opacity$speed,
							ai: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: mergePerspectiveOrigin(config),
							W: 28,
							X: $author$project$Anim$Internal$Property$PerspectiveOrigin$default,
							Y: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance,
							Z: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration,
							h: globalData.h,
							_: globalData,
							ag: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed,
							ai: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig
						}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Rotate$default, Y: $author$project$Anim$Internal$Property$Rotate$distance, Z: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Rotate$speed, ai: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Scale$default, Y: $author$project$Anim$Internal$Property$Scale$distance, Z: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Scale$speed, ai: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: mergeSize(config),
							W: $author$project$Anim$Internal$Unit$default,
							X: $author$project$Anim$Internal$Property$Size$default,
							Y: $author$project$Anim$Internal$Property$Size$distance,
							Z: $author$project$Anim$Internal$Property$Size$duration,
							h: globalData.T,
							_: globalData,
							ag: $author$project$Anim$Internal$Property$Size$speed,
							ai: $author$project$Anim$Internal$Builder$ProcessedSizeConfig
						}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Skew$default, Y: $author$project$Anim$Internal$Property$Skew$distance, Z: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Skew$speed, ai: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							C: mergeTranslate(config),
							W: $author$project$Anim$Internal$Unit$default,
							X: $author$project$Anim$Internal$Property$Translate$default,
							Y: $author$project$Anim$Internal$Property$Translate$distance,
							Z: $author$project$Anim$Internal$Property$Translate$duration,
							h: globalData.h,
							_: globalData,
							ag: $author$project$Anim$Internal$Property$Translate$speed,
							ai: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig
						}));
		}
	});
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.s.am);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.C.b8);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.ao, history.aO));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.R)));
	};
...
var $author$project$Anim$Internal$Engine$Keyframe$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				V: $author$project$Anim$Internal$Builder$init(_List_Nil)
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
	} else {
		...
		var initGroup = F2(
			function (name, config) {
				var playback = A3(
					...
					config.b);
				var discrete = {
					cg: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, name, builder),
					ch: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, name, builder)
				};
				return A7($author$project$Anim$Internal$Engine$Keyframe$Generator$generateAnimation, config.o, playback.r, playback.w, discrete, name, config.b8, config.q);
			});
		var processedGroups = $author$project$Anim$Internal$Builder$process(builder).cj;
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				V: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.R));
	}
};
var $author$project$Anim$Internal$Builder$getDelay = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).aq;
};
...
var $author$project$Anim$Internal$Builder$getTimeSpec = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).aa;
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.N);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.bU);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bn: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bn: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cE: startAlpha, cI: rgb_.cI, cU: rgb_.cU, dm: rgb_.dm});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				var hsl_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cE: startAlpha, cV: hsl_.cV, c2: hsl_.c2, dp: hsl_.dp});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bn: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					ce: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
					m: colorWithPreservedAlpha,
					bn: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Property$CustomColor$init = F4(
	function (animGroupName, cssProperty, value, animBuilder) {
		return $author$project$Anim$Internal$Property$CustomColor$build(
			A2(
				$author$project$Anim$Internal$Property$CustomColor$to,
				value,
				A2(
					$author$project$Anim$Internal$Property$CustomColor$from,
					value,
					A3(
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						H: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.H)
					});
			};
			var defs = data.c;
			var animation = data.a;
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						animation,
						{
							aJ: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, animation.aJ)
						}),
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bn);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Translate$default, clampedStart);
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						aj: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.aj : endRecord.aj,
						ak: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.ak : endRecord.ak,
						al: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.al : endRecord.al
					});
				return _Utils_update(
					config,
					{
						ce: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bn);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bn);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bn);
		return _Utils_update(
			config,
			{
				ce: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bn: $elm$core$Maybe$Just(startVal)
			});
	});
...
var $author$project$Anim$Extra$Color$rgb = F3(
	function (r, g, b) {
		return $author$project$Anim$Internal$Extra$Color$Rgb(
			{cI: b, cU: g, dm: r});
	});
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$init = _Utils_Tuple2(
	{
		M: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$centerXCqw),
					$author$project$Anim$Property$Translate$initCssUnit(8)),
					A3(
					$author$project$Anim$Property$CustomColor$init,
					$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName,
					$author$project$Anim$Property$CustomColor$BackgroundColor,
					A3($author$project$Anim$Extra$Color$rgb, 118, 118, 118))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$XLeft = 0;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$XRight = 2;
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {C: groupConfig, co: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.am);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ao: newEntry, aO: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ao: newEntry,
								aO: A2($elm$core$List$cons, existing.ao, existing.aO)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							s: _Utils_update(
								state,
								{
									am: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.am)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$addStyle = F3(
	function (key, value, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				aF: A3($author$project$Anim$Internal$Engine$CSS$Styles$insert, key, value, animGroup.aF)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$mergeStyles = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			_new,
			{
				aF: A2($author$project$Anim$Internal$Engine$CSS$Styles$merge, _new.aF, existing.aF)
			});
	});
		...
		var hasAnimateTiming = function (config) {
			return A2(
				...
				function (prop) {
					...
					return (timing.v > 0) || (timing.t > 0);
				},
				$author$project$Anim$Internal$Builder$partitionByMode(config.q).a1);
		};
		var builder = transform(state.V);
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var discrete = {
					cg: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, builder),
					ch: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, builder)
				};
		...
		var initialPlayStateFor = function (animGroupName) {
			return A2(
				...
				A2(
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, processedAnimData.cj)));
		};
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
				V: A2(finaliseBuilder, builder, processedAnimData)
			},
			A2(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
				F2(
				...
				A3(
					...
					insertAnimGroup,
					animGroups,
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processedAnimData.cj))));
	});
...
var $author$project$Motion$Easing$Linear = {$: 23};
...
var $author$project$Anim$Internal$Property$CustomColor$duration = F2(
	function (dur, _v0) {
		var cssName = _v0.a;
		var config = _v0.b;
		var builder = _v0.c;
		return A3(
			$author$project$Anim$Internal$Property$CustomColor$Builder,
			cssName,
			A2($author$project$Anim$Internal$Builder$Property$duration, dur, config),
			builder);
	});
var $author$project$Anim$Property$CustomColor$duration = $author$project$Anim$Internal$Property$CustomColor$duration;
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bH: $elm$core$Maybe$Just(easing_),
				bm: $elm$core$Maybe$Nothing
			});
	});
var $author$project$Anim$Internal$Property$CustomColor$easing = F2(
	function (ease, _v0) {
		var cssName = _v0.a;
		var config = _v0.b;
		var builder = _v0.c;
		return A3(
			$author$project$Anim$Internal$Property$CustomColor$Builder,
			cssName,
			A2($author$project$Anim$Internal$Builder$Property$easing, ease, config),
			builder);
	});
var $author$project$Anim$Property$CustomColor$easing = $author$project$Anim$Internal$Property$CustomColor$easing;
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$changeColor = function (color) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BackgroundColor),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$CustomColor$to(color),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$CustomColor$duration(3000),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$CustomColor$easing($author$project$Motion$Easing$Linear),
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$moveBoxX = function (x) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$begin,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$toX(x),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$speed(25),
				A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$centerXCqw;
		default:
			return 100 - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct;
	}
};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isRunning = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(animGroup.aT);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$update = F2(
	function (animMsg, animState) {
		switch (animMsg.$) {
			...
			case 0:
				var animGroupName = animMsg.a;
				var targetId = animMsg.b.fC;
				var currentTargetId = animMsg.b.eh;
				return _Utils_Tuple2(
					A3(
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animationMsg, model.M);
					...
					_Utils_update(
						model,
						{
							M: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$targetX(0))))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							M: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
										$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$targetX(2))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var color = msg.a;
						...
						model,
						{
							M: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$changeColor(color)))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$ChangeColor = function (a) {
	return {$: 3, a: a};
};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$MoveLeft = {$: 1};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$MoveRight = {$: 2};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isComplete = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(animGroup.aT);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$toCssString = function (_v0) {
	...
	return animation.b5 + (' ' + ($elm$core$String$fromInt(animation.v) + ('ms linear 0ms ' + (iterationString + (' ' + (directionString + ' forwards'))))));
};
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxHalfPct = $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct / 2;
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
...
var $author$project$Anim$Internal$Engine$CSS$CSS$SourceEventData = F2(
	function (targetId, currentTargetId) {
		return {eh: currentTargetId, fC: targetId};
	});
...
var $author$project$Anim$Internal$Extra$Color$ElmColor = function (a) {
	return {$: 5, a: a};
};
var $author$project$Anim$Internal$Extra$Color$toHexComponent = function (value) {
	var toHexDigit = function (digit) {
		if (digit < 10) {
	...
	var clampedValue = A3($elm$core$Basics$clamp, 0, 255, value);
	var high = (clampedValue / 16) | 0;
	var low = A2($elm$core$Basics$modBy, 16, clampedValue);
	return _Utils_ap(
		toHexDigit(high),
		toHexDigit(low));
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHex = function (_v0) {
	var a = _v0.cE;
	var b = _v0.cI;
	var g = _v0.cU;
	var r = _v0.dm;
	return '#' + ($author$project$Anim$Internal$Extra$Color$toHexComponent(r) + ($author$project$Anim$Internal$Extra$Color$toHexComponent(g) + ($author$project$Anim$Internal$Extra$Color$toHexComponent(b) + $author$project$Anim$Internal$Extra$Color$toHexComponent(
		$elm$core$Basics$round(a * 255)))));
};
var $author$project$Anim$Internal$Extra$Color$elmColorToHex = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Internal$Extra$Color$ElmColor,
	A2($elm$core$Basics$composeR, $author$project$Anim$Internal$Extra$Color$toRgba, $author$project$Anim$Internal$Extra$Color$rgbaToHex));
var $author$project$Anim$Internal$Extra$Color$rgbToHex = function (_v0) {
	var b = _v0.cI;
	var g = _v0.cU;
	var r = _v0.dm;
	return '#' + ($author$project$Anim$Internal$Extra$Color$toHexComponent(r) + ($author$project$Anim$Internal$Extra$Color$toHexComponent(g) + $author$project$Anim$Internal$Extra$Color$toHexComponent(b)));
};
var $author$project$Anim$Internal$Extra$Color$hslToHex = A2($elm$core$Basics$composeR, $author$project$Anim$Internal$Extra$Color$hslToRgb, $author$project$Anim$Internal$Extra$Color$rgbToHex);
var $author$project$Anim$Internal$Extra$Color$hslaToHex = A2($elm$core$Basics$composeR, $author$project$Anim$Internal$Extra$Color$hslaToRgba, $author$project$Anim$Internal$Extra$Color$rgbaToHex);
var $author$project$Anim$Internal$Extra$Color$toHex = function (color) {
	switch (color.$) {
		case 0:
			var hexStr = color.a;
			return hexStr;
		case 1:
			var rgb_ = color.a;
			return $author$project$Anim$Internal$Extra$Color$rgbToHex(rgb_);
		case 2:
			var rgba_ = color.a;
			return $author$project$Anim$Internal$Extra$Color$rgbaToHex(rgba_);
		case 3:
			var hsl_ = color.a;
			return $author$project$Anim$Internal$Extra$Color$hslToHex(hsl_);
		case 4:
			var hsla_ = color.a;
			return $author$project$Anim$Internal$Extra$Color$hslaToHex(hsla_);
		default:
			var elmColor_ = color.a;
			return $author$project$Anim$Internal$Extra$Color$elmColorToHex(elmColor_);
	}
};
var $author$project$Anim$Extra$Color$toHex = $author$project$Anim$Internal$Extra$Color$toHex;
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$view = function (model) {
	var posButton = F3(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						'background-color',
						$author$project$Anim$Extra$Color$toHex(color))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(label)
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.M),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A3(posButton, '#333', 'Move Left', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$MoveLeft),
						A3(posButton, '#333', 'Move Right', $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$MoveRight)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(colorButton, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color1, 'Color 1'),
						A2(colorButton, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color2, 'Color 2'),
						A2(colorButton, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color3, 'Color 3'),
						A2(colorButton, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$color4, 'Color 4')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.M),
							_Utils_ap(
								$author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$Attributes$style,
										'width',
										$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
										A2(
										$elm$html$Html$Attributes$style,
										'height',
										$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
										...
										$elm$html$Html$Attributes$style,
										'top',
										'calc(50% - ' + ($elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$boxHalfPct) + 'cqw)')),
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$init;
		},
		fA: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		f$: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$update,
		f0: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'InterruptingAnimations':{'MultipleProperties':{'Main':{'init':$author$project$Animation$Keyframe$InterruptingAnimations$MultipleProperties$Main$main(
