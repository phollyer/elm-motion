...
var $author$project$Anim$Property$CustomColor$BorderColor = {$: 2};
var $author$project$Animation$Keyframe$BorderColor$Main$animGroup = 'borderAnim';
...
var $author$project$Animation$Keyframe$BorderColor$Main$init = _Utils_Tuple2(
	{
		au: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Keyframe$BorderColor$Main$animGroup,
					$author$project$Anim$Property$CustomColor$BorderColor,
					A3($author$project$Anim$Extra$Color$rgb, 99, 102, 241))
				]))
	},
...
var $author$project$Animation$Keyframe$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$CustomColor$to(
			A3($author$project$Anim$Extra$Color$rgb, 59, 130, 246)),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$CustomColor$duration(800),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$CustomColor$easing($author$project$Motion$Easing$CubicInOut),
				$author$project$Anim$Property$CustomColor$end))));
var $author$project$Animation$Keyframe$BorderColor$Main$toRed = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$CustomColor$to(
			A3($author$project$Anim$Extra$Color$rgb, 239, 68, 68)),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$CustomColor$duration(800),
			A2(
				...
				$author$project$Anim$Property$CustomColor$easing($author$project$Motion$Easing$CubicInOut),
				$author$project$Anim$Property$CustomColor$end))));
var $author$project$Animation$Keyframe$BorderColor$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$BorderColor$Main$animGroup),
								$author$project$Animation$Keyframe$BorderColor$Main$toRed))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
					...
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$BorderColor$Main$animGroup),
								$author$project$Animation$Keyframe$BorderColor$Main$toBlue))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$BorderColor$Main$TriggerBlue = 1;
var $author$project$Animation$Keyframe$BorderColor$Main$TriggerRed = 0;
...
var $author$project$Animation$Keyframe$BorderColor$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'background-color', '#ef4444')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Red Border')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Blue Border')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$BorderColor$Main$animGroup, model.au),
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('example-box'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#f8fafc'),
									A2($elm$html$Html$Attributes$style, 'border', '4px solid #6366f1'),
...
var $author$project$Animation$Keyframe$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$BorderColor$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$BorderColor$Main$update,
		f0: $author$project$Animation$Keyframe$BorderColor$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'BorderColor':{'Main':{'init':$author$project$Animation$Keyframe$BorderColor$Main$main(
