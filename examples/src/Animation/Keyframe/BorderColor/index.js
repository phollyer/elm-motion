			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$BorderColor$Main$animGroup, model.ar),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$BorderColor$Main$update,
		f$: $author$project$Animation$Keyframe$BorderColor$Main$view
	});
