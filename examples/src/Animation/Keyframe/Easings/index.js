...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bs: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, b$: $elm$core$Set$empty, aq: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {ar: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aS: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.a5;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.aN);
	var k = A2($elm$core$Basics$max, 0, spring.aU);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bi: 0, bM: $elm$core$Maybe$Nothing, aR: 0, cv: 0, aE: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
...
var $author$project$Animation$Keyframe$Easings$Main$init = _Utils_Tuple2(
	{
		a$: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					...
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.ar);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {av: newEntry, a4: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								av: newEntry,
								a4: A2($elm$core$List$cons, existing.av, existing.a4)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							u: _Utils_update(
								state,
								{
									ar: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.ar)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isComplete = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(animGroup.aR);
};
...
var $author$project$Animation$Keyframe$Easings$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.a$),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Easings$Main$animGroup, model.a$),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$Easings$Main$main = $elm$browser$Browser$element(
	{
		...
		f$: $author$project$Animation$Keyframe$Easings$Main$update,
		f0: $author$project$Animation$Keyframe$Easings$Main$view
	});
