...
var $author$project$Animation$Keyframe$Easings$Main$animGroup = 'easingBox';
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var c = A2($elm$core$Basics$max, 0, spring.aJ);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cd: $elm$core$Dict$empty, ce: $elm$core$Dict$empty, bj: 0, bN: $elm$core$Maybe$Nothing, aS: 0, cw: 0, aE: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cD: ''};
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, bt: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aT: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.an, history.aN));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Animation$Keyframe$Easings$Main$init = _Utils_Tuple2(
	{
		a0: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Easings$Main$animGroup, 0)
				])),
		bg: false,
		bI: $author$project$Motion$Easing$CubicOut
	},
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {an: newEntry, aN: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								an: newEntry,
								aN: A2($elm$core$List$cons, existing.an, existing.aN)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$addStyle = F3(
	function (key, value, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				aE: A3($author$project$Anim$Internal$Engine$CSS$Styles$insert, key, value, animGroup.aE)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$mergeStyles = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			_new,
			{
				aE: A2($author$project$Anim$Internal$Engine$CSS$Styles$merge, _new.aE, existing.aE)
			});
	});
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bI: $elm$core$Maybe$Just(easing_),
				bn: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Animation$Keyframe$Easings$Main$animateTo = F2(
	function (x, easing) {
		return A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$speed(350),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Property$Translate$easing(easing),
...
var $author$project$Animation$Keyframe$Easings$Main$update = F2(
	function (msg, model) {
		var easing = msg;
		var target = model.bg ? 0 : 420;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					a0: A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Easings$Main$animGroup),
							A2($author$project$Animation$Keyframe$Easings$Main$animateTo, target, easing))),
					bg: !model.bg,
					bI: easing
				}),
			$elm$core$Platform$Cmd$none);
...
var $author$project$Animation$Keyframe$Easings$Main$Play = $elm$core$Basics$identity;
...
var $author$project$Animation$Keyframe$Easings$Main$curveButton = F2(
	function (selected, _v0) {
		var easing = _v0.a;
		var label = _v0.b;
		var variant = _Utils_eq(easing, selected) ? 'primary' : 'purple';
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(easing),
...
var $author$project$Motion$Easing$ExpoOut = {$: 21};
var $author$project$Motion$Easing$Linear = {$: 23};
var $author$project$Motion$Easing$QuadOut = {$: 25};
var $author$project$Animation$Keyframe$Easings$Main$curves = _List_fromArray(
	[
		_Utils_Tuple2($author$project$Motion$Easing$Linear, 'Linear'),
		_Utils_Tuple2($author$project$Motion$Easing$QuadOut, 'QuadOut'),
		_Utils_Tuple2($author$project$Motion$Easing$ExpoOut, 'ExpoOut'),
		_Utils_Tuple2($author$project$Motion$Easing$ElasticOut, 'ElasticOut'),
		_Utils_Tuple2($author$project$Motion$Easing$BounceOut, 'BounceOut'),
		_Utils_Tuple2($author$project$Motion$Easing$BackInOut, 'BackInOut')
	]);
...
var $author$project$Animation$Keyframe$Easings$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.a0),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Keyframe$Easings$Main$curveButton(model.bI),
					$author$project$Animation$Keyframe$Easings$Main$curves)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Easings$Main$animGroup, model.a0),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$Easings$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Keyframe$Easings$Main$init;
		},
		fB: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f0: $author$project$Animation$Keyframe$Easings$Main$update,
		f1: $author$project$Animation$Keyframe$Easings$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'Easings':{'Main':{'init':$author$project$Animation$Keyframe$Easings$Main$main(
