...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$animGroup = 'fadeAnim';
...
var $author$project$Anim$Internal$Builder$discreteEntry = F3(
	function (propertyName, value, _v0) {
		var data = _v0;
		var _v1 = data.a.p;
		if (_v1.$ === 1) {
			var pb = data.b;
			return _Utils_update(
				data,
				{
					b: _Utils_update(
						pb,
						{
							e: A3($elm$core$Dict$insert, propertyName, value, pb.e),
							bh: true
						})
				});
		} else {
			var animGroupName = _v1.a;
			var currentGroupConfig = A2(
				$elm$core$Maybe$withDefault,
				{e: $elm$core$Maybe$Nothing, f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, d: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, q: _List_Nil, o: $elm$core$Maybe$Nothing, i: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing},
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.y));
			var currentEntryProperties = A2($elm$core$Maybe$withDefault, data.b.e, currentGroupConfig.e);
			return A2(
				...
				_Utils_update(
					currentGroupConfig,
					{
						e: $elm$core$Maybe$Just(
							A3($elm$core$Dict$insert, propertyName, value, currentEntryProperties))
					}),
				data);
		}
	});
var $author$project$Anim$Internal$Engine$CSS$CSS$discreteEntry = $author$project$Anim$Internal$Builder$discreteEntry;
var $author$project$Anim$Engine$Keyframe$discreteEntry = $author$project$Anim$Internal$Engine$CSS$CSS$discreteEntry;
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, bs: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Opacity$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bn: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bn);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					ce: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					m: endPos,
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$init = _Utils_Tuple2(
	{
		T: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Engine$Keyframe$discreteEntry, 'display', 'none'),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$DiscreteProperties$Main$animGroup, 0))
				]))
	},
...
var $author$project$Anim$Internal$Builder$discreteExit = F4(
	function (propertyName, from, to, _v0) {
		var data = _v0;
		var _v1 = data.a.p;
		if (_v1.$ === 1) {
			var pb = data.b;
			...
			var currentGroupConfig = A2(
				...
				{e: $elm$core$Maybe$Nothing, f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, d: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, q: _List_Nil, o: $elm$core$Maybe$Nothing, i: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing},
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.y));
			var currentExitProperties = A2($elm$core$Maybe$withDefault, data.b.f, currentGroupConfig.f);
			return A2(
				$author$project$Anim$Internal$Builder$updateCurrentConfig,
				_Utils_update(
					currentGroupConfig,
...
var $author$project$Anim$Internal$Engine$CSS$CSS$discreteExit = $author$project$Anim$Internal$Builder$discreteExit;
var $author$project$Anim$Engine$Keyframe$discreteExit = $author$project$Anim$Internal$Engine$CSS$CSS$discreteExit;
var $author$project$Motion$Easing$QuartIn = {$: 27};
...
var $author$project$Anim$Internal$Builder$Opacity$duration = F2(
	function (dur, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Opacity$duration = $author$project$Anim$Internal$Builder$Opacity$duration;
...
var $author$project$Anim$Internal$Builder$Opacity$easing = F2(
	function (ease, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Opacity$easing = $author$project$Anim$Internal$Builder$Opacity$easing;
var $author$project$Anim$Property$Opacity$end = $author$project$Anim$Internal$Builder$Opacity$build;
var $author$project$Anim$Property$Opacity$from = A2($elm$core$Basics$composeL, $author$project$Anim$Internal$Builder$Opacity$from, $author$project$Anim$Internal$Property$Opacity$fromFloat);
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Opacity$duration(800),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Opacity$easing($author$project$Motion$Easing$QuartIn),
					$author$project$Anim$Property$Opacity$end)))));
var $author$project$Motion$Easing$CubicIn = {$: 10};
var $author$project$Animation$Keyframe$DiscreteProperties$Main$fadeOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$begin,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$from(1),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Opacity$to(0),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Opacity$duration(800),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Opacity$easing($author$project$Motion$Easing$CubicIn),
					$author$project$Anim$Property$Opacity$end)))));
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							T: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$DiscreteProperties$Main$animGroup),
									A2(
										$elm$core$Basics$composeR,
										A2($author$project$Anim$Engine$Keyframe$discreteEntry, 'display', 'flex'),
										$author$project$Animation$Keyframe$DiscreteProperties$Main$fadeIn)))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
						...
						model,
						{
							T: A2(
								...
								A2(
									...
									A2(
										$elm$core$Basics$composeR,
										A3($author$project$Anim$Engine$Keyframe$discreteExit, 'display', 'flex', 'none'),
										$author$project$Animation$Keyframe$DiscreteProperties$Main$fadeOut)))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animMsg, model.T);
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$GotAnimMsg = function (a) {
	return {$: 2, a: a};
};
var $author$project$Animation$Keyframe$DiscreteProperties$Main$Hide = {$: 1};
var $author$project$Animation$Keyframe$DiscreteProperties$Main$Show = {$: 0};
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.T),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$DiscreteProperties$Main$Show),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$DiscreteProperties$Main$Hide),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Uses discreteEntry/discreteExit to flip display on first/last frames.')
					])),
				A2(
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$DiscreteProperties$Main$animGroup, model.T),
					_Utils_ap(
						$author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$DiscreteProperties$Main$GotAnimMsg),
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('example-box'),
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$DiscreteProperties$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$DiscreteProperties$Main$update,
		f0: $author$project$Animation$Keyframe$DiscreteProperties$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'DiscreteProperties':{'Main':{'init':$author$project$Animation$Keyframe$DiscreteProperties$Main$main(
