...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, ar: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aT: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bm: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bm);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$DiscreteProperties$Main$update,
		f$: $author$project$Animation$Keyframe$DiscreteProperties$Main$view
	});
