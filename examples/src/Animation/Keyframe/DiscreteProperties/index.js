...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.R, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$init = _Utils_Tuple2(
	{
		S: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animMsg, model.S);
...
var $author$project$Animation$Keyframe$DiscreteProperties$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.S),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$DiscreteProperties$Main$animGroup, model.S),
					_Utils_ap(
