		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{E: nodeList, x: (len / $elm$core$Array$branchFactor) | 0, C: tail});
			} else {
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$baseHeight = 15.8;
var $author$project$Animation$Keyframe$ButtonHovers$Main$baseWidth = 51;
					...
					switch (property.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									b$: A3($author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss, maybeControlledAxes, config.A, config.m)
								});
						case 4:
							var config = property.a;
							return _Utils_update(
				...
				case 3:
					...
					return _List_fromArray(
						[
							_Utils_Tuple2(
							'perspective-origin',
							A2($author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString, config.A, config.m))
						]);
				default:
					var config = prop.a;
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
									'width',
									A2($author$project$Anim$Internal$Property$Size$widthToCssString, config.A, config.m))) : $elm$core$Maybe$Nothing,
								controls('height') ? $elm$core$Maybe$Just(
								_Utils_Tuple2(
									'height',
									A2($author$project$Anim$Internal$Property$Size$heightToCssString, config.A, config.m))) : $elm$core$Maybe$Nothing
							]));
			}
		});
};
					...
					case 3:
						...
						return _List_fromArray(
							[
								...
								$author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString(cfg.A),
								cfg)
							]);
					case 6:
						var cfg = p.a;
							...
							_List_fromArray(
								[
									...
									A5(
										...
										$author$project$Anim$Internal$Property$Size$widthToCssString(cfg.A),
									...
									A5(
										...
										$author$project$Anim$Internal$Property$Size$default,
										$author$project$Anim$Internal$Property$Size$interpolate,
										$author$project$Anim$Internal$Property$Size$heightToCssString(cfg.A),
										cfg)) : $elm$core$Maybe$Nothing
								]));
					case 4:
						return _List_Nil;
			...
			switch (p.$) {
				...
				case 6:
					...
					return A3(
						s,
						'size-',
						$author$project$Anim$Internal$Property$Size$toCssString(cfg.A),
						cfg);
				case 7:
					var cfg = p.a;
				...
				default:
					...
					return A3(
						s,
						'pos-',
						$author$project$Anim$Internal$Property$Translate$toCssString(cfg.A),
						cfg);
			}
		};
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Rotate$default, Y: $author$project$Anim$Internal$Property$Rotate$distance, Z: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Rotate$speed, ai: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Scale$default, Y: $author$project$Anim$Internal$Property$Scale$distance, Z: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Scale$speed, ai: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Skew$default, Y: $author$project$Anim$Internal$Property$Skew$distance, Z: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Skew$speed, ai: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.D.b8);
					}),
				$elm$core$Dict$empty,
...
var $author$project$Anim$Internal$Builder$setSizeInitCssUnit = F2(
	function (unit, builder) {
		var data = builder;
		return A4(
			$author$project$Anim$Internal$Builder$writeCssUnitsForGroup,
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.aE),
			_List_fromArray(
				[$author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight]),
			unit,
			builder);
	});
var $author$project$Anim$Property$Size$initCssUnit = $author$project$Anim$Internal$Builder$setSizeInitCssUnit;
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cV: record.cW, M: record.dA};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cW: dimensions.cV, dA: dimensions.M};
};
var $author$project$Anim$Internal$Builder$Size$applyClamps = F2(
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			var animGroupName = _v0.a;
			var cw = A4($author$project$Anim$Internal$Builder$getClamp, animGroupName, 'size', 'width', builder);
			var ch = A4($author$project$Anim$Internal$Builder$getClamp, animGroupName, 'size', 'height', builder);
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				return config;
			} else {
				var clampValue = function (value) {
					var r = $author$project$Anim$Internal$Property$Size$toRecord(value);
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							cW: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.cW),
							dA: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dA)
						});
				};
				var clampedEnd = clampValue(config.m);
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bn);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Size$default, clampedStart);
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Size$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	return A2(
		$author$project$Anim$Internal$Builder$Property$upsert,
		$author$project$Anim$Internal$Builder$SizeConfig(
			A2($author$project$Anim$Internal$Builder$Size$applyClamps, builder, config)),
		builder);
};
var $author$project$Anim$Internal$Builder$Size$SizeBuilder = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Anim$Internal$Builder$Size$default = 0.0;
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, L: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cV: height, M: width};
};
var $author$project$Anim$Internal$Builder$Size$defaultConfig = $author$project$Anim$Internal$Builder$Property$defaultConfig(
	$author$project$Anim$Internal$Property$Size$fromTuple(
		_Utils_Tuple2($author$project$Anim$Internal$Builder$Size$default, $author$project$Anim$Internal$Builder$Size$default)));
...
var $author$project$Anim$Internal$Builder$PropertyBaselines$getSizeConfiguredUnits = function (_v0) {
	var dict = _v0;
	return A2(
		$elm$core$Maybe$andThen,
		function (v) {
		...
		A2($elm$core$Dict$get, 'sizeConfiguredUnits', dict));
};
var $author$project$Anim$Internal$Builder$getSizeCssUnitAxes = F2(
	function (animGroupName, builder) {
		var data = builder;
		return A2(
			$author$project$Anim$Internal$Unit$mergeBaselineUnits,
			$elm$core$Maybe$Just(
				$author$project$Anim$Internal$Builder$getScopedDefaults(builder).T),
			A3(
				$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
				animGroupName,
				{aj: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, ak: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, al: ''},
...
var $author$project$Anim$Internal$Builder$getSizeInitCssUnitAxes = F2(
	function (group, _v0) {
		var data = _v0;
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
...
var $author$project$Anim$Internal$Builder$setSizeCurrentGroup = F2(
	function (name, _v0) {
		var data = _v0;
		var defs = data.c;
		return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Size$for = F2(
	function (animGroupName, builder) {
		var storeUnits = A2($author$project$Anim$Internal$Builder$getSizeInitCssUnitAxes, animGroupName, builder);
		var scopedGlobalUnits = A2($author$project$Anim$Internal$Builder$getSizeCssUnitAxes, animGroupName, builder);
		...
		var baselineUnits = A2(
			$elm$core$Maybe$andThen,
			$author$project$Anim$Internal$Builder$PropertyBaselines$getSizeConfiguredUnits,
			A2($author$project$Anim$Internal$Builder$getBaseline, animGroupName, builder));
		var baseConfig = A6($author$project$Anim$Internal$Builder$Property$for, animGroupName, 'size', $author$project$Anim$Internal$Builder$PropertyBaselines$getSize, extractExisting, $author$project$Anim$Internal$Builder$Size$defaultConfig, builder);
		...
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
			config,
			A2(
				$author$project$Anim$Internal$Builder$setSizeCurrentGroup,
				animGroupName,
				A2($author$project$Anim$Internal$Builder$for, animGroupName, builder)));
	});
var $author$project$Anim$Internal$Builder$Size$fromHW = F3(
	function (height, width, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
...
var $author$project$Anim$Property$Size$fromHW = $author$project$Anim$Internal$Builder$Size$fromHW;
...
var $author$project$Anim$Internal$Builder$registerSizeInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.aE, slots, builder);
	});
...
var $author$project$Anim$Internal$Builder$Size$markAxes = F2(
	function (axes, builder) {
		return A3($author$project$Anim$Internal$Builder$markAxes, 'size', axes, builder);
	});
...
var $author$project$Anim$Internal$Builder$Size$setEnd = F2(
	function (newEnd, config) {
		return A4($author$project$Anim$Internal$Builder$Property$setEnd, $author$project$Anim$Internal$Property$Size$default, $author$project$Anim$Internal$Property$Size$distance, newEnd, config);
	});
var $author$project$Anim$Internal$Builder$Size$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
			A2($author$project$Anim$Internal$Builder$Size$setEnd, value, config),
			A2(
				$author$project$Anim$Internal$Builder$Size$markAxes,
				_List_fromArray(
					['width', 'height']),
				builder));
	});
var $author$project$Anim$Internal$Builder$Size$toHW = F2(
	function (height, width) {
		return $author$project$Anim$Internal$Builder$Size$to(
			$author$project$Anim$Internal$Property$Size$fromTuple(
				_Utils_Tuple2(width, height)));
	});
var $author$project$Anim$Property$Size$initHW = F3(
	function (animationKey, h, w) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Internal$Builder$Size$for(animationKey),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Size$fromHW, h, w),
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Internal$Builder$Size$toHW, h, w),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Internal$Builder$Size$build,
						$author$project$Anim$Internal$Builder$registerSizeInitAxes(
							_List_fromArray(
								[$author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight]))))));
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton = 'scaleButton';
var $author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton = 'sizeButton';
var $author$project$Animation$Keyframe$ButtonHovers$Main$zButton = 'zButton';
var $author$project$Animation$Keyframe$ButtonHovers$Main$init = _Utils_Tuple2(
	{
		z: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton, $author$project$Animation$Keyframe$ButtonHovers$Main$baseHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton, $author$project$Animation$Keyframe$ButtonHovers$Main$baseHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$zButton, $author$project$Animation$Keyframe$ButtonHovers$Main$baseHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7))
				]))
	},
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {D: groupConfig, co: kind};
...
var $author$project$Anim$Property$Size$begin = function (animBuilder) {
	var _v0 = $author$project$Anim$Internal$Builder$getCurrentAnimGroupName(animBuilder);
	if (!_v0.$) {
		var animGroupName = _v0.a;
		return A2($author$project$Anim$Internal$Builder$Size$for, animGroupName, animBuilder);
	} else {
		return A2($author$project$Anim$Internal$Builder$Size$for, '', animBuilder);
	}
};
...
var $author$project$Anim$Internal$Builder$Size$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Size$duration = $author$project$Anim$Internal$Builder$Size$duration;
...
var $author$project$Anim$Internal$Builder$Size$easing = F2(
	function (easingFunction, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
			A2($author$project$Anim$Internal$Builder$Property$easing, easingFunction, config),
			builder);
	});
var $author$project$Anim$Property$Size$easing = $author$project$Anim$Internal$Builder$Size$easing;
var $author$project$Anim$Property$Size$end = $author$project$Anim$Internal$Builder$Size$build;
var $author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration = 200;
var $author$project$Motion$Easing$CubicOut = {$: 11};
var $author$project$Animation$Keyframe$ButtonHovers$Main$hoverEasing = $author$project$Motion$Easing$CubicOut;
var $author$project$Animation$Keyframe$ButtonHovers$Main$hoverHeight = 20;
var $author$project$Animation$Keyframe$ButtonHovers$Main$hoverWidth = 60;
var $author$project$Anim$Property$Size$toHW = $author$project$Anim$Internal$Builder$Size$toHW;
var $author$project$Animation$Keyframe$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Keyframe$ButtonHovers$Main$hoverHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$hoverWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Keyframe$ButtonHovers$Main$hoverEasing),
				$author$project$Anim$Property$Size$end))));
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$toZ(60),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Keyframe$ButtonHovers$Main$hoverEasing),
...
var $author$project$Anim$Internal$Builder$Scale$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Scale$duration = $author$project$Anim$Internal$Builder$Scale$duration;
var $author$project$Anim$Internal$Builder$Scale$easing = F2(
	function (easing_, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Scale$easing = $author$project$Anim$Internal$Builder$Scale$easing;
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						ce: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
...
var $author$project$Motion$Easing$CubicIn = {$: 10};
var $author$project$Animation$Keyframe$ButtonHovers$Main$unhoverEasing = $author$project$Motion$Easing$CubicIn;
var $author$project$Animation$Keyframe$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$begin,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Scale$to(1),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Scale$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Keyframe$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Keyframe$ButtonHovers$Main$scaleUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$begin,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Scale$to(1.1),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Scale$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Keyframe$ButtonHovers$Main$hoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Keyframe$ButtonHovers$Main$setDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$toZ(0),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Keyframe$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Translate$end))));
var $author$project$Animation$Keyframe$ButtonHovers$Main$shrinkSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Keyframe$ButtonHovers$Main$baseHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$baseWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Keyframe$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Size$end))));
var $author$project$Animation$Keyframe$ButtonHovers$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$scaleUp))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
						...
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$scaleDown))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$growSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$shrinkSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$zButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$liftUp))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ButtonHovers$Main$zButton),
									$author$project$Animation$Keyframe$ButtonHovers$Main$setDown))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$ButtonHovers$Main$ScaleHover = 0;
var $author$project$Animation$Keyframe$ButtonHovers$Main$ScaleUnhover = 1;
var $author$project$Animation$Keyframe$ButtonHovers$Main$SizeHover = 2;
var $author$project$Animation$Keyframe$ButtonHovers$Main$SizeUnhover = 3;
var $author$project$Animation$Keyframe$ButtonHovers$Main$ZHover = 4;
var $author$project$Animation$Keyframe$ButtonHovers$Main$ZUnhover = 5;
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {ct: true, cz: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {ee: contactDetails, eS: isPrimary, fa: pointer, fb: pointerId, fc: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cW: height, fd: pressure, fS: tiltX, fT: tiltY, dA: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d5: button, d9: clientPos, eU: keys, e0: offsetPos, e8: pagePos, fk: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dQ: alt, eg: ctrl, eY: meta, fq: shift};
	});
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$button = F5(
	function (label, hoverMsg, unhoverMsg, groupName, animState) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2($author$project$Anim$Engine$Keyframe$attributes, groupName, animState),
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'font-size', 'clamp(14px, 3.5cqw, 26px)'),
						A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
						A2($elm$html$Html$Attributes$style, 'padding', '0 clamp(8px, 2.2cqmin, 16px)'),
						...
						A2($elm$html$Html$Attributes$style, 'box-shadow', '0 3px 5px rgba(0, 0, 0, 0.5), 0 1px 3px rgba(0, 0, 0, 0.4)')
					])),
			_List_fromArray(
				[
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.z),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'border', '2px solid #041e53'),
						A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
						A2($elm$html$Html$Attributes$style, 'gap', 'clamp(12px, 3vmin, 24px)'),
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Scale', 0, 1, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton, model.z),
						A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Size', 2, 3, $author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton, model.z),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$author$project$Anim$Extra$View3D$perspective(600)
							]),
						_List_fromArray(
							[
								A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Translate Z', 4, 5, $author$project$Animation$Keyframe$ButtonHovers$Main$zButton, model.z)
							]))
					]))
			]));
};
var $author$project$Animation$Keyframe$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$ButtonHovers$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$ButtonHovers$Main$update,
		f0: $author$project$Animation$Keyframe$ButtonHovers$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'ButtonHovers':{'Main':{'init':$author$project$Animation$Keyframe$ButtonHovers$Main$main(
