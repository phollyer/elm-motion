			...
			default:
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(
						'width',
						A2($author$project$Anim$Internal$Property$Size$widthToCssString, config.A, config.m)),
						_Utils_Tuple2(
						'height',
						A2($author$project$Anim$Internal$Property$Size$heightToCssString, config.A, config.m))
					]);
		}
	});
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cU: record.cV, L: record.dz};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cV: dimensions.cU, dz: dimensions.L};
};
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				var clampValue = function (value) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							cV: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.cV),
							dz: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dz)
						});
				};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cU: height, L: width};
};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {cs: true, cy: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {ed: contactDetails, eR: isPrimary, e9: pointer, fa: pointerId, fb: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cV: height, fc: pressure, fR: tiltX, fS: tiltY, dz: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d4: button, d8: clientPos, eT: keys, e$: offsetPos, e7: pagePos, fj: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dP: alt, ef: ctrl, eX: meta, fp: shift};
	});
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$ButtonHovers$Main$update,
		f$: $author$project$Animation$Keyframe$ButtonHovers$Main$view
	});
