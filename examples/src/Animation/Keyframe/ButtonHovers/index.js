		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						b$: A2($author$project$Anim$Internal$Property$Translate$toCssString, config.A, config.m)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cV: record.cW, L: record.dA};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cW: dimensions.cV, dA: dimensions.L};
};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cV: height, L: width};
};
...
var $author$project$Anim$Internal$Builder$getSizeCssUnitAxes = F2(
	function (animGroupName, builder) {
		...
		return A2(
			$author$project$Anim$Internal$Unit$mergeBaselineUnits,
			$elm$core$Maybe$Just(
				$author$project$Anim$Internal$Builder$getScopedDefaults(builder).S),
			A3(
				$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
				animGroupName,
				{aj: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, ak: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, al: ''},
