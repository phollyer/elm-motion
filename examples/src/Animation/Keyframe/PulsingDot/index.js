...
{
	if (region.bl.bh === region.m.bh)
	{
		return 'on line ' + region.bl.bh;
	}
	return 'on lines ' + region.bl.bh + ' through ' + region.m.bh;
}
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {av: newEntry, a3: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								av: newEntry,
								a3: A2($elm$core$List$cons, existing.av, existing.a3)
							};
						}
					}();
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bq: $elm$core$Dict$empty};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cD: x0, cH: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bM: omegaD, bu: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.bl);
		...
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					{
						bH: 0,
						bk: $author$project$Motion$Internal$Spring$unwrap(s),
						bZ: 1
					},
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cb: $elm$core$Dict$empty, cc: $elm$core$Dict$empty, bg: 0, bL: $elm$core$Maybe$Nothing, aR: 0, cu: 0, aE: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cB: ''};
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							a$: A2($elm$core$List$cons, prop, acc.a$)
						});
				case 1:
					return _Utils_update(
						acc,
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F8(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, properties) {
		var animated = $author$project$Anim$Internal$Builder$partitionByMode(properties).a$;
			...
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.v) + ('-' + ($elm$core$String$fromInt(cfg.s) + ('-' + (toCssString(cfg.m) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.bl))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.D;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bl);
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, aq: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bf: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bx: $elm$core$Maybe$Nothing, g: false, bW: $elm$core$Maybe$Nothing, bn: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ar: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aS: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bl);
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bk: $elm$core$Maybe$Nothing, bl: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bl: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bl: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bl: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bl);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					...
					m: endPos,
					bl: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bl);
		return _Utils_update(
			config,
			{
				cd: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bl: $elm$core$Maybe$Just(startVal)
			});
	});
...
var $author$project$Animation$Keyframe$PulsingDot$Main$main = $elm$browser$Browser$element(
	{
		...
		f$: $author$project$Animation$Keyframe$PulsingDot$Main$view
	});
