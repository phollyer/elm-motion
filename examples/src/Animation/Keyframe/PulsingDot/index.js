...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a9: $elm$core$Dict$empty};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cE: x0, cI: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bM: omegaD, bu: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bh: 0, bL: $elm$core$Maybe$Nothing, aS: 0, cv: 0, aE: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, b_: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aT: $elm$core$Dict$empty, bT: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Keyframe$PulsingDot$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.bw),
				A2(
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$PulsingDot$Main$groupName, model.bw),
					_List_fromArray(
						[
