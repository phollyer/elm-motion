...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a9: $elm$core$Dict$empty};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cE: x0, cI: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bN: omegaD, bv: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cc: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, bh: 0, bM: $elm$core$Maybe$Nothing, aS: 0, cv: 0, aE: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
	...
	function (finaliseBuilder, _v0, transform) {
		...
		var hasAnimateTiming = function (config) {
			return A2(
				...
				$author$project$Anim$Internal$Builder$partitionByMode(config.q).a0);
		};
...
var $author$project$Animation$Keyframe$PulsingDot$Main$groupName = 'pulsingDot';
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, br: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {by: $elm$core$Maybe$Nothing, g: false, bX: $elm$core$Maybe$Nothing, bo: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aT: $elm$core$Dict$empty, bU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Engine$Keyframe$alternate = $author$project$Anim$Internal$Builder$alternate;
...
var $author$project$Anim$Internal$Engine$CSS$CSS$loopForever = $author$project$Anim$Internal$Builder$loopForever;
var $author$project$Anim$Engine$Keyframe$loopForever = $author$project$Anim$Internal$Engine$CSS$CSS$loopForever;
...
var $author$project$Animation$Keyframe$PulsingDot$Main$pulse = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Engine$Keyframe$loopForever,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Keyframe$alternate,
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$PulsingDot$Main$init = function () {
	var animState = $author$project$Anim$Engine$Keyframe$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Scale$init, $author$project$Animation$Keyframe$PulsingDot$Main$groupName, 1),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$PulsingDot$Main$groupName, 1)
			]));
	return _Utils_Tuple2(
		{
			bx: A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$PulsingDot$Main$groupName),
					$author$project$Animation$Keyframe$PulsingDot$Main$pulse))
		},
...
var $author$project$Animation$Keyframe$PulsingDot$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.bx),
				A2(
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$PulsingDot$Main$groupName, model.bx),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$PulsingDot$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$PulsingDot$Main$init;
		},
		...
		f0: $author$project$Animation$Keyframe$PulsingDot$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'PulsingDot':{'Main':{'init':$author$project$Animation$Keyframe$PulsingDot$Main$main(
