...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup = 'bouncingBall';
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.M),
...
var $author$project$Anim$Internal$Property$Size$default = {cV: 0, M: 0};
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cV: start.cV + ((endSize.cV - start.cV) * t), M: start.M + ((endSize.M - start.M) * t)};
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.M, dimensions.cV);
};
...
var $author$project$Anim$Internal$Builder$initDefaults = {I: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, bs: $elm$core$Set$empty, au: $elm$core$Maybe$Nothing};
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						I: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.I)
					});
			};
			var defs = data.c;
			var animation = data.a;
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, L: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bn);
		return A4(
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$init = _Utils_Tuple2(
	{
		E: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, 0),
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSize = 12;
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$toY(100 - $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSize),
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$Keyframe$GotPaused = function (a) {
	return {$: 4, a: a};
};
var $author$project$Anim$Internal$Engine$Shared$PlayState$Paused = 2;
var $author$project$Anim$Internal$Engine$CSS$CSS$isRunning = F3(
	function (getIsRunning, animGroupName, _v0) {
		var animGroups = _v0.b;
		return A2(
			$elm$core$Maybe$map,
			getIsRunning,
...
var $author$project$Anim$Internal$Engine$Keyframe$setPlayState = F3(
	function (animGroupName, playState, _v0) {
		var state = _v0.a;
		var animGroups = _v0.b;
		var playStateStr = $author$project$Anim$Internal$Engine$Shared$PlayState$toCssString(playState);
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			state,
			A3(
...
var $author$project$Anim$Internal$Engine$Keyframe$toCmd = F3(
	function (animGroupName, toMsg, animMsg) {
		return A2(
			$elm$core$Task$perform,
			$elm$core$Basics$identity,
			$elm$core$Task$succeed(
				toMsg(
					animMsg(animGroupName))));
	});
var $author$project$Anim$Internal$Engine$Keyframe$pause = F3(
	function (animGroupName, toMsg, animState) {
		var _v0 = A3($author$project$Anim$Internal$Engine$CSS$CSS$isRunning, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isRunning, animGroupName, animState);
		if ((!_v0.$) && _v0.a) {
			return _Utils_Tuple2(
				A3($author$project$Anim$Internal$Engine$Keyframe$setPlayState, animGroupName, 2, animState),
				A3($author$project$Anim$Internal$Engine$Keyframe$toCmd, animGroupName, toMsg, $author$project$Anim$Internal$Engine$Keyframe$GotPaused));
		} else {
			return _Utils_Tuple2(animState, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Anim$Engine$Keyframe$pause = $author$project$Anim$Internal$Engine$Keyframe$pause;
var $author$project$Anim$Internal$Engine$Keyframe$Styles$fromProcessedProperties = F3(
	function (maybeOrder, maybeTargetValues, baseStyles) {
		return A3(
			...
			$elm$core$Maybe$Nothing,
			baseStyles,
			A3($author$project$Anim$Internal$Engine$Keyframe$Styles$extractTransformStyles, $elm$core$Maybe$Nothing, maybeOrder, maybeTargetValues));
	});
var $author$project$Anim$Internal$Engine$Keyframe$buildControlStyles = function (maybeConfig) {
	if (!maybeConfig.$) {
		var config = maybeConfig.a;
		return A3($author$project$Anim$Internal$Engine$Keyframe$Styles$fromProcessedPropertiesWithControlledAxes, config.b8, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing);
	} else {
		return A2($author$project$Anim$Internal$Engine$Keyframe$Styles$fromProcessedProperties, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing);
	}
};
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.ao.C);
					}
				}(
					A2(
						$elm$core$Maybe$map,
						...
						$elm$core$List$head(
							A2(
								$elm$core$List$filter,
								isAnimate,
								A2($elm$core$List$cons, h.ao, h.aO)))));
			},
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.s.am));
	});
var $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty = F2(
	function (transforms, prop) {
		switch (prop.$) {
			case 0:
				var cssName = prop.a;
				var unit = prop.b;
				...
				return A3(
					...
					cssName,
					unit,
					A3(transforms.ca, cssName, unit, config));
			case 1:
				var cssName = prop.a;
				var config = prop.b;
				return A2(
...
var $author$project$Anim$Internal$Builder$setBaselinesFromProcessedEnds = F3(
	function (animGroupName, props, _v0) {
		...
		var existing = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Builder$PropertyBaselines$empty,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.N));
		...
		return _Utils_update(
			data,
			{
				s: _Utils_update(
					state,
					{
						N: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, merged, state.N)
					})
			});
	});
var $author$project$Anim$Internal$Engine$CSS$CSS$simpleControl = F7(
	function (fetchConfig, setPlayState, mapper, buildStyles, setStyles, animGroupName, animState) {
		var state = animState.a;
		var animGroups = animState.b;
		var maybeProcessedConfig = A2(fetchConfig, animGroupName, state.V);
		var getProcessedProperties = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
				$elm$core$Maybe$map,
		...
		if (!getProcessedProperties.b) {
			return animState;
		} else {
			var properties = getProcessedProperties;
			var snappedProperties = A2($elm$core$List$map, mapper, properties);
			var animGroup = setPlayState(
				setStyles(
					A3(
						buildStyles,
						maybeProcessedConfig,
			...
			return A2(
				...
				_Utils_update(
					state,
					{
						V: A3($author$project$Anim$Internal$Builder$setBaselinesFromProcessedEnds, animGroupName, snappedProperties, state.V)
					}),
				A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, animGroup, animGroups));
		}
	});
var $author$project$Motion$Easing$Linear = {$: 23};
var $author$project$Anim$Internal$Engine$CSS$CSS$snapTo = F2(
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				t: 0,
				ce: 0,
				bH: $author$project$Motion$Easing$Linear,
				m: value,
				bn: $elm$core$Maybe$Just(value),
				bZ: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
var $author$project$Anim$Extra$Color$transparent = $author$project$Anim$Internal$Extra$Color$transparent;
var $author$project$Anim$Internal$Engine$CSS$CSS$reset = function (setPlayState) {
	var toStartOr = function (_default) {
		return $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
			A2(
				$elm$core$Basics$composeR,
				function ($) {
					return $.bn;
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			b9: function (_v0) {
				return toStartOr($author$project$Anim$Extra$Color$transparent);
			},
			ca: F2(
				function (_v1, _v2) {
					return toStartOr(0);
				}),
			cr: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			cs: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			bS: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bV: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			cy: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bW: toStartOr($author$project$Anim$Internal$Property$Skew$default),
			b$: toStartOr($author$project$Anim$Internal$Property$Translate$default)
		});
	return A3(
		$author$project$Anim$Internal$Engine$CSS$CSS$simpleControl,
		$author$project$Anim$Internal$Builder$getLatestAnimateConfig,
		setPlayState(3),
		toResetProperty);
};
var $author$project$Anim$Internal$Engine$Keyframe$setStyles = function (styles) {
	return A2($author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setStyles, styles, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init);
};
var $author$project$Anim$Internal$Engine$Keyframe$reset = A3($author$project$Anim$Internal$Engine$CSS$CSS$reset, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setPlayState, $author$project$Anim$Internal$Engine$Keyframe$buildControlStyles, $author$project$Anim$Internal$Engine$Keyframe$setStyles);
var $author$project$Anim$Engine$Keyframe$reset = $author$project$Anim$Internal$Engine$Keyframe$reset;
var $author$project$Anim$Internal$Engine$Keyframe$GotRestarted = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Anim$Internal$Engine$Keyframe$updateAnimGroup = F3(
	function (animGroupName, animGroup, _v0) {
		var state = _v0.a;
		var animGroups = _v0.b;
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
...
var $author$project$Anim$Internal$Engine$Keyframe$restartAnimation = F4(
	function (animGroupName, controlledAxes, properties, _v0) {
		var state = _v0.a;
		var animGroups = _v0.b;
		var discrete = {
			cg: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, state.V),
			ch: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, state.V)
		};
		var counter = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		var animGroup = A9(
			$author$project$Anim$Internal$Engine$Keyframe$Generator$generateRestart,
			counter,
			A2($author$project$Anim$Internal$Builder$getTransformOrder, animGroupName, state.V),
			$author$project$Anim$Internal$Builder$getIterations(state.V),
			$author$project$Anim$Internal$Builder$getAnimationDirection(state.V),
			A2($author$project$Anim$Internal$Builder$getBaseline, animGroupName, state.V),
			discrete,
			animGroupName,
			controlledAxes,
			properties);
		return A3(
			$author$project$Anim$Internal$Engine$Keyframe$setPlayState,
			animGroupName,
			1,
			A3(
				$author$project$Anim$Internal$Engine$Keyframe$updateAnimGroup,
				animGroupName,
				animGroup,
				A2(
					$author$project$Anim$Internal$Engine$Keyframe$reset,
					animGroupName,
					A2($author$project$Anim$Internal$Engine$CSS$CSS$AnimState, state, animGroups))));
	});
var $author$project$Anim$Internal$Engine$Keyframe$restart = F3(
	function (animGroupName, toMsg, animState) {
		var state = animState.a;
		var maybeFromHistory = A2($author$project$Anim$Internal$Builder$getCurrentAnimationConfig, animGroupName, state.V);
		if (maybeFromHistory.$ === 1) {
			return _Utils_Tuple2(animState, $elm$core$Platform$Cmd$none);
		} else {
			var config = maybeFromHistory.a;
			return _Utils_Tuple2(
				A4($author$project$Anim$Internal$Engine$Keyframe$restartAnimation, animGroupName, config.b8, config.q, animState),
				A3($author$project$Anim$Internal$Engine$Keyframe$toCmd, animGroupName, toMsg, $author$project$Anim$Internal$Engine$Keyframe$GotRestarted));
		}
	});
var $author$project$Anim$Engine$Keyframe$restart = $author$project$Anim$Internal$Engine$Keyframe$restart;
var $author$project$Anim$Internal$Engine$Keyframe$GotResumed = function (a) {
	return {$: 5, a: a};
};
var $author$project$Anim$Internal$Engine$CSS$CSS$isPaused = F3(
	function (getIsPaused, animGroupName, _v0) {
		var animGroups = _v0.b;
		return A2(
			$elm$core$Maybe$map,
			getIsPaused,
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isPaused = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(animGroup.aT);
};
var $author$project$Anim$Internal$Engine$Keyframe$resume = F3(
	function (animGroupName, toMsg, animState) {
		var _v0 = A3($author$project$Anim$Internal$Engine$CSS$CSS$isPaused, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isPaused, animGroupName, animState);
		if ((!_v0.$) && _v0.a) {
			return _Utils_Tuple2(
				A3($author$project$Anim$Internal$Engine$Keyframe$setPlayState, animGroupName, 1, animState),
				A3($author$project$Anim$Internal$Engine$Keyframe$toCmd, animGroupName, toMsg, $author$project$Anim$Internal$Engine$Keyframe$GotResumed));
		} else {
			return _Utils_Tuple2(animState, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Anim$Engine$Keyframe$resume = $author$project$Anim$Internal$Engine$Keyframe$resume;
var $author$project$Anim$Internal$Engine$Shared$PlayState$isActive = function (state) {
	switch (state) {
		case 1:
			return true;
		case 2:
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isActive = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isActive(animGroup.aT);
};
var $author$project$Anim$Internal$Engine$CSS$CSS$isActive = F3(
	function (getIsActive, animGroupName, _v0) {
		var animGroups = _v0.b;
		return A2(
			$elm$core$Maybe$map,
			getIsActive,
...
var $author$project$Anim$Internal$Engine$CSS$CSS$stop = F6(
	function (setPlayState, getIsActive, buildStyles, setStyles, animGroupName, animState) {
		var _v0 = A3($author$project$Anim$Internal$Engine$CSS$CSS$isActive, getIsActive, animGroupName, animState);
		if ((!_v0.$) && _v0.a) {
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					b9: function (_v1) {
						return $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
							function ($) {
					...
					cr: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					cs: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					bS: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					bV: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					cy: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					bW: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					b$: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						})
				});
			return A7(
				$author$project$Anim$Internal$Engine$CSS$CSS$simpleControl,
				$author$project$Anim$Internal$Builder$getCurrentAnimationConfig,
				setPlayState(4),
				toStopProperty,
				buildStyles,
				setStyles,
...
var $author$project$Anim$Internal$Engine$Keyframe$stop = A4($author$project$Anim$Internal$Engine$CSS$CSS$stop, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setPlayState, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isActive, $author$project$Anim$Internal$Engine$Keyframe$buildControlStyles, $author$project$Anim$Internal$Engine$Keyframe$setStyles);
var $author$project$Anim$Engine$Keyframe$stop = $author$project$Anim$Internal$Engine$Keyframe$stop;
var $author$project$Animation$Keyframe$ControllingAnimations$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup),
									$author$project$Animation$Keyframe$ControllingAnimations$Main$dropBall))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: A2($author$project$Anim$Engine$Keyframe$stop, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.E)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var _v1 = A3($author$project$Anim$Engine$Keyframe$pause, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.E);
				var newState = _v1.a;
				var pauseCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					pauseCmd);
			case 3:
				var _v2 = A3($author$project$Anim$Engine$Keyframe$resume, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.E);
				var newState = _v2.a;
				var resumeCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: A2($author$project$Anim$Engine$Keyframe$reset, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.E)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				var _v3 = A3($author$project$Anim$Engine$Keyframe$restart, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.E);
				var newState = _v3.a;
				var restartCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{E: newState}),
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Animate = {$: 0};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Pause = {$: 2};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Reset = {$: 4};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Restart = {$: 5};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Resume = {$: 3};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Stop = {$: 1};
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSizeCqh = $elm$core$String$fromFloat($author$project$Animation$Keyframe$ControllingAnimations$Main$ballSize) + 'cqh';
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							'left',
							'calc(50% - ' + ($elm$core$String$fromFloat($author$project$Animation$Keyframe$ControllingAnimations$Main$ballSize / 2) + 'cqh)')),
							A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'font-size', $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'line-height', $author$project$Animation$Keyframe$ControllingAnimations$Main$ballSizeCqh)
						])),
				_List_fromArray(
					[
						$elm$html$Html$text('🏀')
...
var $author$project$Anim$Internal$Engine$Keyframe$styleNodeFor = F2(
	function (animGroupName, _v0) {
		var animGroups = _v0.b;
		var keyframes = A2(
			$elm$core$Maybe$withDefault,
		...
		return A3(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(keyframes)
				]));
	});
var $author$project$Anim$Engine$Keyframe$styleNodeFor = $author$project$Anim$Internal$Engine$Keyframe$styleNodeFor;
var $author$project$Animation$Keyframe$ControllingAnimations$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($author$project$Anim$Engine$Keyframe$styleNodeFor, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.E),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Animate),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Pause),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Resume),
								$elm$html$Html$Attributes$class('ui-action-button success')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Stop),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Reset),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$ControllingAnimations$Main$Restart),
								$elm$html$Html$Attributes$class('ui-action-button purple')
							]),
						_List_fromArray(
							[
				...
				$author$project$Animation$Keyframe$ControllingAnimations$Main$animationArea(model.E)
			]));
};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$ControllingAnimations$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$ControllingAnimations$Main$update,
		f0: $author$project$Animation$Keyframe$ControllingAnimations$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'ControllingAnimations':{'Main':{'init':$author$project$Animation$Keyframe$ControllingAnimations$Main$main(
