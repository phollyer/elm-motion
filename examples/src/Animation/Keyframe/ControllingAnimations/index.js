...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$setBaselinesFromProcessedEnds = F3(
	function (animGroupName, props, _v0) {
		...
		var existing = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Builder$PropertyBaselines$empty,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.M));
		...
		return _Utils_update(
			data,
			{
				s: _Utils_update(
					state,
					{
						M: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, merged, state.M)
					})
			});
	});
	...
	function (fetchConfig, setPlayState, mapper, buildStyles, setStyles, animGroupName, animState) {
		...
		var getProcessedProperties = A2(
			...
			A2(
				...
				A2(fetchConfig, animGroupName, state.U)));
		if (!getProcessedProperties.b) {
			...
			return A2(
				...
				_Utils_update(
					state,
					{
						U: A3($author$project$Anim$Internal$Builder$setBaselinesFromProcessedEnds, animGroupName, snappedProperties, state.U)
					}),
	...
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				t: 0,
				ce: 0,
				bG: $author$project$Motion$Easing$Linear,
				m: value,
				bn: $elm$core$Maybe$Just(value),
				bY: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			bR: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bU: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			cy: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bV: toStartOr($author$project$Anim$Internal$Property$Skew$default),
...
var $author$project$Anim$Internal$Engine$Keyframe$reset = A3(
	$author$project$Anim$Internal$Engine$CSS$CSS$reset,
	$author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setPlayState,
	A2($author$project$Anim$Internal$Engine$Keyframe$Styles$fromProcessedProperties, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
	$author$project$Anim$Internal$Engine$Keyframe$setStyles);
...
var $author$project$Anim$Internal$Engine$Keyframe$restartAnimation = F4(
	function (animGroupName, controlledAxes, properties, _v0) {
		...
		var animGroups = _v0.b;
		var discrete = {
			cg: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, state.U),
			ch: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, state.U)
		};
		var counter = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		var animGroup = A9(
			$author$project$Anim$Internal$Engine$Keyframe$Generator$generateRestart,
			counter,
			A2($author$project$Anim$Internal$Builder$getTransformOrder, animGroupName, state.U),
			$author$project$Anim$Internal$Builder$getIterations(state.U),
			$author$project$Anim$Internal$Builder$getAnimationDirection(state.U),
			A2($author$project$Anim$Internal$Builder$getBaseline, animGroupName, state.U),
			discrete,
			animGroupName,
			controlledAxes,
			properties);
...
var $author$project$Anim$Internal$Engine$Keyframe$restart = F3(
	function (animGroupName, toMsg, animState) {
		var state = animState.a;
		var maybeFromHistory = A2($author$project$Anim$Internal$Builder$getCurrentAnimationConfig, animGroupName, state.U);
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					bR: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					bU: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
...
var $author$project$Anim$Internal$Engine$Keyframe$stop = A4(
	$author$project$Anim$Internal$Engine$CSS$CSS$stop,
	$author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setPlayState,
	$author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isActive,
	A2($author$project$Anim$Internal$Engine$Keyframe$Styles$fromProcessedProperties, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
	$author$project$Anim$Internal$Engine$Keyframe$setStyles);
