...
var $author$project$Anim$Internal$Property$Size$default = {cU: 0, L: 0};
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cU: start.cU + ((endSize.cU - start.cU) * t), L: start.L + ((endSize.L - start.L) * t)};
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cU);
};
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Rotate$default, Y: $author$project$Anim$Internal$Property$Rotate$distance, Z: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Rotate$speed, ai: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Scale$default, Y: $author$project$Anim$Internal$Property$Scale$distance, Z: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Scale$speed, ai: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, W: $author$project$Anim$Internal$Unit$default, X: $author$project$Anim$Internal$Property$Skew$default, Y: $author$project$Anim$Internal$Property$Skew$distance, Z: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, _: globalData, ag: $author$project$Anim$Internal$Property$Skew$speed, ai: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bm);
		return A4(
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$init = _Utils_Tuple2(
	{
		D: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {E: groupConfig, cn: kind};
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aw.E);
					}
				}(
					A2(
						$elm$core$Maybe$map,
						...
						$elm$core$List$head(
							A2(
								$elm$core$List$filter,
								isAnimate,
								A2($elm$core$List$cons, h.aw, h.a4)))));
			},
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.as));
	});
		...
		switch (prop.$) {
			case 0:
				...
				return A3(
					...
					cssName,
					unit,
					A3(transforms.b9, cssName, unit, config));
			case 1:
				var cssName = prop.a;
				var config = prop.b;
				return A2(
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			cq: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			cr: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			...
			cx: toStartOr($author$project$Anim$Internal$Property$Size$default),
...
var $author$project$Anim$Internal$Engine$Keyframe$restartAnimation = F3(
	function (animGroupName, properties, _v0) {
		var state = _v0.a;
		var animGroups = _v0.b;
		var discrete = {
			cf: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, state.U),
			cg: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, state.U)
		};
		var counter = A2(
			$elm$core$Maybe$withDefault,
			0,
...
var $author$project$Anim$Internal$Engine$Keyframe$restart = F3(
	function (animGroupName, toMsg, animState) {
		...
		if (maybeFromHistory.$ === 1) {
			...
			var properties = maybeFromHistory.a.q;
			return _Utils_Tuple2(
				A3($author$project$Anim$Internal$Engine$Keyframe$restartAnimation, animGroupName, properties, animState),
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isPaused = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(animGroup.aS);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$isActive = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isActive(animGroup.aS);
};
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					cq: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					...
					cx: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							D: A2($author$project$Anim$Engine$Keyframe$stop, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.D)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var _v1 = A3($author$project$Anim$Engine$Keyframe$pause, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.D);
				var newState = _v1.a;
				var pauseCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					pauseCmd);
			case 3:
				var _v2 = A3($author$project$Anim$Engine$Keyframe$resume, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.D);
				var newState = _v2.a;
				var resumeCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							D: A2($author$project$Anim$Engine$Keyframe$reset, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.D)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				var _v3 = A3($author$project$Anim$Engine$Keyframe$restart, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.D);
				var newState = _v3.a;
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Anim$Engine$Keyframe$styleNodeFor, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.D),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				$author$project$Animation$Keyframe$ControllingAnimations$Main$animationArea(model.D)
			]));
};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		...
		fz: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f_: $author$project$Animation$Keyframe$ControllingAnimations$Main$update,
		f$: $author$project$Animation$Keyframe$ControllingAnimations$Main$view
	});
