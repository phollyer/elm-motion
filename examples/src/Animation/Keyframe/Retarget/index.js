			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aw.D);
					}
				}(
					A2(
						$elm$core$Maybe$map,
...
var $author$project$Animation$Keyframe$Retarget$Main$main = $elm$browser$Browser$element(
	{
		...
		f_: $author$project$Animation$Keyframe$Retarget$Main$update,
		f$: $author$project$Animation$Keyframe$Retarget$Main$view
	});
