...
var $author$project$Animation$Keyframe$Retarget$Main$animGroup = 'square';
...
var $author$project$Animation$Keyframe$Retarget$Main$init = _Utils_Tuple2(
	{
		T: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Keyframe$Retarget$Main$animGroup, 0, 0),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Retarget$Main$boxSize = 12;
var $author$project$Animation$Keyframe$Retarget$Main$endXY = 100 - $author$project$Animation$Keyframe$Retarget$Main$boxSize;
var $author$project$Anim$Property$Translate$toXY = $author$project$Anim$Internal$Builder$Translate$toXY;
var $author$project$Animation$Keyframe$Retarget$Main$animateDiagonal = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, $author$project$Animation$Keyframe$Retarget$Main$endXY, $author$project$Animation$Keyframe$Retarget$Main$endXY),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration(5000),
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$RetargetKind = 1;
var $author$project$Anim$Internal$Builder$addRetargetToHistory = $author$project$Anim$Internal$Builder$addToHistoryWithKind(1);
...
var $author$project$Anim$Internal$Engine$Keyframe$retarget = F2(
	function (animState, build) {
		var origState = animState.a;
		var touchedGroups = $author$project$Anim$Internal$Builder$process(
			build(origState.V)).cj;
		var retargetedState = A3(
			$author$project$Anim$Internal$Engine$Keyframe$runPipeline,
			F2(
				function (builder, processed) {
					return $author$project$Anim$Internal$Builder$clearAnimData(
						$author$project$Anim$Internal$Builder$mergeBaselines(
							A2($author$project$Anim$Internal$Builder$addRetargetToHistory, processed, builder)));
				}),
			animState,
			build);
		return A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			F3(
				function (name, _v0, acc) {
					return A2($author$project$Anim$Internal$Engine$Keyframe$stop, name, acc);
				}),
			retargetedState,
			touchedGroups);
	});
var $author$project$Anim$Engine$Keyframe$retarget = $author$project$Anim$Internal$Engine$Keyframe$retarget;
...
var $author$project$Animation$Keyframe$Retarget$Main$retargetYToTop = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		$author$project$Anim$Property$Translate$end));
var $author$project$Animation$Keyframe$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							T: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Retarget$Main$animGroup),
									$author$project$Animation$Keyframe$Retarget$Main$animateDiagonal))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							T: A2(
								$author$project$Anim$Engine$Keyframe$retarget,
								model.T,
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Retarget$Main$animGroup),
									$author$project$Animation$Keyframe$Retarget$Main$retargetYToTop))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							T: A2($author$project$Anim$Engine$Keyframe$reset, $author$project$Animation$Keyframe$Retarget$Main$animGroup, model.T)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$Retarget$Main$Animate = 0;
var $author$project$Animation$Keyframe$Retarget$Main$Reset = 2;
var $author$project$Animation$Keyframe$Retarget$Main$RetargetY = 1;
...
var $author$project$Animation$Keyframe$Retarget$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Retarget$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							'width',
							$elm$core$String$fromFloat($author$project$Animation$Keyframe$Retarget$Main$boxSize) + 'cqw'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$Keyframe$Retarget$Main$boxSize) + 'cqh'),
							A2($elm$html$Html$Attributes$style, 'background-color', 'rgba(59, 130, 246, 0.35)'),
							A2($elm$html$Html$Attributes$style, 'border', '0.4cqmin solid rgb(59, 130, 246)'),
...
var $author$project$Animation$Keyframe$Retarget$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('▶️ Animate diagonally')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('⬆️ Retarget Y to 0')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Press Animate, then mid-flight press \u0022Retarget Y to 0\u0022. The Keyframe engine snaps Y to 0; X to it\u0027s end value.')
					])),
				$author$project$Animation$Keyframe$Retarget$Main$animationArea(model.T)
			]));
};
var $author$project$Animation$Keyframe$Retarget$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$Retarget$Main$init;
		},
		fA: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		f$: $author$project$Animation$Keyframe$Retarget$Main$update,
		f0: $author$project$Animation$Keyframe$Retarget$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'Retarget':{'Main':{'init':$author$project$Animation$Keyframe$Retarget$Main$main(
