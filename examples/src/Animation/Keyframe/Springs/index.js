...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bt: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, b0: $elm$core$Set$empty, aq: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cE: x0, cI: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bO: omegaD, bx: zeta});
		} else {
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cI: $elm$core$Basics$round(rgba_.b8 * 255),
				cU: $elm$core$Basics$round(rgba_.cj * 255),
				dm: $elm$core$Basics$round(rgba_.cv * 255)
			};
	}
};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {cd: $elm$core$Dict$empty, ce: $elm$core$Dict$empty, bj: 0, bN: $elm$core$Maybe$Nothing, aT: 0, cw: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cC: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b7: '', cc: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, co: ''};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cf: 0, bI: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing};
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {D: groupConfig, cp: kind};
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				bI: $elm$core$Maybe$Nothing,
				bn: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Motion$Spring$custom = function (_v0) {
	var mass = _v0.aP;
	var damping = _v0.aL;
	var stiffness = _v0.aW;
	return {
		aL: A2($elm$core$Basics$max, 0, damping),
		a6: 0,
		aP: A2($elm$core$Basics$max, 1.0e-6, mass),
		aW: A2($elm$core$Basics$max, 0, stiffness)
	};
};
...
var $author$project$Animation$Keyframe$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var target = model.au ? 0 : 420;
				var stiffness = A2($author$project$Animation$Keyframe$Springs$Main$parseWithMin, 1, model.aW);
				var mass = A2($author$project$Animation$Keyframe$Springs$Main$parseWithMin, 0.1, model.aP);
				...
				var spring = $author$project$Motion$Spring$custom(
					{aL: damping, aP: mass, aW: stiffness});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							aP: $elm$core$String$fromFloat(mass),
							a9: 'custom',
							aW: $elm$core$String$fromFloat(stiffness)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var str = msg.a;
...
var $author$project$Animation$Keyframe$Springs$Main$customControls = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$Animation$Keyframe$Springs$Main$numberInput, 'Stiffness', '1', model.aW, $author$project$Animation$Keyframe$Springs$Main$SetStiffness),
				...
				A4($author$project$Animation$Keyframe$Springs$Main$numberInput, 'Mass', '0.1', model.aP, $author$project$Animation$Keyframe$Springs$Main$SetMass),
				A2(
...
var $author$project$Motion$Spring$gentle = {aL: 14, a6: 0, aP: 1, aW: 120};
var $author$project$Motion$Spring$noWobble = {aL: 26, a6: 0, aP: 1, aW: 170};
var $author$project$Motion$Spring$slow = {aL: 18, a6: 0, aP: 1, aW: 60};
var $author$project$Motion$Spring$stiff = {aL: 20, a6: 0, aP: 1, aW: 300};
var $author$project$Motion$Spring$wobbly = {aL: 12, a6: 0, aP: 1, aW: 180};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Springs$Main$animGroup, model.ar),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$Springs$Main$main = $elm$browser$Browser$element(
	{
		...
		f$: $author$project$Animation$Keyframe$Springs$Main$update,
		f0: $author$project$Animation$Keyframe$Springs$Main$view
	});
