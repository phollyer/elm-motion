...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, b0: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bz: $elm$core$Maybe$Nothing, g: false, bY: $elm$core$Maybe$Nothing, br: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						b1: A2($author$project$Anim$Internal$Property$Translate$toCssString, config.z, config.m)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bT: '', bW: '', bX: '', b1: ''};
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b1, transformParts.bT, transformParts.bX, transformParts.bW]);
				} else {
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ab: omega0, bO: omegaD, bx: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {ce: $elm$core$Dict$empty, cf: $elm$core$Dict$empty, bk: 0, bN: $elm$core$Maybe$Nothing, aU: 0, cx: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cD: ''};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cg: 0, bI: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing};
};
