...
var $author$project$Animation$Keyframe$Springs$Main$animGroup = 'springBox';
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bU: '', bX: '', bY: '', b1: ''};
					...
					switch (property.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									b1: A3($author$project$Anim$Internal$Engine$Keyframe$Styles$translateToCss, maybeControlledAxes, config.z, config.m)
								});
						case 4:
							var config = property.a;
							return _Utils_update(
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.b1, transformParts.bU, transformParts.bY, transformParts.bX]);
				} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.bp);
		...
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2($author$project$Shared$Easing$toFunction, cfg.bJ, linearProgress);
			}
		}();
		return toCssString(
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cJ: $elm$core$Basics$round(rgba_.b8 * 255),
				cV: $elm$core$Basics$round(rgba_.ck * 255),
					...
					switch (p.$) {
						...
						case 4:
							...
							return _Utils_update(
								acc,
								{
									bU: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Rotate$default, $author$project$Anim$Internal$Property$Rotate$interpolate, $author$project$Anim$Internal$Property$Rotate$toCssString, cfg)
								});
						case 5:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bX: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Scale$default, $author$project$Anim$Internal$Property$Scale$interpolate, $author$project$Anim$Internal$Property$Scale$toCssString, cfg)
								});
						case 7:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bY: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$interpolate, $author$project$Anim$Internal$Property$Skew$toCssString, cfg)
								});
						default:
							return acc;
					}
	...
	function (controlledAxes, maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.cj));
			var entryStyles = $elm$core$Dict$toList(discrete.ci);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {ce: $elm$core$Dict$empty, cf: $elm$core$Dict$empty, bk: 0, bO: $elm$core$Maybe$Nothing, aU: 0, cx: 0, aG: $author$project$Anim$Internal$Engine$CSS$Styles$empty, cD: ''};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {b7: '', cd: 0, v: 0, r: $author$project$Anim$Internal$Builder$Once, cp: ''};
			...
			switch (_v0.$) {
				...
				case 1:
					return _Utils_update(
						acc,
						{
							ba: A2($elm$core$List$cons, prop, acc.ba)
						});
				default:
					return acc;
			}
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setAnimation = F2(
	function (animation, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				bO: $elm$core$Maybe$Just(animation)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F9(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, controlledAxes, properties) {
		...
		return function (animGroup) {
			if ($elm$core$List$isEmpty(animated) && ($elm$core$Dict$isEmpty(discrete.ci) && $elm$core$Dict$isEmpty(discrete.cj))) {
				return animGroup;
			} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
			...
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.v) + ('-' + ($elm$core$String$fromInt(cfg.t) + ('-' + (toCssString(cfg.m) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.bp))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.ci),
				stringifyExitDict(discrete.cj));
		}();
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, bu: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $elm$core$Dict$empty, bW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aC: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.an, history.aP));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
		...
		var initGroup = F2(
			function (name, config) {
				var playback = A3(
					...
					config.b);
				var discrete = {
					ci: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, name, builder),
					cj: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, name, builder)
				};
				return A7($author$project$Anim$Internal$Engine$Keyframe$Generator$generateAnimation, config.o, playback.r, playback.w, discrete, name, config.ca, config.q);
			});
		var processedGroups = $author$project$Anim$Internal$Builder$process(builder).cl;
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cg: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bp: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cg: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cg: 0, bJ: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cg: A2(distanceFn, startVal, newEnd),
				m: newEnd,
...
var $author$project$Animation$Keyframe$Springs$Main$init = _Utils_Tuple2(
	{
		au: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Springs$Main$animGroup, 0)
				])),
		aw: false,
		aL: '14',
		aQ: '1',
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {C: groupConfig, cq: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {an: newEntry, aP: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								an: newEntry,
								aP: A2($elm$core$List$cons, existing.an, existing.aP)
							};
						}
					}();
					return _Utils_update(
	...
	function (finaliseBuilder, _v0, transform) {
		...
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var discrete = {
					ci: A2($author$project$Anim$Internal$Builder$getDiscreteEntryPropertiesFor, animGroupName, builder),
					cj: A2($author$project$Anim$Internal$Builder$getDiscreteExitPropertiesFor, animGroupName, builder)
				};
		...
		var initialPlayStateFor = function (animGroupName) {
			return A2(
				...
				A2(
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, processedAnimData.cl)));
		};
		return A2(
			$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
			{
			...
			A2(
				...
				A3(
					...
					insertAnimGroup,
					animGroups,
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processedAnimData.cl))));
	});
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			config,
			{
				bJ: $elm$core$Maybe$Nothing,
				bo: $elm$core$Maybe$Just(spring_)
			});
	});
var $author$project$Anim$Internal$Builder$Translate$spring = F2(
	function (s, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
			$author$project$Anim$Internal$Builder$Translate$TranslateBuilder,
			A2($author$project$Anim$Internal$Builder$Property$spring, s, config),
			builder);
	});
var $author$project$Anim$Property$Translate$spring = $author$project$Anim$Internal$Builder$Translate$spring;
var $author$project$Anim$Property$Translate$toX = $author$project$Anim$Internal$Builder$Translate$toX;
var $author$project$Animation$Keyframe$Springs$Main$animateTo = F2(
	function (x, spring) {
		return A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$spring(spring),
					$author$project$Anim$Property$Translate$end)));
	});
var $author$project$Motion$Internal$Spring$Spring = $elm$core$Basics$identity;
var $author$project$Motion$Spring$custom = function (_v0) {
	var mass = _v0.aQ;
	var damping = _v0.aL;
	var stiffness = _v0.aX;
	return {
		aL: A2($elm$core$Basics$max, 0, damping),
		a6: 0,
		aQ: A2($elm$core$Basics$max, 1.0e-6, mass),
		aX: A2($elm$core$Basics$max, 0, stiffness)
	};
};
var $author$project$Anim$Engine$Keyframe$for = $author$project$Anim$Internal$Builder$for;
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Animation$Keyframe$Springs$Main$parseWithMin = F2(
...
var $author$project$Animation$Keyframe$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var label = msg.a;
				var spring = msg.b;
				var target = model.aw ? 0 : 420;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							au: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$Springs$Main$animGroup),
									A2($author$project$Animation$Keyframe$Springs$Main$animateTo, target, spring))),
							aw: !model.aw,
							a9: label
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var target = model.aw ? 0 : 420;
				var stiffness = A2($author$project$Animation$Keyframe$Springs$Main$parseWithMin, 1, model.aX);
				var mass = A2($author$project$Animation$Keyframe$Springs$Main$parseWithMin, 0.1, model.aQ);
				var damping = A2($author$project$Animation$Keyframe$Springs$Main$parseWithMin, 0, model.aL);
				var spring = $author$project$Motion$Spring$custom(
					{aL: damping, aQ: mass, aX: stiffness});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							au: A2(
								...
								A2(
									...
									A2($author$project$Animation$Keyframe$Springs$Main$animateTo, target, spring))),
							aw: !model.aw,
							aL: $elm$core$String$fromFloat(damping),
							aQ: $elm$core$String$fromFloat(mass),
							a9: 'custom',
							aX: $elm$core$String$fromFloat(stiffness)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var str = msg.a;
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$toCssString = function (_v0) {
	...
	return animation.b7 + (' ' + ($elm$core$String$fromInt(animation.v) + ('ms linear 0ms ' + (iterationString + (' ' + (directionString + ' forwards'))))));
};
...
var $author$project$Animation$Keyframe$Springs$Main$PlayCustom = {$: 1};
var $author$project$Animation$Keyframe$Springs$Main$SetDamping = function (a) {
	return {$: 3, a: a};
};
var $author$project$Animation$Keyframe$Springs$Main$SetMass = function (a) {
	return {$: 4, a: a};
};
var $author$project$Animation$Keyframe$Springs$Main$SetStiffness = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Animation$Keyframe$Springs$Main$numberInput = F4(
	function (labelText, stepSize, current, toMsg) {
		return A2(
			$elm$html$Html$label,
			_List_fromArray(
				[
...
var $author$project$Animation$Keyframe$Springs$Main$customControls = function (model) {
	var playVariant = (model.a9 === 'custom') ? 'primary' : 'purple';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A4($author$project$Animation$Keyframe$Springs$Main$numberInput, 'Stiffness', '1', model.aX, $author$project$Animation$Keyframe$Springs$Main$SetStiffness),
				A4($author$project$Animation$Keyframe$Springs$Main$numberInput, 'Damping', '1', model.aL, $author$project$Animation$Keyframe$Springs$Main$SetDamping),
				A4($author$project$Animation$Keyframe$Springs$Main$numberInput, 'Mass', '0.1', model.aQ, $author$project$Animation$Keyframe$Springs$Main$SetMass),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Animation$Keyframe$Springs$Main$PlayCustom),
						$elm$html$Html$Attributes$class('ui-action-button ' + playVariant)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Play custom')
					]))
			]));
};
var $author$project$Animation$Keyframe$Springs$Main$Play = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Animation$Keyframe$Springs$Main$presetButton = F2(
	function (selected, _v0) {
		var label = _v0.a;
		var spring = _v0.b;
		var variant = _Utils_eq(label, selected) ? 'primary' : 'purple';
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(
					A2($author$project$Animation$Keyframe$Springs$Main$Play, label, spring)),
					$elm$html$Html$Attributes$class('ui-action-button ' + variant)
				]),
			_List_fromArray(
				[
...
var $author$project$Motion$Spring$gentle = {aL: 14, a6: 0, aQ: 1, aX: 120};
var $author$project$Motion$Spring$noWobble = {aL: 26, a6: 0, aQ: 1, aX: 170};
var $author$project$Motion$Spring$slow = {aL: 18, a6: 0, aQ: 1, aX: 60};
var $author$project$Motion$Spring$stiff = {aL: 20, a6: 0, aQ: 1, aX: 300};
var $author$project$Motion$Spring$wobbly = {aL: 12, a6: 0, aQ: 1, aX: 180};
var $author$project$Animation$Keyframe$Springs$Main$presets = _List_fromArray(
	[
		_Utils_Tuple2('noWobble', $author$project$Motion$Spring$noWobble),
		_Utils_Tuple2('gentle', $author$project$Motion$Spring$gentle),
		_Utils_Tuple2('wobbly', $author$project$Motion$Spring$wobbly),
		_Utils_Tuple2('stiff', $author$project$Motion$Spring$stiff),
		_Utils_Tuple2('slow', $author$project$Motion$Spring$slow)
	]);
...
var $author$project$Animation$Keyframe$Springs$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'min-height', '260px')
			]),
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Keyframe$Springs$Main$presetButton(model.a9),
					$author$project$Animation$Keyframe$Springs$Main$presets)),
				$author$project$Animation$Keyframe$Springs$Main$customControls(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Springs$Main$animGroup, model.au),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$Springs$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Keyframe$Springs$Main$init;
		},
		fB: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f0: $author$project$Animation$Keyframe$Springs$Main$update,
		f1: $author$project$Animation$Keyframe$Springs$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'Springs':{'Main':{'init':$author$project$Animation$Keyframe$Springs$Main$main(
