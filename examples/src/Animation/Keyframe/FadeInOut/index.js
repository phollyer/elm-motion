...
var $author$project$Animation$Keyframe$FadeInOut$Main$animGroup = 'fadeAnim';
...
var $author$project$Animation$Keyframe$FadeInOut$Main$init = _Utils_Tuple2(
	{
		au: $author$project$Anim$Engine$Keyframe$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$FadeInOut$Main$animGroup, 0)
				]))
	},
...
var $author$project$Animation$Keyframe$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$FadeInOut$Main$fadeIn = $author$project$Animation$Keyframe$FadeInOut$Main$fadeTo(1);
var $author$project$Animation$Keyframe$FadeInOut$Main$fadeOut = $author$project$Animation$Keyframe$FadeInOut$Main$fadeTo(0);
var $author$project$Anim$Engine$Keyframe$for = $author$project$Anim$Internal$Builder$for;
var $author$project$Animation$Keyframe$FadeInOut$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$FadeInOut$Main$animGroup),
								$author$project$Animation$Keyframe$FadeInOut$Main$fadeIn))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
					...
					model,
					{
						au: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Keyframe$for($author$project$Animation$Keyframe$FadeInOut$Main$animGroup),
								$author$project$Animation$Keyframe$FadeInOut$Main$fadeOut))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Keyframe$FadeInOut$Main$TriggerFadeIn = 0;
var $author$project$Animation$Keyframe$FadeInOut$Main$TriggerFadeOut = 1;
...
var $author$project$Animation$Keyframe$FadeInOut$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$FadeInOut$Main$animGroup, model.au),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		eM: function (_v0) {
			return $author$project$Animation$Keyframe$FadeInOut$Main$init;
		},
		fA: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		f$: $author$project$Animation$Keyframe$FadeInOut$Main$update,
		f0: $author$project$Animation$Keyframe$FadeInOut$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'FadeInOut':{'Main':{'init':$author$project$Animation$Keyframe$FadeInOut$Main$main(
