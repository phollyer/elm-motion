...
var $author$project$Animation$Sub$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions,
		f$: $author$project$Animation$Sub$DiscreteProperties$Main$update,
		f0: $author$project$Animation$Sub$DiscreteProperties$Main$view
	});
