...
var $author$project$Animation$Sub$DiscreteProperties$Main$animGroup = 'fadeAnim';
...
var $author$project$Anim$Internal$Engine$Sub$discreteEntry = $author$project$Anim$Internal$Builder$discreteEntry;
var $author$project$Anim$Engine$Sub$discreteEntry = $author$project$Anim$Internal$Engine$Sub$discreteEntry;
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cm: A2($author$project$Anim$Internal$Property$Opacity$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bx: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bx);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					cm: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					m: endPos,
...
var $author$project$Animation$Sub$DiscreteProperties$Main$init = _Utils_Tuple2(
	{
		Z: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Engine$Sub$discreteEntry, 'display', 'none'),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$DiscreteProperties$Main$animGroup, 0))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$DiscreteProperties$Main$GotSubMsg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$DiscreteProperties$Main$GotSubMsg, model.Z);
};
...
var $author$project$Anim$Internal$Engine$Sub$discreteExit = $author$project$Anim$Internal$Builder$discreteExit;
var $author$project$Anim$Engine$Sub$discreteExit = $author$project$Anim$Internal$Engine$Sub$discreteExit;
...
var $author$project$Animation$Sub$DiscreteProperties$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$DiscreteProperties$Main$fadeOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$DiscreteProperties$Main$animGroup),
									A2(
										$elm$core$Basics$composeR,
										A2($author$project$Anim$Engine$Sub$discreteEntry, 'display', 'flex'),
										$author$project$Animation$Sub$DiscreteProperties$Main$fadeIn)))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
						...
						model,
						{
							Z: A2(
								...
								A2(
									...
									A2(
										$elm$core$Basics$composeR,
										A3($author$project$Anim$Engine$Sub$discreteExit, 'display', 'flex', 'none'),
										$author$project$Animation$Sub$DiscreteProperties$Main$fadeOut)))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var subMsg = msg.a;
...
var $author$project$Animation$Sub$DiscreteProperties$Main$Hide = {$: 1};
var $author$project$Animation$Sub$DiscreteProperties$Main$Show = {$: 0};
...
var $author$project$Animation$Sub$DiscreteProperties$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$DiscreteProperties$Main$Show),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$DiscreteProperties$Main$Hide),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$DiscreteProperties$Main$animGroup, model.Z),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$DiscreteProperties$Main$init;
		},
		fC: $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions,
		f0: $author$project$Animation$Sub$DiscreteProperties$Main$update,
		f1: $author$project$Animation$Sub$DiscreteProperties$Main$view
	});
_Platform_export({'Animation':{'Sub':{'DiscreteProperties':{'Main':{'init':$author$project$Animation$Sub$DiscreteProperties$Main$main(
