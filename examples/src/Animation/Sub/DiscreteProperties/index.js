...
var $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$DiscreteProperties$Main$GotSubMsg, model.Y);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$DiscreteProperties$Main$animGroup, model.Y),
					_List_fromArray(
						[
