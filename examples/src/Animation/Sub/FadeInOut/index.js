...
var $author$project$Animation$Sub$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$FadeInOut$Main$subscriptions,
		f$: $author$project$Animation$Sub$FadeInOut$Main$update,
		f0: $author$project$Animation$Sub$FadeInOut$Main$view
	});
