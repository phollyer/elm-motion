...
var $author$project$Animation$Sub$FadeInOut$Main$animGroup = 'fadeAnim';
...
var $author$project$Animation$Sub$FadeInOut$Main$init = _Utils_Tuple2(
	{
		Z: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$FadeInOut$Main$animGroup, 0)
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$FadeInOut$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$FadeInOut$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$FadeInOut$Main$GotSubMsg, model.Z);
};
...
var $author$project$Animation$Sub$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$FadeInOut$Main$fadeIn = $author$project$Animation$Sub$FadeInOut$Main$fadeTo(1);
var $author$project$Animation$Sub$FadeInOut$Main$fadeOut = $author$project$Animation$Sub$FadeInOut$Main$fadeTo(0);
...
var $author$project$Animation$Sub$FadeInOut$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
					...
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$FadeInOut$Main$animGroup),
									$author$project$Animation$Sub$FadeInOut$Main$fadeIn))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$FadeInOut$Main$animGroup),
									$author$project$Animation$Sub$FadeInOut$Main$fadeOut))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$FadeInOut$Main$TriggerFadeIn = {$: 1};
var $author$project$Animation$Sub$FadeInOut$Main$TriggerFadeOut = {$: 2};
...
var $author$project$Animation$Sub$FadeInOut$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$FadeInOut$Main$TriggerFadeIn),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$FadeInOut$Main$TriggerFadeOut),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$FadeInOut$Main$animGroup, model.Z),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$FadeInOut$Main$init;
		},
		fC: $author$project$Animation$Sub$FadeInOut$Main$subscriptions,
		f0: $author$project$Animation$Sub$FadeInOut$Main$update,
		f1: $author$project$Animation$Sub$FadeInOut$Main$view
	});
_Platform_export({'Animation':{'Sub':{'FadeInOut':{'Main':{'init':$author$project$Animation$Sub$FadeInOut$Main$main(
