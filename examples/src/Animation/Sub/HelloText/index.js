...
var $author$project$Animation$Sub$HelloText$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $elm$core$Basics$identity, model.Y);
};
...
var $author$project$Animation$Sub$HelloText$Main$update = F2(
	function (msg, model) {
		var animMsg = msg;
		var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.Y);
		var animState = _v1.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$textLineOne, model.Y),
							_List_Nil),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotOne, model.Y),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotTwo, model.Y),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotThree, model.Y),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$textLineTwo, model.Y),
					_List_fromArray(
						[
