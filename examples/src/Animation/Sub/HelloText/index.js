...
var $author$project$Animation$Sub$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$HelloText$Main$subscriptions,
		f$: $author$project$Animation$Sub$HelloText$Main$update,
		f0: $author$project$Animation$Sub$HelloText$Main$view
	});
