		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						aw: $elm$core$Maybe$Just(ms)
					});
			},
			data);
	});
var $author$project$Anim$Engine$Sub$delay = $author$project$Anim$Internal$Builder$delay;
var $author$project$Animation$Sub$HelloText$Main$dotOne = 'dotOne';
var $author$project$Animation$Sub$HelloText$Main$dotThree = 'dotThree';
var $author$project$Animation$Sub$HelloText$Main$dotTwo = 'dotTwo';
var $author$project$Animation$Sub$HelloText$Main$duration = 500;
...
var $author$project$Animation$Sub$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Opacity$duration($author$project$Animation$Sub$HelloText$Main$duration),
...
var $author$project$Animation$Sub$HelloText$Main$textLineOne = 'textLineOne';
var $author$project$Animation$Sub$HelloText$Main$textLineTwo = 'textLineTwo';
var $author$project$Animation$Sub$HelloText$Main$init = function () {
	var animState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$textLineOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$dotOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$dotTwo, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$dotThree, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$textLineTwo, 0)
			]));
	return _Utils_Tuple2(
		{
			Z: A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$HelloText$Main$textLineOne),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$Sub$HelloText$Main$fadeIn,
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$HelloText$Main$dotOne),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$HelloText$Main$duration),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Sub$HelloText$Main$fadeIn,
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$HelloText$Main$dotTwo),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$HelloText$Main$duration * 2),
											A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Sub$HelloText$Main$fadeIn,
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$HelloText$Main$dotThree),
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$HelloText$Main$duration * 3),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$Sub$HelloText$Main$fadeIn,
															A2(
																$elm$core$Basics$composeR,
																$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$HelloText$Main$textLineTwo),
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$HelloText$Main$duration * 4),
																	$author$project$Animation$Sub$HelloText$Main$fadeIn))))))))))))))
		},
		$elm$core$Platform$Cmd$none);
}();
var $author$project$Animation$Sub$HelloText$Main$GotSubMsg = $elm$core$Basics$identity;
...
var $author$project$Animation$Sub$HelloText$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $elm$core$Basics$identity, model.Z);
};
...
var $author$project$Animation$Sub$HelloText$Main$update = F2(
	function (msg, model) {
		var animMsg = msg;
		var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.Z);
		var animState = _v1.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
...
var $author$project$Animation$Sub$HelloText$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$textLineOne, model.Z),
							_List_Nil),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotOne, model.Z),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotTwo, model.Z),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$dotThree, model.Z),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$textLineTwo, model.Z),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$HelloText$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$HelloText$Main$init;
		},
		fC: $author$project$Animation$Sub$HelloText$Main$subscriptions,
		f0: $author$project$Animation$Sub$HelloText$Main$update,
		f1: $author$project$Animation$Sub$HelloText$Main$view
	});
_Platform_export({'Animation':{'Sub':{'HelloText':{'Main':{'init':$author$project$Animation$Sub$HelloText$Main$main(
