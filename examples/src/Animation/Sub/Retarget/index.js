...
var $author$project$Animation$Sub$Retarget$Main$animGroup = 'square';
...
var $author$project$Animation$Sub$Retarget$Main$init = _Utils_Tuple2(
	{
		R: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$Retarget$Main$animGroup, 0, 0),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Retarget$Main$GotSubMsg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Animation$Sub$Retarget$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Retarget$Main$GotSubMsg, model.R);
};
...
var $author$project$Animation$Sub$Retarget$Main$boxSize = 12;
var $author$project$Animation$Sub$Retarget$Main$endXY = 100 - $author$project$Animation$Sub$Retarget$Main$boxSize;
var $author$project$Anim$Property$Translate$toXY = $author$project$Anim$Internal$Builder$Translate$toXY;
var $author$project$Animation$Sub$Retarget$Main$animateDiagonal = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, $author$project$Animation$Sub$Retarget$Main$endXY, $author$project$Animation$Sub$Retarget$Main$endXY),
		A2(
			$elm$core$Basics$composeR,
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				_Utils_update(
					state,
					{
						I: $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning(animGroup) ? _Utils_ap(
							state.I,
							_List_fromArray(
								[
									A2(
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$getPlayState = function (_v0) {
	var group = _v0;
	return group.bc;
};
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cX: record.bU, Q: record.cb};
};
var $author$project$Anim$Internal$Property$Skew$fromRecord = function (record) {
	return {ap: record.ap, aq: record.aq};
};
var $author$project$Anim$Internal$Engine$Sub$Animation$mergeWH = F7(
	function (touchedAxes, toRec, fromRec, snappedAnim, existingAnim, snapped, wrap) {
		var target = toRec(snappedAnim.m);
		var pick = F3(
			function (axis, fallback, selector) {
				return A2($elm$core$Set$member, axis, touchedAxes) ? selector(target) : fallback;
			});
		var existingStart = toRec(existingAnim.bx);
		var mergedStartRec = {
			bU: A3(
				pick,
				'height',
		...
		var existingEnd = toRec(existingAnim.m);
		var mergedEndRec = {
			bU: A3(
				pick,
				'height',
		...
		return _Utils_eq(mergedStartRec, mergedEndRec) ? snapped : wrap(
			_Utils_update(
				existingAnim,
				{
					m: fromRec(mergedEndRec),
					bx: fromRec(mergedStartRec)
				}));
	});
var $author$project$Anim$Internal$Engine$Sub$Animation$mergeXY = F7(
	function (touchedAxes, toRec, fromRec, snappedAnim, existingAnim, snapped, wrap) {
		var target = toRec(snappedAnim.m);
		var pick = F3(
			function (axis, fallback, selector) {
...
var $author$project$Anim$Internal$Engine$Sub$Animation$mergeXYZ = F7(
	function (touchedAxes, toRec, fromRec, snappedAnim, existingAnim, snapped, wrap) {
		var target = toRec(snappedAnim.m);
		var pick = F3(
			function (axis, fallback, selector) {
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {bU: dimensions.cX, cb: dimensions.Q};
};
var $author$project$Anim$Internal$Property$Skew$toRecord = function (_v0) {
	var values = _v0;
	return {ap: values.ap, aq: values.aq};
};
var $author$project$Anim$Internal$Engine$Sub$Animation$replaceAxes = F3(
	function (touchedAxes, snapped, existing) {
		var _v0 = _Utils_Tuple2(snapped, existing);
		_v0$6:
		while (true) {
			switch (_v0.a.$) {
				case 8:
					if (_v0.b.$ === 8) {
						var _v1 = _v0.a;
						var snappedAnim = _v1.b;
						var _v2 = _v0.b;
						var units = _v2.a;
						var existingAnim = _v2.b;
						return A7(
							$author$project$Anim$Internal$Engine$Sub$Animation$mergeXYZ,
							touchedAxes,
							$author$project$Anim$Internal$Property$Translate$toRecord,
							$author$project$Anim$Internal$Property$Translate$fromRecord,
							snappedAnim,
							existingAnim,
							snapped,
							function (anim) {
								return A2($author$project$Anim$Internal$Engine$Sub$Animation$Translate, units, anim);
							});
					} else {
						break _v0$6;
					}
				case 4:
					if (_v0.b.$ === 4) {
						var snappedAnim = _v0.a.a;
						var existingAnim = _v0.b.a;
						return A7($author$project$Anim$Internal$Engine$Sub$Animation$mergeXYZ, touchedAxes, $author$project$Anim$Internal$Property$Rotate$toRecord, $author$project$Anim$Internal$Property$Rotate$fromRecord, snappedAnim, existingAnim, snapped, $author$project$Anim$Internal$Engine$Sub$Animation$Rotate);
					} else {
						break _v0$6;
					}
				case 5:
					if (_v0.b.$ === 5) {
						var snappedAnim = _v0.a.a;
						var existingAnim = _v0.b.a;
						return A7($author$project$Anim$Internal$Engine$Sub$Animation$mergeXYZ, touchedAxes, $author$project$Anim$Internal$Property$Scale$toRecord, $author$project$Anim$Internal$Property$Scale$fromRecord, snappedAnim, existingAnim, snapped, $author$project$Anim$Internal$Engine$Sub$Animation$Scale);
					} else {
						break _v0$6;
					}
				case 7:
					if (_v0.b.$ === 7) {
						var snappedAnim = _v0.a.a;
						var existingAnim = _v0.b.a;
						return A7($author$project$Anim$Internal$Engine$Sub$Animation$mergeXY, touchedAxes, $author$project$Anim$Internal$Property$Skew$toRecord, $author$project$Anim$Internal$Property$Skew$fromRecord, snappedAnim, existingAnim, snapped, $author$project$Anim$Internal$Engine$Sub$Animation$Skew);
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var _v3 = _v0.a;
						var snappedAnim = _v3.b;
						var _v4 = _v0.b;
						var units = _v4.a;
						var existingAnim = _v4.b;
						return A7(
							$author$project$Anim$Internal$Engine$Sub$Animation$mergeXY,
							touchedAxes,
							$author$project$Anim$Internal$Property$PerspectiveOrigin$toRecord,
							$author$project$Anim$Internal$Property$PerspectiveOrigin$fromRecord,
							snappedAnim,
							existingAnim,
							snapped,
							function (anim) {
								return A2($author$project$Anim$Internal$Engine$Sub$Animation$PerspectiveOrigin, units, anim);
							});
					} else {
						break _v0$6;
					}
				case 6:
					if (_v0.b.$ === 6) {
						var _v5 = _v0.a;
						var snappedAnim = _v5.b;
						var _v6 = _v0.b;
						var units = _v6.a;
						var existingAnim = _v6.b;
						return A7(
							$author$project$Anim$Internal$Engine$Sub$Animation$mergeWH,
							touchedAxes,
							$author$project$Anim$Internal$Property$Size$toRecord,
							$author$project$Anim$Internal$Property$Size$fromRecord,
							snappedAnim,
							existingAnim,
							snapped,
							function (anim) {
								return A2($author$project$Anim$Internal$Engine$Sub$Animation$Size, units, anim);
							});
					} else {
						break _v0$6;
					}
...
var $author$project$Anim$Internal$Engine$Sub$retarget = F2(
	function (_v0, build) {
		var state = _v0.a;
		var animGroups = _v0.b;
		var snapAnimations = function (animGroup) {
			return A2(
				$author$project$Anim$Internal$Engine$Sub$Animations$map,
				function (_v6) {
					return $author$project$Anim$Internal$Engine$Sub$Animation$stop;
				},
				$author$project$Anim$Internal$Engine$Sub$AnimGroup$getAnimations(animGroup));
		};
		var hasIncompleteAnimation = function (animGroup) {
			return A3(
				$author$project$Anim$Internal$Engine$Sub$Animations$foldl,
				F3(
					function (_v5, anim, acc) {
						return acc || (!A2(
		...
		var mergedPlayState = F2(
			function (existingPlayState, merged) {
				return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(existingPlayState) ? 2 : (hasIncompleteAnimation(merged) ? 1 : 4);
			});
		var builder = build(
			A2(
				$author$project$Anim$Internal$Builder$injectCurrentStates,
		...
		var touchedAxesByGroup = $author$project$Anim$Internal$Builder$getAllTouchedAxes(builder);
		var touchedAxesFor = function (groupName) {
			return A3(
				$elm$core$Dict$foldl,
				F3(
					function (_v4, axes, acc) {
						var g = _v4.a;
						var propName = _v4.b;
						return _Utils_eq(g, groupName) ? A3($elm$core$Dict$insert, propName, axes, acc) : acc;
					}),
				$elm$core$Dict$empty,
				touchedAxesByGroup);
		};
			...
			function (animGroupName, freshAnimGroup, acc) {
				...
				if (_v1.$ === 1) {
					return A3(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$insert,
						animGroupName,
						A2($author$project$Anim$Internal$Engine$Sub$AnimGroup$setPlayState, 4, snapped),
						acc);
				} else {
					var existing = _v1.a;
					var groupTouchedAxes = touchedAxesFor(animGroupName);
					var existingAnimations = $author$project$Anim$Internal$Engine$Sub$AnimGroup$getAnimations(existing);
					var mergedTouched = A2(
						$author$project$Anim$Internal$Engine$Sub$Animations$map,
						F2(
							function (propName, snappedAnim) {
								var _v2 = A2($author$project$Anim$Internal$Engine$Sub$Animations$get, propName, existingAnimations);
								if (!_v2.$) {
									...
									if (A2(
										...
										var _v3 = A2($elm$core$Dict$get, propName, groupTouchedAxes);
										if (!_v3.$) {
											var axes = _v3.a;
											return A3($author$project$Anim$Internal$Engine$Sub$Animation$replaceAxes, axes, snappedAnim, existingAnim);
										} else {
											return snappedAnim;
										}
									}
						...
						$author$project$Anim$Internal$Engine$Sub$AnimGroup$getAnimations(snapped));
					var mergedAnimations = A2($author$project$Anim$Internal$Engine$Sub$Animations$add, existingAnimations, mergedTouched);
					var merged = A2($author$project$Anim$Internal$Engine$Sub$AnimGroup$setAnimations, mergedAnimations, snapped);
					return A3(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$insert,
						animGroupName,
						A2(
							...
							A2(
								mergedPlayState,
								$author$project$Anim$Internal$Engine$Sub$AnimGroup$getPlayState(existing),
								merged),
							merged),
						acc);
				}
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				...
				Z: state.Z,
				I: state.I,
				J: nextSubscriptionsActive
			},
			nextAnimGroups);
	});
var $author$project$Anim$Engine$Sub$retarget = $author$project$Anim$Internal$Engine$Sub$retarget;
...
var $author$project$Animation$Sub$Retarget$Main$retargetYToTop = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.R);
					...
					_Utils_update(
						model,
						{
							R: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$Retarget$Main$animGroup),
									$author$project$Animation$Sub$Retarget$Main$animateDiagonal))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							R: A2(
								$author$project$Anim$Engine$Sub$retarget,
								model.R,
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$Retarget$Main$animGroup),
									$author$project$Animation$Sub$Retarget$Main$retargetYToTop))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							R: A2($author$project$Anim$Engine$Sub$reset, $author$project$Animation$Sub$Retarget$Main$animGroup, model.R)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$Retarget$Main$Animate = {$: 0};
var $author$project$Animation$Sub$Retarget$Main$Reset = {$: 2};
var $author$project$Animation$Sub$Retarget$Main$RetargetY = {$: 1};
...
var $author$project$Animation$Sub$Retarget$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Retarget$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'width',
							$elm$core$String$fromFloat($author$project$Animation$Sub$Retarget$Main$boxSize) + 'cqw'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$Sub$Retarget$Main$boxSize) + 'cqh'),
...
var $author$project$Animation$Sub$Retarget$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$Retarget$Main$Animate),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$Retarget$Main$RetargetY),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$Retarget$Main$Reset),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Press Animate, then mid-flight press \u0022Retarget Y to 0\u0022. The Sub engine snaps Y to 0 while X keeps gliding toward the right edge uninterrupted.')
					])),
				$author$project$Animation$Sub$Retarget$Main$animationArea(model.R)
			]));
};
var $author$project$Animation$Sub$Retarget$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$Retarget$Main$init;
		},
		fC: $author$project$Animation$Sub$Retarget$Main$subscriptions,
		f0: $author$project$Animation$Sub$Retarget$Main$update,
		f1: $author$project$Animation$Sub$Retarget$Main$view
	});
_Platform_export({'Animation':{'Sub':{'Retarget':{'Main':{'init':$author$project$Animation$Sub$Retarget$Main$main(
