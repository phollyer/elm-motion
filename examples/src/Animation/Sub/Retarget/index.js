...
var $author$project$Animation$Sub$Retarget$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Retarget$Main$GotSubMsg, model.Q);
};
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cX: record.bT, P: record.cb};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {bT: dimensions.cX, cb: dimensions.P};
};
...
var $author$project$Animation$Sub$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.Q);
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($author$project$Anim$Engine$Sub$reset, $author$project$Animation$Sub$Retarget$Main$animGroup, model.Q)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Sub$Retarget$Main$animationArea(model.Q)
			]));
};
