...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aO: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ah: omega0, bW: omegaD, bF: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$initDefaults = {_: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, av: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, b8: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {ar: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b1: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
