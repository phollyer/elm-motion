				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {at: newEntry, aT: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								at: newEntry,
								aT: A2($elm$core$List$cons, existing.at, existing.aT)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aO: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.at, history.aT));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Builder$initDefaults = {K: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, av: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing, aF: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, bC: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {ar: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aH: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Animation$Sub$PulsingDot$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $elm$core$Basics$identity, model.a5);
};
...
var $author$project$Animation$Sub$PulsingDot$Main$update = F2(
	function (msg, model) {
		var animMsg = msg;
		var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.a5);
		var animState = _v1.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$PulsingDot$Main$groupName, model.a5),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$PulsingDot$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$PulsingDot$Main$subscriptions,
		f0: $author$project$Animation$Sub$PulsingDot$Main$update,
		f1: $author$project$Animation$Sub$PulsingDot$Main$view
	});
