...
var $author$project$Anim$Internal$Builder$initAnimation = {A: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $author$project$Anim$Internal$Builder$CssUnitStore$empty, q: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Z: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bl: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ad: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aL: $elm$core$Maybe$Nothing, aj: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, cc: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bM: $elm$core$Maybe$Nothing, g: false, b8: $elm$core$Maybe$Nothing, bE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a3: $elm$core$Dict$empty, b5: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Property$Size$default = {c$: 0, U: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cJ: x0, cN: (v0 + ((zeta * omega0) * x0)) / omegaD, al: omega0, b_: omegaD, bK: zeta});
		} else {
	...
	return wrapper(
		{
			...
			bV: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bV, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			T: config.T,
			dz: speed_,
			bB: resolvedSpring,
			...
			function (_default, config) {
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bV);
					}
				}();
				return {
					cT: config.v,
					ev: easingFn,
					R: snapped ? (durationMs + config.v) : 0.0,
					m: config.m,
					C: completeFlag,
					bC: resolvedStart,
					P: durationMs
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults._, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Builder$mergeBaselines = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			defaults,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation.Z));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			V: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.V),
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				ac: $author$project$Anim$Internal$Builder$init(_List_Nil),
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ac: $author$project$Anim$Internal$Builder$clearAnimData(
			...
			return _Utils_update(
				data,
				{
					...
					c: _Utils_update(
						defs,
						{
							ad: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defs.ad)
						})
				});
		}
	});
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {B: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cq: 0, bV: $elm$core$Maybe$Nothing, m: defaultEnd, T: $author$project$Anim$Internal$Builder$Animate, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing, ca: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.Z));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.t.V);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.t.b5);
	});
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.Z));
	};
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.C || (timing.P <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.R - timing.cT);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.P);
	}
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.U, dimensions.c$);
};
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.Z));
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bV: $elm$core$Maybe$Just(easing_),
				bB: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cT: anim.cT, R: anim.R, C: anim.C, P: anim.P};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cT: timing.cT, R: timing.R, C: timing.C, P: timing.P});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.C) {
				...
				var newElapsedMs = timing.R + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cT);
				return _Utils_update(
					timing,
					{
						R: newElapsedMs,
						C: _Utils_cmp(animationElapsedMs, timing.P) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		var filteredEvents = A2(
			...
			function (e) {
				if (!e.$) {
					...
					return A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animGroupName, state.ac);
				} else {
					return true;
				}
			},
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{ac: state.ac, aa: state.aa, N: _List_Nil, O: stillRunning},
				updatedGroups),
			_Utils_ap(
		...
		switch (anim.$) {
			...
			case 4:
				...
				return _Utils_update(
					acc,
					{
						b3: $author$project$Anim$Internal$Property$Rotate$toCssString(
			...
			case 7:
				...
				return _Utils_update(
					acc,
					{
						b7: $author$project$Anim$Internal$Property$Skew$toCssString(
			...
			case 5:
				...
				return _Utils_update(
					acc,
					{
						b6: $author$project$Anim$Internal$Property$Scale$toCssString(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b3: '', b6: '', b7: '', cd: ''};
