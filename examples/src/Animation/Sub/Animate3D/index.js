...
{
	if (region.bB.bt === region.m.bt)
	{
		return 'on line ' + region.bB.bt;
	}
	return 'on lines ' + region.bB.bt + ' through ' + region.m.bt;
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{F: nodeList, z: (len / $elm$core$Array$branchFactor) | 0, E: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cX: fragment, c1: host, dk: path, dm: port_, dp: protocol, dq: query};
	});
...
var $author$project$Animation$Sub$Animate3D$Main$backFace = {
	...
	I: 'back-face',
	K: 'BACK',
	t: {aG: 'rgb(0,0,0)', n: 'backFaceTextAnim', I: 'back-face-text', K: 'BACK'}
};
var $author$project$Animation$Sub$Animate3D$Main$bottomFace = {
	...
	I: 'bottom-face',
	K: 'BOTTOM',
	t: {aG: 'rgb(0,0,0)', n: 'bottomFaceTextAnim', I: 'bottom-face-text', K: 'BOTTOM'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$frontFace = {
	...
	I: 'front-face',
	K: 'FRONT',
	t: {aG: 'rgb(0,0,0)', n: 'frontFaceTextAnim', I: 'front-face-text', K: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initAnimation = {A: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $author$project$Anim$Internal$Builder$CssUnitStore$empty, q: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Z: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bG: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ad: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aK: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aL: $elm$core$Maybe$Nothing, aj: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, cc: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {y: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bs: false, s: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bM: $elm$core$Maybe$Nothing, g: false, b8: $elm$core$Maybe$Nothing, bD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a2: $elm$core$Dict$empty, b5: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {y: 0, bp: $author$project$Anim$Internal$Engine$Sub$Animations$init, cm: 0, cn: $elm$core$Dict$empty, co: $elm$core$Dict$empty, s: $author$project$Anim$Internal$Builder$Once, bh: 0, p: $author$project$Anim$Extra$TransformOrder$default, cG: ''};
...
var $author$project$Anim$Internal$Property$Size$default = {c_: 0, U: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.du / 100;
	var l = hslValue.c6 / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.c_ / 60, 2) - 1));
	var _v0 = (hslValue.c_ < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.c_ < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.c_ < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.c_ < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.c_ < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cM: rgba_.cM, cZ: rgba_.cZ, dr: rgba_.dr};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{c_: hsla_.c_, c6: hsla_.c6, du: hsla_.du});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cM: $elm$core$Basics$round(rgba_.ck * 255),
				cZ: $elm$core$Basics$round(rgba_.cr * 255),
				dr: $elm$core$Basics$round(rgba_.cA * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dr - rgb1.dr;
		var dg = rgb2.cZ - rgb1.cZ;
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bf;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.a_);
	var k = A2($elm$core$Basics$max, 0, spring.a4);
		...
		switch (property.$) {
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							H: mergePerspectiveOrigin(config),
							ae: 28,
	...
	function (isComplete, propertyConfig) {
		...
		var build = F2(
			function (_default, config) {
				var resolvedStart = A2($elm$core$Maybe$withDefault, _default, config.bB);
				...
				return {
					cS: config.u,
					eu: easingFn,
					R: snapped ? (durationMs + config.u) : 0.0,
					m: config.m,
					C: completeFlag,
					bB: resolvedStart,
					P: durationMs
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cp: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bB: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cp: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {B: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, u: $elm$core$Maybe$Nothing, cp: 0, bV: $elm$core$Maybe$Nothing, m: defaultEnd, T: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, ca: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.w.V);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.w.b5);
	});
...
var $author$project$Anim$Internal$Builder$Rotate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bB);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getY, $author$project$Anim$Internal$Builder$Rotate$default, config.bB);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cp: A2(distanceFn, startVal, newEnd),
				m: newEnd,
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cp: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bB: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bB);
		return A4(
...
var $author$project$Anim$Internal$Builder$Rotate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bB);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getX, $author$project$Anim$Internal$Builder$Rotate$default, config.bB);
		return A4(
			$author$project$Anim$Internal$Builder$Rotate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bB);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bB);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Animation$Sub$Animate3D$Main$leftFace = {
	...
	I: 'left-face',
	K: 'LEFT',
	t: {aG: 'rgb(0,0,0)', n: 'leftFaceTextAnim', I: 'left-face-text', K: 'LEFT'}
};
var $author$project$Animation$Sub$Animate3D$Main$rightFace = {
	...
	I: 'right-face',
	K: 'RIGHT',
	t: {aG: 'rgb(0,0,0)', n: 'rightFaceTextAnim', I: 'right-face-text', K: 'RIGHT'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$topFace = {
	...
	I: 'top-face',
	K: 'TOP',
	t: {aG: 'rgb(0,0,0)', n: 'topFaceTextAnim', I: 'top-face-text', K: 'TOP'}
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cy: oldTime, dt: request, dz: subs};
	});
...
var $author$project$Animation$Sub$Animate3D$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Animate3D$Main$GotSubMsg, model.G);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				bp: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.bp)
			});
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.w;
					var newEntry = {H: groupConfig, cw: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aJ: newEntry, be: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aJ: newEntry,
								be: A2($elm$core$List$cons, existing.aJ, existing.be)
							};
						}
					}();
					return _Utils_update(
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.C) {
					...
					var prevDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, prev.bB, prev.m);
					var nextStart = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, cfg.bB);
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {c_: hNormalized, c6: l * 100, du: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cM: rgba_.cM, cZ: rgba_.cZ, dr: rgba_.dr};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cI: rgba_.cI, c_: hsla_.c_, c6: hsla_.c6, du: hsla_.du};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {c_: hslaValue.c_, c6: hslaValue.c6, du: hslaValue.du};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cI: 1.0, c_: hslValue.c_, c6: hslValue.c6, du: hslValue.du};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cI: alpha_, cM: rgb_.cM, cZ: rgb_.cZ, dr: rgb_.dr};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{c_: hslaValue.c_, c6: hslaValue.c6, du: hslaValue.du});
	return {cI: hslaValue.cI, cM: rgb_.cM, cZ: rgb_.cZ, dr: rgb_.dr};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cI: 1.0, cM: rgb_.cM, cZ: rgb_.cZ, dr: rgb_.dr};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cZ + ((endRgb.cZ - startRgb.cZ) * t));
							var r = $elm$core$Basics$round(startRgb.dr + ((endRgb.dr - startRgb.dr) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dr + ((endRgba.dr - startRgba.dr) * t));
							var g = $elm$core$Basics$round(startRgba.cZ + ((endRgba.cZ - startRgba.cZ) * t));
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.du + ((endHsl.du - startHsl.du) * t);
							var l = startHsl.c6 + ((endHsl.c6 - startHsl.c6) * t);
							var h = startHsl.c_ + ((endHsl.c_ - startHsl.c_) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.du + ((endHsla.du - startHsla.du) * t);
							var l = startHsla.c6 + ((endHsla.c6 - startHsla.c6) * t);
							var h = startHsla.c_ + ((endHsla.c_ - startHsla.c_) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.C || (timing.P <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.R - timing.cS);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.U, dimensions.c_);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					fh: $author$project$Anim$Internal$Engine$Sub$extractAnimGroupCurrentStates(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cs));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cs));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ac: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						ax: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$Sub$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.t, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.t, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.t, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.t, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.t, 0, 0),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.t, 0, 0))))));
...
var $author$project$Animation$Sub$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.t, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360))))));
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.w.aC));
	});
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cS: anim.cS, R: anim.R, C: anim.C, P: anim.P};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cS: timing.cS, R: timing.R, C: timing.C, P: timing.P});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.C) {
				...
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cS);
				return _Utils_update(
					timing,
					{
						R: newElapsedMs,
					...
					_Utils_update(
						model,
						{
							G: A2(
								$author$project$Anim$Engine$Sub$animate,
								model.G,
								A2($author$project$Animation$Sub$Animate3D$Main$selectAnimation, $author$project$Animation$Sub$Animate3D$Main$depth, model.w))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.G);
				var animState = _v1.a;
			...
			return _List_fromArray(
				[
					...
					_Utils_ap(
						...
						$author$project$Anim$Internal$Unit$toCssSuffix(units.as))),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					_Utils_ap(
						$elm$core$String$fromFloat(height),
						$author$project$Anim$Internal$Unit$toCssSuffix(units.at)))
				]);
		case 7:
			return _List_Nil;
		default:
		...
		return A2(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background-color', config.aE),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.aF),
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$div,
					_Utils_ap(
						A2($author$project$Anim$Engine$Sub$attributes, config.t.n, animState),
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id(config.t.I),
								A2($elm$html$Html$Attributes$style, 'color', config.t.aG),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
							$elm$html$Html$text(config.t.K)
						]))
				]));
	});
var $author$project$Animation$Sub$Animate3D$Main$viewCube = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Animate3D$Main$cubeGroupName, model.G),
			_List_fromArray(
				[
					$author$project$Anim$Extra$View3D$transformStyle(1),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$frontFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$backFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$rightFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$leftFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$topFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.G, $author$project$Animation$Sub$Animate3D$Main$bottomFace)
			]));
};
...
var $author$project$Animation$Sub$Animate3D$Main$main = $elm$browser$Browser$document(
	{eP: $author$project$Animation$Sub$Animate3D$Main$init, fE: $author$project$Animation$Sub$Animate3D$Main$subscriptions, f2: $author$project$Animation$Sub$Animate3D$Main$update, f3: $author$project$Animation$Sub$Animate3D$Main$view});
