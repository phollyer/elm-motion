...
{
	if (region.bC.bu === region.m.bu)
	{
		return 'on line ' + region.bC.bu;
	}
	return 'on lines ' + region.bC.bu + ' through ' + region.m.bu;
}
...
{
	var onUrlChange = impl.e8;
	var onUrlRequest = impl.e9;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eJ: 'hidden', eb: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eJ: 'mozHidden', eb: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eJ: 'msHidden', eb: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eJ: 'webkitHidden', eb: 'webkitvisibilitychange' }
		: { eJ: 'hidden', eb: 'visibilitychange' };
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{G: nodeList, z: (len / $elm$core$Array$branchFactor) | 0, E: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cY: fragment, c2: host, dl: path, dn: port_, dq: protocol, dr: query};
	});
...
var $author$project$Animation$Sub$Animate3D$Main$Opening = 0;
var $author$project$Anim$Unit$Px = 30;
var $author$project$Animation$Sub$Animate3D$Main$TriggerAnimation = {$: 2};
var $elm$core$Basics$always = F2(
	function (a, _v0) {
		return a;
	});
var $author$project$Animation$Sub$Animate3D$Main$backFace = {
	aG: 'rgb(41, 128, 185)',
	aH: 'rgb(33, 97, 140)',
	n: 'backFaceAnim',
	I: 'back-face',
	K: 'BACK',
	u: {aI: 'rgb(0,0,0)', n: 'backFaceTextAnim', I: 'back-face-text', K: 'BACK'}
};
var $author$project$Animation$Sub$Animate3D$Main$bottomFace = {
	aG: 'rgb(155, 89, 182)',
	aH: 'rgb(142, 68, 173)',
	n: 'bottomFaceAnim',
	I: 'bottom-face',
	K: 'BOTTOM',
	u: {aI: 'rgb(0,0,0)', n: 'bottomFaceTextAnim', I: 'bottom-face-text', K: 'BOTTOM'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$cubeGroupName = 'cubeAnim';
var $author$project$Animation$Sub$Animate3D$Main$cubeSize = 18;
var $author$project$Animation$Sub$Animate3D$Main$depth = $author$project$Animation$Sub$Animate3D$Main$cubeSize / 2;
var $author$project$Animation$Sub$Animate3D$Main$frontFace = {
	aG: 'rgb(52, 152, 219)',
	aH: 'rgb(41, 128, 185)',
	n: 'frontFaceAnim',
	I: 'front-face',
	K: 'FRONT',
	u: {aI: 'rgb(0,0,0)', n: 'frontFaceTextAnim', I: 'front-face-text', K: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initAnimation = {A: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $author$project$Anim$Internal$Builder$CssUnitStore$empty, q: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, _: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bl: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Unit$emptyCssUnitAxes = {as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initDefaults = {P: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aa: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aL: $elm$core$Maybe$Nothing, aj: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, bH: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {y: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bt: false, s: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bN: $elm$core$Maybe$Nothing, g: false, b9: $elm$core$Maybe$Nothing, bE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a3: $elm$core$Dict$empty, b6: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aO: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {y: 0, bq: $author$project$Anim$Internal$Engine$Sub$Animations$init, cm: $elm$core$Dict$empty, cn: 0, co: $elm$core$Dict$empty, cp: $elm$core$Dict$empty, s: $author$project$Anim$Internal$Builder$Once, bh: 0, p: $author$project$Anim$Extra$TransformOrder$default, cH: ''};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$default = {as: 50, at: 50};
var $author$project$Anim$Internal$Property$Rotate$Rotate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Rotate$default = {as: 0, at: 0, au: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {as: 1.0, at: 1.0, au: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {c$: 0, V: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {as: 0, at: 0};
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {as: 0, at: 0, au: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dv / 100;
	var l = hslValue.c7 / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.c$ / 60, 2) - 1));
	var _v0 = (hslValue.c$ < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.c$ < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.c$ < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.c$ < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.c$ < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cN: rgba_.cN, c_: rgba_.c_, ds: rgba_.ds};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{c$: hsla_.c$, c7: hsla_.c7, dv: hsla_.dv});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cN: $elm$core$Basics$round(rgba_.ck * 255),
				c_: $elm$core$Basics$round(rgba_.cs * 255),
				ds: $elm$core$Basics$round(rgba_.cB * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.ds - rgb1.ds;
		var dg = rgb2.c_ - rgb1.c_;
		var db = rgb2.cN - rgb1.cN;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fZ(coord2);
		var record1 = support.fZ(coord1);
		var dz = $elm$core$Basics$abs(record2.au - record1.au);
		var dy = $elm$core$Basics$abs(record2.at - record1.at);
		var dx = $elm$core$Basics$abs(record2.as - record1.as);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	dL: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {as: a.as + b.as, at: a.at + b.at, au: a.au + b.au};
		}),
	...
	b7: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {as: angles.as * factor, at: angles.at * factor, au: angles.au * factor};
		}),
	fG: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	b7: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {as: coords.as * factor, at: coords.at * factor, au: coords.au * factor};
		}),
	fG: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Builder$perspectiveOriginStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			...
			animGroupName,
			{as: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginX, at: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginY, au: ''},
			defaults.P);
	});
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bf;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.a$);
	var k = A2($elm$core$Basics$max, 0, spring.a5);
	var omega0 = $elm$core$Basics$sqrt(k / m);
	var c = A2($elm$core$Basics$max, 0, spring.aW);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var wrapper = _v0.ar;
	var speedFn = _v0.ap;
	var durationFn = _v0.ah;
	var distanceFn = _v0.ag;
	var defaultCssUnit = _v0.ae;
	var defaultStart = _v0.af;
	var globalCssUnit = _v0.h;
	var globalData = _v0.ai;
	var config = _v0.F;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bC);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bX: 0,
					bB: $author$project$Motion$Internal$Spring$unwrap(s),
					cc: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			...
			v: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.v, globalData.az, 0),
			cq: distance_,
...
var $author$project$Anim$Internal$Builder$sizeStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{as: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, at: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, au: ''},
			defaults.P);
	});
...
var $author$project$Anim$Internal$Builder$translateStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{as: $author$project$Anim$Internal$Builder$CssUnitStore$translateX, at: $author$project$Anim$Internal$Builder$CssUnitStore$translateY, au: $author$project$Anim$Internal$Builder$CssUnitStore$translateZ},
			defaults.P);
	});
			...
			case 0:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							F: config,
							ae: $author$project$Anim$Internal$Unit$default,
							af: 0,
							ag: F2(
								function (a, b) {
									return $elm$core$Basics$abs(b - a);
								}),
							ah: $author$project$Shared$TimeSpec$duration,
							h: globalData.h,
							ai: globalData,
							ap: $author$project$Shared$TimeSpec$speed,
							ar: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							F: config,
							ae: $author$project$Anim$Internal$Unit$default,
							af: $author$project$Anim$Internal$Extra$Color$transparent,
							ag: $author$project$Anim$Internal$Extra$Color$distance,
							ah: $author$project$Anim$Internal$Extra$Color$duration,
							h: globalData.h,
							ai: globalData,
							ap: $author$project$Anim$Internal$Extra$Color$speed,
							ar: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							F: config,
							ae: $author$project$Anim$Internal$Unit$default,
							af: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							ag: $author$project$Anim$Internal$Property$Opacity$distance,
							ah: $author$project$Anim$Internal$Property$Opacity$duration,
							h: globalData.h,
							ai: globalData,
							ap: $author$project$Anim$Internal$Property$Opacity$speed,
							ar: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							ae: 28,
							af: $author$project$Anim$Internal$Property$PerspectiveOrigin$default,
							ag: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance,
							ah: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration,
							h: globalData.h,
							ai: globalData,
							ap: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed,
							ar: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig
						}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, ae: $author$project$Anim$Internal$Unit$default, af: $author$project$Anim$Internal$Property$Rotate$default, ag: $author$project$Anim$Internal$Property$Rotate$distance, ah: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, ai: globalData, ap: $author$project$Anim$Internal$Property$Rotate$speed, ar: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, ae: $author$project$Anim$Internal$Unit$default, af: $author$project$Anim$Internal$Property$Scale$default, ag: $author$project$Anim$Internal$Property$Scale$distance, ah: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, ai: globalData, ap: $author$project$Anim$Internal$Property$Scale$speed, ar: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							F: mergeSize(config),
							ae: $author$project$Anim$Internal$Unit$default,
							af: $author$project$Anim$Internal$Property$Size$default,
							ag: $author$project$Anim$Internal$Property$Size$distance,
							ah: $author$project$Anim$Internal$Property$Size$duration,
							h: globalData.aa,
							ai: globalData,
							ap: $author$project$Anim$Internal$Property$Size$speed,
							ar: $author$project$Anim$Internal$Builder$ProcessedSizeConfig
						}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, ae: $author$project$Anim$Internal$Unit$default, af: $author$project$Anim$Internal$Property$Skew$default, ag: $author$project$Anim$Internal$Property$Skew$distance, ah: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, ai: globalData, ap: $author$project$Anim$Internal$Property$Skew$speed, ar: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							ae: $author$project$Anim$Internal$Unit$default,
							af: $author$project$Anim$Internal$Property$Translate$default,
							ag: $author$project$Anim$Internal$Property$Translate$distance,
							ah: $author$project$Anim$Internal$Property$Translate$duration,
							h: globalData.h,
							ai: globalData,
							ap: $author$project$Anim$Internal$Property$Translate$speed,
							ar: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig
						}));
		}
	});
	...
	function (isComplete, propertyConfig) {
		...
		var build = F2(
			function (_default, config) {
				var resolvedStart = A2($elm$core$Maybe$withDefault, _default, config.bC);
				var durationMs = config.x;
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bW);
					}
				}();
				return {
					cT: config.v,
					ev: easingFn,
					S: snapped ? (durationMs + config.v) : 0.0,
					m: config.m,
					C: completeFlag,
					bC: resolvedStart,
					Q: durationMs
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.aa, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				ad: $author$project$Anim$Internal$Builder$init(_List_Nil),
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ad: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						P: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.P)
					});
			};
			var defs = data.c;
			var animation = data.a;
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						animation,
						{
							aV: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, animation.aV)
						}),
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bC);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Rotate$default, clampedStart);
				return _Utils_update(
					config,
					{
						cq: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bC: clampedStart
					});
			}
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						as: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.as : endRecord.as,
						at: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.at : endRecord.at,
						au: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.au : endRecord.au
					});
				return _Utils_update(
					config,
					{
						cq: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {B: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cq: 0, bW: $elm$core$Maybe$Nothing, m: defaultEnd, U: $author$project$Anim$Internal$Builder$Animate, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing, cb: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getSpring = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).aL;
};
var $author$project$Anim$Internal$Builder$getTimeSpec = function (_v0) {
	var data = _v0;
	return $author$project$Anim$Internal$Builder$getScopedDefaults(data).aj;
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.t.W);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.t.b6);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bC: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bC: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Rotate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bC);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getY, $author$project$Anim$Internal$Builder$Rotate$default, config.bC);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bC);
		return _Utils_update(
			config,
			{
				cq: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bC: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cq: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bC: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bC);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bC);
		return A4(
...
var $author$project$Anim$Internal$Builder$Rotate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bC);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getX, $author$project$Anim$Internal$Builder$Rotate$default, config.bC);
		return A4(
			$author$project$Anim$Internal$Builder$Rotate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bC);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bC);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Animation$Sub$Animate3D$Main$leftFace = {
	aG: 'rgb(230, 126, 34)',
	aH: 'rgb(211, 84, 0)',
	n: 'leftFaceAnim',
	I: 'left-face',
	K: 'LEFT',
	u: {aI: 'rgb(0,0,0)', n: 'leftFaceTextAnim', I: 'left-face-text', K: 'LEFT'}
};
var $author$project$Animation$Sub$Animate3D$Main$rightFace = {
	aG: 'rgb(231, 76, 60)',
	aH: 'rgb(192, 57, 43)',
	n: 'rightFaceAnim',
	I: 'right-face',
	K: 'RIGHT',
	u: {aI: 'rgb(0,0,0)', n: 'rightFaceTextAnim', I: 'right-face-text', K: 'RIGHT'}
};
var $elm$core$Process$sleep = _Process_sleep;
var $author$project$Animation$Sub$Animate3D$Main$topFace = {
	aG: 'rgb(46, 204, 113)',
	aH: 'rgb(39, 174, 96)',
	n: 'topFaceAnim',
	I: 'top-face',
	K: 'TOP',
	u: {aI: 'rgb(0,0,0)', n: 'topFaceTextAnim', I: 'top-face-text', K: 'TOP'}
};
var $author$project$Animation$Sub$Animate3D$Main$init = function (_v0) {
	var initialAnimState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$cubeGroupName, 200),
				$author$project$Anim$Property$Translate$initCssUnit(30)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$frontFace.n, $author$project$Animation$Sub$Animate3D$Main$depth),
				$author$project$Anim$Property$Translate$initCssUnit(7)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$backFace.n, $author$project$Animation$Sub$Animate3D$Main$depth * (-1)),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$initCssUnit(7),
					A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$backFace.n, 180))),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Animate3D$Main$rightFace.n, $author$project$Animation$Sub$Animate3D$Main$depth),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$initCssUnit(7),
					A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$rightFace.n, 90))),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Animate3D$Main$leftFace.n, (-1) * $author$project$Animation$Sub$Animate3D$Main$depth),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$initCssUnit(7),
					A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$leftFace.n, -90))),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Animate3D$Main$topFace.n, (-1) * $author$project$Animation$Sub$Animate3D$Main$depth),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$initCssUnit(7),
					A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Animate3D$Main$topFace.n, 90))),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Animate3D$Main$bottomFace.n, $author$project$Animation$Sub$Animate3D$Main$depth),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$initCssUnit(7),
					A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Animate3D$Main$bottomFace.n, -90)))
			]));
	return _Utils_Tuple2(
		{H: initialAnimState, t: 0},
		A2(
			$elm$core$Task$perform,
			$elm$core$Basics$always($author$project$Animation$Sub$Animate3D$Main$TriggerAnimation),
			$elm$core$Process$sleep(0)));
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Animation$Sub$Animate3D$Main$GotSubMsg = function (a) {
	return {$: 1, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cz: oldTime, du: request, dA: subs};
	});
...
var $author$project$Animation$Sub$Animate3D$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Animate3D$Main$GotSubMsg, model.H);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				bq: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.bq)
			});
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.t;
					var newEntry = {F: groupConfig, cx: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ax: newEntry, a_: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ax: newEntry,
								a_: A2($elm$core$List$cons, existing.ax, existing.a_)
							};
						}
					}();
					return _Utils_update(
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							bc: A2($elm$core$List$cons, prop, acc.bc)
						});
				case 1:
					return _Utils_update(
						acc,
						{
							bj: A2($elm$core$List$cons, prop, acc.bj)
						});
				default:
					return acc;
			}
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.C) {
					...
					var prevDurationMs = prev.Q;
					var prevDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, prev.bC, prev.m);
					var nextStart = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, cfg.bC);
					var nextDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, nextStart, cfg.m);
					var scaledDurationMs = ((prevDistance <= 0) || (prevDurationMs <= 0)) ? cfg.x : (nextDistance * (prevDurationMs / prevDistance));
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$setControlledAxes = F2(
	function (controlledAxes, _v0) {
		var group = _v0;
		return _Utils_update(
			group,
			{cm: controlledAxes});
...
var $author$project$Anim$Internal$Engine$Sub$Generator$generateAnimation = F8(
	function (iterationCount, directionConfig, maybeOrder, controlledAxes, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var hasAnimateTiming = A2(
			...
			$author$project$Anim$Internal$Builder$partitionByMode(adjustedProperties).bc);
		var initialPlayState = hasAnimateTiming ? 1 : 4;
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimGroup$setWillChange,
			A2($author$project$Anim$Internal$Builder$willChangeCompositeWithControlledAxes, controlledAxes, adjustedProperties),
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimGroup$setControlledAxes,
				controlledAxes,
				A2(
					$author$project$Anim$Internal$Engine$Sub$AnimGroup$setDiscreteExit,
					discreteExitProps,
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.t.av);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.F.cm);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.ax, history.a_));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {c$: hNormalized, c7: l * 100, dv: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cN: rgba_.cN, c_: rgba_.c_, ds: rgba_.ds};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cJ: rgba_.cJ, c$: hsla_.c$, c7: hsla_.c7, dv: hsla_.dv};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {c$: hslaValue.c$, c7: hslaValue.c7, dv: hslaValue.dv};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cJ: 1.0, c$: hslValue.c$, c7: hslValue.c7, dv: hslValue.dv};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cJ: alpha_, cN: rgb_.cN, c_: rgb_.c_, ds: rgb_.ds};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{c$: hslaValue.c$, c7: hslaValue.c7, dv: hslaValue.dv});
	return {cJ: hslaValue.cJ, cN: rgb_.cN, c_: rgb_.c_, ds: rgb_.ds};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cJ: 1.0, cN: rgb_.cN, c_: rgb_.c_, ds: rgb_.ds};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.c_ + ((endRgb.c_ - startRgb.c_) * t));
							var r = $elm$core$Basics$round(startRgb.ds + ((endRgb.ds - startRgb.ds) * t));
							var b = $elm$core$Basics$round(startRgb.cN + ((endRgb.cN - startRgb.cN) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cN: b, c_: g, ds: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.ds + ((endRgba.ds - startRgba.ds) * t));
							var g = $elm$core$Basics$round(startRgba.c_ + ((endRgba.c_ - startRgba.c_) * t));
							var b = $elm$core$Basics$round(startRgba.cN + ((endRgba.cN - startRgba.cN) * t));
							var a = startRgba.cJ + ((endRgba.cJ - startRgba.cJ) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dv + ((endHsl.dv - startHsl.dv) * t);
							var l = startHsl.c7 + ((endHsl.c7 - startHsl.c7) * t);
							var h = startHsl.c$ + ((endHsl.c$ - startHsl.c$) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dv + ((endHsla.dv - startHsla.dv) * t);
							var l = startHsla.c7 + ((endHsla.c7 - startHsla.c7) * t);
							var h = startHsla.c$ + ((endHsla.c$ - startHsla.c$) * t);
							var a = startHsla.cJ + ((endHsla.cJ - startHsla.cJ) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.C || (timing.Q <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.S - timing.cT);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.Q);
	}
};
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		var easedProgress = anim.ev(
			$author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress(anim));
		return A3(interpolate, easedProgress, anim.bC, anim.m);
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate = F3(
	function (t, start, end) {
		...
		var ex = _v1.a;
		var ey = _v1.b;
		return {as: sx + ((ex - sx) * t), at: sy + ((ey - sy) * t)};
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.fZ(coord);
		return _Utils_Tuple3(record.as, record.at, record.au);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.V, dimensions.c$);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					fi: $author$project$Anim$Internal$Engine$Sub$extractAnimGroupCurrentStates(anim)
				};
			}),
		anims);
};
	...
	function (_v0, build) {
		...
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var playback = A3($author$project$Anim$Internal$Builder$resolvePlayback, processed.s, processed.y, config.b);
				return A8(
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.ct));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.ct));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ad: $author$project$Anim$Internal$Builder$clearAnimData(
				...
				ab: state.ab,
				N: _Utils_ap(state.N, runAndStartedEvents),
				O: true
			},
			nextAnimGroups);
		return nextState;
...
var $author$project$Animation$Sub$Animate3D$Main$Closing = 1;
...
var $author$project$Animation$Sub$Animate3D$Main$sharedTiming = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Engine$Sub$duration(1000),
	$author$project$Anim$Engine$Sub$easing($author$project$Motion$Easing$CircInOut));
var $author$project$Animation$Sub$Animate3D$Main$moveFace = F2(
	function (config, moveToBuilder) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Animate3D$Main$sharedTiming,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Sub$for(config.n),
				A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Animate3D$Main$moveBackFaceIn = function (toZ) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$backFace,
...
var $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceIn = function (toY) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$bottomFace,
		$author$project$Anim$Property$Translate$toY(toY));
};
var $author$project$Animation$Sub$Animate3D$Main$moveFrontFaceIn = function (toZ) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$frontFace,
...
var $author$project$Animation$Sub$Animate3D$Main$moveLeftFaceIn = function (toX) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$leftFace,
		$author$project$Anim$Property$Translate$toX((-1) * toX));
};
var $author$project$Animation$Sub$Animate3D$Main$moveRightFaceIn = function (toX) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$rightFace,
		$author$project$Anim$Property$Translate$toX(toX));
};
var $author$project$Animation$Sub$Animate3D$Main$moveTopFaceIn = function (toY) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$topFace,
		$author$project$Anim$Property$Translate$toY((-1) * toY));
};
var $author$project$Animation$Sub$Animate3D$Main$moveSidesIn = function (targetAmount) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Animate3D$Main$moveFrontFaceIn(targetAmount),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Animate3D$Main$moveBackFaceIn(targetAmount),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Animate3D$Main$moveRightFaceIn(targetAmount),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Animation$Sub$Animate3D$Main$moveLeftFaceIn(targetAmount),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$Sub$Animate3D$Main$moveTopFaceIn(targetAmount),
						$author$project$Animation$Sub$Animate3D$Main$moveBottomFaceIn(targetAmount))))));
};
var $author$project$Animation$Sub$Animate3D$Main$moveAmount = 10;
var $author$project$Animation$Sub$Animate3D$Main$moveBackFaceOut = function (toZ) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$backFace,
		$author$project$Anim$Property$Translate$toZ(((-1) * toZ) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceOut = function (toY) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$bottomFace,
		$author$project$Anim$Property$Translate$toY(toY + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveFrontFaceOut = function (toZ) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$frontFace,
		$author$project$Anim$Property$Translate$toZ(toZ + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveLeftFaceOut = function (toX) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$leftFace,
		$author$project$Anim$Property$Translate$toX(((-1) * toX) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveRightFaceOut = function (toX) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$rightFace,
		$author$project$Anim$Property$Translate$toX(toX + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveTopFaceOut = function (toY) {
	return A2(
		$author$project$Animation$Sub$Animate3D$Main$moveFace,
		$author$project$Animation$Sub$Animate3D$Main$topFace,
		$author$project$Anim$Property$Translate$toY(((-1) * toY) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
};
var $author$project$Animation$Sub$Animate3D$Main$moveSidesOut = function (targetAmount) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Animate3D$Main$moveFrontFaceOut(targetAmount),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Animate3D$Main$moveBackFaceOut(targetAmount),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Animate3D$Main$moveRightFaceOut(targetAmount),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Animation$Sub$Animate3D$Main$moveLeftFaceOut(targetAmount),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$Sub$Animate3D$Main$moveTopFaceOut(targetAmount),
						$author$project$Animation$Sub$Animate3D$Main$moveBottomFaceOut(targetAmount))))));
};
...
var $author$project$Animation$Sub$Animate3D$Main$moveText = F3(
...
var $author$project$Animation$Sub$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.u, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.u, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.u, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.u, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.u, 0, 0),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.u, 0, 0))))));
var $author$project$Animation$Sub$Animate3D$Main$textMoveAmount = 14;
var $author$project$Animation$Sub$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.u, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360))))));
...
var $author$project$Animation$Sub$Animate3D$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$Animate3D$Main$cubeGroupName),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Rotate$begin,
			A2(
...
var $author$project$Animation$Sub$Animate3D$Main$rotateCubeAntiClockwise = $author$project$Animation$Sub$Animate3D$Main$rotateCube(0);
var $author$project$Animation$Sub$Animate3D$Main$rotateCubeClockwise = $author$project$Animation$Sub$Animate3D$Main$rotateCube(360);
var $author$project$Animation$Sub$Animate3D$Main$selectAnimation = F2(
	function (targetAmount, state) {
		switch (state) {
			case 0:
				return A2(
					$elm$core$Basics$composeR,
					$author$project$Animation$Sub$Animate3D$Main$moveSidesOut(targetAmount),
					$author$project$Animation$Sub$Animate3D$Main$moveTextsOut);
			case 1:
				return A2(
					$elm$core$Basics$composeR,
					$author$project$Animation$Sub$Animate3D$Main$moveSidesIn(targetAmount),
					$author$project$Animation$Sub$Animate3D$Main$moveTextsIn);
			case 2:
				return $author$project$Animation$Sub$Animate3D$Main$rotateCubeClockwise;
			default:
				return $author$project$Animation$Sub$Animate3D$Main$rotateCubeAntiClockwise;
		}
	});
var $author$project$Animation$Sub$Animate3D$Main$stateChanged = F2(
		...
		return _Utils_update(
			model,
			{
				H: A2(
					...
					model.H,
					A2($author$project$Animation$Sub$Animate3D$Main$selectAnimation, $author$project$Animation$Sub$Animate3D$Main$depth, state)),
				t: state
			});
	});
var $author$project$Animation$Sub$Animate3D$Main$cubeRotationEnded = function (model) {
	var _v0 = model.t;
	switch (_v0) {
		case 2:
			return A2($author$project$Animation$Sub$Animate3D$Main$stateChanged, 1, model);
		case 3:
			return A2($author$project$Animation$Sub$Animate3D$Main$stateChanged, 0, model);
		default:
			return model;
	}
};
var $author$project$Animation$Sub$Animate3D$Main$RotatingClosed = 3;
var $author$project$Animation$Sub$Animate3D$Main$RotatingOpen = 2;
var $author$project$Animation$Sub$Animate3D$Main$sidesMovementEnded = function (model) {
	var _v0 = model.t;
	switch (_v0) {
		case 0:
			return A2($author$project$Animation$Sub$Animate3D$Main$stateChanged, 2, model);
		case 1:
			return A2($author$project$Animation$Sub$Animate3D$Main$stateChanged, 3, model);
		default:
			return model;
	}
};
var $author$project$Animation$Sub$Animate3D$Main$handleMotionEvent = F2(
	function (animEvent, model) {
		...
		while (true) {
			if (animEvent.$ === 2) {
				switch (animEvent.a) {
					case 'cubeAnim':
						return $author$project$Animation$Sub$Animate3D$Main$cubeRotationEnded(model);
					case 'frontFaceAnim':
						return $author$project$Animation$Sub$Animate3D$Main$sidesMovementEnded(model);
					default:
						break _v0$2;
				}
			} else {
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.t.av));
	});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(group.bh);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cT: anim.cT, S: anim.S, C: anim.C, Q: anim.Q};
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(group.bh);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cT: timing.cT, S: timing.S, C: timing.C, Q: timing.Q});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.C) {
				...
				var newElapsedMs = timing.S + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cT);
				return _Utils_update(
					timing,
					{
						S: newElapsedMs,
						C: _Utils_cmp(animationElapsedMs, timing.Q) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		var filteredEvents = A2(
			...
			function (e) {
				if (!e.$) {
					...
					return A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animGroupName, state.ad);
				} else {
					return true;
				}
			},
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{ad: state.ad, ab: state.ab, N: _List_Nil, O: stillRunning},
				updatedGroups),
			_Utils_ap(
				A2($elm$core$List$map, $author$project$Anim$Internal$Engine$Sub$Control, state.N),
...
var $author$project$Animation$Sub$Animate3D$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
					...
					_Utils_update(
						model,
						{
							H: A2(
								$author$project$Anim$Engine$Sub$animate,
								model.H,
								A2($author$project$Animation$Sub$Animate3D$Main$selectAnimation, $author$project$Animation$Sub$Animate3D$Main$depth, model.t))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.H);
				var animState = _v1.a;
				var animEvents = _v1.b;
				return _Utils_Tuple2(
					A3(
						$elm$core$List$foldl,
						$author$project$Animation$Sub$Animate3D$Main$handleMotionEvent,
						_Utils_update(
							model,
							{H: animState}),
						animEvents),
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'rotateX(' + ($elm$core$String$fromFloat(angles.as) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.at)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.at) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.au)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.au) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'skewX(' + ($elm$core$String$fromFloat(values.as) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.at)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.at) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = F2(
	function (axes, _v0) {
		var coords = _v0;
		return 'translate3d(' + ($elm$core$String$fromFloat(coords.as) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.as) + (', ' + ($elm$core$String$fromFloat(coords.at) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.at) + (', ' + ($elm$core$String$fromFloat(coords.au) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.au) + ')'))))))));
	});
		...
		switch (anim.$) {
			...
			case 4:
				...
				return _Utils_update(
					acc,
					{
						b4: $author$project$Anim$Internal$Property$Rotate$toCssString(
			...
			case 7:
				...
				return _Utils_update(
					acc,
					{
						b8: $author$project$Anim$Internal$Property$Skew$toCssString(
			...
			case 5:
				...
				return _Utils_update(
					acc,
					{
						b7: $author$project$Anim$Internal$Property$Scale$toCssString(
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isComplete = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(group.bh);
};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b4: '', b7: '', b8: '', cd: ''};
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$getControlledAxes = function (_v0) {
	var group = _v0;
	return group.cm;
};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString = F2(
	function (axes, _v0) {
		var y = _v0.at;
		var x = _v0.as;
		return $elm$core$String$fromFloat(x) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.as) + (' ' + ($elm$core$String$fromFloat(y) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.at))));
	});
var $author$project$Anim$Internal$Engine$Sub$getNonTransformStyleAttribute = F2(
	function (controlledAxes, anim) {
		switch (anim.$) {
			case 0:
				var cssName = anim.a;
				var unit = anim.b;
						...
						[
							...
							A2(
								...
								_Utils_ap(
									...
									$author$project$Anim$Internal$Unit$toCssSuffix(units.as)))) : $elm$core$Maybe$Nothing,
							...
							A2(
								...
								_Utils_ap(
									...
									$author$project$Anim$Internal$Unit$toCssSuffix(units.at)))) : $elm$core$Maybe$Nothing
						]));
			case 7:
				return _List_Nil;
			default:
	...
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var anims = $author$project$Anim$Internal$Engine$Sub$Animations$list(
				$author$project$Anim$Internal$Engine$Sub$AnimGroup$getAnimations(animGroup));
			var nonTransformStyles = A2(
				$elm$core$List$concatMap,
				$author$project$Anim$Internal$Engine$Sub$getNonTransformStyleAttribute(
					$author$project$Anim$Internal$Engine$Sub$AnimGroup$getControlledAxes(animGroup)),
				anims);
...
var $author$project$Animation$Sub$Animate3D$Main$cubeSizeCss = $elm$core$String$fromFloat($author$project$Animation$Sub$Animate3D$Main$cubeSize) + 'cqmin';
...
var $author$project$Animation$Sub$Animate3D$Main$viewFace = F2(
	function (animState, config) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2($author$project$Anim$Engine$Sub$attributes, config.n, animState),
				_List_fromArray(
					[
						$author$project$Anim$Extra$View3D$transformStyle(1),
						$elm$html$Html$Attributes$id(config.I),
						A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
						A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$Sub$Animate3D$Main$cubeSizeCss),
						A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$Sub$Animate3D$Main$cubeSizeCss),
						A2($elm$html$Html$Attributes$style, 'background-color', config.aG),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.aH),
						A2($elm$html$Html$Attributes$style, 'box-sizing', 'border-box'),
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
						A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
						A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
						A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
						A2($elm$html$Html$Attributes$style, 'font-size', 'calc(' + ($author$project$Animation$Sub$Animate3D$Main$cubeSizeCss + ' * 0.13)'))
					])),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(config.K)
						])),
					A2(
					$elm$html$Html$div,
					_Utils_ap(
						A2($author$project$Anim$Engine$Sub$attributes, config.u.n, animState),
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id(config.u.I),
								A2($elm$html$Html$Attributes$style, 'color', config.u.aI),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
							$elm$html$Html$text(config.u.K)
						]))
				]));
	});
var $author$project$Animation$Sub$Animate3D$Main$viewCube = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Animate3D$Main$cubeGroupName, model.H),
			_List_fromArray(
				[
					$author$project$Anim$Extra$View3D$transformStyle(1),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$frontFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$backFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$rightFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$leftFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$topFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.H, $author$project$Animation$Sub$Animate3D$Main$bottomFace)
			]));
};
var $author$project$Animation$Sub$Animate3D$Main$viewAnimationArea = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Animation$Sub$Animate3D$Main$viewCube(model)
			]));
};
var $author$project$Animation$Sub$Animate3D$Main$view = function (model) {
	return {
		d1: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$author$project$Animation$Sub$Animate3D$Main$viewAnimationArea(model)
					]))
			]),
		fY: 'Sub 3D Example'
	};
};
var $author$project$Animation$Sub$Animate3D$Main$main = $elm$browser$Browser$document(
	{eQ: $author$project$Animation$Sub$Animate3D$Main$init, fF: $author$project$Animation$Sub$Animate3D$Main$subscriptions, f3: $author$project$Animation$Sub$Animate3D$Main$update, f4: $author$project$Animation$Sub$Animate3D$Main$view});
_Platform_export({'Animation':{'Sub':{'Animate3D':{'Main':{'init':$author$project$Animation$Sub$Animate3D$Main$main(
	A2(
