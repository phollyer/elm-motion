...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b8: $elm$core$Set$empty, ax: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b1: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cl: $elm$core$Basics$abs(clampedEnd - startForDistance),
						m: clampedEnd,
						bw: clampedStart
					});
			}
	...
	function (endValue, _v0) {
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					cl: $elm$core$Basics$abs(endValue - startValue),
					m: endValue,
					bw: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$BorderRadius$Main$subscriptions,
		f$: $author$project$Animation$Sub$BorderRadius$Main$update,
		f0: $author$project$Animation$Sub$BorderRadius$Main$view
	});
