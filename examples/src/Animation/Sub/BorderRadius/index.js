...
var $author$project$Animation$Sub$BorderRadius$Main$animGroup = 'radiusAnim';
...
var $author$project$Anim$Internal$Builder$initDefaults = {K: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, bC: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cm: $elm$core$Basics$abs(clampedEnd - startForDistance),
						m: clampedEnd,
						bx: clampedStart
					});
			}
	...
	function (endValue, _v0) {
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					cm: $elm$core$Basics$abs(endValue - startValue),
					m: endValue,
					bx: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$BorderRadius$Main$init = _Utils_Tuple2(
	{
		Z: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Sub$BorderRadius$Main$animGroup,
					$author$project$Anim$Property$Custom$BorderRadius(30),
					0)
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$BorderRadius$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$BorderRadius$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$BorderRadius$Main$GotSubMsg, model.Z);
};
...
var $author$project$Animation$Sub$BorderRadius$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$BorderRadius$Main$roundCorners = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$Sub$BorderRadius$Main$standardTiming, $author$project$Anim$Property$Custom$end)));
var $author$project$Animation$Sub$BorderRadius$Main$squareCorners = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Custom$begin(
		$author$project$Anim$Property$Custom$BorderRadius(30)),
	A2(
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{aa: state.aa, Y: state.Y, I: _List_Nil, J: stillRunning},
				updatedGroups),
			_Utils_ap(
...
var $author$project$Animation$Sub$BorderRadius$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
					...
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$BorderRadius$Main$animGroup),
									$author$project$Animation$Sub$BorderRadius$Main$roundCorners))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$BorderRadius$Main$animGroup),
									$author$project$Animation$Sub$BorderRadius$Main$squareCorners))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$BorderRadius$Main$TriggerRound = {$: 1};
var $author$project$Animation$Sub$BorderRadius$Main$TriggerSquare = {$: 2};
...
var $author$project$Animation$Sub$BorderRadius$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$BorderRadius$Main$TriggerRound),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$BorderRadius$Main$TriggerSquare),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$BorderRadius$Main$animGroup, model.Z),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$BorderRadius$Main$init;
		},
		fC: $author$project$Animation$Sub$BorderRadius$Main$subscriptions,
		f0: $author$project$Animation$Sub$BorderRadius$Main$update,
		f1: $author$project$Animation$Sub$BorderRadius$Main$view
	});
_Platform_export({'Animation':{'Sub':{'BorderRadius':{'Main':{'init':$author$project$Animation$Sub$BorderRadius$Main$main(
