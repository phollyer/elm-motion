		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{F: nodeList, y: (len / $elm$core$Array$branchFactor) | 0, D: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cS: fragment, cZ: host, dg: path, di: port_, dl: protocol, dm: query};
	});
...
var $author$project$Animation$Sub$ButtonHovers$Main$baseHeight = 15.8;
var $author$project$Animation$Sub$ButtonHovers$Main$baseWidth = 51;
...
var $author$project$Anim$Internal$Builder$initAnimation = {z: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			b: _Utils_update(
				pb,
				{x: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once})
		});
};
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.z);
	});
...
var $author$project$Anim$Internal$Builder$initDefaults = {L: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, bC: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {x: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bo: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bI: $elm$core$Maybe$Nothing, g: false, b4: $elm$core$Maybe$Nothing, bz: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b1: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {x: 0, bl: $author$project$Anim$Internal$Engine$Sub$Animations$init, cg: $elm$core$Dict$empty, ch: 0, ci: $elm$core$Dict$empty, cj: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bc: 0, o: $author$project$Anim$Extra$TransformOrder$default, cB: ''};
...
var $author$project$Anim$Internal$Property$Size$default = {cV: 0, R: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cH: rgba_.cH, cU: rgba_.cU, dn: rgba_.dn};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cV: hsla_.cV, c2: hsla_.c2, dq: hsla_.dq});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cH: $elm$core$Basics$round(rgba_.ce * 255),
				cU: $elm$core$Basics$round(rgba_.cm * 255),
	...
	return wrapper(
		{
			...
			t: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.t, globalData.aw, 0),
			ck: distance_,
			w: $elm$core$Basics$round(duration_),
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Rotate$default, ad: $author$project$Anim$Internal$Property$Rotate$distance, ae: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Rotate$speed, ao: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Scale$default, ad: $author$project$Anim$Internal$Property$Scale$distance, ae: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Scale$speed, ao: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Skew$default, ad: $author$project$Anim$Internal$Property$Skew$distance, ae: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Skew$speed, ao: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$setSizeInitCssUnit = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.aL),
			_List_fromArray(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cV: record.cW, R: record.dB};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cW: dimensions.cV, dB: dimensions.R};
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							...
							dB: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dB)
						});
				};
				...
				return _Utils_update(
					config,
					{
						ck: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
	...
	function (config, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var mergedConfig = function () {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animKey, anim.z);
				if (!_v2.$) {
					var existing = _v2.a;
								...
								if (!_v7.b.$) {
									if (!_v7.a.$) {
										...
										return $elm$core$Maybe$Just(
											{
												x: function () {
													var _v8 = incomingPlayback.x;
													if (!_v8.$) {
														return incomingPlayback.x;
													} else {
														return existingPlayback.x;
													}
												}(),
												r: function () {
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{
							z: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animKey, mergedConfig, anim.z),
							W: A3(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ck: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b6: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cV: height, R: width};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.b1);
	});
...
var $author$project$Anim$Internal$Builder$getSizeCssUnitAxes = F2(
	function (animGroupName, builder) {
		...
		return A2(
			$author$project$Anim$Internal$Unit$mergeBaselineUnits,
			$elm$core$Maybe$Just(
				$author$project$Anim$Internal$Builder$getScopedDefaults(builder).Y),
			A3(
				$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
				animGroupName,
				{ap: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, aq: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, ar: ''},
...
var $author$project$Anim$Internal$Builder$registerSizeInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.aL, slots, builder);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				ck: A2(distanceFn, startVal, newEnd),
				m: newEnd,
...
var $author$project$Animation$Sub$ButtonHovers$Main$scaleButton = 'scaleButton';
var $author$project$Animation$Sub$ButtonHovers$Main$sizeButton = 'sizeButton';
var $author$project$Animation$Sub$ButtonHovers$Main$zButton = 'zButton';
var $author$project$Animation$Sub$ButtonHovers$Main$init = _Utils_Tuple2(
	{
		v: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$sizeButton, $author$project$Animation$Sub$ButtonHovers$Main$baseHeight, $author$project$Animation$Sub$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$scaleButton, $author$project$Animation$Sub$ButtonHovers$Main$baseHeight, $author$project$Animation$Sub$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$zButton, $author$project$Animation$Sub$ButtonHovers$Main$baseHeight, $author$project$Animation$Sub$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$ButtonHovers$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ct: oldTime, dp: request, dv: subs};
	});
...
var $author$project$Animation$Sub$ButtonHovers$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$ButtonHovers$Main$GotSubMsg, model.v);
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {E: groupConfig, cr: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {au: newEntry, aU: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								au: newEntry,
								aU: A2($elm$core$List$cons, existing.au, existing.aU)
							};
						}
					}();
					return _Utils_update(
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.B) {
					...
					var scaledDurationMs = ((prevDistance <= 0) || (prevDurationMs <= 0)) ? cfg.w : (nextDistance * (prevDurationMs / prevDistance));
	...
	function (iterationCount, directionConfig, maybeOrder, controlledAxes, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var hasAnimateTiming = A2(
			...
			function (prop) {
				...
				return (timing.w > 0) || (timing.t > 0);
			},
			$author$project$Anim$Internal$Builder$partitionByMode(adjustedProperties).a6);
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.s.as);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.E.cg);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.au, history.aU));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Builder$resolvePlayback = F3(
	function (globalIterations, globalDirection, maybePlayback) {
		if (maybePlayback.$ === 1) {
			return {x: globalDirection, r: globalIterations};
		} else {
			var playback = maybePlayback.a;
			return {
				x: A2($elm$core$Maybe$withDefault, globalDirection, playback.x),
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cV: hNormalized, c2: l * 100, dq: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cH: rgba_.cH, cU: rgba_.cU, dn: rgba_.dn};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cD: rgba_.cD, cV: hsla_.cV, c2: hsla_.c2, dq: hsla_.dq};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cV: hslaValue.cV, c2: hslaValue.c2, dq: hslaValue.dq};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cD: 1.0, cV: hslValue.cV, c2: hslValue.c2, dq: hslValue.dq};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cD: alpha_, cH: rgb_.cH, cU: rgb_.cU, dn: rgb_.dn};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cV: hslaValue.cV, c2: hslaValue.c2, dq: hslaValue.dq});
	return {cD: hslaValue.cD, cH: rgb_.cH, cU: rgb_.cU, dn: rgb_.dn};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cD: 1.0, cH: rgb_.cH, cU: rgb_.cU, dn: rgb_.dn};
	}
};
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.B || (timing.M <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.O - timing.cN);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.R, dimensions.cV);
};
	...
	function (_v0, build) {
		...
		var generateAnimGroup = F2(
			function (animGroupName, config) {
				var playback = A3($author$project$Anim$Internal$Builder$resolvePlayback, processed.r, processed.x, config.b);
				return A8(
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cn));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cn));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aa: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bR: $elm$core$Maybe$Just(easing_),
				bw: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Animation$Sub$ButtonHovers$Main$hoverDuration = 200;
var $author$project$Motion$Easing$CubicOut = {$: 11};
var $author$project$Animation$Sub$ButtonHovers$Main$hoverEasing = $author$project$Motion$Easing$CubicOut;
var $author$project$Animation$Sub$ButtonHovers$Main$hoverHeight = 20;
var $author$project$Animation$Sub$ButtonHovers$Main$hoverWidth = 60;
var $author$project$Anim$Property$Size$toHW = $author$project$Anim$Internal$Builder$Size$toHW;
var $author$project$Animation$Sub$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Sub$ButtonHovers$Main$hoverHeight, $author$project$Animation$Sub$ButtonHovers$Main$hoverWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Sub$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Sub$ButtonHovers$Main$hoverEasing),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						ck: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						ck: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Animation$Sub$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration($author$project$Animation$Sub$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Sub$ButtonHovers$Main$hoverEasing),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						ck: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
...
var $author$project$Animation$Sub$ButtonHovers$Main$unhoverEasing = $author$project$Motion$Easing$CubicIn;
var $author$project$Animation$Sub$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Scale$duration($author$project$Animation$Sub$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Sub$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Sub$ButtonHovers$Main$scaleUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Sub$ButtonHovers$Main$hoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Sub$ButtonHovers$Main$setDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Sub$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Translate$end))));
var $author$project$Animation$Sub$ButtonHovers$Main$shrinkSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Sub$ButtonHovers$Main$baseHeight, $author$project$Animation$Sub$ButtonHovers$Main$baseWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Sub$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Sub$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Size$end))));
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.s.as));
	});
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cN: anim.cN, O: anim.O, B: anim.B, M: anim.M};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cN: timing.cN, O: timing.O, B: timing.B, M: timing.M});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.B) {
				...
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cN);
				return _Utils_update(
					timing,
					{
						O: newElapsedMs,
						B: _Utils_cmp(animationElapsedMs, timing.M) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{aa: state.aa, Z: state.Z, J: _List_Nil, K: stillRunning},
				updatedGroups),
			_Utils_ap(
...
var $author$project$Animation$Sub$ButtonHovers$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.v);
				var animState = _v1.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					_Utils_update(
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Sub$ButtonHovers$Main$scaleUp))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Sub$ButtonHovers$Main$scaleDown))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Sub$ButtonHovers$Main$growSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
						...
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Sub$ButtonHovers$Main$shrinkSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$zButton),
									$author$project$Animation$Sub$ButtonHovers$Main$liftUp))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							v: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$ButtonHovers$Main$zButton),
									$author$project$Animation$Sub$ButtonHovers$Main$setDown))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$ButtonHovers$Main$ScaleHover = {$: 1};
var $author$project$Animation$Sub$ButtonHovers$Main$ScaleUnhover = {$: 2};
var $author$project$Animation$Sub$ButtonHovers$Main$SizeHover = {$: 3};
var $author$project$Animation$Sub$ButtonHovers$Main$SizeUnhover = {$: 4};
var $author$project$Animation$Sub$ButtonHovers$Main$ZHover = {$: 5};
var $author$project$Animation$Sub$ButtonHovers$Main$ZUnhover = {$: 6};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b$: '', b2: '', b3: '', b8: ''};
						...
						[
							...
							A2(
								...
								_Utils_ap(
									...
									$author$project$Anim$Internal$Unit$toCssSuffix(units.ap)))) : $elm$core$Maybe$Nothing,
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {cu: true, cy: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {ef: contactDetails, eT: isPrimary, fb: pointer, fc: pointerId, fd: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cW: height, fe: pressure, fT: tiltX, fU: tiltY, dB: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d6: button, ea: clientPos, eV: keys, e1: offsetPos, e9: pagePos, fl: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dR: alt, eh: ctrl, eZ: meta, fr: shift};
	});
...
var $author$project$Animation$Sub$ButtonHovers$Main$button = F5(
	function (label, hoverMsg, unhoverMsg, groupName, animState) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2($author$project$Anim$Engine$Sub$attributes, groupName, animState),
				_List_fromArray(
					[
...
var $author$project$Animation$Sub$ButtonHovers$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Scale', $author$project$Animation$Sub$ButtonHovers$Main$ScaleHover, $author$project$Animation$Sub$ButtonHovers$Main$ScaleUnhover, $author$project$Animation$Sub$ButtonHovers$Main$scaleButton, model.v),
						A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Size', $author$project$Animation$Sub$ButtonHovers$Main$SizeHover, $author$project$Animation$Sub$ButtonHovers$Main$SizeUnhover, $author$project$Animation$Sub$ButtonHovers$Main$sizeButton, model.v),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Translate Z', $author$project$Animation$Sub$ButtonHovers$Main$ZHover, $author$project$Animation$Sub$ButtonHovers$Main$ZUnhover, $author$project$Animation$Sub$ButtonHovers$Main$zButton, model.v)
							]))
					]))
			]));
};
var $author$project$Animation$Sub$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$ButtonHovers$Main$init;
		},
		fC: $author$project$Animation$Sub$ButtonHovers$Main$subscriptions,
		f0: $author$project$Animation$Sub$ButtonHovers$Main$update,
		f1: $author$project$Animation$Sub$ButtonHovers$Main$view
	});
_Platform_export({'Animation':{'Sub':{'ButtonHovers':{'Main':{'init':$author$project$Animation$Sub$ButtonHovers$Main$main(
