		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{E: nodeList, y: (len / $elm$core$Array$branchFactor) | 0, D: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cR: fragment, cY: host, df: path, dh: port_, dk: protocol, dl: query};
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {z: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bB: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b7: $elm$core$Set$empty, ax: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {x: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bn: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bH: $elm$core$Maybe$Nothing, g: false, b3: $elm$core$Maybe$Nothing, by: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b0: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {x: 0, bk: $author$project$Anim$Internal$Engine$Sub$Animations$init, cg: 0, ch: $elm$core$Dict$empty, ci: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bc: 0, o: $author$project$Anim$Extra$TransformOrder$default, cA: ''};
...
var $author$project$Anim$Internal$Property$Size$default = {cU: 0, Q: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cG: rgba_.cG, cT: rgba_.cT, dm: rgba_.dm};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cU: hsla_.cU, c1: hsla_.c1, dp: hsla_.dp});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cG: $elm$core$Basics$round(rgba_.ce * 255),
				cT: $elm$core$Basics$round(rgba_.cl * 255),
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cU: record.cV, Q: record.dA};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cV: dimensions.cU, dA: dimensions.Q};
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				return _Utils_update(
					config,
					{
						cj: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bw: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cj: 0, bQ: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, b5: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cU: height, Q: width};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.b0);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cj: A2(distanceFn, startVal, newEnd),
				m: newEnd,
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cs: oldTime, $7: request, du: subs};
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {F: groupConfig, cq: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.az);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aD: newEntry, a9: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aD: newEntry,
								a9: A2($elm$core$List$cons, existing.aD, existing.a9)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							u: _Utils_update(
								state,
								{
									az: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.az)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cU: hNormalized, c1: l * 100, dp: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cG: rgba_.cG, cT: rgba_.cT, dm: rgba_.dm};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cC: rgba_.cC, cU: hsla_.cU, c1: hsla_.c1, dp: hsla_.dp};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cU: hslaValue.cU, c1: hslaValue.c1, dp: hslaValue.dp};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cC: 1.0, cU: hslValue.cU, c1: hslValue.c1, dp: hslValue.dp};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cC: alpha_, cG: rgb_.cG, cT: rgb_.cT, dm: rgb_.dm};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cU: hslaValue.cU, c1: hslaValue.c1, dp: hslaValue.dp});
	return {cC: hslaValue.cC, cG: rgb_.cG, cT: rgb_.cT, dm: rgb_.dm};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cC: 1.0, cG: rgb_.cG, cT: rgb_.cT, dm: rgb_.dm};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var b = $elm$core$Basics$round(startRgb.cG + ((endRgb.cG - startRgb.cG) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cG: b, cT: g, dm: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var b = $elm$core$Basics$round(startRgba.cG + ((endRgba.cG - startRgba.cG) * t));
							var a = startRgba.cC + ((endRgba.cC - startRgba.cC) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var a = startHsla.cC + ((endHsla.cC - startHsla.cC) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.B || (timing.L <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.N - timing.cM);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.cU);
};
...
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cm));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cm));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				_: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cj: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bw: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cj: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cj: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bw: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.az));
	});
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cM: anim.cM, N: anim.N, B: anim.B, L: anim.L};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cM: timing.cM, N: timing.N, B: timing.B, L: timing.L});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.B) {
				...
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cM);
				return _Utils_update(
					timing,
					{
						N: newElapsedMs,
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {ct: true, cx: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cV: height, fd: pressure, fS: tiltX, fT: tiltY, dA: width};
	});
...
var $author$project$Animation$Sub$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$ButtonHovers$Main$subscriptions,
		f$: $author$project$Animation$Sub$ButtonHovers$Main$update,
		f0: $author$project$Animation$Sub$ButtonHovers$Main$view
	});
