...
{
	if (region.bx.bp === region.m.bp)
	{
		return 'on line ' + region.bx.bp;
	}
	return 'on lines ' + region.bx.bp + ' through ' + region.m.bp;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cU: fragment, c_: host, dh: path, dj: port_, dm: protocol, dn: query};
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bC: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ab: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, av: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, b9: $elm$core$Set$empty, ay: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bo: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bI: $elm$core$Maybe$Nothing, g: false, b5: $elm$core$Maybe$Nothing, bz: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aA: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bl: $author$project$Anim$Internal$Engine$Sub$Animations$init, cj: 0, ck: $elm$core$Dict$empty, cl: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bd: 0, o: $author$project$Anim$Extra$TransformOrder$default, cD: ''};
...
var $author$project$Anim$Internal$Property$Size$default = {cX: 0, Q: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dr / 100;
	var l = hslValue.c3 / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cX / 60, 2) - 1));
	var _v0 = (hslValue.cX < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cX < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cX < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cX < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cX < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cJ: rgba_.cJ, cW: rgba_.cW, $7: rgba_.$7};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cX: hsla_.cX, c3: hsla_.c3, dr: hsla_.dr});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cJ: $elm$core$Basics$round(rgba_.ch * 255),
				cW: $elm$core$Basics$round(rgba_.co * 255),
				$7: $elm$core$Basics$round(rgba_.cx * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.$7 - rgb1.$7;
		var dg = rgb2.cW - rgb1.cW;
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.E;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bx);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bS: 0,
					bw: $author$project$Motion$Internal$Spring$unwrap(s),
					b8: 1
				});
		} else {
			return rawDuration;
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Rotate$default, ae: $author$project$Anim$Internal$Property$Rotate$distance, af: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Rotate$speed, ap: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Scale$default, ae: $author$project$Anim$Internal$Property$Scale$distance, af: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Scale$speed, ap: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Skew$default, ae: $author$project$Anim$Internal$Property$Skew$distance, af: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Skew$speed, ap: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
	...
	function (isComplete, propertyConfig) {
		...
		var build = F2(
			function (_default, config) {
				var resolvedStart = A2($elm$core$Maybe$withDefault, _default, config.bx);
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bx);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, clampedStart);
				return _Utils_update(
					config,
					{
						cm: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.b2);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bx: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bx: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bx);
		return _Utils_update(
			config,
			{
				cm: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bx: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cm: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cm: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bx);
		return A4(
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cv: oldTime, dq: request, dw: subs};
	});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				bl: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.bl)
			});
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {E: groupConfig, ct: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aE: newEntry, ba: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aE: newEntry,
								ba: A2($elm$core$List$cons, existing.aE, existing.ba)
							};
						}
					}();
					return _Utils_update(
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.A) {
					...
					var prevDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, prev.bx, prev.m);
					var nextStart = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, cfg.bx);
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cX: hNormalized, c3: l * 100, dr: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cJ: rgba_.cJ, cW: rgba_.cW, $7: rgba_.$7};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cF: rgba_.cF, cX: hsla_.cX, c3: hsla_.c3, dr: hsla_.dr};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cX: hslaValue.cX, c3: hslaValue.c3, dr: hslaValue.dr};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cF: 1.0, cX: hslValue.cX, c3: hslValue.c3, dr: hslValue.dr};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cF: alpha_, cJ: rgb_.cJ, cW: rgb_.cW, $7: rgb_.$7};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cX: hslaValue.cX, c3: hslaValue.c3, dr: hslaValue.dr});
	return {cF: hslaValue.cF, cJ: rgb_.cJ, cW: rgb_.cW, $7: rgb_.$7};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cF: 1.0, cJ: rgb_.cJ, cW: rgb_.cW, $7: rgb_.$7};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cW + ((endRgb.cW - startRgb.cW) * t));
							var r = $elm$core$Basics$round(startRgb.$7 + ((endRgb.$7 - startRgb.$7) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.$7 + ((endRgba.$7 - startRgba.$7) * t));
							var g = $elm$core$Basics$round(startRgba.cW + ((endRgba.cW - startRgba.cW) * t));
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dr + ((endHsl.dr - startHsl.dr) * t);
							var l = startHsl.c3 + ((endHsl.c3 - startHsl.c3) * t);
							var h = startHsl.cX + ((endHsl.cX - startHsl.cX) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dr + ((endHsla.dr - startHsla.dr) * t);
							var l = startHsla.c3 + ((endHsla.c3 - startHsla.c3) * t);
							var h = startHsla.cX + ((endHsla.cX - startHsla.cX) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.L <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.N - timing.cP);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.cX);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					ff: $author$project$Anim$Internal$Engine$Sub$extractAnimGroupCurrentStates(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cp));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cp));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aa: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						av: $elm$core$Maybe$Just(easingValue),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cm: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cm: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bx: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cP: anim.cP, N: anim.N, A: anim.A, L: anim.L};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cP: timing.cP, N: timing.N, A: timing.A, L: timing.L});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.A) {
				...
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cP);
				return _Utils_update(
					timing,
					{
						N: newElapsedMs,
			...
			return _List_fromArray(
				[
					...
					_Utils_ap(
						...
						$author$project$Anim$Internal$Unit$toCssSuffix(units.ar)))
				]);
		case 7:
			return _List_Nil;
		default:
...
var $author$project$Animation$Sub$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$TransformOrder$Main$subscriptions,
		f0: $author$project$Animation$Sub$TransformOrder$Main$update,
		f1: $author$project$Animation$Sub$TransformOrder$Main$view
	});
