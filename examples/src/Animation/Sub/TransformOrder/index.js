...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bh: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ab: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, b9: $elm$core$Set$empty, aB: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bI: $elm$core$Maybe$Nothing, g: false, b5: $elm$core$Maybe$Nothing, bA: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a_: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Property$Size$default = {cY: 0, Q: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cG: x0, cK: (v0 + ((zeta * omega0) * x0)) / omegaD, aj: omega0, bX: omegaD, bG: zeta});
		} else {
	...
	return wrapper(
		{
			...
			bR: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bR, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			P: config.P,
			dw: speed_,
			bx: resolvedSpring,
			...
			function (_default, config) {
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bR);
					}
				}();
				return {
					cQ: config.t,
					et: easingFn,
					N: snapped ? (durationMs + config.t) : 0.0,
					m: config.m,
					A: completeFlag,
					by: resolvedStart,
					L: durationMs
			...
			case 6:
				...
				return A2(
					...
					A2(
						...
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.Y, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				aa: $author$project$Anim$Internal$Builder$init(_List_Nil),
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aa: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cn: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.R);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.b2);
	});
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.L <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.N - timing.cQ);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.cY);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cQ: anim.cQ, N: anim.N, A: anim.A, L: anim.L};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cQ: timing.cQ, N: timing.N, A: timing.A, L: timing.L});
	});
		...
		function (timing) {
			if (timing.A) {
				...
				return _Utils_update(
					...
					{
						N: newElapsedMs,
						A: _Utils_cmp(animationElapsedMs, timing.L) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		var filteredEvents = A2(
			...
			function (e) {
				if (!e.$) {
					...
					return A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animGroupName, state.aa);
				} else {
					return true;
				}
			},
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{aa: state.aa, Z: state.Z, I: _List_Nil, J: stillRunning},
				updatedGroups),
			_Utils_ap(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							X: A2($elm$core$List$member, perm, model.X) ? model.X : A2($elm$core$List$cons, perm, model.X)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							K: A2(
								...
								A3(
									...
									$elm$core$Basics$identity,
									$author$project$Animation$Sub$TransformOrder$Main$allPermutations)),
							X: $author$project$Animation$Sub$TransformOrder$Main$allPermutations
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
		...
		switch (anim.$) {
			...
			case 4:
				...
				return _Utils_update(
					acc,
					{
						b0: $author$project$Anim$Internal$Property$Rotate$toCssString(
			...
			case 7:
				...
				return _Utils_update(
					acc,
					{
						b4: $author$project$Anim$Internal$Property$Skew$toCssString(
			...
			case 5:
				...
				return _Utils_update(
					acc,
					{
						b3: $author$project$Anim$Internal$Property$Scale$toCssString(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b0: '', b3: '', b4: '', ca: ''};
