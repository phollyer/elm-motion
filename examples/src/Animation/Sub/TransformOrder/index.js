...
{
	if (region.by.bq === region.m.bq)
	{
		return 'on line ' + region.by.bq;
	}
	return 'on lines ' + region.by.bq + ' through ' + region.m.bq;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cV: fragment, c$: host, di: path, dk: port_, dn: protocol, $7: query};
	});
...
var $author$project$Animation$Sub$TransformOrder$Main$RSkTS = 5;
var $author$project$Animation$Sub$TransformOrder$Main$RTSkS = 2;
var $author$project$Animation$Sub$TransformOrder$Main$STRSk = 4;
var $author$project$Animation$Sub$TransformOrder$Main$SkTRS = 3;
var $author$project$Animation$Sub$TransformOrder$Main$TRSkS = 0;
var $author$project$Animation$Sub$TransformOrder$Main$TSkRS = 1;
var $author$project$Animation$Sub$TransformOrder$Main$allPermutations = _List_fromArray(
	[0, 1, 2, 3, 4, 5]);
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bh: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Unit$emptyCssUnitAxes = {aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initDefaults = {L: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, Z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, bD: $elm$core$Set$empty, aB: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bp: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bJ: $elm$core$Maybe$Nothing, g: false, b6: $elm$core$Maybe$Nothing, bA: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a_: $elm$core$Dict$empty, b3: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bm: $author$project$Anim$Internal$Engine$Sub$Animations$init, cj: $elm$core$Dict$empty, ck: 0, cl: $elm$core$Dict$empty, cm: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bd: 0, o: $author$project$Anim$Extra$TransformOrder$default, cE: ''};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$default = {aq: 50, ar: 50};
var $author$project$Anim$Internal$Property$Rotate$Rotate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Rotate$default = {aq: 0, ar: 0, as: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {aq: 1.0, ar: 1.0, as: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cY: 0, R: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {aq: 0, ar: 0};
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {aq: 0, ar: 0, as: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cK: rgba_.cK, cX: rgba_.cX, dp: rgba_.dp};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cY: hsla_.cY, c4: hsla_.c4, ds: hsla_.ds});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cK: $elm$core$Basics$round(rgba_.ch * 255),
				cX: $elm$core$Basics$round(rgba_.cp * 255),
				dp: $elm$core$Basics$round(rgba_.cy * 255)
			};
	}
};
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		...
		var dz = $elm$core$Basics$abs(record2.as - record1.as);
		var dy = $elm$core$Basics$abs(record2.ar - record1.ar);
		var dx = $elm$core$Basics$abs(record2.aq - record1.aq);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	dI: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {aq: a.aq + b.aq, ar: a.ar + b.ar, as: a.as + b.as};
		}),
	...
	b4: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {aq: angles.aq * factor, ar: angles.ar * factor, as: angles.as * factor};
		}),
	fE: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	b4: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {aq: coords.aq * factor, ar: coords.ar * factor, as: coords.as * factor};
		}),
	fE: F2(
		function (_v3, _v4) {
			var a = _v3;
...
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.aq, values.ar);
};
...
var $author$project$Anim$Internal$Builder$perspectiveOriginStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			...
			animGroupName,
			{aq: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginX, ar: $author$project$Anim$Internal$Builder$CssUnitStore$perspectiveOriginY, as: ''},
			defaults.L);
	});
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bb;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.aW);
	var k = A2($elm$core$Basics$max, 0, spring.a0);
	var omega0 = $elm$core$Basics$sqrt(k / m);
	var c = A2($elm$core$Basics$max, 0, spring.aR);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.D;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.by);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bT: 0,
					bx: $author$project$Motion$Internal$Spring$unwrap(s),
					b9: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			...
			t: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.t, globalData.ax, 0),
			cn: distance_,
			v: $elm$core$Basics$round(duration_),
			bS: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bS, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			Q: config.Q,
			dw: speed_,
			bx: resolvedSpring,
...
var $author$project$Anim$Internal$Builder$sizeStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{aq: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, ar: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, as: ''},
			defaults.L);
	});
...
var $author$project$Anim$Internal$Builder$translateStoreAxes = F2(
	function (defaults, animGroupName) {
		return A3(
			$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
			animGroupName,
			{aq: $author$project$Anim$Internal$Builder$CssUnitStore$translateX, ar: $author$project$Anim$Internal$Builder$CssUnitStore$translateY, as: $author$project$Anim$Internal$Builder$CssUnitStore$translateZ},
			defaults.L);
	});
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.h,
							ag: globalData,
							an: $author$project$Shared$TimeSpec$speed,
							ap: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.h,
							ag: globalData,
							an: $author$project$Anim$Internal$Extra$Color$speed,
							ap: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.h,
							ag: globalData,
							an: $author$project$Anim$Internal$Property$Opacity$speed,
							ap: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.h,
							ag: globalData,
							an: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed,
							ap: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig
						}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Rotate$default, ae: $author$project$Anim$Internal$Property$Rotate$distance, af: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Rotate$speed, ap: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Scale$default, ae: $author$project$Anim$Internal$Property$Scale$distance, af: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Scale$speed, ap: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.Z,
							ag: globalData,
							an: $author$project$Anim$Internal$Property$Size$speed,
							ap: $author$project$Anim$Internal$Builder$ProcessedSizeConfig
						}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Skew$default, ae: $author$project$Anim$Internal$Property$Skew$distance, af: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, ag: globalData, an: $author$project$Anim$Internal$Property$Skew$speed, ap: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							h: globalData.h,
							ag: globalData,
							an: $author$project$Anim$Internal$Property$Translate$speed,
							ap: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig
						}));
		}
	});
	...
	function (isComplete, propertyConfig) {
		...
		var build = F2(
			function (_default, config) {
				var resolvedStart = A2($elm$core$Maybe$withDefault, _default, config.by);
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bS);
					}
				}();
				return {
					cQ: config.t,
					et: easingFn,
					O: snapped ? (durationMs + config.t) : 0.0,
					m: config.m,
					A: completeFlag,
					by: resolvedStart,
					M: durationMs
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				ab: $author$project$Anim$Internal$Builder$init(_List_Nil),
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ab: $author$project$Anim$Internal$Builder$clearAnimData(
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						L: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.L)
					});
			};
			var defs = data.c;
			var animation = data.a;
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						animation,
						{
							aQ: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, animation.aQ)
						}),
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.by);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, clampedStart);
				return _Utils_update(
					config,
					{
						cn: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						by: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cn: 0, bS: $elm$core$Maybe$Nothing, m: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, b8: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.S);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.b3);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								by: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								by: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.by);
		return _Utils_update(
			config,
			{
				cn: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				by: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cn: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						by: clampedStart
					});
			}
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						aq: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.aq : endRecord.aq,
						ar: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.ar : endRecord.ar,
						as: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.as : endRecord.as
					});
				return _Utils_update(
					config,
					{
						cn: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.by);
		return A4(
...
var $author$project$Animation$Sub$TransformOrder$Main$permutationKey = function (perm) {
	switch (perm) {
		case 0:
			return 't-r-sk-s';
		case 1:
...
var $author$project$Animation$Sub$TransformOrder$Main$init = _Utils_Tuple2(
	{
		K: $author$project$Anim$Engine$Sub$init(
			A2(
				$elm$core$List$concatMap,
				function (perm) {
					return _List_fromArray(
						[
							...
							A3(
								...
								$author$project$Animation$Sub$TransformOrder$Main$permutationKey(perm),
								0,
								0),
							A2(
								$elm$core$Basics$composeR,
				...
				$author$project$Animation$Sub$TransformOrder$Main$allPermutations)),
		Y: _List_Nil
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$TransformOrder$Main$GotSubMsg = function (a) {
	return {$: 4, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cw: oldTime, dr: request, dx: subs};
	});
...
var $author$project$Animation$Sub$TransformOrder$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$TransformOrder$Main$GotSubMsg, model.K);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				bm: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.bm)
			});
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {D: groupConfig, cu: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {av: newEntry, aV: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								av: newEntry,
								aV: A2($elm$core$List$cons, existing.av, existing.aV)
							};
						}
					}();
					return _Utils_update(
			...
			switch (_v0.$) {
				...
				case 1:
					return _Utils_update(
						acc,
						{
							bf: A2($elm$core$List$cons, prop, acc.bf)
						});
				default:
					return acc;
			}
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.A) {
					...
					var prevDurationMs = prev.M;
					var prevDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, prev.by, prev.m);
					var nextStart = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, cfg.by);
...
var $author$project$Anim$Internal$Engine$Sub$Generator$generateAnimation = F8(
	function (iterationCount, directionConfig, maybeOrder, controlledAxes, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var hasAnimateTiming = A2(
			...
			$author$project$Anim$Internal$Builder$partitionByMode(adjustedProperties).a7);
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.s.at);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.D.cj);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.av, history.aV));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cY: hNormalized, c4: l * 100, ds: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cK: rgba_.cK, cX: rgba_.cX, dp: rgba_.dp};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cG: rgba_.cG, cY: hsla_.cY, c4: hsla_.c4, ds: hsla_.ds};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cY: hslaValue.cY, c4: hslaValue.c4, ds: hslaValue.ds};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cG: 1.0, cY: hslValue.cY, c4: hslValue.c4, ds: hslValue.ds};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cG: alpha_, cK: rgb_.cK, cX: rgb_.cX, dp: rgb_.dp};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cY: hslaValue.cY, c4: hslaValue.c4, ds: hslaValue.ds});
	return {cG: hslaValue.cG, cK: rgb_.cK, cX: rgb_.cX, dp: rgb_.dp};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cG: 1.0, cK: rgb_.cK, cX: rgb_.cX, dp: rgb_.dp};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var b = $elm$core$Basics$round(startRgb.cK + ((endRgb.cK - startRgb.cK) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cK: b, cX: g, dp: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var b = $elm$core$Basics$round(startRgba.cK + ((endRgba.cK - startRgba.cK) * t));
							var a = startRgba.cG + ((endRgba.cG - startRgba.cG) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var l = startHsl.c4 + ((endHsl.c4 - startHsl.c4) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var l = startHsla.c4 + ((endHsla.c4 - startHsla.c4) * t);
							var h = startHsla.cY + ((endHsla.cY - startHsla.cY) * t);
							var a = startHsla.cG + ((endHsla.cG - startHsla.cG) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.M <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.O - timing.cQ);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.M);
	}
};
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		var easedProgress = anim.et(
			$author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress(anim));
		return A3(interpolate, easedProgress, anim.by, anim.m);
	});
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate = F3(
	function (t, start, end) {
		...
		var ex = _v1.a;
		var ey = _v1.b;
		return {aq: sx + ((ex - sx) * t), ar: sy + ((ey - sy) * t)};
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		...
		return _Utils_Tuple3(record.aq, record.ar, record.as);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.R, dimensions.cY);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					fg: $author$project$Anim$Internal$Engine$Sub$extractAnimGroupCurrentStates(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cq));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cq));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ab: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Engine$Sub$cssUnitX = $author$project$Anim$Internal$Builder$cssUnitX;
var $author$project$Anim$Internal$Unit$setCssUnitY = F2(
	function (unit, axes) {
		return _Utils_update(
			axes,
			{
				ar: $elm$core$Maybe$Just(unit)
			});
	});
...
var $author$project$Anim$Engine$Sub$cssUnitY = $author$project$Anim$Internal$Builder$cssUnitY;
...
var $author$project$Animation$Sub$TransformOrder$Main$permutationOrder = function (perm) {
	switch (perm) {
		case 0:
			return _List_fromArray(
				[0, 1, 2, 3]);
...
var $author$project$Anim$Internal$Engine$Sub$transformOrder = $author$project$Anim$Internal$Builder$transformOrder;
var $author$project$Anim$Engine$Sub$transformOrder = $author$project$Anim$Internal$Engine$Sub$transformOrder;
var $author$project$Animation$Sub$TransformOrder$Main$engineDefaults = function (perm) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Sub$for(
			$author$project$Animation$Sub$TransformOrder$Main$permutationKey(perm)),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Sub$transformOrder(
				$author$project$Animation$Sub$TransformOrder$Main$permutationOrder(perm)),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Sub$duration(2000),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$Sub$easing($author$project$Motion$Easing$EaseInOut),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$Sub$cssUnitX(8),
						$author$project$Anim$Engine$Sub$cssUnitY(4))))));
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cn: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						by: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cn: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						by: clampedStart
					});
			}
...
var $author$project$Animation$Sub$TransformOrder$Main$moveOut = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$TransformOrder$Main$reset = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.s.at));
	});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(group.bd);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cQ: anim.cQ, O: anim.O, A: anim.A, M: anim.M};
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(group.bd);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cQ: timing.cQ, O: timing.O, A: timing.A, M: timing.M});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.A) {
				...
				var newElapsedMs = timing.O + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.cQ);
				return _Utils_update(
					timing,
					{
						O: newElapsedMs,
						A: _Utils_cmp(animationElapsedMs, timing.M) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		var filteredEvents = A2(
			...
			function (e) {
				if (!e.$) {
					...
					return A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animGroupName, state.ab);
				} else {
					return true;
				}
			},
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{ab: state.ab, _: state._, I: _List_Nil, J: stillRunning},
				updatedGroups),
			_Utils_ap(
...
var $author$project$Animation$Sub$TransformOrder$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 4:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.K);
					...
					_Utils_update(
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Sub$TransformOrder$Main$engineDefaults(perm),
									$author$project$Animation$Sub$TransformOrder$Main$moveOut)),
							Y: A2($elm$core$List$member, perm, model.Y) ? model.Y : A2($elm$core$List$cons, perm, model.Y)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Sub$TransformOrder$Main$engineDefaults(perm),
									$author$project$Animation$Sub$TransformOrder$Main$reset)),
							Y: A2(
								$elm$core$List$filter,
									...
									F2(
										function (perm, acc) {
											return A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Sub$TransformOrder$Main$engineDefaults(perm),
												A2($elm$core$Basics$composeR, $author$project$Animation$Sub$TransformOrder$Main$moveOut, acc));
										}),
									$elm$core$Basics$identity,
									$author$project$Animation$Sub$TransformOrder$Main$allPermutations)),
							Y: $author$project$Animation$Sub$TransformOrder$Main$allPermutations
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
									...
									F2(
										function (perm, acc) {
											return A2(
												$elm$core$Basics$composeR,
												$author$project$Animation$Sub$TransformOrder$Main$engineDefaults(perm),
												A2($elm$core$Basics$composeR, $author$project$Animation$Sub$TransformOrder$Main$reset, acc));
										}),
									$elm$core$Basics$identity,
									model.Y)),
							Y: _List_Nil
...
var $author$project$Animation$Sub$TransformOrder$Main$AnimateAll = {$: 2};
var $author$project$Animation$Sub$TransformOrder$Main$ResetAll = {$: 3};
...
var $author$project$Animation$Sub$TransformOrder$Main$actionButton = F3(
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'rotateX(' + ($elm$core$String$fromFloat(angles.aq) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.ar)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.ar) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.as)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.as) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'skewX(' + ($elm$core$String$fromFloat(values.aq) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.ar)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.ar) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = F2(
	function (axes, _v0) {
		var coords = _v0;
		return 'translate3d(' + ($elm$core$String$fromFloat(coords.aq) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aq) + (', ' + ($elm$core$String$fromFloat(coords.ar) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.ar) + (', ' + ($elm$core$String$fromFloat(coords.as) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.as) + ')'))))))));
	});
		...
		switch (anim.$) {
			...
			case 4:
				...
				return _Utils_update(
					acc,
					{
						b1: $author$project$Anim$Internal$Property$Rotate$toCssString(
			...
			case 7:
				...
				return _Utils_update(
					acc,
					{
						b5: $author$project$Anim$Internal$Property$Skew$toCssString(
			...
			case 5:
				...
				return _Utils_update(
					acc,
					{
						b4: $author$project$Anim$Internal$Property$Scale$toCssString(
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isComplete = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(group.bd);
};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b1: '', b4: '', b5: '', ca: ''};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString = F2(
	function (axes, _v0) {
		var y = _v0.ar;
		var x = _v0.aq;
		return $elm$core$String$fromFloat(x) + ($author$project$Anim$Internal$Unit$toCssSuffix(axes.aq) + (' ' + ($elm$core$String$fromFloat(y) + $author$project$Anim$Internal$Unit$toCssSuffix(axes.ar))));
	});
						...
						[
							...
							A2(
								...
								_Utils_ap(
									...
									$author$project$Anim$Internal$Unit$toCssSuffix(units.aq)))) : $elm$core$Maybe$Nothing,
							...
							A2(
								...
								_Utils_ap(
									...
									$author$project$Anim$Internal$Unit$toCssSuffix(units.ar)))) : $elm$core$Maybe$Nothing
						]));
			case 7:
				return _List_Nil;
			default:
...
var $author$project$Animation$Sub$TransformOrder$Main$boxSize = 16;
var $author$project$Animation$Sub$TransformOrder$Main$boxSizeCss = $elm$core$String$fromFloat($author$project$Animation$Sub$TransformOrder$Main$boxSize) + 'cqmin';
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Animation$Sub$TransformOrder$Main$permutationColor = function (perm) {
	switch (perm) {
		case 0:
			return '59, 130, 246';
		case 1:
...
var $author$project$Animation$Sub$TransformOrder$Main$permutationLabel = function (perm) {
	switch (perm) {
		case 0:
			return 'T → R → Sk → S';
		case 1:
...
var $author$project$Animation$Sub$TransformOrder$Main$animatedBox = F2(
	function (animState, perm) {
		var rgb = $author$project$Animation$Sub$TransformOrder$Main$permutationColor(perm);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						A2(
							$author$project$Anim$Engine$Sub$attributes,
							$author$project$Animation$Sub$TransformOrder$Main$permutationKey(perm),
							animState),
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$Sub$TransformOrder$Main$boxSizeCss),
								A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$Sub$TransformOrder$Main$boxSizeCss),
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Animation$Sub$TransformOrder$Main$permutationLabel(perm))
						]))
				]));
	});
...
var $author$project$Animation$Sub$TransformOrder$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			$author$project$Animation$Sub$TransformOrder$Main$animatedBox(animState),
			$author$project$Animation$Sub$TransformOrder$Main$allPermutations));
};
var $author$project$Animation$Sub$TransformOrder$Main$Animate = function (a) {
	return {$: 0, a: a};
};
var $author$project$Animation$Sub$TransformOrder$Main$permButton = function (perm) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Animation$Sub$TransformOrder$Main$Animate(perm)),
				A2($elm$html$Html$Attributes$style, 'padding', '6px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2(
				$elm$html$Html$Attributes$style,
				'background-color',
				'rgb(' + ($author$project$Animation$Sub$TransformOrder$Main$permutationColor(perm) + ')')),
				A2($elm$html$Html$Attributes$style, 'color', 'white'),
				A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
				A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
				A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
...
var $author$project$Animation$Sub$TransformOrder$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Animation$Sub$TransformOrder$Main$permButton, $author$project$Animation$Sub$TransformOrder$Main$allPermutations)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A3($author$project$Animation$Sub$TransformOrder$Main$actionButton, '▶️ All', $author$project$Animation$Sub$TransformOrder$Main$AnimateAll, '#16a34a'),
						A3($author$project$Animation$Sub$TransformOrder$Main$actionButton, '⏮️ Reset All', $author$project$Animation$Sub$TransformOrder$Main$ResetAll, '#d97706')
					])),
				$author$project$Animation$Sub$TransformOrder$Main$animationArea(model.K)
			]));
};
var $author$project$Animation$Sub$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		eO: function (_v0) {
			return $author$project$Animation$Sub$TransformOrder$Main$init;
		},
		fD: $author$project$Animation$Sub$TransformOrder$Main$subscriptions,
		f1: $author$project$Animation$Sub$TransformOrder$Main$update,
		f2: $author$project$Animation$Sub$TransformOrder$Main$view
	});
_Platform_export({'Animation':{'Sub':{'TransformOrder':{'Main':{'init':$author$project$Animation$Sub$TransformOrder$Main$main(
