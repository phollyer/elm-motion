...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bB: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {_: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b9: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bH: $elm$core$Maybe$Nothing, g: false, b5: $elm$core$Maybe$Nothing, by: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bk: $author$project$Anim$Internal$Engine$Sub$Animations$init, cj: 0, ck: $elm$core$Dict$empty, cl: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bc: 0, o: $author$project$Anim$Extra$TransformOrder$default, cD: ''};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ah: omega0, bX: omegaD, bF: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bw);
		return A4(
...
var $author$project$Animation$Sub$Sequencing$Main$init = _Utils_Tuple2(
	{
		ay: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
...
var $author$project$Animation$Sub$Sequencing$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Sequencing$Main$GotSubMsg, model.ay);
};
...
var $author$project$Animation$Sub$Sequencing$Main$globalConfig = {s: 1000, bR: $author$project$Motion$Easing$BounceOut, dv: 50};
...
var $author$project$Animation$Sub$Sequencing$Main$rowOneConfig = {s: 0, bR: $author$project$Motion$Easing$BackOut, dv: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Sub$Sequencing$Main$rowThreeConfig = {s: 500, bR: $author$project$Motion$Easing$QuadInOut, dv: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Sub$Sequencing$Main$rowTwoConfig = {s: 250, bR: $author$project$Motion$Easing$ElasticOut, dv: 75};
...
var $author$project$Animation$Sub$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$Sequencing$Main$globalConfig.s),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Sub$speed($author$project$Animation$Sub$Sequencing$Main$globalConfig.dv),
			A2(
				$elm$core$Basics$composeR,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$Sequencing$Main$rowOneConfig.s),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Sub$speed($author$project$Animation$Sub$Sequencing$Main$rowOneConfig.dv),
								A2(
									$elm$core$Basics$composeR,
									...
									A2(
										...
										A2(
											...
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$Sequencing$Main$rowTwoConfig.s),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Sub$speed($author$project$Animation$Sub$Sequencing$Main$rowTwoConfig.dv),
													A2(
														$elm$core$Basics$composeR,
														...
														A2(
															...
															A2(
																...
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Sub$delay($author$project$Animation$Sub$Sequencing$Main$rowThreeConfig.s),
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$Sub$speed($author$project$Animation$Sub$Sequencing$Main$rowThreeConfig.dv),
																		A2(
																			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Sequencing$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var subMsg = msg.a;
			var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.ay);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$Sub$attributes, groupName, model.ay),
								_List_fromArray(
									[
...
var $author$project$Animation$Sub$Sequencing$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$Sequencing$Main$subscriptions,
		f0: $author$project$Animation$Sub$Sequencing$Main$update,
		f1: $author$project$Animation$Sub$Sequencing$Main$view
	});
