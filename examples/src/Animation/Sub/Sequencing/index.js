...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {_: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, av: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b9: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bH: $elm$core$Maybe$Nothing, g: false, b5: $elm$core$Maybe$Nothing, bz: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ar: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cG: x0, cK: (v0 + ((zeta * omega0) * x0)) / omegaD, ah: omega0, bX: omegaD, bF: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cn: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.Q);
	});
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.K <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.M - timing.cQ);
...
var $author$project$Animation$Sub$Sequencing$Main$globalConfig = {t: 1000, bR: $author$project$Motion$Easing$BounceOut, dw: 50};
...
var $author$project$Animation$Sub$Sequencing$Main$rowOneConfig = {t: 0, bR: $author$project$Motion$Easing$BackOut, dw: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Sub$Sequencing$Main$rowThreeConfig = {t: 500, bR: $author$project$Motion$Easing$QuadInOut, dw: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Sub$Sequencing$Main$rowTwoConfig = {t: 250, bR: $author$project$Motion$Easing$ElasticOut, dw: 75};
...
var $author$project$Animation$Sub$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$Sub$easing($author$project$Animation$Sub$Sequencing$Main$globalConfig.bR),
				A2(
					$elm$core$Basics$composeR,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$easing($author$project$Animation$Sub$Sequencing$Main$rowOneConfig.bR),
									A2(
										$elm$core$Basics$composeR,
										...
										A2(
											...
											A2(
												...
												A2(
													...
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$Sub$easing($author$project$Animation$Sub$Sequencing$Main$rowTwoConfig.bR),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$Sub$Sequencing$Main$moveTo(targetX),
															A2(
																...
																A2(
																	...
																	A2(
																		...
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Engine$Sub$easing($author$project$Animation$Sub$Sequencing$Main$rowThreeConfig.bR),
																			A2(
																				$elm$core$Basics$composeR,
																				$author$project$Animation$Sub$Sequencing$Main$moveTo(targetX),
																				A2(
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cQ: anim.cQ, M: anim.M, A: anim.A, K: anim.K};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cQ: timing.cQ, M: timing.M, A: timing.A, K: timing.K});
	});
