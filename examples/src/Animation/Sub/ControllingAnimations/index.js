		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{F: nodeList, x: (len / $elm$core$Array$branchFactor) | 0, D: tail});
			} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {A: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bx);
		return A4(
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.E.ci);
					}),
				$elm$core$Dict$empty,
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cP: anim.cP, O: anim.O, B: anim.B, M: anim.M};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cP: timing.cP, O: timing.O, B: timing.B, M: timing.M});
	});
...
var $author$project$Animation$Sub$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$ControllingAnimations$Main$subscriptions,
		f0: $author$project$Animation$Sub$ControllingAnimations$Main$update,
		f1: $author$project$Animation$Sub$ControllingAnimations$Main$view
	});
