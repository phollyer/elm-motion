...
var $author$project$Animation$Sub$Easings$Main$animGroup = 'easingBox';
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cG: x0, cK: (v0 + ((zeta * omega0) * x0)) / omegaD, ah: omega0, bY: omegaD, bH: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cn: 0, bS: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, b8: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.by);
		return A4(
...
var $author$project$Animation$Sub$Easings$Main$init = _Utils_Tuple2(
	{
		aB: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Easings$Main$animGroup, 0)
				])),
		bm: false,
		bS: $author$project$Motion$Easing$CubicOut
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$Easings$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$Easings$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Easings$Main$GotSubMsg, model.aB);
};
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bS: $elm$core$Maybe$Just(easing_),
				bx: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Animation$Sub$Easings$Main$animateTo = F2(
	function (x, easing) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Easings$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var subMsg = msg.a;
				...
				_Utils_update(
					model,
					{
						aB: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$Easings$Main$animGroup),
								A2($author$project$Animation$Sub$Easings$Main$animateTo, target, easing))),
						bm: !model.bm,
						bS: easing
					}),
				$elm$core$Platform$Cmd$none);
...
var $author$project$Animation$Sub$Easings$Main$Play = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Animation$Sub$Easings$Main$curveButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Animation$Sub$Easings$Main$Play(easing)),
...
var $author$project$Animation$Sub$Easings$Main$curves = _List_fromArray(
	[
...
var $author$project$Animation$Sub$Easings$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Sub$Easings$Main$curveButton(model.bS),
					$author$project$Animation$Sub$Easings$Main$curves)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Easings$Main$animGroup, model.aB),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$Easings$Main$main = $elm$browser$Browser$element(
	{
		eO: function (_v0) {
			return $author$project$Animation$Sub$Easings$Main$init;
		},
		fD: $author$project$Animation$Sub$Easings$Main$subscriptions,
		f1: $author$project$Animation$Sub$Easings$Main$update,
		f2: $author$project$Animation$Sub$Easings$Main$view
	});
_Platform_export({'Animation':{'Sub':{'Easings':{'Main':{'init':$author$project$Animation$Sub$Easings$Main$main(
