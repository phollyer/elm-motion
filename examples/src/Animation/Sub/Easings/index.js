...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bC: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Sub$Easings$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Easings$Main$GotSubMsg, model.ay);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Easings$Main$animGroup, model.ay),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$Easings$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$Easings$Main$subscriptions,
		f0: $author$project$Animation$Sub$Easings$Main$update,
		f1: $author$project$Animation$Sub$Easings$Main$view
	});
