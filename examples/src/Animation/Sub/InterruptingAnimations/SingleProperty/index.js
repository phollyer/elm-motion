...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cl: 0, bQ: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, b6: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cO: anim.cO, N: anim.N, A: anim.A, L: anim.L};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cO: timing.cO, N: timing.N, A: timing.A, L: timing.L});
	});
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$subscriptions,
		f$: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$update,
		f0: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$view
	});
