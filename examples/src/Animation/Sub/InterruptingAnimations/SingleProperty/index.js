...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName = 'movingBox';
...
var $author$project$Anim$Internal$Property$Size$default = {cX: 0, R: 0};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$init = _Utils_Tuple2(
	{
		K: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName,
					$author$project$Anim$Property$CustomColor$BackgroundColor,
					A3($author$project$Anim$Extra$Color$rgb, 118, 118, 118))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate, model.K);
};
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.M <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.O - timing.cP);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.R, dimensions.cX);
};
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor1 = $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color1));
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor2 = $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color2));
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor3 = $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color3));
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor4 = $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color4));
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cP: anim.cP, O: anim.O, A: anim.A, M: anim.M};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cP: timing.cP, O: timing.O, A: timing.A, M: timing.M});
	});
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animationMsg, model.K);
					...
					_Utils_update(
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor1))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor2))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor3))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor4))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color1 = {$: 1};
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color2 = {$: 2};
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color3 = {$: 3};
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color4 = {$: 4};
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$view = function (model) {
	var button = F3(
	...
	var color1Button = A3(button, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color1, 'Color 1', $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color1);
	var color2Button = A3(button, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color2, 'Color 2', $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color2);
	var color3Button = A3(button, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color3, 'Color 3', $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color3);
	var color4Button = A3(button, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$color4, 'Color 4', $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$Color4);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName, model.K),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$init;
		},
		fC: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$subscriptions,
		f0: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$update,
		f1: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$view
	});
_Platform_export({'Animation':{'Sub':{'InterruptingAnimations':{'SingleProperty':{'Main':{'init':$author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$main(
