...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct = 12;
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$centerXCqw = (100 - $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$centerYCqh = (100 - $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$init = _Utils_Tuple2(
	{
		K: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName, $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$centerXCqw, $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$centerYCqh),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$GotAnimationUpdate, model.K);
};
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$XLeft = 0;
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$XRight = 2;
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$YBottom = 2;
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$YTop = 0;
		...
		if (_v1.$ === 1) {
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{
							d: applyFreezeAxesToDict(anim.d)
						})
				});
		} else {
			var animGroupName = _v1.a;
			var baseFrozenAxes = A2(
				...
				A2(
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.y)));
			return A2(
				$author$project$Anim$Internal$Builder$updateCurrentConfig,
				{
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxX = function (x) {
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxY = function (y) {
	return $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(y));
};
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return (100 - $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
		default:
			return 100 - $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct;
	}
};
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetY = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
						...
						model,
						{
							K: A2(
								...
								A2(
									...
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName),
										$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxX(
											$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetX(0)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
							...
							K: A2(
								...
								A2(
									...
									A2(
										...
										$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName),
										$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxX(
											$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetX(2)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
							...
							K: A2(
								...
								A2(
									...
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName),
										$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxY(
											$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetY(0)))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
							...
							K: A2(
								...
								A2(
									...
									A2(
										...
										$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName),
										$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$moveBoxY(
											$author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$targetY(2)))))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$view = function (model) {
	...
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$animGroupName, model.K),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct) + 'cqw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$boxPct) + 'cqh'),
...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$init;
		},
		fC: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$subscriptions,
		f0: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$update,
		f1: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$view
	});
