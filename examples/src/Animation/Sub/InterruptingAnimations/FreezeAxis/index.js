...
var $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$subscriptions,
		f$: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$update,
		f0: $author$project$Animation$Sub$InterruptingAnimations$FreezeAxis$Main$view
	});
