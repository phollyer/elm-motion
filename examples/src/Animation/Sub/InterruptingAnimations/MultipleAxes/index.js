...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$subscriptions,
		f$: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$update,
		f0: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$view
	});
