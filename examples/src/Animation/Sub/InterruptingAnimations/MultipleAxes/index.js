...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName = 'movingBox';
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct = 12;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$centerXCqw = (100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$centerYCqh = (100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$init = _Utils_Tuple2(
	{
		K: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$centerXCqw, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$centerYCqh),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate, model.K);
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$XLeft = 0;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$XRight = 2;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$YBottom = 2;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$YTop = 0;
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetSpeed = 25;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$speed($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetSpeed),
				A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxX = function (x) {
	return $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxY = function (y) {
	return $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(y));
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return (100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
		default:
			return 100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct;
	}
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetY = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
					...
					_Utils_update(
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetX(0))))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetX(2))))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetY(0))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							K: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$targetY(2))))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveDown = {$: 4};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveLeft = {$: 1};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveRight = {$: 2};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveUp = {$: 3};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	var button = F3(
	...
	var moveDownButton = A3(button, '#FFC107', 'Move Down', $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveDown);
	var moveLeftButton = A3(button, '#007BFF', 'Move Left', $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveLeft);
	var moveRightButton = A3(button, '#28A745', 'Move Right', $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveRight);
	var moveUpButton = A3(button, '#6F42C1', 'Move Up', $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$MoveUp);
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName, model.K),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqh'),
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$init;
		},
		fC: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$subscriptions,
		f0: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$update,
		f1: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$view
	});
_Platform_export({'Animation':{'Sub':{'InterruptingAnimations':{'MultipleAxes':{'Main':{'init':$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$main(
