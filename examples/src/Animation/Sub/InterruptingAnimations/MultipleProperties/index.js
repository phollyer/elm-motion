...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b8: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bH: $elm$core$Maybe$Nothing, g: false, b4: $elm$core$Maybe$Nothing, bz: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b1: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Property$Size$default = {cX: 0, P: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, bW: omegaD, bF: zeta});
		} else {
		...
		var build = F2(
			function (_default, config) {
				...
				return {
					cP: config.t,
					es: easingFn,
					M: snapped ? (durationMs + config.t) : 0.0,
					m: config.m,
					A: completeFlag,
					bx: resolvedStart,
					K: durationMs
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cm: 0, bQ: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b6: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$init = _Utils_Tuple2(
	{
		Q: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate, model.Q);
};
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.A || (timing.K <= 0)) {
		...
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.M - timing.cP);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.P, dimensions.cX);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {cP: anim.cP, M: anim.M, A: anim.A, K: anim.K};
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{cP: timing.cP, M: timing.M, A: timing.A, K: timing.K});
	});
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{_: state._, Y: state.Y, I: _List_Nil, J: stillRunning},
				updatedGroups),
			_Utils_ap(
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animationMsg, model.Q);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.Q),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$Attributes$style,
