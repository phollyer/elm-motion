...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aE: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, b8: $elm$core$Set$empty, ax: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $elm$core$Dict$empty, b1: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cE: startAlpha, cI: rgb_.cI, cV: rgb_.cV, dn: rgb_.dn});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cE: startAlpha, cW: hsl_.cW, c2: hsl_.c2, dq: hsl_.dq});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bw: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					cl: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions,
		f$: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$update,
		f0: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$view
	});
