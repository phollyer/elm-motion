...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName = 'movingBox';
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct = 12;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$centerXCqw = (100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct) / 2;
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aP: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bg: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {K: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aG: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing, bC: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b2: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bl: $author$project$Anim$Internal$Engine$Sub$Animations$init, ci: $elm$core$Dict$empty, cj: 0, ck: $elm$core$Dict$empty, cl: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bc: 0, o: $author$project$Anim$Extra$TransformOrder$default, cD: ''};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cJ: $elm$core$Basics$round(rgba_.cg * 255),
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Rotate$default, ad: $author$project$Anim$Internal$Property$Rotate$distance, ae: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Rotate$speed, ao: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Scale$default, ad: $author$project$Anim$Internal$Property$Scale$distance, ae: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Scale$speed, ao: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Skew$default, ad: $author$project$Anim$Internal$Property$Skew$distance, ae: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, af: globalData, am: $author$project$Anim$Internal$Property$Skew$speed, ao: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cm: 0, bR: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bw: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, b7: $elm$core$Maybe$Nothing};
};
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cF: startAlpha, cJ: rgb_.cJ, cW: rgb_.cW, $7: rgb_.$7});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cF: startAlpha, cX: hsl_.cX, c3: hsl_.c3, dr: hsl_.dr});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bx: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					cm: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
					m: colorWithPreservedAlpha,
					bx: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						K: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.K)
					});
			};
			var defs = data.c;
			var animation = data.a;
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bx);
		return A4(
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$init = _Utils_Tuple2(
	{
		R: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$centerXCqw),
					$author$project$Anim$Property$Translate$initCssUnitX(8)),
					A3(
					$author$project$Anim$Property$CustomColor$init,
					$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName,
					$author$project$Anim$Property$CustomColor$BackgroundColor,
					A3($author$project$Anim$Extra$Color$rgb, 118, 118, 118))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate, model.R);
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$XLeft = 0;
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$XRight = 2;
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {D: groupConfig, ct: kind};
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.D.ci);
					}),
				$elm$core$Dict$empty,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$changeColor = function (color) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBoxX = function (x) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$centerXCqw;
		default:
			return 100 - $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct;
	}
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animationMsg, model.R);
					...
					_Utils_update(
						model,
						{
							R: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$targetX(0))))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
						...
						model,
						{
							R: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
										$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$targetX(2))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var color = msg.a;
						...
						model,
						{
							R: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName),
									$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$changeColor(color)))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$ChangeColor = function (a) {
	return {$: 3, a: a};
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$MoveLeft = {$: 1};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$MoveRight = {$: 2};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b0: '', b3: '', b4: '', b9: ''};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxHalfPct = $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct / 2;
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$view = function (model) {
	var posButton = F3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(posButton, '#333', 'Move Left', $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$MoveLeft),
						A3(posButton, '#333', 'Move Right', $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$MoveRight)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(colorButton, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color1, 'Color 1'),
						A2(colorButton, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color2, 'Color 2'),
						A2(colorButton, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color3, 'Color 3'),
						A2(colorButton, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$color4, 'Color 4')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.R),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$Attributes$style,
									'width',
									$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
									A2(
									$elm$html$Html$Attributes$style,
									'height',
									$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
									...
									$elm$html$Html$Attributes$style,
									'top',
									'calc(50% - ' + ($elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxHalfPct) + 'cqw)')),
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$init;
		},
		fC: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions,
		f0: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$update,
		f1: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$view
	});
_Platform_export({'Animation':{'Sub':{'InterruptingAnimations':{'MultipleProperties':{'Main':{'init':$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$main(
