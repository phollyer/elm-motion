...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bD: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aF: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, ca: $elm$core$Set$empty, ax: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aZ: $elm$core$Dict$empty, b3: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bm: $author$project$Anim$Internal$Engine$Sub$Animations$init, ck: 0, cl: $elm$core$Dict$empty, cm: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bd: 0, o: $author$project$Anim$Extra$TransformOrder$default, cD: ''};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cJ: $elm$core$Basics$round(rgba_.ci * 255),
				cW: $elm$core$Basics$round(rgba_.cp * 255),
				$7: $elm$core$Basics$round(rgba_.cy * 255)
			};
	}
};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cF: x0, cJ: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, bY: omegaD, bH: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cn: 0, bS: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, b8: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.b3);
	});
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cw: oldTime, dq: request, dw: subs};
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {E: groupConfig, cu: kind};
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				bS: $elm$core$Maybe$Nothing,
				bx: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Motion$Spring$custom = function (_v0) {
	...
	return {
		...
		bb: 0,
		aV: A2($elm$core$Basics$max, 1.0e-6, mass),
		a$: A2($elm$core$Basics$max, 0, stiffness)
	};
};
...
var $author$project$Animation$Sub$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var target = model.aB ? 0 : 420;
				var stiffness = A2($author$project$Animation$Sub$Springs$Main$parseWithMin, 1, model.a$);
				var mass = A2($author$project$Animation$Sub$Springs$Main$parseWithMin, 0.1, model.aV);
				...
				var spring = $author$project$Motion$Spring$custom(
					{aR: damping, aV: mass, a$: stiffness});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							aV: $elm$core$String$fromFloat(mass),
							be: 'custom',
							a$: $elm$core$String$fromFloat(stiffness)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var str = msg.a;
...
var $author$project$Animation$Sub$Springs$Main$customControls = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$Animation$Sub$Springs$Main$numberInput, 'Stiffness', '1', model.a$, $author$project$Animation$Sub$Springs$Main$SetStiffness),
				...
				A4($author$project$Animation$Sub$Springs$Main$numberInput, 'Mass', '0.1', model.aV, $author$project$Animation$Sub$Springs$Main$SetMass),
				A2(
...
var $author$project$Motion$Spring$gentle = {aR: 14, bb: 0, aV: 1, a$: 120};
var $author$project$Motion$Spring$noWobble = {aR: 26, bb: 0, aV: 1, a$: 170};
var $author$project$Motion$Spring$slow = {aR: 18, bb: 0, aV: 1, a$: 60};
var $author$project$Motion$Spring$stiff = {aR: 20, bb: 0, aV: 1, a$: 300};
var $author$project$Motion$Spring$wobbly = {aR: 12, bb: 0, aV: 1, a$: 180};
...
var $author$project$Animation$Sub$Springs$Main$main = $elm$browser$Browser$element(
	{
		...
		fC: $author$project$Animation$Sub$Springs$Main$subscriptions,
		f0: $author$project$Animation$Sub$Springs$Main$update,
		f1: $author$project$Animation$Sub$Springs$Main$view
	});
