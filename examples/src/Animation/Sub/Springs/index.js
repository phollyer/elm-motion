...
{
	if (region.bz.br === region.m.br)
	{
		return 'on line ' + region.bz.br;
	}
	return 'on lines ' + region.bz.br + ' through ' + region.m.br;
}
...
var $author$project$Animation$Sub$Springs$Main$animGroup = 'springBox';
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bi: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {K: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, X: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, bE: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bq: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bK: $elm$core$Maybe$Nothing, g: false, b7: $elm$core$Maybe$Nothing, bB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a_: $elm$core$Dict$empty, b4: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {w: 0, bn: $author$project$Anim$Internal$Engine$Sub$Animations$init, ck: $elm$core$Dict$empty, cl: 0, cm: $elm$core$Dict$empty, cn: $elm$core$Dict$empty, r: $author$project$Anim$Internal$Builder$Once, bd: 0, o: $author$project$Anim$Extra$TransformOrder$default, cE: ''};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cK: $elm$core$Basics$round(rgba_.ci * 255),
				cX: $elm$core$Basics$round(rgba_.cq * 255),
				dp: $elm$core$Basics$round(rgba_.cz * 255)
			};
	}
};
	...
	return wrapper(
		{
			...
			bT: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bT, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			m: config.m,
			P: config.P,
			dw: speed_,
			by: resolvedSpring,
	...
	function (isComplete, propertyConfig) {
		...
		var build = F2(
			function (_default, config) {
				var resolvedStart = A2($elm$core$Maybe$withDefault, _default, config.bz);
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bT);
					}
				}();
				return {
					cQ: config.t,
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						co: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bz: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						co: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, co: 0, bT: $elm$core$Maybe$Nothing, m: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, b9: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.b4);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				co: A2(distanceFn, startVal, newEnd),
				m: newEnd,
...
var $author$project$Animation$Sub$Springs$Main$init = _Utils_Tuple2(
	{
		Z: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Springs$Main$animGroup, 0)
				])),
		aD: false,
		aR: '14',
		aW: '1',
...
var $author$project$Animation$Sub$Springs$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {cx: oldTime, dr: request, dx: subs};
	});
...
var $author$project$Animation$Sub$Springs$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Springs$Main$GotSubMsg, model.Z);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				bn: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.bn)
			});
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {D: groupConfig, cv: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {au: newEntry, aV: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								au: newEntry,
								aV: A2($elm$core$List$cons, existing.au, existing.aV)
							};
						}
					}();
					return _Utils_update(
			...
			switch (_v0.$) {
				...
				case 1:
					return _Utils_update(
						acc,
						{
							bg: A2($elm$core$List$cons, prop, acc.bg)
						});
				default:
					return acc;
			}
		...
		if ((!_v0.a.$) && (_v0.b.$ === 2)) {
			...
			if ((!_v1.$) && (_v1.a.$ === 2)) {
				...
				if (prev.A) {
					...
					var prevDistance = A2($author$project$Anim$Internal$Property$Opacity$distance, prev.bz, prev.m);
					var nextStart = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, cfg.bz);
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.D.ck);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.au, history.aV));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		...
		return A3(interpolate, easedProgress, anim.bz, anim.m);
	});
...
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var nextAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cr));
		var runAndStartedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.cr));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aa: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				bT: $elm$core$Maybe$Nothing,
				by: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Animation$Sub$Springs$Main$animateTo = F2(
	function (x, spring) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Motion$Spring$custom = function (_v0) {
	var mass = _v0.aW;
	var damping = _v0.aR;
	var stiffness = _v0.a0;
	return {
		aR: A2($elm$core$Basics$max, 0, damping),
		bb: 0,
		aW: A2($elm$core$Basics$max, 1.0e-6, mass),
		a0: A2($elm$core$Basics$max, 0, stiffness)
	};
};
var $author$project$Anim$Engine$Sub$for = $author$project$Anim$Internal$Builder$for;
var $elm$core$String$fromFloat = _String_fromNumber;
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Animation$Sub$Springs$Main$parseWithMin = F2(
...
var $author$project$Animation$Sub$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
					...
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$Springs$Main$animGroup),
									A2($author$project$Animation$Sub$Springs$Main$animateTo, target, spring))),
							aD: !model.aD,
							be: label
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				var target = model.aD ? 0 : 420;
				var stiffness = A2($author$project$Animation$Sub$Springs$Main$parseWithMin, 1, model.a0);
				var mass = A2($author$project$Animation$Sub$Springs$Main$parseWithMin, 0.1, model.aW);
				var damping = A2($author$project$Animation$Sub$Springs$Main$parseWithMin, 0, model.aR);
				var spring = $author$project$Motion$Spring$custom(
					{aR: damping, aW: mass, a0: stiffness});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									...
									A2($author$project$Animation$Sub$Springs$Main$animateTo, target, spring))),
							aD: !model.aD,
							aR: $elm$core$String$fromFloat(damping),
							aW: $elm$core$String$fromFloat(mass),
							be: 'custom',
							a0: $elm$core$String$fromFloat(stiffness)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var str = msg.a;
		...
		switch (anim.$) {
			...
			case 4:
				...
				return _Utils_update(
					acc,
					{
						b2: $author$project$Anim$Internal$Property$Rotate$toCssString(
			...
			case 7:
				...
				return _Utils_update(
					acc,
					{
						b6: $author$project$Anim$Internal$Property$Skew$toCssString(
			...
			case 5:
				...
				return _Utils_update(
					acc,
					{
						b5: $author$project$Anim$Internal$Property$Scale$toCssString(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b2: '', b5: '', b6: '', cb: ''};
...
var $author$project$Animation$Sub$Springs$Main$PlayCustom = {$: 2};
var $author$project$Animation$Sub$Springs$Main$SetDamping = function (a) {
	return {$: 4, a: a};
};
var $author$project$Animation$Sub$Springs$Main$SetMass = function (a) {
	return {$: 5, a: a};
};
var $author$project$Animation$Sub$Springs$Main$SetStiffness = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Animation$Sub$Springs$Main$numberInput = F4(
...
var $author$project$Animation$Sub$Springs$Main$customControls = function (model) {
	var playVariant = (model.be === 'custom') ? 'primary' : 'purple';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A4($author$project$Animation$Sub$Springs$Main$numberInput, 'Stiffness', '1', model.a0, $author$project$Animation$Sub$Springs$Main$SetStiffness),
				A4($author$project$Animation$Sub$Springs$Main$numberInput, 'Damping', '1', model.aR, $author$project$Animation$Sub$Springs$Main$SetDamping),
				A4($author$project$Animation$Sub$Springs$Main$numberInput, 'Mass', '0.1', model.aW, $author$project$Animation$Sub$Springs$Main$SetMass),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Animation$Sub$Springs$Main$PlayCustom),
...
var $author$project$Animation$Sub$Springs$Main$Play = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Animation$Sub$Springs$Main$presetButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Animation$Sub$Springs$Main$Play, label, spring)),
...
var $author$project$Motion$Spring$gentle = {aR: 14, bb: 0, aW: 1, a0: 120};
var $author$project$Motion$Spring$noWobble = {aR: 26, bb: 0, aW: 1, a0: 170};
var $author$project$Motion$Spring$slow = {aR: 18, bb: 0, aW: 1, a0: 60};
var $author$project$Motion$Spring$stiff = {aR: 20, bb: 0, aW: 1, a0: 300};
var $author$project$Motion$Spring$wobbly = {aR: 12, bb: 0, aW: 1, a0: 180};
var $author$project$Animation$Sub$Springs$Main$presets = _List_fromArray(
	[
...
var $author$project$Animation$Sub$Springs$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Sub$Springs$Main$presetButton(model.be),
					$author$project$Animation$Sub$Springs$Main$presets)),
				$author$project$Animation$Sub$Springs$Main$customControls(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Springs$Main$animGroup, model.Z),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$Springs$Main$main = $elm$browser$Browser$element(
	{
		eO: function (_v0) {
			return $author$project$Animation$Sub$Springs$Main$init;
		},
		fD: $author$project$Animation$Sub$Springs$Main$subscriptions,
		f1: $author$project$Animation$Sub$Springs$Main$update,
		f2: $author$project$Animation$Sub$Springs$Main$view
	});
_Platform_export({'Animation':{'Sub':{'Springs':{'Main':{'init':$author$project$Animation$Sub$Springs$Main$main(
