...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aQ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, U: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bi: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aw: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, W: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aM: $elm$core$Maybe$Nothing, ca: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bJ: $elm$core$Maybe$Nothing, g: false, b6: $elm$core$Maybe$Nothing, bB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {as: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a_: $elm$core$Dict$empty, b3: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cG: x0, cK: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, bY: omegaD, bH: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, co: 0, bS: $elm$core$Maybe$Nothing, m: defaultEnd, O: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, b8: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Sub$Springs$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Springs$Main$GotSubMsg, model.Y);
};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {b1: '', b4: '', b5: '', cb: ''};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Springs$Main$animGroup, model.Y),
							_List_fromArray(
								[
