...
var $author$project$Animation$Sub$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$BorderColor$Main$GotSubMsg, model.Y);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$BorderColor$Main$animGroup, model.Y),
							_List_fromArray(
								[
