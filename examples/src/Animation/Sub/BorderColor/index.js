...
var $author$project$Animation$Sub$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		fB: $author$project$Animation$Sub$BorderColor$Main$subscriptions,
		f$: $author$project$Animation$Sub$BorderColor$Main$update,
		f0: $author$project$Animation$Sub$BorderColor$Main$view
	});
