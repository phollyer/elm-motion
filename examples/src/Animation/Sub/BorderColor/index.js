...
var $author$project$Animation$Sub$BorderColor$Main$animGroup = 'borderAnim';
...
var $author$project$Animation$Sub$BorderColor$Main$init = _Utils_Tuple2(
	{
		Z: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Sub$BorderColor$Main$animGroup,
					$author$project$Anim$Property$CustomColor$BorderColor,
					A3($author$project$Anim$Extra$Color$rgb, 99, 102, 241))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$Sub$BorderColor$Main$GotSubMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$Sub$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$BorderColor$Main$GotSubMsg, model.Z);
};
...
var $author$project$Animation$Sub$BorderColor$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$Sub$BorderColor$Main$standardTiming, $author$project$Anim$Property$CustomColor$end)));
var $author$project$Animation$Sub$BorderColor$Main$toRed = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$BorderColor$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
					...
					_Utils_update(
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$BorderColor$Main$animGroup),
									$author$project$Animation$Sub$BorderColor$Main$toRed))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							Z: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Sub$for($author$project$Animation$Sub$BorderColor$Main$animGroup),
									$author$project$Animation$Sub$BorderColor$Main$toBlue))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Sub$BorderColor$Main$TriggerBlue = {$: 2};
var $author$project$Animation$Sub$BorderColor$Main$TriggerRed = {$: 1};
...
var $author$project$Animation$Sub$BorderColor$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$BorderColor$Main$TriggerRed),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$Sub$BorderColor$Main$TriggerBlue),
								$elm$html$Html$Attributes$class('ui-action-button'),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$BorderColor$Main$animGroup, model.Z),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		eN: function (_v0) {
			return $author$project$Animation$Sub$BorderColor$Main$init;
		},
		fC: $author$project$Animation$Sub$BorderColor$Main$subscriptions,
		f0: $author$project$Animation$Sub$BorderColor$Main$update,
		f1: $author$project$Animation$Sub$BorderColor$Main$view
	});
_Platform_export({'Animation':{'Sub':{'BorderColor':{'Main':{'init':$author$project$Animation$Sub$BorderColor$Main$main(
