...
var $author$project$Animation$Transition$FadeInOut$Main$animGroup = 'fadeAnim';
...
var $author$project$Animation$Transition$FadeInOut$Main$init = _Utils_Tuple2(
	{
		aJ: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$FadeInOut$Main$animGroup, 0)
				]))
	},
...
var $author$project$Animation$Transition$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Transition$FadeInOut$Main$fadeIn = $author$project$Animation$Transition$FadeInOut$Main$fadeTo(1);
var $author$project$Animation$Transition$FadeInOut$Main$fadeOut = $author$project$Animation$Transition$FadeInOut$Main$fadeTo(0);
var $author$project$Anim$Engine$Transition$for = $author$project$Anim$Internal$Builder$for;
var $author$project$Animation$Transition$FadeInOut$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aJ: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$FadeInOut$Main$animGroup),
								$author$project$Animation$Transition$FadeInOut$Main$fadeIn))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
					...
					model,
					{
						aJ: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$FadeInOut$Main$animGroup),
								$author$project$Animation$Transition$FadeInOut$Main$fadeOut))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Transition$FadeInOut$Main$TriggerFadeIn = 0;
var $author$project$Animation$Transition$FadeInOut$Main$TriggerFadeOut = 1;
...
var $author$project$Animation$Transition$FadeInOut$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$FadeInOut$Main$animGroup, model.aJ),
					_List_fromArray(
						[
...
var $author$project$Animation$Transition$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$FadeInOut$Main$init;
		},
		fv: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fW: $author$project$Animation$Transition$FadeInOut$Main$update,
		fX: $author$project$Animation$Transition$FadeInOut$Main$view
	});
_Platform_export({'Animation':{'Transition':{'FadeInOut':{'Main':{'init':$author$project$Animation$Transition$FadeInOut$Main$main(
