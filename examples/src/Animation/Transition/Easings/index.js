...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aL: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {ap: $elm$core$Dict$empty, aO: $elm$core$Dict$empty, aE: 0, aX: $elm$core$Set$empty, br: _List_Nil, b$: 0, I: $author$project$Anim$Internal$Engine$CSS$Styles$empty, be: ''};
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ar: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, bw: $elm$core$Set$empty, av: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, N: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bX: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cz: x0, cD: (v0 + ((zeta * omega0) * x0)) / omegaD, ac: omega0, bQ: omegaD, bA: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bL: $elm$core$Maybe$Nothing, m: defaultEnd, L: $author$project$Anim$Internal$Builder$Animate, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, b1: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Transition$Easings$Main$init = _Utils_Tuple2(
	{
		...
		bj: false,
		bL: $author$project$Motion$Easing$CubicOut
	},
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var partialTranslateRenderedAsTransform = A2($elm$core$Set$member, 'translate', newGroup.aX) && ((!A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'translate', newGroup.I)) && A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transform', newGroup.I));
		...
		return {
			...
			aE: newGroup.aE,
			aX: A2($elm$core$Set$union, newGroup.aX, existingGroup.aX),
			br: newGroup.br,
			b$: existingGroup.b$ + 1,
			I: styles,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Transition$Easings$Main$curveButton(model.bL),
