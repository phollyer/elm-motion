...
{
	if (region.bq.bm === region.m.bm)
	{
		return 'on line ' + region.bq.bm;
	}
	return 'on lines ' + region.bq.bm + ' through ' + region.m.bm;
}
...
var $author$project$Animation$Transition$Easings$Main$animGroup = 'easingBox';
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aL: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bl: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bB: $elm$core$Maybe$Nothing, g: false, bZ: $elm$core$Maybe$Nothing, bt: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {ap: $elm$core$Dict$empty, aO: $elm$core$Dict$empty, aE: 0, a9: $elm$core$Set$empty, br: _List_Nil, b_: 0, S: $author$project$Anim$Internal$Engine$CSS$Styles$empty, be: ''};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var c = A2($elm$core$Basics$max, 0, spring.aM);
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cz: x0, cD: (v0 + ((zeta * omega0) * x0)) / omegaD, ac: omega0, bP: omegaD, bz: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.C;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bq);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bL: 0,
					bp: $author$project$Motion$Internal$Spring$unwrap(s),
					b1: 1
				});
		} else {
			return rawDuration;
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bq);
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, ce: 0, bK: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing};
};
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bq: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								m: baseline,
								bq: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bq);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bq);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bq);
		return _Utils_update(
			config,
			{
				ce: A2(distanceFn, startVal, newEnd),
				m: newEnd,
				bq: $elm$core$Maybe$Just(startVal)
			});
	});
...
var $author$project$Animation$Transition$Easings$Main$init = _Utils_Tuple2(
	{
		bi: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Transition$Easings$Main$animGroup, 0)
				])),
		bj: false,
		bK: $author$project$Motion$Easing$CubicOut
	},
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ao: newEntry, aR: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ao: newEntry,
								aR: A2($elm$core$List$cons, existing.ao, existing.aR)
							};
						}
					}();
					return _Utils_update(
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.ao, history.aR));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
	...
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var hasAnimateTiming = function (config) {
			return A2(
				...
				$author$project$Anim$Internal$Builder$partitionByMode(config.q).a3);
		};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var mergedDiscreteExit = newGroup.aO;
		...
		return {
			...
			aO: mergedDiscreteExit,
			aE: newGroup.aE,
			a9: A2($elm$core$Set$union, newGroup.a9, existingGroup.a9),
			br: newGroup.br,
...
var $author$project$Animation$Transition$Easings$Main$animateTo = F2(
	function (x, easing) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Transition$Easings$Main$update = F2(
	function (msg, model) {
		var easing = msg;
		var target = model.bj ? 0 : 420;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					bi: A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$Easings$Main$animGroup),
							A2($author$project$Animation$Transition$Easings$Main$animateTo, target, easing))),
					bj: !model.bj,
					bK: easing
				}),
			$elm$core$Platform$Cmd$none);
...
var $author$project$Animation$Transition$Easings$Main$Play = $elm$core$Basics$identity;
...
var $author$project$Animation$Transition$Easings$Main$curveButton = F2(
...
var $author$project$Animation$Transition$Easings$Main$curves = _List_fromArray(
	[
...
var $author$project$Animation$Transition$Easings$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$Transition$Easings$Main$curveButton(model.bK),
					$author$project$Animation$Transition$Easings$Main$curves)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$Easings$Main$animGroup, model.bi),
							_List_fromArray(
								[
...
var $author$project$Animation$Transition$Easings$Main$main = $elm$browser$Browser$element(
	{
		eI: function (_v0) {
			return $author$project$Animation$Transition$Easings$Main$init;
		},
		fw: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fX: $author$project$Animation$Transition$Easings$Main$update,
		fY: $author$project$Animation$Transition$Easings$Main$view
	});
_Platform_export({'Animation':{'Transition':{'Easings':{'Main':{'init':$author$project$Animation$Transition$Easings$Main$main(
