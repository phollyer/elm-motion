...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aL: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bv: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aV: $elm$core$Dict$empty, bW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {an: $elm$core$Dict$empty, aO: $elm$core$Dict$empty, aE: 0, a9: $elm$core$Set$empty, bq: _List_Nil, b_: 0, S: $author$project$Anim$Internal$Engine$CSS$Styles$empty, bd: ''};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.a7;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.aR);
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bK: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$Transition$Easings$Main$init = _Utils_Tuple2(
	{
		bh: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ay: newEntry, a6: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ay: newEntry,
								a6: A2($elm$core$List$cons, existing.ay, existing.a6)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		return {
			...
			S: styles,
			bd: A2($author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeWillChange, existingGroup.bd, newGroup.bd)
		};
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$Easings$Main$animGroup, model.bh),
							_List_fromArray(
								[
...
var $author$project$Animation$Transition$Easings$Main$main = $elm$browser$Browser$element(
	{
		...
		fW: $author$project$Animation$Transition$Easings$Main$update,
		fX: $author$project$Animation$Transition$Easings$Main$view
	});
