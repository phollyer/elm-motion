...
var $author$project$Animation$Transition$HelloText$Main$TriggerAnimation = 0;
var $author$project$Animation$Transition$HelloText$Main$dotOne = 'dotOne';
var $author$project$Animation$Transition$HelloText$Main$dotThree = 'dotThree';
var $author$project$Animation$Transition$HelloText$Main$dotTwo = 'dotTwo';
...
var $author$project$Animation$Transition$HelloText$Main$textLineOne = 'textLineOne';
var $author$project$Animation$Transition$HelloText$Main$textLineTwo = 'textLineTwo';
var $author$project$Animation$Transition$HelloText$Main$init = _Utils_Tuple2(
	{
		am: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$textLineOne, 0),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$dotOne, 0),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$dotTwo, 0),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$dotThree, 0),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$textLineTwo, 0)
				]))
	},
	A2(
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						as: $elm$core$Maybe$Just(ms)
					});
			},
			data);
	});
var $author$project$Anim$Engine$Transition$delay = $author$project$Anim$Internal$Builder$delay;
var $author$project$Animation$Transition$HelloText$Main$duration = 500;
...
var $author$project$Animation$Transition$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Opacity$duration($author$project$Animation$Transition$HelloText$Main$duration),
...
var $author$project$Animation$Transition$HelloText$Main$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					am: A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$HelloText$Main$textLineOne),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Animation$Transition$HelloText$Main$fadeIn,
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$HelloText$Main$dotOne),
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$HelloText$Main$duration),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Animation$Transition$HelloText$Main$fadeIn,
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$HelloText$Main$dotTwo),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$HelloText$Main$duration * 2),
													A2(
														$elm$core$Basics$composeR,
														$author$project$Animation$Transition$HelloText$Main$fadeIn,
														A2(
															$elm$core$Basics$composeR,
															$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$HelloText$Main$dotThree),
															A2(
																$elm$core$Basics$composeR,
																$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$HelloText$Main$duration * 3),
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Animation$Transition$HelloText$Main$fadeIn,
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$HelloText$Main$textLineTwo),
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$HelloText$Main$duration * 4),
																			$author$project$Animation$Transition$HelloText$Main$fadeIn))))))))))))))
				}),
...
var $author$project$Animation$Transition$HelloText$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$textLineOne, model.am),
							_List_Nil),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$dotOne, model.am),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$dotTwo, model.am),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$dotThree, model.am),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$textLineTwo, model.am),
					_List_fromArray(
						[
...
var $author$project$Animation$Transition$HelloText$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$HelloText$Main$init;
		},
		fv: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fW: $author$project$Animation$Transition$HelloText$Main$update,
		fX: $author$project$Animation$Transition$HelloText$Main$view
	});
_Platform_export({'Animation':{'Transition':{'HelloText':{'Main':{'init':$author$project$Animation$Transition$HelloText$Main$main(
