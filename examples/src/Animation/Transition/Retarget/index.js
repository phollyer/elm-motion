...
var $author$project$Animation$Transition$Retarget$Main$animGroup = 'square';
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, T: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, bv: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
...
var $author$project$Animation$Transition$Retarget$Main$init = _Utils_Tuple2(
	{
		am: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Transition$Retarget$Main$animGroup, 0, 0),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$Transition$Retarget$Main$boxSize = 12;
var $author$project$Animation$Transition$Retarget$Main$endXY = 100 - $author$project$Animation$Transition$Retarget$Main$boxSize;
var $author$project$Anim$Property$Translate$toXY = $author$project$Anim$Internal$Builder$Translate$toXY;
var $author$project$Animation$Transition$Retarget$Main$animateDiagonal = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, $author$project$Animation$Transition$Retarget$Main$endXY, $author$project$Animation$Transition$Retarget$Main$endXY),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedProperties = function (baseStyles) {
	return A2(
		...
		baseStyles,
		$author$project$Anim$Internal$Engine$Transition$Styles$extractTransformStyles($elm$core$Maybe$Nothing));
};
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.ap.C);
					}
				}(
					A2(
						$elm$core$Maybe$map,
						...
						$elm$core$List$head(
							A2(
								$elm$core$List$filter,
								isAnimate,
								A2($elm$core$List$cons, h.ap, h.aS)))));
			},
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.s.an));
	});
		...
		switch (prop.$) {
			case 0:
				...
				return A3(
					...
					cssName,
					unit,
					A3(transforms.cc, cssName, unit, config));
			case 1:
				var cssName = prop.a;
				var config = prop.b;
				return A2(
	...
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				t: 0,
				cd: 0,
				bK: $author$project$Motion$Easing$Linear,
				m: value,
				bp: $elm$core$Maybe$Just(value),
				b0: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			cn: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			co: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			bU: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bX: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			ct: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bY: toStartOr($author$project$Anim$Internal$Property$Skew$default),
			b2: toStartOr($author$project$Anim$Internal$Property$Translate$default)
		});
	return A3(
...
var $author$project$Anim$Internal$Engine$Transition$setStyles = function (styles) {
	return A2($author$project$Anim$Internal$Engine$Transition$AnimGroup$setStyles, styles, $author$project$Anim$Internal$Engine$Transition$AnimGroup$init);
};
var $author$project$Anim$Internal$Engine$Transition$reset = A3(
	$author$project$Anim$Internal$Engine$CSS$CSS$reset,
	$author$project$Anim$Internal$Engine$Transition$AnimGroup$setPlayState,
	function (maybeProcessedConfig) {
		if (!maybeProcessedConfig.$) {
			var processedConfig = maybeProcessedConfig.a;
			return $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedPropertiesWithControlledAxes(processedConfig.ca);
		} else {
			return $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedProperties;
		}
	},
	$author$project$Anim$Internal$Engine$Transition$setStyles);
var $author$project$Anim$Engine$Transition$reset = $author$project$Anim$Internal$Engine$Transition$reset;
...
var $author$project$Anim$Internal$Engine$CSS$CSS$retarget = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		var state = _v0.a;
		var animGroups = _v0.b;
		...
		return A2(
			...
			{
				V: $author$project$Anim$Internal$Builder$clearAnimData(
					A2($author$project$Anim$Internal$Builder$addRetargetToHistory, processedAnimData, builder))
			},
			setAllRunning(
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
				...
				A2(
					...
					A2(
						...
						A3(
							...
							'transition',
							'none',
							$author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles(group))),
					group));
		};
		var _v0 = A5($author$project$Anim$Internal$Engine$CSS$CSS$retarget, $author$project$Anim$Internal$Engine$Transition$AnimGroup$setPlayState, $author$project$Anim$Internal$Engine$Transition$generateAnimGroup, $author$project$Anim$Internal$Engine$Transition$insertAnimGroup, animState, build);
		var newState = _v0.a;
		var newGroups = _v0.b;
		var snappedGroups = A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			F3(
				function (name, _v1, acc) {
					var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, name, acc);
					if (!_v2.$) {
						var group = _v2.a;
						return A3(
							$author$project$Anim$Internal$Engine$Shared$AnimGroups$insert,
			...
			newGroups,
			touchedGroups);
		return A2($author$project$Anim$Internal$Engine$CSS$CSS$AnimState, newState, snappedGroups);
	});
var $author$project$Anim$Engine$Transition$retarget = $author$project$Anim$Internal$Engine$Transition$retarget;
...
var $author$project$Animation$Transition$Retarget$Main$retargetYToTop = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		$author$project$Anim$Property$Translate$end));
var $author$project$Animation$Transition$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$Retarget$Main$animGroup),
									$author$project$Animation$Transition$Retarget$Main$animateDiagonal))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							am: A2(
								$author$project$Anim$Engine$Transition$retarget,
								model.am,
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$Retarget$Main$animGroup),
									$author$project$Animation$Transition$Retarget$Main$retargetYToTop))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: A2($author$project$Anim$Engine$Transition$reset, $author$project$Animation$Transition$Retarget$Main$animGroup, model.am)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Transition$Retarget$Main$Animate = 0;
var $author$project$Animation$Transition$Retarget$Main$Reset = 2;
var $author$project$Animation$Transition$Retarget$Main$RetargetY = 1;
...
var $author$project$Animation$Transition$Retarget$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$Retarget$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							'width',
							$elm$core$String$fromFloat($author$project$Animation$Transition$Retarget$Main$boxSize) + 'cqw'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$Transition$Retarget$Main$boxSize) + 'cqh'),
...
var $author$project$Animation$Transition$Retarget$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Press Animate, then mid-flight press \u0022Retarget Y to 0\u0022. The Transition engine snaps Y to 0; X to it\u0027s end value.')
					])),
				$author$project$Animation$Transition$Retarget$Main$animationArea(model.am)
			]));
};
var $author$project$Animation$Transition$Retarget$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$Retarget$Main$init;
		},
		fv: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		fW: $author$project$Animation$Transition$Retarget$Main$update,
		fX: $author$project$Animation$Transition$Retarget$Main$view
	});
_Platform_export({'Animation':{'Transition':{'Retarget':{'Main':{'init':$author$project$Animation$Transition$Retarget$Main$main(
