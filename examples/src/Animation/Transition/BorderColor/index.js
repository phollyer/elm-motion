...
var $author$project$Animation$Transition$BorderColor$Main$animGroup = 'borderAnim';
...
var $author$project$Animation$Transition$BorderColor$Main$init = _Utils_Tuple2(
	{
		aJ: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					...
					$author$project$Animation$Transition$BorderColor$Main$animGroup,
...
var $author$project$Animation$Transition$BorderColor$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Transition$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$Transition$BorderColor$Main$standardTiming, $author$project$Anim$Property$CustomColor$end)));
var $author$project$Animation$Transition$BorderColor$Main$toRed = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$Transition$BorderColor$Main$standardTiming, $author$project$Anim$Property$CustomColor$end)));
var $author$project$Animation$Transition$BorderColor$Main$update = F2(
	function (msg, model) {
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aJ: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$BorderColor$Main$animGroup),
								$author$project$Animation$Transition$BorderColor$Main$toRed))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
					...
					model,
					{
						aJ: A2(
							...
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$BorderColor$Main$animGroup),
								$author$project$Animation$Transition$BorderColor$Main$toBlue))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Transition$BorderColor$Main$TriggerBlue = 1;
var $author$project$Animation$Transition$BorderColor$Main$TriggerRed = 0;
...
var $author$project$Animation$Transition$BorderColor$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$BorderColor$Main$animGroup, model.aJ),
							_List_fromArray(
								[
...
var $author$project$Animation$Transition$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$BorderColor$Main$init;
		},
		fv: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fW: $author$project$Animation$Transition$BorderColor$Main$update,
		fX: $author$project$Animation$Transition$BorderColor$Main$view
	});
_Platform_export({'Animation':{'Transition':{'BorderColor':{'Main':{'init':$author$project$Animation$Transition$BorderColor$Main$main(
