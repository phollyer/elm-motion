...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, ap: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, b2: $elm$core$Set$empty, as: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bA: $elm$core$Maybe$Nothing, g: false, bZ: $elm$core$Maybe$Nothing, br: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aD: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Transition$Generator$transitionRule = F2(
	function (cssName, cfg) {
		return cssName + (' ' + ($elm$core$String$fromInt(cfg.v) + ('ms ' + ($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction(cfg.bK) + (' ' + ($elm$core$String$fromInt(cfg.s) + 'ms'))))));
	});
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {an: $elm$core$Dict$empty, aP: $elm$core$Dict$empty, aE: 0, ba: $elm$core$Set$empty, bp: _List_Nil, b_: 0, S: $author$project$Anim$Internal$Engine$CSS$Styles$empty, be: ''};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cC: $elm$core$Basics$round(rgba_.b9 * 255),
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cy: x0, cC: (v0 + ((zeta * omega0) * x0)) / omegaD, ac: omega0, bP: omegaD, by: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cd: 0, bK: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.bW);
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					...
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.au);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ay: newEntry, a7: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ay: newEntry,
								a7: A2($elm$core$List$cons, existing.ay, existing.a7)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							u: _Utils_update(
								state,
								{
									au: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.au)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var mergedDiscreteEntry = A2($elm$core$Dict$union, newGroup.an, existingGroup.an);
...
var $author$project$Animation$Transition$Sequencing$Main$globalConfig = {s: 1000, bK: $author$project$Motion$Easing$BounceOut, $7: 50};
...
var $author$project$Animation$Transition$Sequencing$Main$rowOneConfig = {s: 0, bK: $author$project$Motion$Easing$BackOut, $7: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$Transition$Sequencing$Main$rowThreeConfig = {s: 500, bK: $author$project$Motion$Easing$QuadInOut, $7: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$Transition$Sequencing$Main$rowTwoConfig = {s: 250, bK: $author$project$Motion$Easing$ElasticOut, $7: 75};
...
var $author$project$Animation$Transition$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$Sequencing$Main$globalConfig.s),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$Transition$speed($author$project$Animation$Transition$Sequencing$Main$globalConfig.$7),
			A2(
				$elm$core$Basics$composeR,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$Sequencing$Main$rowOneConfig.s),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$Transition$speed($author$project$Animation$Transition$Sequencing$Main$rowOneConfig.$7),
								A2(
									$elm$core$Basics$composeR,
									...
									A2(
										...
										A2(
											...
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$Sequencing$Main$rowTwoConfig.s),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$Transition$speed($author$project$Animation$Transition$Sequencing$Main$rowTwoConfig.$7),
													A2(
														$elm$core$Basics$composeR,
														...
														A2(
															...
															A2(
																...
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$Transition$delay($author$project$Animation$Transition$Sequencing$Main$rowThreeConfig.s),
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$Transition$speed($author$project$Animation$Transition$Sequencing$Main$rowThreeConfig.$7),
																		A2(
																			$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.S, animGroup.an);
};
...
var $author$project$Animation$Transition$Sequencing$Main$main = $elm$browser$Browser$element(
	{
		...
		fW: $author$project$Animation$Transition$Sequencing$Main$update,
		fX: $author$project$Animation$Transition$Sequencing$Main$view
	});
