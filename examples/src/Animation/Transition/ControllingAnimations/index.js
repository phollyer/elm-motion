...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, b1: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bo);
		return A4(
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.az.D);
					}
				}(
					A2(
						$elm$core$Maybe$map,
						...
						$elm$core$List$head(
							A2(
								$elm$core$List$filter,
								isAnimate,
								A2($elm$core$List$cons, h.az, h.a7)))));
			},
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.av));
	});
		...
		switch (prop.$) {
			case 0:
				...
				return A3(
					...
					cssName,
					unit,
					A3(transforms.cb, cssName, unit, config));
			case 1:
				var cssName = prop.a;
				var config = prop.b;
				return A2(
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			cm: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			cn: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			...
			cs: toStartOr($author$project$Anim$Internal$Property$Size$default),
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					cm: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
...
var $author$project$Animation$Transition$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$Transition$ControllingAnimations$Main$update,
		fW: $author$project$Animation$Transition$ControllingAnimations$Main$view
	});
