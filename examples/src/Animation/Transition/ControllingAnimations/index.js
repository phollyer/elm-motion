...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, b1: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cy: x0, cC: (v0 + ((zeta * omega0) * x0)) / omegaD, ac: omega0, bO: omegaD, by: zeta});
		} else {
	...
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				t: 0,
				cd: 0,
				bJ: $author$project$Motion$Easing$Linear,
				m: value,
				bp: $elm$core$Maybe$Just(value),
				b$: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			bT: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bW: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			ct: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bX: toStartOr($author$project$Anim$Internal$Property$Skew$default),
...
var $author$project$Anim$Internal$Engine$Transition$reset = A3($author$project$Anim$Internal$Engine$CSS$CSS$reset, $author$project$Anim$Internal$Engine$Transition$AnimGroup$setPlayState, $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedProperties, $author$project$Anim$Internal$Engine$Transition$setStyles);
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					bT: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
...
var $author$project$Anim$Internal$Engine$Transition$stop = A4($author$project$Anim$Internal$Engine$CSS$CSS$stop, $author$project$Anim$Internal$Engine$Transition$AnimGroup$setPlayState, $author$project$Anim$Internal$Engine$Transition$AnimGroup$isActive, $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedProperties, $author$project$Anim$Internal$Engine$Transition$setStyles);
