...
var $author$project$Animation$Transition$ControllingAnimations$Main$animGroup = 'bouncingBall';
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bp);
		return A4(
...
var $author$project$Animation$Transition$ControllingAnimations$Main$init = _Utils_Tuple2(
	{
		am: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, 0),
...
var $author$project$Animation$Transition$ControllingAnimations$Main$ballSize = 12;
...
var $author$project$Animation$Transition$ControllingAnimations$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$toY(100 - $author$project$Animation$Transition$ControllingAnimations$Main$ballSize),
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$isActive = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isActive(animGroup.aF);
};
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					cn: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					co: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					...
					bX: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					ct: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					bY: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						}),
					b2: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.m;
						})
				});
...
var $author$project$Anim$Internal$Engine$Transition$stop = A4(
	$author$project$Anim$Internal$Engine$CSS$CSS$stop,
	$author$project$Anim$Internal$Engine$Transition$AnimGroup$setPlayState,
	$author$project$Anim$Internal$Engine$Transition$AnimGroup$isActive,
	function (maybeProcessedConfig) {
		if (!maybeProcessedConfig.$) {
			var processedConfig = maybeProcessedConfig.a;
			return $author$project$Anim$Internal$Engine$Transition$Styles$fromProcessedPropertiesWithControlledAxes(processedConfig.ca);
	...
	$author$project$Anim$Internal$Engine$Transition$setStyles);
var $author$project$Anim$Engine$Transition$stop = $author$project$Anim$Internal$Engine$Transition$stop;
var $author$project$Animation$Transition$ControllingAnimations$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ControllingAnimations$Main$animGroup),
									$author$project$Animation$Transition$ControllingAnimations$Main$dropBall))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: A2($author$project$Anim$Engine$Transition$stop, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, model.am)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: A2($author$project$Anim$Engine$Transition$reset, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, model.am)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Transition$ControllingAnimations$Main$Animate = 0;
var $author$project$Animation$Transition$ControllingAnimations$Main$Reset = 2;
var $author$project$Animation$Transition$ControllingAnimations$Main$Stop = 1;
...
var $author$project$Animation$Transition$ControllingAnimations$Main$ballSizeCqh = $elm$core$String$fromFloat($author$project$Animation$Transition$ControllingAnimations$Main$ballSize) + 'cqh';
...
var $author$project$Animation$Transition$ControllingAnimations$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							'left',
							'calc(50% - ' + ($elm$core$String$fromFloat($author$project$Animation$Transition$ControllingAnimations$Main$ballSize / 2) + 'cqh)')),
							A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$Transition$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$Transition$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'font-size', $author$project$Animation$Transition$ControllingAnimations$Main$ballSizeCqh),
							A2($elm$html$Html$Attributes$style, 'line-height', $author$project$Animation$Transition$ControllingAnimations$Main$ballSizeCqh)
						])),
				_List_fromArray(
					[
						$elm$html$Html$text('🏀')
...
var $author$project$Animation$Transition$ControllingAnimations$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Transition$ControllingAnimations$Main$animationArea(model.am)
			]));
};
var $author$project$Animation$Transition$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$ControllingAnimations$Main$init;
		},
		fv: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		fW: $author$project$Animation$Transition$ControllingAnimations$Main$update,
		fX: $author$project$Animation$Transition$ControllingAnimations$Main$view
	});
_Platform_export({'Animation':{'Transition':{'ControllingAnimations':{'Main':{'init':$author$project$Animation$Transition$ControllingAnimations$Main$main(
