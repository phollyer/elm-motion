...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, ap: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aH: $elm$core$Maybe$Nothing, b1: $elm$core$Set$empty, as: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {an: $elm$core$Dict$empty, aP: $elm$core$Dict$empty, aE: 0, ba: $elm$core$Set$empty, bp: _List_Nil, bZ: 0, S: $author$project$Anim$Internal$Engine$CSS$Styles$empty, be: ''};
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cc: $elm$core$Basics$abs(clampedEnd - startForDistance),
						m: clampedEnd,
						bo: clampedStart
					});
			}
	...
	function (endValue, _v0) {
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					cc: $elm$core$Basics$abs(endValue - startValue),
					m: endValue,
					bo: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Animation$Transition$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$Transition$BorderRadius$Main$update,
		fW: $author$project$Animation$Transition$BorderRadius$Main$view
	});
