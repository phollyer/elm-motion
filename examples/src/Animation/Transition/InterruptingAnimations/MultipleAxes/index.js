...
var $author$project$Animation$Transition$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$Transition$InterruptingAnimations$MultipleAxes$Main$update,
		fW: $author$project$Animation$Transition$InterruptingAnimations$MultipleAxes$Main$view
	});
