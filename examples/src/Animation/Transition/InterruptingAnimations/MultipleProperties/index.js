...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ez: 'hidden', d1: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ez: 'mozHidden', d1: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ez: 'msHidden', d1: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ez: 'webkitHidden', d1: 'webkitvisibilitychange' }
		: { ez: 'hidden', d1: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cL: fragment, cS: host, c9: path, db: port_, de: protocol, df: query};
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aM: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bu: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, b1: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {w: 0, e: $elm$core$Dict$empty, f: $elm$core$Dict$empty, bj: false, r: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bA: $elm$core$Maybe$Nothing, g: false, bY: $elm$core$Maybe$Nothing, br: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Internal$Engine$Transition$Generator$transitionRule = F2(
	function (cssName, cfg) {
		return cssName + (' ' + ($elm$core$String$fromInt(cfg.v) + ('ms ' + ($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction(cfg.bJ) + (' ' + ($elm$core$String$fromInt(cfg.s) + 'ms'))))));
	});
var $author$project$Anim$Internal$Engine$Transition$Generator$nonTransformTransitionFromProcessed = function (property) {
	switch (property.$) {
		case 0:
		...
		case 6:
			var config = property.a;
			return $elm$core$Maybe$Just(
				A2($author$project$Anim$Internal$Engine$Transition$Generator$transitionRule, 'width', config) + (', ' + A2($author$project$Anim$Internal$Engine$Transition$Generator$transitionRule, 'height', config)));
		case 7:
			return $elm$core$Maybe$Nothing;
		default:
			var config = property.a;
			...
			switch (_v0.$) {
				case 0:
					return _Utils_update(
						acc,
						{
							a3: A2($elm$core$List$cons, prop, acc.a3)
						});
				case 1:
					return _Utils_update(
						acc,
...
var $author$project$Anim$Internal$Engine$Transition$Generator$generate = F4(
	function (discreteTransitions, discreteEntry, discreteExit, properties) {
		...
		var animated = $author$project$Anim$Internal$Builder$partitionByMode(properties).a3;
		...
		if (allDurationsZero) {
			...
			var nonTransformTransitions = A2($elm$core$List$filterMap, $author$project$Anim$Internal$Engine$Transition$Generator$nonTransformTransitionFromProcessed, animated);
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.cO),
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {ao: $elm$core$Dict$empty, aP: $elm$core$Dict$empty, aF: 0, ba: $elm$core$Set$empty, bp: _List_Nil, bZ: 0, T: $author$project$Anim$Internal$Engine$CSS$Styles$empty, be: ''};
...
var $author$project$Anim$Internal$Property$Size$default = {cO: 0, K: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cB: rgba_.cB, cN: rgba_.cN, dg: rgba_.dg};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cO: hsla_.cO, cX: hsla_.cX, dj: hsla_.dj});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cB: $elm$core$Basics$round(rgba_.b8 * 255),
				cN: $elm$core$Basics$round(rgba_.ce * 255),
				dg: $elm$core$Basics$round(rgba_.cp * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dg - rgb1.dg;
		var dg = rgb2.cN - rgb1.cN;
		var db = rgb2.cB - rgb1.cB;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fP(coord2);
		var record1 = support.fP(coord1);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	ef: $author$project$Anim$Internal$Property$Rotate$default,
	ev: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var angles = _v2;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	ef: $author$project$Anim$Internal$Property$Scale$default,
	ev: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	ef: $author$project$Anim$Internal$Property$Translate$default,
	ev: $elm$core$Basics$identity,
	bW: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.a8;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.aS);
	var k = A2($elm$core$Basics$max, 0, spring.aY);
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cc: 0, bJ: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.bV);
	});
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cx: startAlpha, cB: rgb_.cB, cN: rgb_.cN, dg: rgb_.dg});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cx: startAlpha, cO: hsl_.cO, cX: hsl_.cX, dj: hsl_.dj});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bo: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					cc: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
					m: colorWithPreservedAlpha,
					bo: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$setTranslateInitCssUnitX = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.at),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cc: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cc: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bo);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cc: A2(distanceFn, startVal, newEnd),
				m: newEnd,
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {D: groupConfig, cj: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {az: newEntry, a7: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								az: newEntry,
								a7: A2($elm$core$List$cons, existing.az, existing.a7)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$CSS$CSS$animate = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var setAllRunning = function (groups) {
			return A2(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
				F2(
					function (_v1, group) {
						return A2(setPlayState, 1, group);
					}),
				groups);
		};
		...
		return A2(
			...
			setAllRunning(
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
					insertData(processedAnimData.cf),
					animGroups,
					A2(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
						F2(
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.K, dimensions.cO);
};
...
var $author$project$Anim$Internal$Engine$Transition$Generator$generateAnimation = F4(
	function (discreteTransitions, discreteEntry, discreteExit, processedProps) {
		return A2(
			$author$project$Anim$Internal$Engine$Transition$AnimGroup$setStyles,
			A2(
...
var $author$project$Anim$Internal$Engine$Transition$generateAnimGroup = F4(
	function (_v0, builder, animGroupName, _v1) {
		...
		var startingStylesForThisAnimate = $elm$core$Dict$isEmpty(freshEntry) ? _List_Nil : $author$project$Anim$Internal$Engine$Transition$extractStartingStyles(properties);
		return A2(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var mergedDiscreteEntry = A2($elm$core$Dict$union, newGroup.ao, existingGroup.ao);
		...
		return {
			...
			T: styles,
			be: A2($author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeWillChange, existingGroup.be, newGroup.be)
		};
	});
	...
	function (animMsg, animState) {
		switch (animMsg.$) {
			case 0:
				...
				var targetId = animMsg.b.fw;
				var currentTargetId = animMsg.b.eb;
				return _Utils_Tuple2(
					A3(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.T, animGroup.ao);
};
...
var $author$project$Anim$Internal$Engine$CSS$CSS$SourceEventData = F2(
	function (targetId, currentTargetId) {
		return {eb: currentTargetId, fw: targetId};
	});
...
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cx: alpha_, cB: rgb_.cB, cN: rgb_.cN, dg: rgb_.dg};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cO: hslaValue.cO, cX: hslaValue.cX, dj: hslaValue.dj});
	return {cx: hslaValue.cx, cB: rgb_.cB, cN: rgb_.cN, dg: rgb_.dg};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cx: 1.0, cB: rgb_.cB, cN: rgb_.cN, dg: rgb_.dg};
	}
};
...
var $author$project$Animation$Transition$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$Transition$InterruptingAnimations$MultipleProperties$Main$update,
		fW: $author$project$Animation$Transition$InterruptingAnimations$MultipleProperties$Main$view
	});
