...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aM: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bu: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Property$Size$default = {cO: 0, L: 0};
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Rotate$default, Z: $author$project$Anim$Internal$Property$Rotate$distance, _: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Rotate$speed, aj: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Scale$default, Z: $author$project$Anim$Internal$Property$Scale$distance, _: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Scale$speed, aj: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, X: $author$project$Anim$Internal$Unit$default, Y: $author$project$Anim$Internal$Property$Skew$default, Z: $author$project$Anim$Internal$Property$Skew$distance, _: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, aa: globalData, ah: $author$project$Anim$Internal$Property$Skew$speed, aj: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cO: record.cP, L: record.du};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cP: dimensions.cO, du: dimensions.L};
};
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				var clampValue = function (value) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							cP: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.cP),
							du: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.du)
						});
				};
				...
				return _Utils_update(
					config,
					{
						cc: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, s: $elm$core$Maybe$Nothing, cc: 0, bJ: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cO: height, L: width};
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {E: groupConfig, cj: kind};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cO);
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cc: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bo: clampedStart
					});
			}
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {co: true, ct: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {d8: contactDetails, eM: isPrimary, e4: pointer, e5: pointerId, e6: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cP: height, e7: pressure, fM: tiltX, fN: tiltY, du: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d$: button, d3: clientPos, eO: keys, eW: offsetPos, e2: pagePos, fe: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dK: alt, ea: ctrl, eS: meta, fk: shift};
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		fV: $author$project$Animation$Transition$ButtonHovers$Main$update,
		fW: $author$project$Animation$Transition$ButtonHovers$Main$view
	});
