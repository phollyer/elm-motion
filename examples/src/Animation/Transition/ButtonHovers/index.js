		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{E: nodeList, x: (len / $elm$core$Array$branchFactor) | 0, B: tail});
			} else {
...
var $author$project$Animation$Transition$ButtonHovers$Main$baseHeight = 15.8;
var $author$project$Animation$Transition$ButtonHovers$Main$baseWidth = 51;
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aM: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bd: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initState = {an: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $elm$core$Dict$empty, bV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Property$Size$default = {cP: 0, L: 0};
...
var $author$project$Anim$Internal$Builder$setSizeInitCssUnit = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.aI),
			_List_fromArray(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cP: record.cQ, L: record.dv};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cQ: dimensions.cP, dv: dimensions.L};
};
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				var clampValue = function (value) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							cQ: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.cQ),
							dv: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dv)
						});
				};
				...
				return _Utils_update(
					config,
					{
						cd: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bp: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cd: 0, bJ: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cP: height, L: width};
};
...
var $author$project$Anim$Internal$Builder$registerSizeInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.aI, slots, builder);
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$scaleButton = 'scaleButton';
var $author$project$Animation$Transition$ButtonHovers$Main$sizeButton = 'sizeButton';
var $author$project$Animation$Transition$ButtonHovers$Main$zButton = 'zButton';
var $author$project$Animation$Transition$ButtonHovers$Main$init = _Utils_Tuple2(
	{
		C: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$scaleButton, $author$project$Animation$Transition$ButtonHovers$Main$baseHeight, $author$project$Animation$Transition$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$sizeButton, $author$project$Animation$Transition$ButtonHovers$Main$baseHeight, $author$project$Animation$Transition$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$zButton, $author$project$Animation$Transition$ButtonHovers$Main$baseHeight, $author$project$Animation$Transition$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7))
				]))
	},
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.s;
					var newEntry = {D: groupConfig, ck: kind};
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.D.ca);
					}),
				$elm$core$Dict$empty,
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cP);
};
...
var $author$project$Animation$Transition$ButtonHovers$Main$hoverDuration = 200;
var $author$project$Motion$Easing$CubicOut = {$: 11};
var $author$project$Animation$Transition$ButtonHovers$Main$hoverEasing = $author$project$Motion$Easing$CubicOut;
var $author$project$Animation$Transition$ButtonHovers$Main$hoverHeight = 20;
var $author$project$Animation$Transition$ButtonHovers$Main$hoverWidth = 60;
var $author$project$Anim$Property$Size$toHW = $author$project$Anim$Internal$Builder$Size$toHW;
var $author$project$Animation$Transition$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Transition$ButtonHovers$Main$hoverHeight, $author$project$Animation$Transition$ButtonHovers$Main$hoverWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Transition$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Transition$ButtonHovers$Main$hoverEasing),
...
var $author$project$Animation$Transition$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration($author$project$Animation$Transition$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Transition$ButtonHovers$Main$hoverEasing),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cd: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bp: clampedStart
					});
			}
...
var $author$project$Animation$Transition$ButtonHovers$Main$unhoverEasing = $author$project$Motion$Easing$CubicIn;
var $author$project$Animation$Transition$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Scale$duration($author$project$Animation$Transition$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Transition$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Transition$ButtonHovers$Main$scaleUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$Transition$ButtonHovers$Main$hoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$Transition$ButtonHovers$Main$setDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$Transition$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Translate$end))));
var $author$project$Animation$Transition$ButtonHovers$Main$shrinkSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Transition$ButtonHovers$Main$baseHeight, $author$project$Animation$Transition$ButtonHovers$Main$baseWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Transition$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$Transition$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Size$end))));
var $author$project$Animation$Transition$ButtonHovers$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Transition$ButtonHovers$Main$scaleUp))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
						...
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$scaleButton),
									$author$project$Animation$Transition$ButtonHovers$Main$scaleDown))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Transition$ButtonHovers$Main$growSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
						...
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$sizeButton),
									$author$project$Animation$Transition$ButtonHovers$Main$shrinkSize))
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$zButton),
									$author$project$Animation$Transition$ButtonHovers$Main$liftUp))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
						...
						model,
						{
							C: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$Transition$for($author$project$Animation$Transition$ButtonHovers$Main$zButton),
									$author$project$Animation$Transition$ButtonHovers$Main$setDown))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Animation$Transition$ButtonHovers$Main$ScaleHover = 0;
var $author$project$Animation$Transition$ButtonHovers$Main$ScaleUnhover = 1;
var $author$project$Animation$Transition$ButtonHovers$Main$SizeHover = 2;
var $author$project$Animation$Transition$ButtonHovers$Main$SizeUnhover = 3;
var $author$project$Animation$Transition$ButtonHovers$Main$ZHover = 4;
var $author$project$Animation$Transition$ButtonHovers$Main$ZUnhover = 5;
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {cp: true, cu: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {d9: contactDetails, eN: isPrimary, e5: pointer, e6: pointerId, e7: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cQ: height, e8: pressure, fN: tiltX, fO: tiltY, dv: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {d0: button, d4: clientPos, eP: keys, eX: offsetPos, e3: pagePos, ff: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dL: alt, eb: ctrl, eT: meta, fl: shift};
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$button = F5(
	function (label, hoverMsg, unhoverMsg, groupName, animState) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2($author$project$Anim$Engine$Transition$attributes, groupName, animState),
				_List_fromArray(
					[
...
var $author$project$Animation$Transition$ButtonHovers$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Scale', 0, 1, $author$project$Animation$Transition$ButtonHovers$Main$scaleButton, model.C),
						A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Size', 2, 3, $author$project$Animation$Transition$ButtonHovers$Main$sizeButton, model.C),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Translate Z', 4, 5, $author$project$Animation$Transition$ButtonHovers$Main$zButton, model.C)
							]))
					]))
			]));
};
var $author$project$Animation$Transition$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		eH: function (_v0) {
			return $author$project$Animation$Transition$ButtonHovers$Main$init;
		},
		fv: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fW: $author$project$Animation$Transition$ButtonHovers$Main$update,
		fX: $author$project$Animation$Transition$ButtonHovers$Main$view
	});
_Platform_export({'Animation':{'Transition':{'ButtonHovers':{'Main':{'init':$author$project$Animation$Transition$ButtonHovers$Main$main(
