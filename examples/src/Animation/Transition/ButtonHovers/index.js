...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aM: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bd: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.N),
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {aq: $elm$core$Dict$empty, aP: $elm$core$Dict$empty, aF: 0, aY: $elm$core$Set$empty, bq: _List_Nil, b_: 0, J: $author$project$Anim$Internal$Engine$CSS$Styles$empty, bf: ''};
...
var $author$project$Anim$Internal$Builder$initDefaults = {I: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, U: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aB: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, bv: $elm$core$Set$empty, aw: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {an: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, O: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $elm$core$Dict$empty, bW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation.S)));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			O: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.O),
...
var $author$project$Anim$Internal$Property$Size$default = {cP: 0, N: 0};
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.S)));
	};
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cP: record.cQ, N: record.dv};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {cQ: dimensions.cP, dv: dimensions.N};
};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, cd: 0, bK: $elm$core$Maybe$Nothing, m: defaultEnd, M: $author$project$Anim$Internal$Builder$Animate, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cP: height, N: width};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.S));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.O);
	});
...
var $author$project$Anim$Internal$Builder$getSizeCssUnitAxes = F2(
	function (animGroupName, builder) {
		...
		return A2(
			$author$project$Anim$Internal$Unit$mergeBaselineUnits,
			$elm$core$Maybe$Just(
				$author$project$Anim$Internal$Builder$getScopedDefaults(builder).U),
			A3(
				$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
				animGroupName,
				{ak: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, al: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, am: ''},
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.N, dimensions.cP);
};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var partialTranslateRenderedAsTransform = A2($elm$core$Set$member, 'translate', newGroup.aY) && ((!A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'translate', newGroup.J)) && A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transform', newGroup.J));
		var oldTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', existingGroup.J));
		...
		var newTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', newGroup.J));
		...
		var newPropertyStyles = A2(
			...
			newGroup.J);
		var hasTransitionBehavior = A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', existingGroup.J) || A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', newGroup.J);
		var existingStyles = A2(
			...
			A2(
				$author$project$Anim$Internal$Engine$CSS$Styles$remove,
				'transition',
				partialTranslateRenderedAsTransform ? A2($author$project$Anim$Internal$Engine$CSS$Styles$remove, 'translate', existingGroup.J) : existingGroup.J));
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.J, animGroup.aq);
};
