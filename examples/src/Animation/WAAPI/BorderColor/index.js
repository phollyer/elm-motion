...
var $author$project$Animation$WAAPI$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$BorderColor$Main$GotWaapiMsg, model._);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$BorderColor$Main$animGroup, model._),
							_List_fromArray(
								[
