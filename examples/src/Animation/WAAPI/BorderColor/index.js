...
var $author$project$Animation$WAAPI$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$BorderColor$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$BorderColor$Main$update,
		gc: $author$project$Animation$WAAPI$BorderColor$Main$view
	});
