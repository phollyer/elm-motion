...
var $author$project$Animation$WAAPI$BorderColor$Main$animGroup = 'borderAnim';
...
var $author$project$Animation$WAAPI$BorderColor$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$BorderColor$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
...
var $author$project$Animation$WAAPI$BorderColor$Main$init = _Utils_Tuple2(
	{
		aa: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$BorderColor$Main$motionCmd,
			$author$project$Animation$WAAPI$BorderColor$Main$motionMsg,
			_List_fromArray(
				[
					A3(
					$author$project$Anim$Property$CustomColor$init,
					$author$project$Animation$WAAPI$BorderColor$Main$animGroup,
					$author$project$Anim$Property$CustomColor$BorderColor,
					A3($author$project$Anim$Extra$Color$rgb, 99, 102, 241))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$BorderColor$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$BorderColor$Main$GotWaapiMsg, model.aa);
};
...
var $author$project$Animation$WAAPI$BorderColor$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$BorderColor$Main$standardTiming, $author$project$Anim$Property$CustomColor$end)));
var $author$project$Animation$WAAPI$BorderColor$Main$toRed = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$CustomColor$begin($author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$BorderColor$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$BorderColor$Main$animGroup),
						$author$project$Animation$WAAPI$BorderColor$Main$toRed));
			...
			default:
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$BorderColor$Main$animGroup),
						$author$project$Animation$WAAPI$BorderColor$Main$toBlue));
...
var $author$project$Animation$WAAPI$BorderColor$Main$TriggerBlue = {$: 2};
var $author$project$Animation$WAAPI$BorderColor$Main$TriggerRed = {$: 1};
...
var $author$project$Animation$WAAPI$BorderColor$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$BorderColor$Main$TriggerRed),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$BorderColor$Main$TriggerBlue),
								$elm$html$Html$Attributes$class('ui-action-button'),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$BorderColor$Main$animGroup, model.aa),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$BorderColor$Main$init;
		},
		fO: $author$project$Animation$WAAPI$BorderColor$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$BorderColor$Main$update,
		gd: $author$project$Animation$WAAPI$BorderColor$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'BorderColor':{'Main':{'init':$author$project$Animation$WAAPI$BorderColor$Main$main(
