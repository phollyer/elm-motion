...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bp: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ac: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, ci: $elm$core$Set$empty, aE: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bN: $elm$core$Maybe$Nothing, h: false, cd: $elm$core$Maybe$Nothing, bD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ay: 0, ct: $elm$core$Dict$empty, cu: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fs: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a8: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c4: 0, R: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cP: x0, cT: (v0 + ((zeta * omega0) * x0)) / omegaD, ak: omega0, b2: omegaD, bK: zeta});
		} else {
	...
	return wrapper(
		{
			...
			bX: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bX, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			n: config.n,
			Q: config.Q,
			dH: speed_,
			bA: resolvedSpring,
			...
			return _Utils_update(
				data,
				{
					...
					c: _Utils_update(
						defs,
						{
							ac: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defs.ac)
						})
				});
		}
	});
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cv: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.S);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.ca);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.R, dimensions.c4);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bX, config.bA))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.W));
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aF: animGroupName, dc: isAnimating, X: progress, dx: propertyProgress, cG: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bM: animGroup, et: commandVersion, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bM: animGroup, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$ProgressApply$progressToT = F2(
	function (cfg, rawProgress) {
		...
		if (!_v0.$) {
			...
			return A2($author$project$Shared$Easing$toFunction, cfg.bX, rawProgress);
		}
	});
		...
		var updateStatus = F2(
			function (propType, propAnim) {
				...
				if (_v2.$ === 1) {
					...
					return _Utils_eq(currentVersion, propAnim.bI) ? _Utils_update(
						propAnim,
						{
							ce: animUpdate.dc ? 1 : 3
						}) : propAnim;
				}
			});
			...
			F2(
				function (propType, _v0) {
					...
					if ((!_v1.a.$) && (!_v1.b.$)) {
						...
						return _Utils_eq(incomingVersion, currentState.bI);
					} else {
						return false;
					}
				}),
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aF, animUpdate.X)) : $elm$core$Maybe$Nothing;
		...
		switch (msg.$) {
			...
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							N: newAnimState,
							Z: A2($elm$core$List$member, perm, model.Z) ? model.Z : A2($elm$core$List$cons, perm, model.Z)
						}),
					animCmd);
			case 1:
				var perm = msg.a;
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{N: finalState, Z: $author$project$Animation$WAAPI$TransformOrder$Main$allPermutations}),
					cmd);
			default:
				var _v5 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
