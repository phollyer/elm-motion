...
{
	if (region.bB.bx === region.n.bx)
	{
		return 'on line ' + region.bB.bx;
	}
	return 'on lines ' + region.bB.bx + ' through ' + region.n.bx;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eT: 'hidden', em: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eT: 'mozHidden', em: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eT: 'msHidden', em: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eT: 'webkitHidden', em: 'webkitvisibilitychange' }
		: { eT: 'hidden', em: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {c1: fragment, c8: host, ds: path, du: port_, dy: protocol, dz: query};
	});
...
var $author$project$Animation$WAAPI$TransformOrder$Main$RSkTS = 5;
var $author$project$Animation$WAAPI$TransformOrder$Main$RTSkS = 2;
var $author$project$Animation$WAAPI$TransformOrder$Main$STRSk = 4;
var $author$project$Animation$WAAPI$TransformOrder$Main$SkTRS = 3;
var $author$project$Animation$WAAPI$TransformOrder$Main$TRSkS = 0;
var $author$project$Animation$WAAPI$TransformOrder$Main$TSkRS = 1;
var $author$project$Animation$WAAPI$TransformOrder$Main$allPermutations = _List_fromArray(
	[0, 1, 2, 3, 4, 5]);
...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, X: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bp: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {O: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aA: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aa: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, bG: $elm$core$Set$empty, aE: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {A: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bv: false, t: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bO: $elm$core$Maybe$Nothing, h: false, ce: $elm$core$Maybe$Nothing, bD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, T: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, cb: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = function () {
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aE: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return A2(
		$elm$core$List$foldl,
		runInitEntry,
		{a: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: false, b: $author$project$Anim$Internal$Builder$initPlayback, o: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, u: $author$project$Anim$Internal$Builder$initState, j: 0});
}();
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ay: 0, ct: $elm$core$Dict$empty, cu: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, Y: 0, fs: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a8: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c4: 0, S: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dD / 100;
	var l = hslValue.de / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.c4 / 60, 2) - 1));
	var _v0 = (hslValue.c4 < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.c4 < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.c4 < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.c4 < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.c4 < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cT: rgba_.cT, c3: rgba_.c3, dA: rgba_.dA};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{c4: hsla_.c4, de: hsla_.de, dD: hsla_.dD});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cT: $elm$core$Basics$round(rgba_.cq * 255),
				c3: $elm$core$Basics$round(rgba_.cx * 255),
				dA: $elm$core$Basics$round(rgba_.cH * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dA - rgb1.dA;
		var dg = rgb2.c3 - rgb1.c3;
		var db = rgb2.cT - rgb1.cT;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.f7(coord2);
		var record1 = support.f7(coord1);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	eA: $author$project$Anim$Internal$Property$Rotate$default,
	eP: $elm$core$Basics$identity,
	cc: F2(
		function (factor, _v2) {
			var angles = _v2;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	eA: $author$project$Anim$Internal$Property$Scale$default,
	eP: $elm$core$Basics$identity,
	cc: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Size$distance = F2(
	function (_v0, _v1) {
		var start = _v0;
		var end = _v1;
		var dw = end.S - start.S;
		var dh = end.c4 - start.c4;
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	eA: $author$project$Anim$Internal$Property$Translate$default,
	eP: $elm$core$Basics$identity,
	cc: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bk;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.a2);
	var k = A2($elm$core$Basics$max, 0, spring.a9);
	var omega0 = $elm$core$Basics$sqrt(k / m);
	var c = A2($elm$core$Basics$max, 0, spring.aZ);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var wrapper = _v0.ar;
	var speedFn = _v0.ap;
	var durationFn = _v0.ag;
	var distanceFn = _v0.af;
	var defaultCssUnit = _v0.ad;
	var defaultStart = _v0.ae;
	var globalCssUnit = _v0.i;
	var globalData = _v0.ah;
	var config = _v0.G;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bB);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bZ: 0,
					bA: $author$project$Motion$Internal$Spring$unwrap(s),
					ci: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			D: A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, config.D, globalCssUnit, defaultCssUnit),
			w: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.w, globalData.aA, 0),
			cv: distance_,
			y: $elm$core$Basics$round(duration_),
			bY: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bY, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			n: config.n,
			R: config.R,
			dH: speed_,
			bA: resolvedSpring,
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			case 0:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							G: config,
							ad: $author$project$Anim$Internal$Unit$default,
							ae: 0,
							af: F2(
								function (a, b) {
									return $elm$core$Basics$abs(b - a);
								}),
							ag: $author$project$Shared$TimeSpec$duration,
							i: globalData.i,
							ah: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							G: config,
							ad: $author$project$Anim$Internal$Unit$default,
							ae: $author$project$Anim$Internal$Extra$Color$transparent,
							af: $author$project$Anim$Internal$Extra$Color$distance,
							ag: $author$project$Anim$Internal$Extra$Color$duration,
							i: globalData.i,
							ah: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							G: config,
							ad: $author$project$Anim$Internal$Unit$default,
							ae: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							af: $author$project$Anim$Internal$Property$Opacity$distance,
							ag: $author$project$Anim$Internal$Property$Opacity$duration,
							i: globalData.i,
							ah: globalData,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							ad: 28,
							ae: $author$project$Anim$Internal$Property$PerspectiveOrigin$default,
							af: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance,
							ag: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration,
							i: globalData.i,
							ah: globalData,
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ad: $author$project$Anim$Internal$Unit$default, ae: $author$project$Anim$Internal$Property$Rotate$default, af: $author$project$Anim$Internal$Property$Rotate$distance, ag: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, ah: globalData, ap: $author$project$Anim$Internal$Property$Rotate$speed, ar: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ad: $author$project$Anim$Internal$Unit$default, ae: $author$project$Anim$Internal$Property$Scale$default, af: $author$project$Anim$Internal$Property$Scale$distance, ag: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, ah: globalData, ap: $author$project$Anim$Internal$Property$Scale$speed, ar: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							G: mergeSize(config),
							ad: $author$project$Anim$Internal$Unit$default,
							ae: $author$project$Anim$Internal$Property$Size$default,
							af: $author$project$Anim$Internal$Property$Size$distance,
							ag: $author$project$Anim$Internal$Property$Size$duration,
							i: globalData.aa,
							ah: globalData,
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ad: $author$project$Anim$Internal$Unit$default, ae: $author$project$Anim$Internal$Property$Skew$default, af: $author$project$Anim$Internal$Property$Skew$distance, ag: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, ah: globalData, ap: $author$project$Anim$Internal$Property$Skew$speed, ar: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							ad: $author$project$Anim$Internal$Unit$default,
							ae: $author$project$Anim$Internal$Property$Translate$default,
							af: $author$project$Anim$Internal$Property$Translate$distance,
							ag: $author$project$Anim$Internal$Property$Translate$duration,
							i: globalData.i,
							ah: globalData,
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation.X)));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			T: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.T),
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						O: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.O)
					});
			};
			var defs = data.c;
			var animation = data.a;
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						animation,
						{
							aY: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, animation.aY)
						}),
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bB);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, clampedStart);
				return _Utils_update(
					config,
					{
						cv: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bB: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cv: 0, bY: $elm$core$Maybe$Nothing, n: defaultEnd, R: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, ch: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.X));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.T);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.cb);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bB: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bB: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bB);
		return _Utils_update(
			config,
			{
				cv: A2(distanceFn, startVal, newEnd),
				n: newEnd,
				bB: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cv: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bB: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cv: A2(calcDistance, startVal, end),
						n: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bB);
		return A4(
...
var $author$project$Animation$WAAPI$TransformOrder$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$TransformOrder$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$TransformOrder$Main$permutationKey = function (perm) {
	switch (perm) {
		case 0:
			return 't-r-sk-s';
		case 1:
...
var $author$project$Animation$WAAPI$TransformOrder$Main$init = _Utils_Tuple2(
	{
		N: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$TransformOrder$Main$motionCmd,
			$author$project$Animation$WAAPI$TransformOrder$Main$motionMsg,
			A2(
				$elm$core$List$concatMap,
				function (perm) {
					return _List_fromArray(
						[
							...
							A3(
								...
								$author$project$Animation$WAAPI$TransformOrder$Main$permutationKey(perm),
								0,
								0),
							A2(
								$elm$core$Basics$composeR,
				...
				$author$project$Animation$WAAPI$TransformOrder$Main$allPermutations)),
		_: _List_Nil
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$TransformOrder$Main$GotWaapiMsg = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Animation$WAAPI$TransformOrder$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$TransformOrder$Main$GotWaapiMsg, model.N);
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {G: groupConfig, cC: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {ax: newEntry, a1: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								ax: newEntry,
								a1: A2($elm$core$List$cons, existing.ax, existing.a1)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$addPropertyStates = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			newGroup,
			{
				am: A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$union, newGroup.am, existingGroup.am)
			});
	});
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'offset',
						$elm$json$Json$Encode$float(sample.dk)),
						_Utils_Tuple2(
						'value',
						$elm$json$Json$Encode$float(sample.dL))
					]));
		},
		samples);
};
	...
	function (s, durationMs) {
		...
		return A2(
			...
			function (i) {
				...
				return {
					dk: offset,
					dL: A2($author$project$Shared$Spring$valueAt, motion, offset * durationMs)
				};
			},
			A2($elm$core$List$range, 0, n - 1));
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.S, dimensions.c4);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'delay',
												$elm$json$Json$Encode$int(config.w))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bY, config.bA))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bB));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bB));
				var startX = _v1.a;
				var startY = _v1.b;
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										'unitX',
										$elm$json$Json$Encode$string(
											$author$project$Anim$Internal$Unit$toCssSuffix(config.D.as))),
										_Utils_Tuple2(
										'unitY',
										$elm$json$Json$Encode$string(
											$author$project$Anim$Internal$Unit$toCssSuffix(config.D.at))),
										_Utils_Tuple2(
										'duration',
										$elm$json$Json$Encode$int(config.y)),
										_Utils_Tuple2(
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bB));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bB));
								...
								_Utils_ap(
									_List_fromArray(
										[
											...
											'unitZ',
											$elm$json$Json$Encode$string(
												$author$project$Anim$Internal$Unit$toCssSuffix(config.D.au))),
											_Utils_Tuple2(
											'duration',
											$elm$json$Json$Encode$int(config.y)),
											_Utils_Tuple2(
	...
	function (typeTag, animGroups, touchedAxes, processed) {
		var elementsWithVersions = A2(
			...
			function (_v0) {
				...
				var effectiveTouchedAxes = (typeTag === 'retarget') ? perGroupTouchedAxes : config.cs;
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeTransformBaseline(snapshot))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(config.j)(config.e)(config.f)(config.g)(effectiveTouchedAxes)(config.cs)(playback.t)(playback.A)(config.s));
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cy));
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						bB: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.bB, start)
					};
				case 3:
					var config = property.a;
					return {
						...
						bB: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOriginUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.bB, start))
					};
				case 4:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.n, end),
						bB: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.bB, start)
					};
				case 5:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.n, end),
						bB: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.bB, start)
					};
				case 6:
					var config = property.a;
					return {
						...
						bB: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.bB, start))
					};
				case 7:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.n, end),
						bB: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.bB, start)
					};
				default:
					var config = property.a;
					return {
						...
						bB: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setTranslateUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.bB, start))
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{n: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, bB: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
	...
	function (iterations, animationDirection, globalTransformOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var snapshot = function () {
			if (!existingAnimation.$) {
				...
				return A2($author$project$Anim$Internal$Builder$PropertyBaselines$merge, animationBounds.bB, snapBounds.n);
			}
		}();
			...
			A2(
				...
				function (property) {
					...
					return _Utils_Tuple2(
						propType,
						{
							G: A2($author$project$Anim$Internal$Engine$WAAPI$Generator$resolveStartFromSnapshot, snapshot, property),
							cf: initialStatus,
							bJ: newVersion
						});
				},
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.u.av);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.G.cs);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.ax, history.a1));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a.X)));
	};
...
var $author$project$Anim$Internal$Engine$WAAPI$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					fs: $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$WAAPI$animate = F2(
	function (_v0, build) {
		...
		var hasSnap = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$groups(processed.cy));
		var processedAnimGroups = A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cy));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$WAAPI$AnimState,
			_Utils_update(
				state,
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.X));
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						i: A2($author$project$Anim$Internal$Unit$setCssUnitX, unit, defs.i)
					});
			},
			data);
	});
var $author$project$Anim$Engine$WAAPI$cssUnitX = $author$project$Anim$Internal$Builder$cssUnitX;
var $author$project$Anim$Internal$Unit$setCssUnitY = F2(
	function (unit, axes) {
		return _Utils_update(
			axes,
			{
				at: $elm$core$Maybe$Just(unit)
			});
	});
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						i: A2($author$project$Anim$Internal$Unit$setCssUnitY, unit, defs.i)
					});
			},
			data);
	});
var $author$project$Anim$Engine$WAAPI$cssUnitY = $author$project$Anim$Internal$Builder$cssUnitY;
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						aB: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$WAAPI$TransformOrder$Main$permutationOrder = function (perm) {
	switch (perm) {
		case 0:
			return _List_fromArray(
				[0, 1, 2, 3]);
	...
	function (order, builder) {
		...
		if (!_v0.$) {
			...
			var nextConfig = function () {
				var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.C);
				if (!_v1.$) {
					var existing = _v1.a;
					return _Utils_update(
						existing,
					...
					return {f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, e: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, s: _List_Nil, p: normalizedOrder, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
				}
			}();
...
var $author$project$Anim$Internal$Engine$WAAPI$transformOrder = $author$project$Anim$Internal$Builder$transformOrder;
var $author$project$Anim$Engine$WAAPI$transformOrder = $author$project$Anim$Internal$Engine$WAAPI$transformOrder;
var $author$project$Animation$WAAPI$TransformOrder$Main$engineDefaults = function (perm) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$WAAPI$for(
			$author$project$Animation$WAAPI$TransformOrder$Main$permutationKey(perm)),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$WAAPI$transformOrder(
				$author$project$Animation$WAAPI$TransformOrder$Main$permutationOrder(perm)),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$WAAPI$duration(2000),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$WAAPI$easing($author$project$Motion$Easing$EaseInOut),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$cssUnitX(8),
						$author$project$Anim$Engine$WAAPI$cssUnitY(4))))));
};
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cv: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bB: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cv: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bB: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Scale$toXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Property$Scale$getZ(config.n);
...
var $author$project$Animation$WAAPI$TransformOrder$Main$moveOut = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$TransformOrder$Main$reset = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aF: animGroupName, dc: isAnimating, Y: progress, dx: propertyProgress, cG: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bN: animGroup, et: commandVersion, b9: rotate, cc: scale, cd: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Property$Skew$fromRecord = function (record) {
	return {as: record.as, at: record.at};
};
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bN: animGroup, b9: rotate, cc: scale, cd: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {c4: hNormalized, de: l * 100, dD: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cT: rgba_.cT, c3: rgba_.c3, dA: rgba_.dA};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cP: rgba_.cP, c4: hsla_.c4, de: hsla_.de, dD: hsla_.dD};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {c4: hslaValue.c4, de: hslaValue.de, dD: hslaValue.dD};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cP: 1.0, c4: hslValue.c4, de: hslValue.de, dD: hslValue.dD};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cP: alpha_, cT: rgb_.cT, c3: rgb_.c3, dA: rgb_.dA};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{c4: hslaValue.c4, de: hslaValue.de, dD: hslaValue.dD});
	return {cP: hslaValue.cP, cT: rgb_.cT, c3: rgb_.c3, dA: rgb_.dA};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cP: 1.0, cT: rgb_.cT, c3: rgb_.c3, dA: rgb_.dA};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.c3 + ((endRgb.c3 - startRgb.c3) * t));
							var r = $elm$core$Basics$round(startRgb.dA + ((endRgb.dA - startRgb.dA) * t));
							var b = $elm$core$Basics$round(startRgb.cT + ((endRgb.cT - startRgb.cT) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dA + ((endRgba.dA - startRgba.dA) * t));
							var g = $elm$core$Basics$round(startRgba.c3 + ((endRgba.c3 - startRgba.c3) * t));
							var b = $elm$core$Basics$round(startRgba.cT + ((endRgba.cT - startRgba.cT) * t));
							var a = startRgba.cP + ((endRgba.cP - startRgba.cP) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dD + ((endHsl.dD - startHsl.dD) * t);
							var l = startHsl.de + ((endHsl.de - startHsl.de) * t);
							var h = startHsl.c4 + ((endHsl.c4 - startHsl.c4) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dD + ((endHsla.dD - startHsla.dD) * t);
							var l = startHsla.de + ((endHsla.de - startHsla.de) * t);
							var h = startHsla.c4 + ((endHsla.c4 - startHsla.c4) * t);
							var a = startHsla.cP + ((endHsla.cP - startHsla.cP) * t);
...
var $author$project$Anim$Internal$Engine$WAAPI$ProgressApply$progressToT = F2(
	function (cfg, rawProgress) {
		...
		if (!_v0.$) {
			...
			return A2($author$project$Shared$Easing$toFunction, cfg.bY, rawProgress);
		}
	});
			...
			F3(
				function (propType, rawProgress, acc) {
					...
					if (_v0.$ === 1) {
						...
						var propState = _v0.a;
						return A3($author$project$Anim$Internal$Engine$WAAPI$ProgressApply$applyConfigProgress, propState.G, rawProgress, acc);
					}
				}),
			baselines,
			propertyProgress);
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cG);
				if (_v2.$ === 1) {
					return propAnim;
				} else {
					var currentVersion = _v2.a;
					return _Utils_eq(currentVersion, propAnim.bJ) ? _Utils_update(
						propAnim,
						{
							cf: animUpdate.dc ? 1 : 3
						}) : propAnim;
				}
			});
			...
			F2(
				function (propType, _v0) {
					var _v1 = _Utils_Tuple2(
						A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cG),
					...
					if ((!_v1.a.$) && (!_v1.b.$)) {
						...
						return _Utils_eq(incomingVersion, currentState.bJ);
					} else {
						return false;
					}
				}),
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setProgress, animUpdate.Y, animGroup)));
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var updatedAnimations = A3(
							...
							animGroups);
						var shouldEmitProgress = A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animUpdate.aF, state.q);
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aF, animUpdate.Y)) : $elm$core$Maybe$Nothing;
...
var $author$project$Animation$WAAPI$TransformOrder$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 4:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, subMsg, model.N);
			...
			case 0:
				...
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$WAAPI$TransformOrder$Main$engineDefaults(perm),
						$author$project$Animation$WAAPI$TransformOrder$Main$moveOut));
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							N: newAnimState,
							_: A2($elm$core$List$member, perm, model._) ? model._ : A2($elm$core$List$cons, perm, model._)
						}),
					animCmd);
			case 1:
				var perm = msg.a;
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Animation$WAAPI$TransformOrder$Main$engineDefaults(perm),
						$author$project$Animation$WAAPI$TransformOrder$Main$reset));
						...
						F2(
							function (perm, acc) {
								return A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$WAAPI$TransformOrder$Main$engineDefaults(perm),
									A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$TransformOrder$Main$moveOut, acc));
							}),
						$elm$core$Basics$identity,
						$author$project$Animation$WAAPI$TransformOrder$Main$allPermutations));
				var finalState = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{N: finalState, _: $author$project$Animation$WAAPI$TransformOrder$Main$allPermutations}),
					cmd);
			default:
				var _v5 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
						...
						F2(
							function (perm, acc) {
								return A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$WAAPI$TransformOrder$Main$engineDefaults(perm),
									A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$TransformOrder$Main$reset, acc));
							}),
						$elm$core$Basics$identity,
						model._));
				var finalState = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{N: finalState, _: _List_Nil}),
					cmd);
		}
	});
var $author$project$Animation$WAAPI$TransformOrder$Main$AnimateAll = {$: 2};
var $author$project$Animation$WAAPI$TransformOrder$Main$ResetAll = {$: 3};
...
var $author$project$Animation$WAAPI$TransformOrder$Main$actionButton = F3(
...
var $author$project$Anim$Internal$Builder$getAnimationConfigs = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.av);
		if (_v1.$ === 1) {
			return _List_Nil;
		} else {
			var h = _v1.a;
			return A2(
				...
				A2($elm$core$List$cons, h.ax, h.a1));
		}
	});
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.c4),
			$author$project$Anim$Internal$Unit$toCssSuffix(axes.at));
	});
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.S),
			...
			var sizeStyles = isElmOwned('size') ? A2(
				...
				A2(
					...
					function (s) {
						var sizeUnits = A2(
							$elm$core$Maybe$withDefault,
							{as: $author$project$Anim$Internal$Unit$default, at: $author$project$Anim$Internal$Unit$default, au: $author$project$Anim$Internal$Unit$default},
...
var $author$project$Animation$WAAPI$TransformOrder$Main$boxSize = 16;
var $author$project$Animation$WAAPI$TransformOrder$Main$boxSizeCss = $elm$core$String$fromFloat($author$project$Animation$WAAPI$TransformOrder$Main$boxSize) + 'cqmin';
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Animation$WAAPI$TransformOrder$Main$permutationColor = function (perm) {
	switch (perm) {
		case 0:
			return '59, 130, 246';
		case 1:
...
var $author$project$Animation$WAAPI$TransformOrder$Main$permutationLabel = function (perm) {
	switch (perm) {
		case 0:
			return 'T → R → Sk → S';
		case 1:
...
var $author$project$Animation$WAAPI$TransformOrder$Main$animatedBox = F2(
	function (animState, perm) {
		var rgb = $author$project$Animation$WAAPI$TransformOrder$Main$permutationColor(perm);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_Utils_ap(
						A2(
							$author$project$Anim$Engine$WAAPI$attributes,
							$author$project$Animation$WAAPI$TransformOrder$Main$permutationKey(perm),
							animState),
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'width', $author$project$Animation$WAAPI$TransformOrder$Main$boxSizeCss),
								A2($elm$html$Html$Attributes$style, 'height', $author$project$Animation$WAAPI$TransformOrder$Main$boxSizeCss),
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Animation$WAAPI$TransformOrder$Main$permutationLabel(perm))
						]))
				]));
	});
...
var $author$project$Animation$WAAPI$TransformOrder$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			$author$project$Animation$WAAPI$TransformOrder$Main$animatedBox(animState),
			$author$project$Animation$WAAPI$TransformOrder$Main$allPermutations));
};
var $author$project$Animation$WAAPI$TransformOrder$Main$Animate = function (a) {
	return {$: 0, a: a};
};
var $author$project$Animation$WAAPI$TransformOrder$Main$permButton = function (perm) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Animation$WAAPI$TransformOrder$Main$Animate(perm)),
				A2($elm$html$Html$Attributes$style, 'padding', '6px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2(
				$elm$html$Html$Attributes$style,
				'background-color',
				'rgb(' + ($author$project$Animation$WAAPI$TransformOrder$Main$permutationColor(perm) + ')')),
				A2($elm$html$Html$Attributes$style, 'color', 'white'),
				A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
				A2($elm$html$Html$Attributes$style, 'font-weight', '600'),
				A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
...
var $author$project$Animation$WAAPI$TransformOrder$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Animation$WAAPI$TransformOrder$Main$permButton, $author$project$Animation$WAAPI$TransformOrder$Main$allPermutations)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						A3($author$project$Animation$WAAPI$TransformOrder$Main$actionButton, '▶️ All', $author$project$Animation$WAAPI$TransformOrder$Main$AnimateAll, '#16a34a'),
						A3($author$project$Animation$WAAPI$TransformOrder$Main$actionButton, '⏮️ Reset All', $author$project$Animation$WAAPI$TransformOrder$Main$ResetAll, '#d97706')
					])),
				$author$project$Animation$WAAPI$TransformOrder$Main$animationArea(model.N)
			]));
};
var $author$project$Animation$WAAPI$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		e_: function (_v0) {
			return $author$project$Animation$WAAPI$TransformOrder$Main$init;
		},
		fP: $author$project$Animation$WAAPI$TransformOrder$Main$subscriptions,
		gd: $author$project$Animation$WAAPI$TransformOrder$Main$update,
		ge: $author$project$Animation$WAAPI$TransformOrder$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'TransformOrder':{'Main':{'init':$author$project$Animation$WAAPI$TransformOrder$Main$main(
