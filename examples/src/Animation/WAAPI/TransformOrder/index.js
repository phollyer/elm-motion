...
{
	if (region.bA.bw === region.n.bw)
	{
		return 'on line ' + region.bA.bw;
	}
	return 'on lines ' + region.bA.bw + ' through ' + region.n.bw;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eS: 'hidden', el: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eS: 'mozHidden', el: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eS: 'msHidden', el: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eS: 'webkitHidden', el: 'webkitvisibilitychange' }
		: { eS: 'hidden', el: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {c0: fragment, c7: host, dr: path, dt: port_, dx: protocol, dy: query};
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bF: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ac: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ai: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, ci: $elm$core$Set$empty, aB: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {A: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bu: false, t: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bN: $elm$core$Maybe$Nothing, h: false, cd: $elm$core$Maybe$Nothing, bC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, aw: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, am: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c3: 0, R: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dC / 100;
	var l = hslValue.dd / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.c3 / 60, 2) - 1));
	var _v0 = (hslValue.c3 < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.c3 < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.c3 < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.c3 < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.c3 < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cS: rgba_.cS, c2: rgba_.c2, dz: rgba_.dz};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{c3: hsla_.c3, dd: hsla_.dd, dC: hsla_.dC});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cS: $elm$core$Basics$round(rgba_.cq * 255),
				c2: $elm$core$Basics$round(rgba_.cw * 255),
				dz: $elm$core$Basics$round(rgba_.cG * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dz - rgb1.dz;
		var dg = rgb2.c2 - rgb1.c2;
		var db = rgb2.cS - rgb1.cS;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.f6(coord2);
		var record1 = support.f6(coord1);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	ez: $author$project$Anim$Internal$Property$Rotate$default,
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	ez: $author$project$Anim$Internal$Property$Scale$default,
	eO: $elm$core$Basics$identity,
	cb: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	ez: $author$project$Anim$Internal$Property$Translate$default,
	eO: $elm$core$Basics$identity,
	cb: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bk;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.a1);
	var k = A2($elm$core$Basics$max, 0, spring.a8);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.H;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bA);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bY: 0,
					bz: $author$project$Motion$Internal$Spring$unwrap(s),
					ch: 1
				});
		} else {
			return rawDuration;
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && _Utils_eq(cy, $elm$core$Maybe$Nothing)) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bA);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, clampedStart);
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Skew$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.ca);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bA: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bA: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bA);
		return _Utils_update(
			config,
			{
				cu: A2(distanceFn, startVal, newEnd),
				n: newEnd,
				bA: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cu: A2(calcDistance, startVal, end),
						n: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bA);
		return A4(
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.x;
					var newEntry = {H: groupConfig, cB: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aH: newEntry, bj: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aH: newEntry,
								bj: A2($elm$core$List$cons, existing.aH, existing.bj)
							};
						}
					}();
					return _Utils_update(
	...
	function (s, durationMs) {
		...
		return A2(
			...
			function (i) {
				...
				return {
					dj: offset,
					dK: A2($author$project$Shared$Spring$valueAt, motion, offset * durationMs)
				};
			},
			A2($elm$core$List$range, 0, n - 1));
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.R, dimensions.c3);
};
		...
		switch (property.$) {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bX, config.bz))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bA));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bA));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bA));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bA));
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimateLike = F4(
	function (typeTag, animGroups, touchedAxes, processed) {
		var elementsWithVersions = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cx));
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						bA: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.bA, start)
					};
				case 3:
					var config = property.a;
					return {
						...
						bA: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOriginUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.bA, start))
					};
				case 4:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.n, end),
						bA: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.bA, start)
					};
				case 5:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.n, end),
						bA: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.bA, start)
					};
				case 6:
					var config = property.a;
					return {
						...
						bA: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.bA, start))
					};
				case 7:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.n, end),
						bA: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.bA, start)
					};
				default:
					var config = property.a;
					return {
						...
						bA: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setTranslateUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.bA, start))
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{n: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, bA: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
	...
	function (iterations, animationDirection, globalTransformOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var snapshot = function () {
			if (!existingAnimation.$) {
				...
				return A2($author$project$Anim$Internal$Builder$PropertyBaselines$merge, animationBounds.bA, snapBounds.n);
			}
		}();
			...
			A2(
				...
				function (property) {
					...
					return _Utils_Tuple2(
						propType,
						{
							H: A2($author$project$Anim$Internal$Engine$WAAPI$Generator$resolveStartFromSnapshot, snapshot, property),
							ce: initialStatus,
							bI: newVersion
						});
				},
...
var $author$project$Anim$Internal$Engine$WAAPI$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					fr: $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$WAAPI$animate = F2(
	function (_v0, build) {
		...
		var hasSnap = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$groups(processed.cx));
		var processedAnimGroups = A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cx));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$WAAPI$AnimState,
			_Utils_update(
				state,
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						ay: $elm$core$Maybe$Just(easingValue),
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aC: animGroupName, db: isAnimating, X: progress, dw: propertyProgress, cF: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bM: animGroup, es: commandVersion, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {c3: hNormalized, dd: l * 100, dC: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cS: rgba_.cS, c2: rgba_.c2, dz: rgba_.dz};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cO: rgba_.cO, c3: hsla_.c3, dd: hsla_.dd, dC: hsla_.dC};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {c3: hslaValue.c3, dd: hslaValue.dd, dC: hslaValue.dC};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cO: 1.0, c3: hslValue.c3, dd: hslValue.dd, dC: hslValue.dC};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cO: alpha_, cS: rgb_.cS, c2: rgb_.c2, dz: rgb_.dz};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{c3: hslaValue.c3, dd: hslaValue.dd, dC: hslaValue.dC});
	return {cO: hslaValue.cO, cS: rgb_.cS, c2: rgb_.c2, dz: rgb_.dz};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cO: 1.0, cS: rgb_.cS, c2: rgb_.c2, dz: rgb_.dz};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.c2 + ((endRgb.c2 - startRgb.c2) * t));
							var r = $elm$core$Basics$round(startRgb.dz + ((endRgb.dz - startRgb.dz) * t));
							var b = $elm$core$Basics$round(startRgb.cS + ((endRgb.cS - startRgb.cS) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dz + ((endRgba.dz - startRgba.dz) * t));
							var g = $elm$core$Basics$round(startRgba.c2 + ((endRgba.c2 - startRgba.c2) * t));
							var b = $elm$core$Basics$round(startRgba.cS + ((endRgba.cS - startRgba.cS) * t));
							var a = startRgba.cO + ((endRgba.cO - startRgba.cO) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dC + ((endHsl.dC - startHsl.dC) * t);
							var l = startHsl.dd + ((endHsl.dd - startHsl.dd) * t);
							var h = startHsl.c3 + ((endHsl.c3 - startHsl.c3) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dC + ((endHsla.dC - startHsla.dC) * t);
							var l = startHsla.dd + ((endHsla.dd - startHsla.dd) * t);
							var h = startHsla.c3 + ((endHsla.c3 - startHsla.c3) * t);
							var a = startHsla.cO + ((endHsla.cO - startHsla.cO) * t);
			...
			F3(
				function (propType, rawProgress, acc) {
					...
					if (_v0.$ === 1) {
						...
						var propState = _v0.a;
						return A3($author$project$Anim$Internal$Engine$WAAPI$ProgressApply$applyConfigProgress, propState.H, rawProgress, acc);
					}
				}),
			baselines,
			propertyProgress);
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cF);
				if (_v2.$ === 1) {
					return propAnim;
				} else {
			...
			F2(
				function (propType, _v0) {
					var _v1 = _Utils_Tuple2(
						A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cF),
	...
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				A2($elm$core$List$cons, h.aH, h.bj));
		}
	});
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.c3),
...
var $author$project$Animation$WAAPI$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		fO: $author$project$Animation$WAAPI$TransformOrder$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$TransformOrder$Main$update,
		gd: $author$project$Animation$WAAPI$TransformOrder$Main$view
	});
