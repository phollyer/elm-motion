...
var $author$project$Animation$WAAPI$ButtonHovers$Main$baseHeight = 15.8;
var $author$project$Animation$WAAPI$ButtonHovers$Main$baseWidth = 51;
...
var $author$project$Anim$Internal$Builder$initAnimation = {D: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, X: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bo: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			b: _Utils_update(
				pb,
				{B: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once})
		});
};
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.D);
	});
...
var $author$project$Anim$Internal$Builder$initDefaults = {O: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, bF: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {B: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bu: false, t: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, T: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {B: 0, ax: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, Y: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c3: 0, S: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cS: $elm$core$Basics$round(rgba_.cp * 255),
	...
	return wrapper(
		{
			...
			w: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.w, globalData.az, 0),
			cu: distance_,
			z: $elm$core$Basics$round(duration_),
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Rotate$default, ae: $author$project$Anim$Internal$Property$Rotate$distance, af: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Rotate$speed, aq: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Scale$default, ae: $author$project$Anim$Internal$Property$Scale$distance, af: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Scale$speed, aq: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Skew$default, ae: $author$project$Anim$Internal$Property$Skew$distance, af: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Skew$speed, aq: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {c3: record.c4, S: record.dO};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {c4: dimensions.c3, dO: dimensions.S};
};
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				var clampValue = function (value) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							c4: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.c4),
							dO: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dO)
						});
				};
				...
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
	...
	if (_v1.$ === 1) {
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.D)));
	}
};
	...
	function (config, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var mergedConfig = function () {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animKey, anim.D);
				if (!_v2.$) {
					var existing = _v2.a;
								...
								if (!_v7.b.$) {
									if (!_v7.a.$) {
										...
										return $elm$core$Maybe$Just(
											{
												B: function () {
													var _v8 = incomingPlayback.B;
													if (!_v8.$) {
														return incomingPlayback.B;
													} else {
														return existingPlayback.B;
													}
												}(),
												t: function () {
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{
							D: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animKey, mergedConfig, anim.D),
							X: A3(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {E: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, R: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {c3: height, S: width};
};
...
var $author$project$Anim$Internal$Builder$getSizeCssUnitAxes = F2(
	function (animGroupName, builder) {
		...
		return A2(
			$author$project$Anim$Internal$Unit$mergeBaselineUnits,
			$elm$core$Maybe$Just(
				$author$project$Anim$Internal$Builder$getScopedDefaults(builder)._),
			A3(
				$author$project$Anim$Internal$Builder$CssUnitStore$getAxes,
				animGroupName,
				{ar: $author$project$Anim$Internal$Builder$CssUnitStore$sizeWidth, as: $author$project$Anim$Internal$Builder$CssUnitStore$sizeHeight, at: ''},
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$ButtonHovers$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton = 'scaleButton';
var $author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton = 'sizeButton';
var $author$project$Animation$WAAPI$ButtonHovers$Main$zButton = 'zButton';
var $author$project$Animation$WAAPI$ButtonHovers$Main$init = _Utils_Tuple2(
	{
		y: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$ButtonHovers$Main$motionCmd,
			$author$project$Animation$WAAPI$ButtonHovers$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton, $author$project$Animation$WAAPI$ButtonHovers$Main$baseHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton, $author$project$Animation$WAAPI$ButtonHovers$Main$baseHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7)),
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$zButton, $author$project$Animation$WAAPI$ButtonHovers$Main$baseHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$baseWidth),
					$author$project$Anim$Property$Size$initCssUnit(7))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$ButtonHovers$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$ButtonHovers$Main$GotWaapiMsg, model.y);
};
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aw: newEntry, a0: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aw: newEntry,
								a0: A2($elm$core$List$cons, existing.aw, existing.a0)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.S, dimensions.c3);
};
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'duration',
												$elm$json$Json$Encode$int(config.z)),
												_Utils_Tuple2(
												'delay',
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.z, config.bX, config.bz))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
...
var $author$project$Anim$Internal$Builder$resolvePlayback = F3(
	function (globalIterations, globalDirection, maybePlayback) {
		if (maybePlayback.$ === 1) {
			return {B: globalDirection, t: globalIterations};
		} else {
			var playback = maybePlayback.a;
			return {
				B: A2($elm$core$Maybe$withDefault, globalDirection, playback.B),
	...
	function (typeTag, animGroups, touchedAxes, processed) {
		var elementsWithVersions = A2(
			...
			function (_v0) {
				var animGroupName = _v0.a;
				var config = _v0.b;
				var playback = A3($author$project$Anim$Internal$Builder$resolvePlayback, processed.t, processed.B, config.b);
				...
				var effectiveTouchedAxes = (typeTag === 'retarget') ? perGroupTouchedAxes : config.cr;
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeTransformBaseline(snapshot))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(config.j)(config.e)(config.f)(config.g)(effectiveTouchedAxes)(config.cr)(playback.t)(playback.B)(config.s));
			},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.B))
				]));
	});
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var historicalControlledAxesForGroup = function (groupName) {
		var _v7 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.u.au);
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.H.cr);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.aw, history.a0));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bX: $elm$core$Maybe$Just(easing_),
				bz: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration = 200;
var $author$project$Motion$Easing$CubicOut = {$: 11};
var $author$project$Animation$WAAPI$ButtonHovers$Main$hoverEasing = $author$project$Motion$Easing$CubicOut;
var $author$project$Animation$WAAPI$ButtonHovers$Main$hoverHeight = 20;
var $author$project$Animation$WAAPI$ButtonHovers$Main$hoverWidth = 60;
var $author$project$Anim$Property$Size$toHW = $author$project$Anim$Internal$Builder$Size$toHW;
var $author$project$Animation$WAAPI$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$WAAPI$ButtonHovers$Main$hoverHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$hoverWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$WAAPI$ButtonHovers$Main$hoverEasing),
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$duration($author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$WAAPI$ButtonHovers$Main$hoverEasing),
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$unhoverEasing = $author$project$Motion$Easing$CubicIn;
var $author$project$Animation$WAAPI$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Scale$duration($author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$WAAPI$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$WAAPI$ButtonHovers$Main$scaleUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Scale$easing($author$project$Animation$WAAPI$ButtonHovers$Main$hoverEasing),
				$author$project$Anim$Property$Scale$end))));
var $author$project$Animation$WAAPI$ButtonHovers$Main$setDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Animation$WAAPI$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Translate$end))));
var $author$project$Animation$WAAPI$ButtonHovers$Main$shrinkSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$WAAPI$ButtonHovers$Main$baseHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$baseWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Size$easing($author$project$Animation$WAAPI$ButtonHovers$Main$unhoverEasing),
				$author$project$Anim$Property$Size$end))));
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aE: animGroupName, db: isAnimating, Y: progress, dw: propertyProgress, cF: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bM: animGroup, es: commandVersion, b8: rotate, cb: scale, cc: skew, ci: translate};
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.au));
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bM: animGroup, b8: rotate, cb: scale, cc: skew, ci: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$ProgressApply$progressToT = F2(
	function (cfg, rawProgress) {
		...
		if (!_v0.$) {
			...
			return A2($author$project$Shared$Spring$valueAt, motion, rawProgress * cfg.z);
		} else {
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var updatedAnimations = A3(
							...
							animGroups);
						var shouldEmitProgress = A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animUpdate.aE, state.q);
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aE, animUpdate.Y)) : $elm$core$Maybe$Nothing;
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.y);
				var animState = _v1.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$scaleUp));
				var animState = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$scaleDown));
				var animState = _v3.a;
				var cmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 3:
				var _v4 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$growSize));
				var animState = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				var _v5 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$shrinkSize));
				var animState = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var _v6 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$zButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$liftUp));
				var animState = _v6.a;
				var cmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var _v7 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$ButtonHovers$Main$zButton),
						$author$project$Animation$WAAPI$ButtonHovers$Main$setDown));
				var animState = _v7.a;
				var cmd = _v7.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleHover = {$: 1};
var $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleUnhover = {$: 2};
var $author$project$Animation$WAAPI$ButtonHovers$Main$SizeHover = {$: 3};
var $author$project$Animation$WAAPI$ButtonHovers$Main$SizeUnhover = {$: 4};
var $author$project$Animation$WAAPI$ButtonHovers$Main$ZHover = {$: 5};
var $author$project$Animation$WAAPI$ButtonHovers$Main$ZUnhover = {$: 6};
...
var $author$project$Anim$Internal$Builder$getAnimationConfigs = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.u.au);
		if (_v1.$ === 1) {
			return _List_Nil;
		} else {
			var h = _v1.a;
			return A2(
				...
				A2($elm$core$List$cons, h.aw, h.a0));
		}
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {cE: true, cJ: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {et: contactDetails, e3: isPrimary, fn: pointer, fo: pointerId, fp: pointerType};
	});
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {c4: height, fq: pressure, f3: tiltX, f4: tiltY, dO: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {ej: button, en: clientPos, e5: keys, fd: offsetPos, fl: pagePos, fx: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {d2: alt, ev: ctrl, e9: meta, fD: shift};
	});
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$button = F5(
	function (label, hoverMsg, unhoverMsg, groupName, animState) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				A2($author$project$Anim$Engine$WAAPI$attributes, groupName, animState),
				_List_fromArray(
					[
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Scale', $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleHover, $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton, model.y),
						A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Size', $author$project$Animation$WAAPI$ButtonHovers$Main$SizeHover, $author$project$Animation$WAAPI$ButtonHovers$Main$SizeUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton, model.y),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Translate Z', $author$project$Animation$WAAPI$ButtonHovers$Main$ZHover, $author$project$Animation$WAAPI$ButtonHovers$Main$ZUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$zButton, model.y)
							]))
					]))
			]));
};
var $author$project$Animation$WAAPI$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$ButtonHovers$Main$init;
		},
		fO: $author$project$Animation$WAAPI$ButtonHovers$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$ButtonHovers$Main$update,
		gd: $author$project$Animation$WAAPI$ButtonHovers$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'ButtonHovers':{'Main':{'init':$author$project$Animation$WAAPI$ButtonHovers$Main$main(
