		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{H: nodeList, C: (len / $elm$core$Array$branchFactor) | 0, G: tail});
			} else {
...
var $author$project$Anim$Internal$Builder$initPlayback = {B: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bt: false, t: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {B: 0, av: 0, cr: $elm$core$Dict$empty, cs: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fq: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {c3: dimensions.c2, dN: dimensions.R};
};
			...
			if (_Utils_eq(cw, $elm$core$Maybe$Nothing) && _Utils_eq(ch, $elm$core$Maybe$Nothing)) {
				...
				var clampValue = function (value) {
					...
					return $author$project$Anim$Internal$Property$Size$fromRecord(
						{
							c3: A2($author$project$Anim$Internal$Builder$Property$clampAxis, ch, r.c3),
							dN: A2($author$project$Anim$Internal$Builder$Property$clampAxis, cw, r.dN)
						});
				};
				...
				return _Utils_update(
					config,
					{
						ct: A2($author$project$Anim$Internal$Property$Size$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bz: clampedStart
					});
			}
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.z, config.bW, config.by))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						A2($author$project$Anim$Internal$Engine$WAAPI$Encoder$touchedAxesForGroup, animGroupName, touchedAxes))(playback.t)(playback.B)(config.s));
			},
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						ct: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bz: clampedStart
					});
			}
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {cD: true, cI: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {es: contactDetails, e2: isPrimary, fm: pointer, fn: pointerId, fo: pointerType};
	});
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {c3: height, fp: pressure, f2: tiltX, f3: tiltY, dN: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {ei: button, em: clientPos, e4: keys, fc: offsetPos, fk: pagePos, fw: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {d1: alt, eu: ctrl, e8: meta, fC: shift};
	});
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$ButtonHovers$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$ButtonHovers$Main$update,
		gc: $author$project$Animation$WAAPI$ButtonHovers$Main$view
	});
