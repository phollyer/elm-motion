...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bo: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, ci: $elm$core$Set$empty, aC: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bM: $elm$core$Maybe$Nothing, h: false, cd: $elm$core$Maybe$Nothing, bC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, aw: 0, ct: $elm$core$Dict$empty, cu: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fs: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c4: 0, Q: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cP: x0, cT: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b2: omegaD, bJ: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cv: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.c4);
};
...
var $author$project$Animation$WAAPI$Sequencing$Main$globalConfig = {w: 1000, bX: $author$project$Motion$Easing$BounceOut, dH: 50};
...
var $author$project$Animation$WAAPI$Sequencing$Main$rowOneConfig = {w: 0, bX: $author$project$Motion$Easing$BackOut, dH: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$WAAPI$Sequencing$Main$rowThreeConfig = {w: 500, bX: $author$project$Motion$Easing$QuadInOut, dH: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$WAAPI$Sequencing$Main$rowTwoConfig = {w: 250, bX: $author$project$Motion$Easing$ElasticOut, dH: 75};
...
var $author$project$Animation$WAAPI$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Engine$WAAPI$easing($author$project$Animation$WAAPI$Sequencing$Main$globalConfig.bX),
				A2(
					$elm$core$Basics$composeR,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$WAAPI$easing($author$project$Animation$WAAPI$Sequencing$Main$rowOneConfig.bX),
									A2(
										$elm$core$Basics$composeR,
										...
										A2(
											...
											A2(
												...
												A2(
													...
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$WAAPI$easing($author$project$Animation$WAAPI$Sequencing$Main$rowTwoConfig.bX),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Animation$WAAPI$Sequencing$Main$moveTo(targetX),
															A2(
																...
																A2(
																	...
																	A2(
																		...
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Engine$WAAPI$easing($author$project$Animation$WAAPI$Sequencing$Main$rowThreeConfig.bX),
																			A2(
																				$elm$core$Basics$composeR,
																				$author$project$Animation$WAAPI$Sequencing$Main$moveTo(targetX),
																				A2(
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aD: animGroupName, dc: isAnimating, W: progress, dx: propertyProgress, cG: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bL: animGroup, et: commandVersion, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bL: animGroup, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
	...
	function (animUpdate, animGroup) {
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setProgress, animUpdate.W, animGroup)));
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aD, animUpdate.W)) : $elm$core$Maybe$Nothing;
