...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bE: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, ci: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bM: $elm$core$Maybe$Nothing, h: false, cd: $elm$core$Maybe$Nothing, bB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a4: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, au: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cO: x0, cS: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b2: omegaD, bJ: zeta});
		} else {
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Rotate$default, ad: $author$project$Anim$Internal$Property$Rotate$distance, ae: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, af: globalData, an: $author$project$Anim$Internal$Property$Rotate$speed, ap: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Scale$default, ad: $author$project$Anim$Internal$Property$Scale$distance, ae: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, af: globalData, an: $author$project$Anim$Internal$Property$Scale$speed, ap: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{H: config, ab: $author$project$Anim$Internal$Unit$default, ac: $author$project$Anim$Internal$Property$Skew$default, ad: $author$project$Anim$Internal$Property$Skew$distance, ae: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, af: globalData, an: $author$project$Anim$Internal$Property$Skew$speed, ap: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.R);
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bz);
		return A4(
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.az, slots, builder);
	});
...
var $author$project$Animation$WAAPI$Sequencing$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Sequencing$Main$GotWaapiMsg, model.aB);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bX, config.by))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						aw: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$WAAPI$Sequencing$Main$globalConfig = {v: 1000, bX: $author$project$Motion$Easing$BounceOut, dG: 50};
...
var $author$project$Animation$WAAPI$Sequencing$Main$rowOneConfig = {v: 0, bX: $author$project$Motion$Easing$BackOut, dG: 85};
var $author$project$Motion$Easing$QuadInOut = {$: 26};
var $author$project$Animation$WAAPI$Sequencing$Main$rowThreeConfig = {v: 500, bX: $author$project$Motion$Easing$QuadInOut, dG: 60};
var $author$project$Motion$Easing$ElasticOut = {$: 18};
var $author$project$Animation$WAAPI$Sequencing$Main$rowTwoConfig = {v: 250, bX: $author$project$Motion$Easing$ElasticOut, dG: 75};
...
var $author$project$Animation$WAAPI$Sequencing$Main$animateRows = function (targetX) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$Sequencing$Main$globalConfig.v),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$WAAPI$speed($author$project$Animation$WAAPI$Sequencing$Main$globalConfig.dG),
			A2(
				$elm$core$Basics$composeR,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$Sequencing$Main$rowOneConfig.v),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$WAAPI$speed($author$project$Animation$WAAPI$Sequencing$Main$rowOneConfig.dG),
								A2(
									$elm$core$Basics$composeR,
									...
									A2(
										...
										A2(
											...
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$Sequencing$Main$rowTwoConfig.v),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Anim$Engine$WAAPI$speed($author$project$Animation$WAAPI$Sequencing$Main$rowTwoConfig.dG),
													A2(
														$elm$core$Basics$composeR,
														...
														A2(
															...
															A2(
																...
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$Sequencing$Main$rowThreeConfig.v),
																	A2(
																		$elm$core$Basics$composeR,
																		$author$project$Anim$Engine$WAAPI$speed($author$project$Animation$WAAPI$Sequencing$Main$rowThreeConfig.dG),
																		A2(
																			$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aA: animGroupName, db: isAnimating, W: progress, dw: propertyProgress, cF: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bL: animGroup, es: commandVersion, b8: rotate, cb: scale, cc: skew, cj: translate};
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var updatedAnimations = A3(
							...
							animGroups);
						var shouldEmitProgress = A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animUpdate.aA, state.q);
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aA, animUpdate.W)) : $elm$core$Maybe$Nothing;
...
var $author$project$Animation$WAAPI$Sequencing$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var waapiMsg = msg.a;
			var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.aB);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$div,
							_Utils_ap(
								A2($author$project$Anim$Engine$WAAPI$attributes, groupName, model.aB),
								_List_fromArray(
									[
...
var $author$project$Animation$WAAPI$Sequencing$Main$main = $elm$browser$Browser$element(
	{
		...
		fO: $author$project$Animation$WAAPI$Sequencing$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$Sequencing$Main$update,
		gd: $author$project$Animation$WAAPI$Sequencing$Main$view
	});
