		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{I: nodeList, B: (len / $elm$core$Array$branchFactor) | 0, G: tail});
			} else {
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bA);
		return A4(
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aw.H);
					}
				}(
					A2(
						$elm$core$Maybe$map,
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeTransformBaseline(snapshot))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(config.j)(config.e)(config.f)(config.g)(config.cr)(config.cr)(playback.t)(playback.A)(config.s));
			},
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$foldResizeStates = F3(
	function (f, acc, _v0) {
		var group = _v0;
		return A3($elm$core$Dict$foldl, f, acc, group.a7);
	});
					...
					cfg,
					{
						...
						bA: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Property$PerspectiveOrigin$fromRecord(
								{ar: cached.bA.ar, as: cached.bA.as}))
					}));
		} else {
			return config;
		}
			...
			return $author$project$Anim$Internal$Builder$ProcessedScaleConfig(
				_Utils_update(
					cfg,
					{
						...
						bA: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Property$Scale$fromRecord(cached.bA))
					}));
		} else {
			return config;
		}
				...
				_Utils_update(
					cfg,
					{
						...
						n: $author$project$Anim$Internal$Property$Size$fromRecord(
							{c4: cached.n.as, dO: cached.n.ar}),
						bA: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Property$Size$fromRecord(
								{c4: cached.bA.as, dO: cached.bA.ar}))
					}));
		} else {
			return config;
		}
			...
			return $author$project$Anim$Internal$Builder$ProcessedTranslateConfig(
				_Utils_update(
					cfg,
					{
						...
						bA: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Property$Translate$fromRecord(cached.bA))
					}));
		} else {
			return config;
		}
...
var $author$project$Anim$Internal$Engine$WAAPI$restartSingleKey = F2(
	function (resolvedKey, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var startStates = $author$project$Anim$Internal$Engine$WAAPI$Generator$propertyBounds(processedData.s).bA;
			...
			if (_v2.$ === 1) {
				...
				var rebasedProcessedData = A3(
					...
					processedData,
					animGroup);
				var rebasedStartStates = $author$project$Anim$Internal$Engine$WAAPI$Generator$propertyBounds(rebasedProcessedData.s).bA;
...
var $author$project$Animation$WAAPI$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		...
		fO: $author$project$Animation$WAAPI$ControllingAnimations$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$ControllingAnimations$Main$update,
		gd: $author$project$Animation$WAAPI$ControllingAnimations$Main$view
	});
