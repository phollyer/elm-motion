				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aF: newEntry, bi: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aF: newEntry,
								bi: A2($elm$core$List$cons, existing.aF, existing.bi)
							};
						}
					}();
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cN: x0, cR: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b1: omegaD, bJ: zeta});
		} else {
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, au: 0, cr: $elm$core$Dict$empty, cs: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fq: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, ch: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a4: $elm$core$Dict$empty, b9: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				A2($elm$core$List$cons, h.aF, h.bi));
		}
	});
...
var $author$project$Animation$WAAPI$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		gc: $author$project$Animation$WAAPI$HelloText$Main$view
	});
