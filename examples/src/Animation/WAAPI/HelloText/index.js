...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, aw: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Animation$WAAPI$HelloText$Main$dotOne = 'dotOne';
var $author$project$Animation$WAAPI$HelloText$Main$dotThree = 'dotThree';
var $author$project$Animation$WAAPI$HelloText$Main$dotTwo = 'dotTwo';
var $author$project$Animation$WAAPI$HelloText$Main$duration = 500;
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cu: A2($author$project$Anim$Internal$Property$Opacity$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bA: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bA);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					cu: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					n: endPos,
...
var $author$project$Animation$WAAPI$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Opacity$duration($author$project$Animation$WAAPI$HelloText$Main$duration),
...
var $author$project$Anim$Internal$Builder$initDefaults = {N: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, Z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, bF: $elm$core$Set$empty, aC: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bA: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
...
var $author$project$Animation$WAAPI$HelloText$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$HelloText$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $author$project$Animation$WAAPI$HelloText$Main$textLineOne = 'textLineOne';
var $author$project$Animation$WAAPI$HelloText$Main$textLineTwo = 'textLineTwo';
var $author$project$Animation$WAAPI$HelloText$Main$init = function () {
	var animState = A3(
		$author$project$Anim$Engine$WAAPI$init,
		$author$project$Animation$WAAPI$HelloText$Main$motionCmd,
		$author$project$Animation$WAAPI$HelloText$Main$motionMsg,
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$textLineOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$dotOne, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$dotTwo, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$dotThree, 0),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$textLineTwo, 0)
			]));
	var _v0 = A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$HelloText$Main$textLineOne),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$WAAPI$HelloText$Main$fadeIn,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$HelloText$Main$dotOne),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$HelloText$Main$duration),
						A2(
							$elm$core$Basics$composeR,
							$author$project$Animation$WAAPI$HelloText$Main$fadeIn,
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$HelloText$Main$dotTwo),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$HelloText$Main$duration * 2),
									A2(
										$elm$core$Basics$composeR,
										$author$project$Animation$WAAPI$HelloText$Main$fadeIn,
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$HelloText$Main$dotThree),
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$HelloText$Main$duration * 3),
												A2(
													$elm$core$Basics$composeR,
													$author$project$Animation$WAAPI$HelloText$Main$fadeIn,
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$HelloText$Main$textLineTwo),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Anim$Engine$WAAPI$delay($author$project$Animation$WAAPI$HelloText$Main$duration * 4),
															$author$project$Animation$WAAPI$HelloText$Main$fadeIn))))))))))))));
...
var $author$project$Animation$WAAPI$HelloText$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$textLineOne, model.aU),
							_List_Nil),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$dotOne, model.aU),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$dotTwo, model.aU),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$dotThree, model.aU),
							_List_Nil),
						_List_fromArray(
							[
								$elm$html$Html$text('.')
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$textLineTwo, model.aU),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$HelloText$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$HelloText$Main$init;
		},
		fO: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		gc: F2(
			function (_v1, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		gd: $author$project$Animation$WAAPI$HelloText$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'HelloText':{'Main':{'init':$author$project$Animation$WAAPI$HelloText$Main$main(
