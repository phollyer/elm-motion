...
var $author$project$Anim$Internal$Builder$initAnimation = {E: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a1: $author$project$Anim$Internal$Builder$CssUnitStore$empty, s: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, _: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bt: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ae: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aC: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, ab: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aO: $elm$core$Maybe$Nothing, ak: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aW: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, cl: $elm$core$Set$empty, aG: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bR: $elm$core$Maybe$Nothing, h: false, cg: $elm$core$Maybe$Nothing, bH: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ax: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bb: $elm$core$Dict$empty, cd: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {C: 0, aA: 0, cw: $elm$core$Dict$empty, cx: $elm$core$Dict$empty, u: $author$project$Anim$Internal$Builder$Once, aa: 0, fu: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ao: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bd: $elm$core$Dict$empty, q: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c7: 0, V: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cS: x0, cW: (v0 + ((zeta * omega0) * x0)) / omegaD, am: omega0, b5: omegaD, bO: zeta});
		} else {
	...
	return wrapper(
		{
			...
			b$: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.b$, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			n: config.n,
			U: config.U,
			dK: speed_,
			bE: resolvedSpring,
		...
		switch (propConfig.$) {
			...
			case 6:
				...
				return A2(
					...
					A2(
						$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
						A3($author$project$Anim$Internal$Unit$resolveCssUnitAxes, merged, defaults.ab, $author$project$Anim$Internal$Unit$default),
...
var $author$project$Anim$Internal$Builder$mergeBaselines = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			defaults,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, animation._));
	};
	var newBaselines = A2(
	...
	var newState = _Utils_update(
		state,
		{
			W: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.W),
			...
			return _Utils_update(
				data,
				{
					...
					c: _Utils_update(
						defs,
						{
							ae: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defs.ae)
						})
				});
		}
	});
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {F: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, y: $elm$core$Maybe$Nothing, cy: 0, b$: $elm$core$Maybe$Nothing, n: defaultEnd, U: $author$project$Anim$Internal$Builder$Animate, bE: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing, cj: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getScopedDefaults = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a._));
	}
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.W);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.v.cd);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.V, dimensions.c7);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.A, config.b$, config.bE))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
...
var $author$project$Anim$Internal$Builder$process = function (_v0) {
	...
	var getDefaultsForGroup = function (groupName) {
		return A2(
			$elm$core$Maybe$withDefault,
			data.c,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, groupName, data.a._));
	};
	...
	function (updateDefaults, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentDefaults = A2(
				$elm$core$Maybe$withDefault,
				data.c,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim._));
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aH: animGroupName, df: isAnimating, aa: progress, dA: propertyProgress, cJ: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bQ: animGroup, ev: commandVersion, cb: rotate, ce: scale, cf: skew, cm: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bQ: animGroup, cb: rotate, ce: scale, cf: skew, cm: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$ProgressApply$progressToT = F2(
	function (cfg, rawProgress) {
		...
		if (!_v0.$) {
			...
			return A2($author$project$Shared$Easing$toFunction, cfg.b$, rawProgress);
		}
	});
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				...
				if (_v2.$ === 1) {
					...
					return _Utils_eq(currentVersion, propAnim.bM) ? _Utils_update(
						propAnim,
						{
							ch: animUpdate.df ? 1 : 3
						}) : propAnim;
				}
			});
			...
			F2(
				function (propType, _v0) {
					...
					if ((!_v1.a.$) && (!_v1.b.$)) {
						...
						return _Utils_eq(incomingVersion, currentState.bM);
					} else {
						return false;
					}
				}),
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setProgress, animUpdate.aa, animGroup)));
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aH, animUpdate.aa)) : $elm$core$Maybe$Nothing;
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.V),
