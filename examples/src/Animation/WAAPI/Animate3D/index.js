...
{
	if (region.bE.bA === region.n.bA)
	{
		return 'on line ' + region.bE.bA;
	}
	return 'on lines ' + region.bE.bA + ' through ' + region.n.bA;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eU: 'hidden', en: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eU: 'mozHidden', en: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eU: 'msHidden', en: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eU: 'webkitHidden', en: 'webkitvisibilitychange' }
		: { eU: 'hidden', en: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {c3: fragment, da: host, du: path, dw: port_, dA: protocol, dB: query};
	});
...
var $author$project$Animation$WAAPI$Animate3D$Main$backFace = {
	...
	L: 'back-face',
	N: 'BACK',
	v: {aJ: 'rgb(0,0,0)', o: 'backFaceTextAnim', L: 'back-face-text', N: 'BACK'}
};
var $author$project$Animation$WAAPI$Animate3D$Main$bottomFace = {
	...
	L: 'bottom-face',
	N: 'BOTTOM',
	v: {aJ: 'rgb(0,0,0)', o: 'bottomFaceTextAnim', L: 'bottom-face-text', N: 'BOTTOM'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$frontFace = {
	...
	L: 'front-face',
	N: 'FRONT',
	v: {aJ: 'rgb(0,0,0)', o: 'frontFaceTextAnim', L: 'front-face-text', N: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initAnimation = {E: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a1: $author$project$Anim$Internal$Builder$CssUnitStore$empty, s: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, _: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bJ: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ae: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aN: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, ab: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aO: $elm$core$Maybe$Nothing, ak: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aW: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, cl: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {C: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, by: false, u: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bR: $elm$core$Maybe$Nothing, h: false, cg: $elm$core$Maybe$Nothing, bG: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aF: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ba: $elm$core$Dict$empty, cd: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = function () {
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aW: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
	...
	return A2(
		$elm$core$List$foldl,
		runInitEntry,
		{a: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: false, b: $author$project$Anim$Internal$Builder$initPlayback, p: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, z: $author$project$Anim$Internal$Builder$initState, j: 0});
}();
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {C: 0, ay: 0, cv: $elm$core$Dict$empty, cw: $elm$core$Dict$empty, u: $author$project$Anim$Internal$Builder$Once, aa: 0, ft: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ao: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty, q: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c6: 0, V: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dF / 100;
	var l = hslValue.dg / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.c6 / 60, 2) - 1));
	var _v0 = (hslValue.c6 < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.c6 < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.c6 < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.c6 < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.c6 < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cV: rgba_.cV, c5: rgba_.c5, dC: rgba_.dC};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{c6: hsla_.c6, dg: hsla_.dg, dF: hsla_.dF});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cV: $elm$core$Basics$round(rgba_.ct * 255),
				c5: $elm$core$Basics$round(rgba_.cz * 255),
				dC: $elm$core$Basics$round(rgba_.cJ * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.dC - rgb1.dC;
		var dg = rgb2.c5 - rgb1.c5;
		var db = rgb2.cV - rgb1.cV;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.f8(coord2);
		var record1 = support.f8(coord1);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	eB: $author$project$Anim$Internal$Property$Rotate$default,
	eQ: $elm$core$Basics$identity,
	ce: F2(
		function (factor, _v2) {
			var angles = _v2;
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	eB: $author$project$Anim$Internal$Property$Scale$default,
	eQ: $elm$core$Basics$identity,
	ce: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	eB: $author$project$Anim$Internal$Property$Translate$default,
	eQ: $elm$core$Basics$identity,
	ce: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.bo;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.a6);
	var k = A2($elm$core$Basics$max, 0, spring.bd);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var config = _v0.K;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.bE);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					b0: 0,
					bD: $author$project$Motion$Internal$Spring$unwrap(s),
					ck: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			...
			x: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.x, $elm$core$Maybe$Nothing, 0),
			cx: distance_,
		...
		switch (property.$) {
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							K: mergePerspectiveOrigin(config),
							af: 28,
...
var $author$project$Anim$Internal$Builder$setTranslateInitCssUnit = F2(
	function (unit, builder) {
		...
		return A4(
			...
			A2($author$project$Anim$Internal$Builder$unitTargetGroup, data, data.c.aD),
			_List_fromArray(
	...
	function (builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				var clampedStart = A2($elm$core$Maybe$map, clampValue, config.bE);
				var startForDistance = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Rotate$default, clampedStart);
				return _Utils_update(
					config,
					{
						cx: A2($author$project$Anim$Internal$Property$Rotate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bE: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cx: A2(calcDistance, startVal, end),
						n: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {F: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, x: $elm$core$Maybe$Nothing, cx: 0, b$: $elm$core$Maybe$Nothing, n: defaultEnd, U: $author$project$Anim$Internal$Builder$Animate, bD: $elm$core$Maybe$Nothing, bE: $elm$core$Maybe$Nothing, cj: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.z.W);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.z.cd);
	});
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bE: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v2.a.a;
					var _v3 = _v2.b;
				...
				if (!_v2.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								n: baseline,
								bE: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
...
var $author$project$Anim$Internal$Builder$Rotate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bE);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getY, $author$project$Anim$Internal$Builder$Rotate$default, config.bE);
		return A4(
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		var startVal = A2($elm$core$Maybe$withDefault, default_, config.bE);
		return _Utils_update(
			config,
			{
				cx: A2(distanceFn, startVal, newEnd),
				n: newEnd,
				bE: $elm$core$Maybe$Just(startVal)
			});
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cx: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bE: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bE);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bE);
		return A4(
...
var $author$project$Anim$Internal$Builder$registerTranslateInitAxes = F2(
	function (slots, builder) {
		var data = builder;
		return A3($author$project$Anim$Internal$Builder$markInitTouched, data.c.aD, slots, builder);
	});
...
var $author$project$Anim$Internal$Builder$Rotate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.bE);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getX, $author$project$Anim$Internal$Builder$Rotate$default, config.bE);
		return A4(
			$author$project$Anim$Internal$Builder$Rotate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.bE);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.bE);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Animation$WAAPI$Animate3D$Main$leftFace = {
	...
	L: 'left-face',
	N: 'LEFT',
	v: {aJ: 'rgb(0,0,0)', o: 'leftFaceTextAnim', L: 'left-face-text', N: 'LEFT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$rightFace = {
	...
	L: 'right-face',
	N: 'RIGHT',
	v: {aJ: 'rgb(0,0,0)', o: 'rightFaceTextAnim', L: 'right-face-text', N: 'RIGHT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$topFace = {
	...
	L: 'top-face',
	N: 'TOP',
	v: {aJ: 'rgb(0,0,0)', o: 'topFaceTextAnim', L: 'top-face-text', N: 'TOP'}
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.z;
					var newEntry = {K: groupConfig, cE: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.aF);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aM: newEntry, bn: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aM: newEntry,
								bn: A2($elm$core$List$cons, existing.aM, existing.bn)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							z: _Utils_update(
								state,
								{
									aF: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.aF)
								})
						});
				}),
			data,
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'offset',
						$elm$json$Json$Encode$float(sample.dm)),
						_Utils_Tuple2(
						'value',
	...
	function (s, durationMs) {
		...
		return A2(
			...
			function (i) {
				...
				return {
					dm: offset,
					dN: A2($author$project$Shared$Spring$valueAt, motion, offset * durationMs)
				};
			},
			A2($elm$core$List$range, 0, n - 1));
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.V, dimensions.c6);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'delay',
												$elm$json$Json$Encode$int(config.x))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.A, config.b$, config.bD))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bE));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bE));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bE));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bE));
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						A2($author$project$Anim$Internal$Engine$WAAPI$Encoder$touchedAxesForGroup, animGroupName, touchedAxes))(playback.u)(playback.C)(config.t));
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cA));
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						bE: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.bE, start)
					};
				case 3:
					var config = property.a;
					return {
						...
						bE: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOriginUnits,
							config.F,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.bE, start))
					};
				case 4:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.n, end),
						bE: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.bE, start)
					};
				case 5:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.n, end),
						bE: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.bE, start)
					};
				case 6:
					var config = property.a;
					return {
						...
						bE: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
							config.F,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.bE, start))
					};
				case 7:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.n, end),
						bE: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.bE, start)
					};
				default:
					var config = property.a;
					return {
						...
						bE: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setTranslateUnits,
							config.F,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.bE, start))
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{n: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, bE: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
	...
	function (iterations, animationDirection, globalTransformOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var snapshot = function () {
			if (!existingAnimation.$) {
				...
				return A2($author$project$Anim$Internal$Builder$PropertyBaselines$merge, animationBounds.bE, snapBounds.n);
			}
		}();
			...
			A2(
				...
				function (property) {
					...
					return _Utils_Tuple2(
						propType,
						{
							K: A2($author$project$Anim$Internal$Engine$WAAPI$Generator$resolveStartFromSnapshot, snapshot, property),
							ch: initialStatus,
							bM: newVersion
						});
				},
...
var $author$project$Anim$Internal$Engine$WAAPI$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					ft: $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$WAAPI$animate = F2(
	function (_v0, build) {
		...
		var hasSnap = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$groups(processed.cA));
		var processedAnimGroups = A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cA));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$WAAPI$AnimState,
			_Utils_update(
				state,
		...
		return A2(
			...
			function (defs) {
				return _Utils_update(
					defs,
					{
						aA: $elm$core$Maybe$Just(easingValue),
...
var $author$project$Animation$WAAPI$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$frontFace.v, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$backFace.v, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.v, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.v, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$topFace.v, 0, 0),
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.v, 0, 0))))));
...
var $author$project$Animation$WAAPI$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$frontFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$backFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$topFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.v, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360))))));
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aE: animGroupName, de: isAnimating, aa: progress, dz: propertyProgress, cI: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bQ: animGroup, eu: commandVersion, cb: rotate, ce: scale, cf: skew, cm: translate};
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.z.aF));
	});
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {c6: hNormalized, dg: l * 100, dF: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cV: rgba_.cV, c5: rgba_.c5, dC: rgba_.dC};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cR: rgba_.cR, c6: hsla_.c6, dg: hsla_.dg, dF: hsla_.dF};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {c6: hslaValue.c6, dg: hslaValue.dg, dF: hslaValue.dF};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cR: 1.0, c6: hslValue.c6, dg: hslValue.dg, dF: hslValue.dF};
	}
};
var $author$project$Anim$Internal$Extra$Color$hexToRgba = function (hex_) {
	...
	return {cR: alpha_, cV: rgb_.cV, c5: rgb_.c5, dC: rgb_.dC};
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{c6: hslaValue.c6, dg: hslaValue.dg, dF: hslaValue.dF});
	return {cR: hslaValue.cR, cV: rgb_.cV, c5: rgb_.c5, dC: rgb_.dC};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cR: 1.0, cV: rgb_.cV, c5: rgb_.c5, dC: rgb_.dC};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.c5 + ((endRgb.c5 - startRgb.c5) * t));
							var r = $elm$core$Basics$round(startRgb.dC + ((endRgb.dC - startRgb.dC) * t));
							var b = $elm$core$Basics$round(startRgb.cV + ((endRgb.cV - startRgb.cV) * t));
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.dC + ((endRgba.dC - startRgba.dC) * t));
							var g = $elm$core$Basics$round(startRgba.c5 + ((endRgba.c5 - startRgba.c5) * t));
							var b = $elm$core$Basics$round(startRgba.cV + ((endRgba.cV - startRgba.cV) * t));
							var a = startRgba.cR + ((endRgba.cR - startRgba.cR) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.dF + ((endHsl.dF - startHsl.dF) * t);
							var l = startHsl.dg + ((endHsl.dg - startHsl.dg) * t);
							var h = startHsl.c6 + ((endHsl.c6 - startHsl.c6) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.dF + ((endHsla.dF - startHsla.dF) * t);
							var l = startHsla.dg + ((endHsla.dg - startHsla.dg) * t);
							var h = startHsla.c6 + ((endHsla.c6 - startHsla.c6) * t);
							var a = startHsla.cR + ((endHsla.cR - startHsla.cR) * t);
			...
			F3(
				function (propType, rawProgress, acc) {
					...
					if (_v0.$ === 1) {
						...
						var propState = _v0.a;
						return A3($author$project$Anim$Internal$Engine$WAAPI$ProgressApply$applyConfigProgress, propState.K, rawProgress, acc);
					}
				}),
			baselines,
			propertyProgress);
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cI);
				if (_v2.$ === 1) {
					return propAnim;
				} else {
			...
			F2(
				function (propType, _v0) {
					var _v1 = _Utils_Tuple2(
						A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cI),
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var updatedAnimations = A3(
							...
							animGroups);
						var shouldEmitProgress = A2($author$project$Anim$Internal$Builder$getEmitProgressFor, animUpdate.aE, state.r);
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aE, animUpdate.aa)) : $elm$core$Maybe$Nothing;
		...
		switch (msg.$) {
			...
			case 2:
				var _v1 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.I,
					A2($author$project$Animation$WAAPI$Animate3D$Main$selectAnimation, $author$project$Animation$WAAPI$Animate3D$Main$depth, model.z));
				var animState = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Anim$Internal$Builder$getAnimationConfigs = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.z.aF);
		if (_v1.$ === 1) {
			return _List_Nil;
		} else {
			var h = _v1.a;
			return A2(
				...
				A2($elm$core$List$cons, h.aM, h.bn));
		}
	});
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = F2(
	function (axes, _v0) {
		var dimensions = _v0;
		return _Utils_ap(
			$elm$core$String$fromFloat(dimensions.c6),
		...
		return A2(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background-color', config.aH),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.aI),
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$div,
					_Utils_ap(
						A2($author$project$Anim$Engine$WAAPI$attributes, config.v.o, animState),
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id(config.v.L),
								A2($elm$html$Html$Attributes$style, 'color', config.v.aJ),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
							$elm$html$Html$text(config.v.N)
						]))
				]));
	});
...
var $author$project$Animation$WAAPI$Animate3D$Main$main = $elm$browser$Browser$document(
	{
		...
		fQ: $author$project$Animation$WAAPI$Animate3D$Main$subscriptions,
		ge: $author$project$Animation$WAAPI$Animate3D$Main$update,
		gf: $author$project$Animation$WAAPI$Animate3D$Main$view
	});
