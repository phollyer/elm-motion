...
var $author$project$Anim$Internal$Builder$initDefaults = {ab: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, ch: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a4: $elm$core$Dict$empty, b9: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, av: 0, cr: $elm$core$Dict$empty, cs: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fq: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						ct: $elm$core$Basics$abs(clampedEnd - startForDistance),
						n: clampedEnd,
						bz: clampedStart
					});
			}
	...
	function (endValue, _v0) {
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					ct: $elm$core$Basics$abs(endValue - startValue),
					n: endValue,
					bz: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aB: animGroupName, da: isAnimating, W: progress, dv: propertyProgress, cE: propertyVersions};
	});
...
var $author$project$Animation$WAAPI$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$BorderRadius$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$BorderRadius$Main$update,
		gc: $author$project$Animation$WAAPI$BorderRadius$Main$view
	});
