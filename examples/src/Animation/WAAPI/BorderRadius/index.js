...
var $author$project$Animation$WAAPI$BorderRadius$Main$animGroup = 'radiusAnim';
...
var $author$project$Anim$Internal$Builder$initDefaults = {N: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, Z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, bF: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, ca: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (cssName, builder, config) {
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				var clampedEnd = A3($elm$core$Basics$clamp, lo, hi, config.n);
				return _Utils_update(
					config,
					{
						cu: $elm$core$Basics$abs(clampedEnd - startForDistance),
						n: clampedEnd,
						bA: clampedStart
					});
			}
	...
	function (endValue, _v0) {
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					cu: $elm$core$Basics$abs(endValue - startValue),
					n: endValue,
					bA: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Animation$WAAPI$BorderRadius$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$BorderRadius$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$BorderRadius$Main$init = _Utils_Tuple2(
	{
		aa: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$BorderRadius$Main$motionCmd,
			$author$project$Animation$WAAPI$BorderRadius$Main$motionMsg,
			_List_fromArray(
				[
					A3(
					$author$project$Anim$Property$Custom$init,
					$author$project$Animation$WAAPI$BorderRadius$Main$animGroup,
					$author$project$Anim$Property$Custom$BorderRadius(30),
					0)
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$BorderRadius$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$BorderRadius$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$BorderRadius$Main$GotWaapiMsg, model.aa);
};
...
var $author$project$Animation$WAAPI$BorderRadius$Main$standardTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$BorderRadius$Main$roundCorners = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$BorderRadius$Main$standardTiming, $author$project$Anim$Property$Custom$end)));
var $author$project$Animation$WAAPI$BorderRadius$Main$squareCorners = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Custom$begin(
		$author$project$Anim$Property$Custom$BorderRadius(30)),
	A2(
...
var $author$project$Animation$WAAPI$BorderRadius$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$BorderRadius$Main$animGroup),
						$author$project$Animation$WAAPI$BorderRadius$Main$roundCorners));
			...
			default:
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$BorderRadius$Main$animGroup),
						$author$project$Animation$WAAPI$BorderRadius$Main$squareCorners));
...
var $author$project$Animation$WAAPI$BorderRadius$Main$TriggerRound = {$: 1};
var $author$project$Animation$WAAPI$BorderRadius$Main$TriggerSquare = {$: 2};
...
var $author$project$Animation$WAAPI$BorderRadius$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$BorderRadius$Main$TriggerRound),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$BorderRadius$Main$TriggerSquare),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$BorderRadius$Main$animGroup, model.aa),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$BorderRadius$Main$init;
		},
		fO: $author$project$Animation$WAAPI$BorderRadius$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$BorderRadius$Main$update,
		gd: $author$project$Animation$WAAPI$BorderRadius$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'BorderRadius':{'Main':{'init':$author$project$Animation$WAAPI$BorderRadius$Main$main(
