...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$DiscreteProperties$Main$update,
		gc: $author$project$Animation$WAAPI$DiscreteProperties$Main$view
	});
