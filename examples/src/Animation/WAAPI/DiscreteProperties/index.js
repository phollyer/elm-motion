...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup = 'fadeAnim';
	...
	function (propertyName, value, _v0) {
		...
		if (_v1.$ === 1) {
			...
			return _Utils_update(
				data,
				{
					b: _Utils_update(
						pb,
						{
							f: A3($elm$core$Dict$insert, propertyName, value, pb.f),
							bu: true
						})
				});
		} else {
			...
			var currentGroupConfig = A2(
				...
				{f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, e: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, s: _List_Nil, p: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing},
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.C));
			var currentEntryProperties = A2($elm$core$Maybe$withDefault, data.b.f, currentGroupConfig.f);
			return A2(
...
var $author$project$Anim$Internal$Engine$WAAPI$discreteEntry = $author$project$Anim$Internal$Builder$discreteEntry;
var $author$project$Anim$Engine$WAAPI$discreteEntry = $author$project$Anim$Internal$Engine$WAAPI$discreteEntry;
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$DiscreteProperties$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$DiscreteProperties$Main$init = _Utils_Tuple2(
	{
		aa: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$DiscreteProperties$Main$motionCmd,
			$author$project$Animation$WAAPI$DiscreteProperties$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Engine$WAAPI$discreteEntry, 'display', 'none'),
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup, 0))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$DiscreteProperties$Main$GotWaapiMsg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$DiscreteProperties$Main$GotWaapiMsg, model.aa);
};
	...
	function (propertyName, from, to, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var currentGroupConfig = A2(
				...
				{f: $elm$core$Maybe$Nothing, g: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, e: $elm$core$Maybe$Nothing, b: $elm$core$Maybe$Nothing, s: _List_Nil, p: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing},
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.a.C));
			var currentExitProperties = A2($elm$core$Maybe$withDefault, data.b.g, currentGroupConfig.g);
			return A2(
				$author$project$Anim$Internal$Builder$updateCurrentConfig,
				_Utils_update(
					currentGroupConfig,
...
var $author$project$Anim$Internal$Engine$WAAPI$discreteExit = $author$project$Anim$Internal$Builder$discreteExit;
var $author$project$Anim$Engine$WAAPI$discreteExit = $author$project$Anim$Internal$Engine$WAAPI$discreteExit;
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$fadeOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var _v1 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup),
						A2(
							$elm$core$Basics$composeR,
							A2($author$project$Anim$Engine$WAAPI$discreteEntry, 'display', 'flex'),
							$author$project$Animation$WAAPI$DiscreteProperties$Main$fadeIn)));
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							A3($author$project$Anim$Engine$WAAPI$discreteExit, 'display', 'flex', 'none'),
							$author$project$Animation$WAAPI$DiscreteProperties$Main$fadeOut)));
			...
			default:
				var waapiMsg = msg.a;
				var _v3 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.aa);
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$Hide = {$: 1};
var $author$project$Animation$WAAPI$DiscreteProperties$Main$Show = {$: 0};
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$DiscreteProperties$Main$Show),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$DiscreteProperties$Main$Hide),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup, model.aa),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$DiscreteProperties$Main$init;
		},
		fO: $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$DiscreteProperties$Main$update,
		gd: $author$project$Animation$WAAPI$DiscreteProperties$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'DiscreteProperties':{'Main':{'init':$author$project$Animation$WAAPI$DiscreteProperties$Main$main(
