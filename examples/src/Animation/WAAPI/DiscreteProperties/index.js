...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$DiscreteProperties$Main$GotWaapiMsg, model._);
};
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var waapiMsg = msg.a;
				var _v3 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model._);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup, model._),
					_List_fromArray(
						[
