...
var $author$project$Animation$WAAPI$Easings$Main$animGroup = 'easingBox';
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cP: x0, cT: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b3: omegaD, bL: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cv: 0, bY: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, ch: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Easings$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$Easings$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$Easings$Main$init = _Utils_Tuple2(
	{
		aE: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$Easings$Main$motionCmd,
			$author$project$Animation$WAAPI$Easings$Main$motionMsg,
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$WAAPI$Easings$Main$animGroup, 0)
				])),
		bt: false,
		bY: $author$project$Motion$Easing$CubicOut
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$Easings$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$Easings$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Easings$Main$GotWaapiMsg, model.aE);
};
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				bY: $elm$core$Maybe$Just(easing_),
				bA: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Animation$WAAPI$Easings$Main$animateTo = F2(
	function (x, easing) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$Easings$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var waapiMsg = msg.a;
			...
			var easing = msg.a;
			var target = model.bt ? 0 : 420;
			var _v2 = A2(
				$author$project$Anim$Engine$WAAPI$animate,
				model.aE,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$Easings$Main$animGroup),
					A2($author$project$Animation$WAAPI$Easings$Main$animateTo, target, easing)));
			var newAnimState = _v2.a;
			var cmd = _v2.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{aE: newAnimState, bt: !model.bt, bY: easing}),
				cmd);
		}
	});
...
var $author$project$Animation$WAAPI$Easings$Main$Play = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Animation$WAAPI$Easings$Main$curveButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Animation$WAAPI$Easings$Main$Play(easing)),
...
var $author$project$Animation$WAAPI$Easings$Main$curves = _List_fromArray(
	[
...
var $author$project$Animation$WAAPI$Easings$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$WAAPI$Easings$Main$curveButton(model.bY),
					$author$project$Animation$WAAPI$Easings$Main$curves)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Easings$Main$animGroup, model.aE),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$Easings$Main$main = $elm$browser$Browser$element(
	{
		e_: function (_v0) {
			return $author$project$Animation$WAAPI$Easings$Main$init;
		},
		fP: $author$project$Animation$WAAPI$Easings$Main$subscriptions,
		gd: $author$project$Animation$WAAPI$Easings$Main$update,
		ge: $author$project$Animation$WAAPI$Easings$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'Easings':{'Main':{'init':$author$project$Animation$WAAPI$Easings$Main$main(
