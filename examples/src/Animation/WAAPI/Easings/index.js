	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cP: x0, cT: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b2: omegaD, bK: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cv: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Easings$Main$init = _Utils_Tuple2(
	{
		...
		bt: false,
		bX: $author$project$Motion$Easing$CubicOut
	},
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{aE: newAnimState, bt: !model.bt, bX: easing}),
				cmd);
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$WAAPI$Easings$Main$curveButton(model.bX),
