...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aX: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bF: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Easings$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Easings$Main$GotWaapiMsg, model.aB);
};
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{aB: newAnimState, bs: !model.bs, bX: easing}),
				cmd);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Easings$Main$animGroup, model.aB),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$Easings$Main$main = $elm$browser$Browser$element(
	{
		...
		fO: $author$project$Animation$WAAPI$Easings$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$Easings$Main$update,
		gd: $author$project$Animation$WAAPI$Easings$Main$view
	});
