...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, ct: 0, bW: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, cf: $elm$core$Maybe$Nothing};
};
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aG.H);
					}
				}(
					A2(
						$elm$core$Maybe$map,
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {c2: record.c3, Q: record.dN};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {c3: dimensions.c2, dN: dimensions.Q};
};
		...
		var mergeWH = F3(
			function (touched, previousRec, value) {
				...
				return $author$project$Anim$Internal$Property$Size$fromRecord(
					{
						c3: A3(pick, 'height', rec.c3, previousRec.c3),
						dN: A3(pick, 'width', rec.dN, previousRec.dN)
					});
			});
									...
									if (_v3.b.a.$ === 8) {
										...
										if (isFullyTouchedXYZ(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
																bz: $elm$core$Maybe$Just(newStart)
															}))
												});
										}
									} else {
									...
									if (_v3.b.a.$ === 4) {
										...
										if (isFullyTouchedXYZ(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedRotateConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
									...
									if (_v3.b.a.$ === 5) {
										...
										if (isFullyTouchedXYZ(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedScaleConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
									...
									if (_v3.b.a.$ === 7) {
										...
										if (isFullyTouchedXY(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedSkewConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
									...
									if (_v3.b.a.$ === 3) {
										...
										if (isFullyTouchedXY(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
									...
									if (_v3.b.a.$ === 6) {
										...
										if (isFullyTouchedWH(touched)) {
											...
											return _Utils_update(
												propState,
												{
													H: $author$project$Anim$Internal$Builder$ProcessedSizeConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
...
var $author$project$Animation$WAAPI$Retarget$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$Retarget$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$Retarget$Main$update,
		gc: $author$project$Animation$WAAPI$Retarget$Main$view
	});
