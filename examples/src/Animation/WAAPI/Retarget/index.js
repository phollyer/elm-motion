...
var $author$project$Animation$WAAPI$Retarget$Main$animGroup = 'square';
...
var $author$project$Anim$Internal$Builder$initDefaults = {N: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, _: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aJ: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, bF: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ax: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, Y: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Rotate$default, ae: $author$project$Anim$Internal$Property$Rotate$distance, af: $author$project$Anim$Internal$Property$Rotate$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Rotate$speed, aq: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Scale$default, ae: $author$project$Anim$Internal$Property$Scale$distance, af: $author$project$Anim$Internal$Property$Scale$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Scale$speed, aq: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{G: config, ac: $author$project$Anim$Internal$Unit$default, ad: $author$project$Anim$Internal$Property$Skew$default, ae: $author$project$Anim$Internal$Property$Skew$distance, af: $author$project$Anim$Internal$Property$Skew$duration, i: globalData.i, ag: globalData, ao: $author$project$Anim$Internal$Property$Skew$speed, aq: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
		...
		if (maybeGroup.$ === 1) {
			...
			var updateDefaultsCssUnits = function (defaultsConfig) {
				return _Utils_update(
					defaultsConfig,
					{
						N: A4($author$project$Anim$Internal$Builder$CssUnitStore$set, group, slot, unit, defaultsConfig.N)
					});
			};
			var defs = data.c;
			var animation = data.a;
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Retarget$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$Retarget$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$Retarget$Main$init = _Utils_Tuple2(
	{
		S: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$Retarget$Main$motionCmd,
			$author$project$Animation$WAAPI$Retarget$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$Retarget$Main$animGroup, 0, 0),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$Retarget$Main$GotWaapiMsg = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Animation$WAAPI$Retarget$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Retarget$Main$GotWaapiMsg, model.S);
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {G: groupConfig, cB: kind};
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										'unitX',
										$elm$json$Json$Encode$string(
											$author$project$Anim$Internal$Unit$toCssSuffix(config.D.ar))),
										_Utils_Tuple2(
										'unitY',
										$elm$json$Json$Encode$string(
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeTransformBaseline(snapshot))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(config.j)(config.e)(config.f)(config.g)(effectiveTouchedAxes)(config.cr)(playback.t)(playback.A)(config.s));
			},
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.G.cr);
					}),
				$elm$core$Dict$empty,
...
var $author$project$Animation$WAAPI$Retarget$Main$boxSize = 12;
var $author$project$Animation$WAAPI$Retarget$Main$endXY = 100 - $author$project$Animation$WAAPI$Retarget$Main$boxSize;
var $author$project$Anim$Property$Translate$toXY = $author$project$Anim$Internal$Builder$Translate$toXY;
var $author$project$Animation$WAAPI$Retarget$Main$animateDiagonal = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Translate$toXY, $author$project$Animation$WAAPI$Retarget$Main$endXY, $author$project$Animation$WAAPI$Retarget$Main$endXY),
		A2(
			$elm$core$Basics$composeR,
			...
			function (h) {
				...
				return function (result) {
					if (!result.$) {
						...
						return $elm$core$Maybe$Just(h.aw.G);
					}
				}(
					A2(
						$elm$core$Maybe$map,
...
var $author$project$Anim$Internal$Builder$setBaselinesFromProcessedEnds = F3(
	function (animGroupName, props, _v0) {
		...
		var existing = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Builder$PropertyBaselines$empty,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.T));
		...
		return _Utils_update(
			data,
			{
				u: _Utils_update(
					state,
					{
						T: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, merged, state.T)
					})
			});
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$resetSingleKey = F2(
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var startStates = $author$project$Anim$Internal$Engine$WAAPI$Generator$propertyBounds(properties).bA;
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeRetarget = $author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimateLike('retarget');
...
var $author$project$Anim$Internal$Builder$getAllTouchedAxes = function (_v0) {
	var data = _v0;
	return data.a.bo;
};
...
var $author$project$Anim$Internal$Property$PerspectiveOrigin$toRecord = function (_v0) {
	var rec = _v0;
	return rec;
};
...
var $author$project$Anim$Internal$Property$Skew$toRecord = function (_v0) {
	var values = _v0;
	return {ar: values.ar, as: values.as};
};
var $author$project$Anim$Internal$Engine$WAAPI$retarget = F2(
	function (_v0, build) {
		var state = _v0.a;
		var animGroups = _v0.b;
		var mergeXYZ = F5(
			function (touched, previousRec, toRec, fromRec, value) {
				var rec = toRec(value);
				var pick = F3(
					function (axis, cur, prev) {
						return A2($elm$core$Set$member, axis, touched) ? cur : prev;
					});
				return fromRec(
					{
						ar: A3(pick, 'x', rec.ar, previousRec.ar),
						as: A3(pick, 'y', rec.as, previousRec.as),
						at: A3(pick, 'z', rec.at, previousRec.at)
					});
			});
		var mergeXY = F5(
			function (touched, previousRec, toRec, fromRec, value) {
		...
		var mergeWH = F3(
			function (touched, previousRec, value) {
				var rec = $author$project$Anim$Internal$Property$Size$toRecord(value);
				var pick = F3(
					function (axis, cur, prev) {
						return A2($elm$core$Set$member, axis, touched) ? cur : prev;
					});
				return $author$project$Anim$Internal$Property$Size$fromRecord(
					{
						c4: A3(pick, 'height', rec.c4, previousRec.c4),
						dO: A3(pick, 'width', rec.dO, previousRec.dO)
					});
			});
		var isFullyTouchedXYZ = function (touched) {
			return A2($elm$core$Set$member, 'x', touched) && (A2($elm$core$Set$member, 'y', touched) && A2($elm$core$Set$member, 'z', touched));
		};
		var isFullyTouchedXY = function (touched) {
			return A2($elm$core$Set$member, 'x', touched) && A2($elm$core$Set$member, 'y', touched);
		};
		var isFullyTouchedWH = function (touched) {
			return A2($elm$core$Set$member, 'width', touched) && A2($elm$core$Set$member, 'height', touched);
		};
		var patchAxesPropState = F3(
			function (touched, maybeExistingState, propState) {
				if ($elm$core$Set$isEmpty(touched)) {
					return propState;
				} else {
							...
							switch (_v3.a.$) {
								case 8:
									if (_v3.b.a.$ === 8) {
										var cfg = _v3.a.a;
										var prev = _v3.b.a.a;
										if (isFullyTouchedXYZ(touched)) {
											return propState;
										} else {
											var previousRec = $author$project$Anim$Internal$Property$Translate$toRecord(prev.n);
											var newEnd = A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Translate$toRecord, $author$project$Anim$Internal$Property$Translate$fromRecord, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													function (s) {
														return A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Translate$toRecord, $author$project$Anim$Internal$Property$Translate$fromRecord, s);
													},
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
																bA: $elm$core$Maybe$Just(newStart)
															}))
												});
										}
									} else {
								...
								case 4:
									if (_v3.b.a.$ === 4) {
										...
										if (isFullyTouchedXYZ(touched)) {
											...
											var previousRec = $author$project$Anim$Internal$Property$Rotate$toRecord(prev.n);
											var newEnd = A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Rotate$toRecord, $author$project$Anim$Internal$Property$Rotate$fromRecord, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													function (s) {
														return A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Rotate$toRecord, $author$project$Anim$Internal$Property$Rotate$fromRecord, s);
													},
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedRotateConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
								...
								case 5:
									if (_v3.b.a.$ === 5) {
										...
										if (isFullyTouchedXYZ(touched)) {
											...
											var previousRec = $author$project$Anim$Internal$Property$Scale$toRecord(prev.n);
											var newEnd = A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Scale$toRecord, $author$project$Anim$Internal$Property$Scale$fromRecord, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													function (s) {
														return A5(mergeXYZ, touched, previousRec, $author$project$Anim$Internal$Property$Scale$toRecord, $author$project$Anim$Internal$Property$Scale$fromRecord, s);
													},
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedScaleConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
								...
								case 7:
									if (_v3.b.a.$ === 7) {
										var cfg = _v3.a.a;
										var prev = _v3.b.a.a;
										if (isFullyTouchedXY(touched)) {
											return propState;
										} else {
											var previousRec = $author$project$Anim$Internal$Property$Skew$toRecord(prev.n);
											var newEnd = A5(mergeXY, touched, previousRec, $author$project$Anim$Internal$Property$Skew$toRecord, $author$project$Anim$Internal$Property$Skew$fromRecord, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													function (s) {
														return A5(mergeXY, touched, previousRec, $author$project$Anim$Internal$Property$Skew$toRecord, $author$project$Anim$Internal$Property$Skew$fromRecord, s);
													},
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedSkewConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
								...
								case 3:
									if (_v3.b.a.$ === 3) {
										...
										if (isFullyTouchedXY(touched)) {
											...
											var previousRec = $author$project$Anim$Internal$Property$PerspectiveOrigin$toRecord(prev.n);
											var newEnd = A5(mergeXY, touched, previousRec, $author$project$Anim$Internal$Property$PerspectiveOrigin$toRecord, $author$project$Anim$Internal$Property$PerspectiveOrigin$fromRecord, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													function (s) {
														return A5(mergeXY, touched, previousRec, $author$project$Anim$Internal$Property$PerspectiveOrigin$toRecord, $author$project$Anim$Internal$Property$PerspectiveOrigin$fromRecord, s);
													},
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
								...
								case 6:
									if (_v3.b.a.$ === 6) {
										var cfg = _v3.a.a;
										var prev = _v3.b.a.a;
										if (isFullyTouchedWH(touched)) {
											return propState;
										} else {
											var previousRec = $author$project$Anim$Internal$Property$Size$toRecord(prev.n);
											var newEnd = A3(mergeWH, touched, previousRec, cfg.n);
											var newStart = A2(
												$elm$core$Maybe$withDefault,
												newEnd,
												A2(
													$elm$core$Maybe$map,
													A2(mergeWH, touched, previousRec),
													cfg.bA));
											return _Utils_update(
												propState,
												{
													G: $author$project$Anim$Internal$Builder$ProcessedSizeConfig(
														_Utils_update(
															cfg,
															{
																n: newEnd,
		...
		var touchedAxes = $author$project$Anim$Internal$Builder$getAllTouchedAxes(builder);
		var touchedAxesFor = F2(
			function (groupName, propType) {
				return A2(
					$elm$core$Maybe$withDefault,
					$elm$core$Set$empty,
					A2(
						$elm$core$Dict$get,
						_Utils_Tuple2(groupName, propType),
						touchedAxes));
			});
		var preserveUntouchedAxesConfig = F3(
			function (groupName, maybeExisting, freshAnimGroup) {
				if (maybeExisting.$ === 1) {
					return freshAnimGroup;
				} else {
					var existing = maybeExisting.a;
					var states = $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertyStates(freshAnimGroup);
					var existingStates = $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertyStates(existing);
					var patched = A2(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
						F2(
							function (propType, propState) {
								return A3(
									patchAxesPropState,
									A2(touchedAxesFor, groupName, propType),
									A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, existingStates),
									propState);
							}),
						states);
					return A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setPropertyStates, patched, freshAnimGroup);
				}
			});
		var snapPropertyStates = F3(
			function (groupName, maybeExisting, freshAnimGroup) {
				var patchedGroup = A3(preserveUntouchedAxesConfig, groupName, maybeExisting, freshAnimGroup);
				var touchedStates = $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertyStates(patchedGroup);
				var fullProgress = $elm$core$Dict$fromList(
					A2(
						$elm$core$List$map,
						function (name) {
							return _Utils_Tuple2(name, 1.0);
						},
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(touchedStates)));
				var snappedSnapshot = A3(
					$author$project$Anim$Internal$Engine$WAAPI$ProgressApply$applyPropertyProgress,
					fullProgress,
					touchedStates,
					$author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(patchedGroup));
				return A2(
					$author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setStatus,
					3,
					A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setSnapshot, snappedSnapshot, patchedGroup));
			});
		var insertSnap = F3(
			function (animGroupName, freshAnimGroup, acc) {
				var maybeExisting = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, acc);
				var snapped = A3(snapPropertyStates, animGroupName, maybeExisting, freshAnimGroup);
				if (maybeExisting.$ === 1) {
					return A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, snapped, acc);
				} else {
					var existing = maybeExisting.a;
					return A3(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$insert,
						animGroupName,
						A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$addPropertyStates, snapped, existing),
						acc);
				}
			});
		var nextAnimGroups = A3(
			...
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cx));
		var nextSubscriptionsActive = A2(
			$elm$core$List$any,
			$author$project$Anim$Internal$Engine$WAAPI$AnimGroup$isRunning,
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$groups(nextAnimGroups));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$WAAPI$AnimState,
			_Utils_update(
				state,
				{
					...
					aa: nextSubscriptionsActive
				}),
			nextAnimGroups);
		var retargetCmd = state.L(
			A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeRetarget, nextAnimGroups, touchedAxes, processed));
		return _Utils_Tuple2(nextState, retargetCmd);
	});
var $author$project$Anim$Engine$WAAPI$retarget = $author$project$Anim$Internal$Engine$WAAPI$retarget;
...
var $author$project$Animation$WAAPI$Retarget$Main$retargetYToTop = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$begin,
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, subMsg, model.S);
			...
			case 0:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$Retarget$Main$animGroup),
						$author$project$Animation$WAAPI$Retarget$Main$animateDiagonal));
			...
			case 1:
				var _v3 = A2(
					$author$project$Anim$Engine$WAAPI$retarget,
					model.S,
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$Retarget$Main$animGroup),
						$author$project$Animation$WAAPI$Retarget$Main$retargetYToTop));
				...
				return _Utils_Tuple2(
					...
					animCmd);
			default:
				var _v4 = A2($author$project$Anim$Engine$WAAPI$reset, $author$project$Animation$WAAPI$Retarget$Main$animGroup, model.S);
...
var $author$project$Animation$WAAPI$Retarget$Main$Animate = {$: 0};
var $author$project$Animation$WAAPI$Retarget$Main$Reset = {$: 2};
var $author$project$Animation$WAAPI$Retarget$Main$RetargetY = {$: 1};
...
var $author$project$Animation$WAAPI$Retarget$Main$animationArea = function (animState) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Retarget$Main$animGroup, animState),
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'width',
							$elm$core$String$fromFloat($author$project$Animation$WAAPI$Retarget$Main$boxSize) + 'cqw'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$WAAPI$Retarget$Main$boxSize) + 'cqh'),
...
var $author$project$Animation$WAAPI$Retarget$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$Retarget$Main$Animate),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$Retarget$Main$RetargetY),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$Retarget$Main$Reset),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Press Animate, then mid-flight press \u0022Retarget Y to 0\u0022. The WAAPI engine snaps Y to 0 while X keeps gliding toward the right edge uninterrupted.')
					])),
				$author$project$Animation$WAAPI$Retarget$Main$animationArea(model.S)
			]));
};
var $author$project$Animation$WAAPI$Retarget$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$Retarget$Main$init;
		},
		fO: $author$project$Animation$WAAPI$Retarget$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$Retarget$Main$update,
		gd: $author$project$Animation$WAAPI$Retarget$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'Retarget':{'Main':{'init':$author$project$Animation$WAAPI$Retarget$Main$main(
