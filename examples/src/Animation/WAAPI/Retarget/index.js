...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ax: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {c3: 0, Q: 0};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cu: 0, bW: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cf: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Retarget$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Retarget$Main$GotWaapiMsg, model.R);
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.c3);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bW, config.bz))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {c3: record.c4, Q: record.dO};
};
...
var $author$project$Anim$Internal$Property$Size$toRecord = function (_v0) {
	var dimensions = _v0;
	return {c4: dimensions.c3, dO: dimensions.Q};
};
...
var $author$project$Animation$WAAPI$Retarget$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 3:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, subMsg, model.R);
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					animCmd);
			default:
				var _v4 = A2($author$project$Anim$Engine$WAAPI$reset, $author$project$Animation$WAAPI$Retarget$Main$animGroup, model.R);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$WAAPI$Retarget$Main$animationArea(model.R)
			]));
};
