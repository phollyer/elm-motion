				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {av: newEntry, a$: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								av: newEntry,
								a$: A2($elm$core$List$cons, existing.av, existing.a$)
							};
						}
					}();
...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bn: $elm$core$Dict$empty};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var c = A2($elm$core$Basics$max, 0, spring.aX);
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cO: x0, cS: (v0 + ((zeta * omega0) * x0)) / omegaD, ai: omega0, b0: omegaD, bI: zeta});
		} else {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bV, config.by))))))));
			case 1:
				var cssName = property.a;
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, aw: 0, cs: $elm$core$Dict$empty, ct: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.av, history.a$));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Animation$WAAPI$PulsingDot$Main$groupName = 'pulsingDot';
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ay: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, cg: $elm$core$Set$empty, aC: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bL: $elm$core$Maybe$Nothing, h: false, cb: $elm$core$Maybe$Nothing, bB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {at: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a4: $elm$core$Dict$empty, b8: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cu: 0, bV: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, ce: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.b8);
	});
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bz: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.bz);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					...
					n: endPos,
					bz: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Animation$WAAPI$PulsingDot$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$PulsingDot$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
...
var $author$project$Anim$Engine$WAAPI$alternate = $author$project$Anim$Internal$Builder$alternate;
	...
	if (_v1.$ === 1) {
		...
		return _Utils_update(
			data,
			{
				b: _Utils_update(
					pb,
					{t: $author$project$Anim$Internal$Builder$Infinite})
			});
	} else {
		return A2(
			$author$project$Anim$Internal$Builder$updateCurrentConfig,
				...
				b: $elm$core$Maybe$Just(
					{
						...
						t: $elm$core$Maybe$Just($author$project$Anim$Internal$Builder$Infinite)
					}),
				s: _List_Nil,
				p: $elm$core$Maybe$Nothing,
				j: $elm$core$Maybe$Nothing,
...
var $author$project$Anim$Internal$Engine$WAAPI$loopForever = $author$project$Anim$Internal$Builder$loopForever;
var $author$project$Anim$Engine$WAAPI$loopForever = $author$project$Anim$Internal$Engine$WAAPI$loopForever;
...
var $author$project$Animation$WAAPI$PulsingDot$Main$pulse = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Engine$WAAPI$loopForever,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$WAAPI$alternate,
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$PulsingDot$Main$init = function () {
	var animState = A3(
		$author$project$Anim$Engine$WAAPI$init,
		$author$project$Animation$WAAPI$PulsingDot$Main$motionCmd,
		$author$project$Animation$WAAPI$PulsingDot$Main$motionMsg,
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Scale$init, $author$project$Animation$WAAPI$PulsingDot$Main$groupName, 1),
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$PulsingDot$Main$groupName, 1)
			]));
	var _v0 = A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$PulsingDot$Main$groupName),
			$author$project$Animation$WAAPI$PulsingDot$Main$pulse));
	...
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				A2($elm$core$List$cons, h.av, h.a$));
		}
	});
...
var $author$project$Animation$WAAPI$PulsingDot$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$PulsingDot$Main$groupName, model.co),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$PulsingDot$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$PulsingDot$Main$init;
		},
		...
		gd: $author$project$Animation$WAAPI$PulsingDot$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'PulsingDot':{'Main':{'init':$author$project$Animation$WAAPI$PulsingDot$Main$main(
