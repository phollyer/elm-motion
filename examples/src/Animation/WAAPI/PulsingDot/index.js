...
{
	if (region.by.bu === region.n.bu)
	{
		return 'on line ' + region.by.bu;
	}
	return 'on lines ' + region.by.bu + ' through ' + region.n.bu;
}
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.x;
					var newEntry = {H: groupConfig, cA: kind};
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.aB);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aF: newEntry, bh: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aF: newEntry,
								bh: A2($elm$core$List$cons, existing.aF, existing.bh)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							x: _Utils_update(
								state,
								{
									aB: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.aB)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aW: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bD: $elm$core$Dict$empty};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var k = A2($elm$core$Basics$max, 0, spring.a6);
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.Q, dimensions.c2);
};
		...
		switch (property.$) {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bV, config.bx))))))));
			case 1:
				var cssName = property.a;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.by));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.by));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.by));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.by));
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, au: 0, cr: $elm$core$Dict$empty, cs: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fq: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, ak: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						by: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.by, start)
					};
				case 3:
					var config = property.a;
					return {
						...
						by: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOriginUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.by, start))
					};
				case 4:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.n, end),
						by: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.by, start)
					};
				case 5:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.n, end),
						by: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.by, start)
					};
				case 6:
					var config = property.a;
					return {
						...
						by: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.by, start))
					};
				case 7:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.n, end),
						by: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.by, start)
					};
				default:
					var config = property.a;
					return {
						...
						by: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setTranslateUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.by, start))
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{n: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, by: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
	...
	function (iterations, animationDirection, globalTransformOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var snapshot = function () {
			if (!existingAnimation.$) {
				...
				return A2($author$project$Anim$Internal$Builder$PropertyBaselines$merge, animationBounds.by, snapBounds.n);
			}
		}();
...
var $author$project$Anim$Internal$Property$Size$default = {c2: 0, Q: 0};
...
var $author$project$Anim$Internal$Builder$initDefaults = {aa: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aG: $elm$core$Maybe$Nothing, aw: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aH: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, aI: $elm$core$Maybe$Nothing, aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, cg: $elm$core$Set$empty, az: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {A: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bs: false, t: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bL: $elm$core$Maybe$Nothing, h: false, cb: $elm$core$Maybe$Nothing, bA: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aB: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a3: $elm$core$Dict$empty, b8: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aP: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, az: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
		...
		if (_v0.$ === 1) {
			...
			if (_v1.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						ct: A2($author$project$Anim$Internal$Property$Opacity$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						by: clampedStart
					});
			}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, ct: 0, bV: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, ce: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.b8);
	});
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					by: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.by);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					ct: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					n: endPos,
					by: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$getAnimationConfigs = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.x.aB);
		if (_v1.$ === 1) {
			return _List_Nil;
		} else {
			var h = _v1.a;
			return A2(
				...
				A2($elm$core$List$cons, h.aF, h.bh));
		}
	});
...
var $author$project$Animation$WAAPI$PulsingDot$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		gb: F2(
			function (_v1, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		gc: $author$project$Animation$WAAPI$PulsingDot$Main$view
	});
