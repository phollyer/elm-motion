...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bG: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ab: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aI: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, cj: $elm$core$Set$empty, aA: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initState = {aC: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a5: $elm$core$Dict$empty, cb: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, av: 0, ct: $elm$core$Dict$empty, cu: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fr: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a7: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cS: $elm$core$Basics$round(rgba_.cr * 255),
				c2: $elm$core$Basics$round(rgba_.cx * 255),
				dz: $elm$core$Basics$round(rgba_.cH * 255)
			};
	}
};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cO: x0, cS: (v0 + ((zeta * omega0) * x0)) / omegaD, aj: omega0, b3: omegaD, bL: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, cv: 0, bY: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, ch: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.x.cb);
	});
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.x;
					var newEntry = {H: groupConfig, cC: kind};
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				bY: $elm$core$Maybe$Nothing,
				bA: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Motion$Spring$custom = function (_v0) {
	var mass = _v0.a1;
	var damping = _v0.aZ;
	var stiffness = _v0.a8;
	return {
		aZ: A2($elm$core$Basics$max, 0, damping),
		bk: 0,
		a1: A2($elm$core$Basics$max, 1.0e-6, mass),
		a8: A2($elm$core$Basics$max, 0, stiffness)
	};
};
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aB: animGroupName, db: isAnimating, W: progress, dw: propertyProgress, cG: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bN: animGroup, es: commandVersion, b9: rotate, cc: scale, cd: skew, ck: translate};
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aB, animUpdate.W)) : $elm$core$Maybe$Nothing;
		...
		switch (msg.$) {
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{_: newAnimState, aE: !model.aE, bm: label}),
					cmd);
			case 2:
				var target = model.aE ? 0 : 420;
				var stiffness = A2($author$project$Animation$WAAPI$Springs$Main$parseWithMin, 1, model.a8);
				var mass = A2($author$project$Animation$WAAPI$Springs$Main$parseWithMin, 0.1, model.a1);
				...
				var spring = $author$project$Motion$Spring$custom(
					{aZ: damping, a1: mass, a8: stiffness});
				var _v3 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model._,
					A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							a1: $elm$core$String$fromFloat(mass),
							bm: 'custom',
							a8: $elm$core$String$fromFloat(stiffness)
						}),
					cmd);
			case 3:
				var str = msg.a;
...
var $author$project$Animation$WAAPI$Springs$Main$customControls = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$Animation$WAAPI$Springs$Main$numberInput, 'Stiffness', '1', model.a8, $author$project$Animation$WAAPI$Springs$Main$SetStiffness),
				...
				A4($author$project$Animation$WAAPI$Springs$Main$numberInput, 'Mass', '0.1', model.a1, $author$project$Animation$WAAPI$Springs$Main$SetMass),
				A2(
...
var $author$project$Motion$Spring$gentle = {aZ: 14, bk: 0, a1: 1, a8: 120};
var $author$project$Motion$Spring$noWobble = {aZ: 26, bk: 0, a1: 1, a8: 170};
var $author$project$Motion$Spring$slow = {aZ: 18, bk: 0, a1: 1, a8: 60};
var $author$project$Motion$Spring$stiff = {aZ: 20, bk: 0, a1: 1, a8: 300};
var $author$project$Motion$Spring$wobbly = {aZ: 12, bk: 0, a1: 1, a8: 180};
...
var $author$project$Animation$WAAPI$Springs$Main$main = $elm$browser$Browser$element(
	{
		...
		fO: $author$project$Animation$WAAPI$Springs$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$Springs$Main$update,
		gd: $author$project$Animation$WAAPI$Springs$Main$view
	});
