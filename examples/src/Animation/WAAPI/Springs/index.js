...
{
	if (region.bC.by === region.n.by)
	{
		return 'on line ' + region.bC.by;
	}
	return 'on lines ' + region.bC.by + ' through ' + region.n.by;
}
...
var $author$project$Animation$WAAPI$Springs$Main$animGroup = 'springBox';
...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, W: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bq: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {N: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, Z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, bH: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {A: 0, f: $elm$core$Dict$empty, g: $elm$core$Dict$empty, bw: false, t: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bP: $elm$core$Maybe$Nothing, h: false, cf: $elm$core$Maybe$Nothing, bE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, S: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, cc: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var resetInitEntryScope = function (_v0) {
		...
		return _Utils_update(
			data,
			{
				...
				c: _Utils_update(
					defs,
					{aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing})
			});
	};
	var runInitEntry = F2(
		function (f, builder) {
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ax: 0, cu: $elm$core$Dict$empty, cv: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, X: 0, fs: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a8: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cT: $elm$core$Basics$round(rgba_.cr * 255),
				c3: $elm$core$Basics$round(rgba_.cy * 255),
				dA: $elm$core$Basics$round(rgba_.cI * 255)
			};
	}
};
	...
	return wrapper(
		{
			...
			bZ: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bZ, $elm$core$Maybe$Nothing, $author$project$Motion$Easing$EaseInOut),
			n: config.n,
			Q: config.Q,
			dH: speed_,
			bB: resolvedSpring,
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						cw: A2($author$project$Anim$Internal$Property$Translate$distance, startForDistance, clampedEnd),
						n: clampedEnd,
						bC: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						cw: A2(calcDistance, startVal, end),
						n: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cw: 0, bZ: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing, ci: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.u.cc);
	});
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				cw: A2(distanceFn, startVal, newEnd),
				n: newEnd,
...
var $author$project$Animation$WAAPI$Springs$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$Springs$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$Springs$Main$init = _Utils_Tuple2(
	{
		aa: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$Springs$Main$motionCmd,
			$author$project$Animation$WAAPI$Springs$Main$motionMsg,
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$WAAPI$Springs$Main$animGroup, 0)
				])),
		aG: false,
		aZ: '14',
		a2: '1',
...
var $author$project$Animation$WAAPI$Springs$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$Springs$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Springs$Main$GotWaapiMsg, model.aa);
};
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.u;
					var newEntry = {G: groupConfig, cD: kind};
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aw: newEntry, a1: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aw: newEntry,
								a1: A2($elm$core$List$cons, existing.aw, existing.a1)
							};
						}
					}();
					return _Utils_update(
		...
		switch (property.$) {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bZ, config.bB))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bC));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bC));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bC));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bC));
	...
	function (typeTag, animGroups, touchedAxes, processed) {
		var elementsWithVersions = A2(
			...
			function (_v0) {
				...
				var effectiveTouchedAxes = (typeTag === 'retarget') ? perGroupTouchedAxes : config.ct;
				...
				return _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(animGroupName)(
						...
						$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeTransformBaseline(snapshot))($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)(config.j)(config.e)(config.f)(config.g)(effectiveTouchedAxes)(config.ct)(playback.t)(playback.A)(config.s));
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cz));
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						bC: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.bC, start)
					};
				case 3:
					var config = property.a;
					return {
						...
						bC: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOriginUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.bC, start))
					};
				case 4:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.n, end),
						bC: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.bC, start)
					};
				case 5:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.n, end),
						bC: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.bC, start)
					};
				case 6:
					var config = property.a;
					return {
						...
						bC: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setSizeUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.bC, start))
					};
				case 7:
					var config = property.a;
					return {
						n: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.n, end),
						bC: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.bC, start)
					};
				default:
					var config = property.a;
					return {
						...
						bC: A2(
							$author$project$Anim$Internal$Builder$PropertyBaselines$setTranslateUnits,
							config.D,
							A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.bC, start))
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{n: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, bC: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
	...
	function (iterations, animationDirection, globalTransformOrder, discreteEntryProps, discreteExitProps, existingAnimation, properties) {
		...
		var snapshot = function () {
			if (!existingAnimation.$) {
				...
				return A2($author$project$Anim$Internal$Builder$PropertyBaselines$merge, animationBounds.bC, snapBounds.n);
			}
		}();
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.G.ct);
					}),
				$elm$core$Dict$empty,
				A2($elm$core$List$cons, history.aw, history.a1));
		}
	};
	var getDefaultsForGroup = function (groupName) {
		return A2(
...
var $author$project$Anim$Internal$Engine$WAAPI$animate = F2(
	function (_v0, build) {
		...
		var hasSnap = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$groups(processed.cz));
		var processedAnimGroups = A3(
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.cz));
		var nextState = A2(
			$author$project$Anim$Internal$Engine$WAAPI$AnimState,
			_Utils_update(
				state,
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				bZ: $elm$core$Maybe$Nothing,
				bB: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Animation$WAAPI$Springs$Main$animateTo = F2(
	function (x, spring) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Motion$Spring$custom = function (_v0) {
	var mass = _v0.a2;
	var damping = _v0.aZ;
	var stiffness = _v0.a9;
	return {
		aZ: A2($elm$core$Basics$max, 0, damping),
		bk: 0,
		a2: A2($elm$core$Basics$max, 1.0e-6, mass),
		a9: A2($elm$core$Basics$max, 0, stiffness)
	};
};
var $author$project$Anim$Engine$WAAPI$for = $author$project$Anim$Internal$Builder$for;
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Animation$WAAPI$Springs$Main$parseWithMin = F2(
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aE: animGroupName, dc: isAnimating, X: progress, dx: propertyProgress, cH: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bO: animGroup, et: commandVersion, ca: rotate, cd: scale, ce: skew, ck: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bO: animGroup, ca: rotate, cd: scale, ce: skew, ck: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$ProgressApply$progressToT = F2(
	function (cfg, rawProgress) {
		...
		if (!_v0.$) {
			...
			return A2($author$project$Shared$Easing$toFunction, cfg.bZ, rawProgress);
		}
	});
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				var _v2 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cH);
				if (_v2.$ === 1) {
					return propAnim;
				} else {
					var currentVersion = _v2.a;
					return _Utils_eq(currentVersion, propAnim.bK) ? _Utils_update(
						propAnim,
						{
							cg: animUpdate.dc ? 1 : 3
						}) : propAnim;
				}
			});
			...
			F2(
				function (propType, _v0) {
					var _v1 = _Utils_Tuple2(
						A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cH),
					...
					if ((!_v1.a.$) && (!_v1.b.$)) {
						...
						return _Utils_eq(incomingVersion, currentState.bK);
					} else {
						return false;
					}
				}),
...
var $author$project$Animation$WAAPI$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.aa);
			...
			case 1:
				var label = msg.a;
				var spring = msg.b;
				var target = model.aG ? 0 : 420;
				var _v2 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.aa,
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$Springs$Main$animGroup),
						A2($author$project$Animation$WAAPI$Springs$Main$animateTo, target, spring)));
				var newAnimState = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aa: newAnimState, aG: !model.aG, bm: label}),
					cmd);
			case 2:
				var target = model.aG ? 0 : 420;
				var stiffness = A2($author$project$Animation$WAAPI$Springs$Main$parseWithMin, 1, model.a9);
				var mass = A2($author$project$Animation$WAAPI$Springs$Main$parseWithMin, 0.1, model.a2);
				var damping = A2($author$project$Animation$WAAPI$Springs$Main$parseWithMin, 0, model.aZ);
				var spring = $author$project$Motion$Spring$custom(
					{aZ: damping, a2: mass, a9: stiffness});
				var _v3 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.aa,
					A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aa: newAnimState,
							aG: !model.aG,
							aZ: $elm$core$String$fromFloat(damping),
							a2: $elm$core$String$fromFloat(mass),
							bm: 'custom',
							a9: $elm$core$String$fromFloat(stiffness)
						}),
					cmd);
			case 3:
				var str = msg.a;
	...
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				A2($elm$core$List$cons, h.aw, h.a1));
		}
	});
...
var $author$project$Animation$WAAPI$Springs$Main$PlayCustom = {$: 2};
var $author$project$Animation$WAAPI$Springs$Main$SetDamping = function (a) {
	return {$: 4, a: a};
};
var $author$project$Animation$WAAPI$Springs$Main$SetMass = function (a) {
	return {$: 5, a: a};
};
var $author$project$Animation$WAAPI$Springs$Main$SetStiffness = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Animation$WAAPI$Springs$Main$numberInput = F4(
...
var $author$project$Animation$WAAPI$Springs$Main$customControls = function (model) {
	var playVariant = (model.bm === 'custom') ? 'primary' : 'purple';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A4($author$project$Animation$WAAPI$Springs$Main$numberInput, 'Stiffness', '1', model.a9, $author$project$Animation$WAAPI$Springs$Main$SetStiffness),
				A4($author$project$Animation$WAAPI$Springs$Main$numberInput, 'Damping', '1', model.aZ, $author$project$Animation$WAAPI$Springs$Main$SetDamping),
				A4($author$project$Animation$WAAPI$Springs$Main$numberInput, 'Mass', '0.1', model.a2, $author$project$Animation$WAAPI$Springs$Main$SetMass),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$Springs$Main$PlayCustom),
...
var $author$project$Animation$WAAPI$Springs$Main$Play = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Animation$WAAPI$Springs$Main$presetButton = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Animation$WAAPI$Springs$Main$Play, label, spring)),
...
var $author$project$Motion$Spring$gentle = {aZ: 14, bk: 0, a2: 1, a9: 120};
var $author$project$Motion$Spring$noWobble = {aZ: 26, bk: 0, a2: 1, a9: 170};
var $author$project$Motion$Spring$slow = {aZ: 18, bk: 0, a2: 1, a9: 60};
var $author$project$Motion$Spring$stiff = {aZ: 20, bk: 0, a2: 1, a9: 300};
var $author$project$Motion$Spring$wobbly = {aZ: 12, bk: 0, a2: 1, a9: 180};
var $author$project$Animation$WAAPI$Springs$Main$presets = _List_fromArray(
	[
...
var $author$project$Animation$WAAPI$Springs$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Animation$WAAPI$Springs$Main$presetButton(model.bm),
					$author$project$Animation$WAAPI$Springs$Main$presets)),
				$author$project$Animation$WAAPI$Springs$Main$customControls(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Springs$Main$animGroup, model.aa),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$Springs$Main$main = $elm$browser$Browser$element(
	{
		e_: function (_v0) {
			return $author$project$Animation$WAAPI$Springs$Main$init;
		},
		fP: $author$project$Animation$WAAPI$Springs$Main$subscriptions,
		gd: $author$project$Animation$WAAPI$Springs$Main$update,
		ge: $author$project$Animation$WAAPI$Springs$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'Springs':{'Main':{'init':$author$project$Animation$WAAPI$Springs$Main$main(
