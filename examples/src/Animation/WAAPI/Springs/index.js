...
var $author$project$Anim$Internal$Builder$initAnimation = {C: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aY: $author$project$Anim$Internal$Builder$CssUnitStore$empty, r: $elm$core$Maybe$Nothing, e: $elm$core$Dict$empty, V: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bq: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {ab: $author$project$Anim$Internal$Builder$CssUnitStore$empty, i: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, Y: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, aJ: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, cj: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bO: $elm$core$Maybe$Nothing, h: false, ce: $elm$core$Maybe$Nothing, bE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, k: $elm$core$Maybe$Nothing, l: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {au: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, R: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a6: $elm$core$Dict$empty, cb: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {A: 0, ax: 0, cu: $elm$core$Dict$empty, cv: $elm$core$Dict$empty, t: $author$project$Anim$Internal$Builder$Once, W: 0, fs: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, a8: $elm$core$Dict$empty, p: $author$project$Anim$Extra$TransformOrder$default};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{cP: x0, cT: (v0 + ((zeta * omega0) * x0)) / omegaD, aj: omega0, b3: omegaD, bL: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cw: 0, bY: $elm$core$Maybe$Nothing, n: defaultEnd, P: $author$project$Anim$Internal$Builder$Animate, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing, ch: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$Springs$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Springs$Main$GotWaapiMsg, model._);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.y, config.bY, config.bB))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimationUpdate = F5(
	function (animGroupName, progress, isAnimating, propertyVersions, propertyProgress) {
		return {aE: animGroupName, dc: isAnimating, W: progress, dx: propertyProgress, cH: propertyVersions};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$FrozenAxesPayload = F6(
	function (animGroup, translate, scale, rotate, skew, commandVersion) {
		return {bN: animGroup, et: commandVersion, b9: rotate, cc: scale, cd: skew, ck: translate};
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$SettledValuesPayload = F5(
	function (animGroup, translate, scale, rotate, skew) {
		return {bN: animGroup, b9: rotate, cc: scale, cd: skew, ck: translate};
	});
				...
				case 'propertyUpdate':
					...
					if (!_v4.$) {
						...
						var progressEvent = shouldEmitProgress ? $elm$core$Maybe$Just(
							A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.aE, animUpdate.W)) : $elm$core$Maybe$Nothing;
...
var $author$project$Animation$WAAPI$Springs$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model._);
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{_: newAnimState, aG: !model.aG, bm: label}),
					cmd);
			case 2:
				var target = model.aG ? 0 : 420;
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Springs$Main$animGroup, model._),
							_List_fromArray(
								[
