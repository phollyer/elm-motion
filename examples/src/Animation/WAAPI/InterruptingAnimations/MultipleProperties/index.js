	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cN: startAlpha, cR: rgb_.cR, c1: rgb_.c1, dy: rgb_.dy});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cN: startAlpha, c2: hsl_.c2, dc: hsl_.dc, dB: hsl_.dB});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bz: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					ct: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$update,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$view
	});
