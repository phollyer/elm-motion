...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName = 'movingBox';
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct = 12;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$centerXCqw = (100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct) / 2;
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{cO: startAlpha, cS: rgb_.cS, c2: rgb_.c2, dz: rgb_.dz});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{cO: startAlpha, c3: hsl_.c3, dd: hsl_.dd, dC: hsl_.dC});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		var colorWithPreservedAlpha = function () {
			...
			if (_v1.$ === 1) {
				...
				var _v2 = _Utils_Tuple2(
					...
					$author$project$Anim$Internal$Extra$Color$hasExplicitAlpha(config.n));
				if ((!_v2.a) && _v2.b) {
					return A2($author$project$Anim$Internal$Extra$Color$applyAlphaFromStart, color, config.n);
				} else {
					return color;
				}
			}
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bA: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					cu: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
					n: colorWithPreservedAlpha,
					bA: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		...
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.bA);
		return A4(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$init = _Utils_Tuple2(
	{
		S: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$motionCmd,
			$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$centerXCqw),
					$author$project$Anim$Property$Translate$initCssUnitX(8)),
					A3(
					$author$project$Anim$Property$CustomColor$init,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName,
					$author$project$Anim$Property$CustomColor$BackgroundColor,
					A3($author$project$Anim$Extra$Color$rgb, 118, 118, 118))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate, model.S);
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$XLeft = 0;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$XRight = 2;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$changeColor = function (color) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBoxX = function (x) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$centerXCqw;
		default:
			return 100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct;
	}
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, animationMsg, model.S);
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
							$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$targetX(0))));
			...
			case 2:
				var _v3 = A2(
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBoxX(
							$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$targetX(2))));
			...
			default:
				...
				var _v4 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$changeColor(color)));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$ChangeColor = function (a) {
	return {$: 3, a: a};
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$MoveLeft = {$: 1};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$MoveRight = {$: 2};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxHalfPct = $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct / 2;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$view = function (model) {
	var posButton = F3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(posButton, '#333', 'Move Left', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$MoveLeft),
						A3(posButton, '#333', 'Move Right', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$MoveRight)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(colorButton, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color1, 'Color 1'),
						A2(colorButton, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color2, 'Color 2'),
						A2(colorButton, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color3, 'Color 3'),
						A2(colorButton, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$color4, 'Color 4')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.S),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$Attributes$style,
									'width',
									$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
									A2(
									$elm$html$Html$Attributes$style,
									'height',
									$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxPct) + 'cqw'),
									...
									$elm$html$Html$Attributes$style,
									'top',
									'calc(50% - ' + ($elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxHalfPct) + 'cqw)')),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$init;
		},
		fO: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$update,
		gd: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'InterruptingAnimations':{'MultipleProperties':{'Main':{'init':$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$main(
