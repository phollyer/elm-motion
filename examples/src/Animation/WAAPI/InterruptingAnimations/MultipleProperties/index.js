...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate, model.R);
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, animationMsg, model.R);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.R),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$Attributes$style,
