...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$update,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$view
	});
