...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup = 'movingBox';
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct = 12;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$centerXCqw = (100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$centerYCqh = (100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$init = _Utils_Tuple2(
	{
		N: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$motionCmd,
			$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$centerXCqw, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$centerYCqh),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate, model.N);
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$XLeft = 0;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$XRight = 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$YBottom = 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$YTop = 0;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxX = function (x) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxY = function (y) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(y));
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return (100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct) / 2;
		default:
			return 100 - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct;
	}
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetY = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
			...
			case 1:
				var _v2 = A2(
					...
					model.N,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetX(0)));
			...
			case 2:
				var _v3 = A2(
					...
					model.N,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxX(
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetX(2)));
			...
			case 3:
				var _v4 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.N,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetY(0)));
			...
			default:
				var _v5 = A2(
					...
					model.N,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBoxY(
						$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$targetY(2)));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveDown = {$: 4};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveLeft = {$: 1};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveRight = {$: 2};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveUp = {$: 3};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	var button = F3(
	...
	var moveDownButton = A3(button, '#FFC107', 'Move Down', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveDown);
	var moveLeftButton = A3(button, '#007BFF', 'Move Left', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveLeft);
	var moveRightButton = A3(button, '#28A745', 'Move Right', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveRight);
	var moveUpButton = A3(button, '#6F42C1', 'Move Up', $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$MoveUp);
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup, model.N),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxPct) + 'cqh'),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$init;
		},
		fO: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$update,
		gd: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'InterruptingAnimations':{'MultipleAxes':{'Main':{'init':$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$main(
