...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$update,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$view
	});
