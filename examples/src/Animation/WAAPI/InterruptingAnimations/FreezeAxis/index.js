...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup = 'movingBox';
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct = 12;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$centerXCqw = (100 - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$centerYCqh = (100 - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$init = _Utils_Tuple2(
	{
		N: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$motionCmd,
			$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$motionMsg,
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$centerXCqw, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$centerYCqh),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$GotAnimationUpdate, model.N);
};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$XLeft = 0;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$XRight = 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$YBottom = 2;
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$YTop = 0;
...
var $author$project$Anim$Internal$Builder$freezeAxes = F3(
	function (axes, properties, _v0) {
		...
		var applyFreezeAxesToDict = function (dict) {
			return A3(
				$elm$core$List$foldl,
				F2(
					function (propName, acc) {
						return A3(
							$elm$core$Dict$update,
							propName,
							function (maybeAxes) {
			...
			return _Utils_update(
				data,
				{
					a: _Utils_update(
						anim,
						{
							e: applyFreezeAxesToDict(anim.e)
						})
				});
		} else {
			var animGroupName = _v1.a;
			var baseFrozenAxes = A2(
				$elm$core$Maybe$withDefault,
				anim.e,
				A2(
					$elm$core$Maybe$andThen,
					...
					A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, anim.C)));
			return A2(
				$author$project$Anim$Internal$Builder$updateCurrentConfig,
				{
					...
					e: $elm$core$Maybe$Just(
						applyFreezeAxesToDict(baseFrozenAxes)),
					b: $elm$core$Maybe$Nothing,
					s: _List_Nil,
...
var $author$project$Anim$Internal$Engine$WAAPI$freezeAxes = $author$project$Anim$Internal$Builder$freezeAxes;
var $author$project$Anim$Engine$WAAPI$freezeX = $author$project$Anim$Internal$Engine$WAAPI$freezeAxes(
	_List_fromArray(
		['x']));
var $author$project$Anim$Engine$WAAPI$freezeY = $author$project$Anim$Internal$Engine$WAAPI$freezeAxes(
	_List_fromArray(
		['y']));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxX = function (x) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxY = function (y) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(y));
};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetX = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
			return (100 - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct) / 2;
		default:
			return 100 - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct;
	}
};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetY = function (pos) {
	switch (pos) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Anim$Internal$Engine$WAAPI$freezeTranslate = 0;
var $author$project$Anim$Engine$WAAPI$translate = $author$project$Anim$Internal$Engine$WAAPI$freezeTranslate;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$freezeY(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxX(
							$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetX(0))));
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$freezeY(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxX(
							$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetX(2))));
			...
			case 3:
				var _v4 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$freezeX(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxY(
							$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetY(0))));
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$freezeX(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBoxY(
							$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$targetY(2))));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveDown = {$: 4};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveLeft = {$: 1};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveRight = {$: 2};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveUp = {$: 3};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$view = function (model) {
	var button = F3(
	...
	var moveDownButton = A3(button, '#FFC107', 'Move Down', $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveDown);
	var moveLeftButton = A3(button, '#007BFF', 'Move Left', $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveLeft);
	var moveRightButton = A3(button, '#28A745', 'Move Right', $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveRight);
	var moveUpButton = A3(button, '#6F42C1', 'Move Up', $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$MoveUp);
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup, model.N),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct) + 'cqw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxPct) + 'cqh'),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$init;
		},
		fO: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$update,
		gd: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'InterruptingAnimations':{'FreezeAxis':{'Main':{'init':$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$main(
