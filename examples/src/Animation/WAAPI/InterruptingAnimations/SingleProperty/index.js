...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, v: $elm$core$Maybe$Nothing, ct: 0, bW: $elm$core$Maybe$Nothing, n: defaultEnd, Q: $author$project$Anim$Internal$Builder$Animate, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, cf: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$update,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$view
	});
