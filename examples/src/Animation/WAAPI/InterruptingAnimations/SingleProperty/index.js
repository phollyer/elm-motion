...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName = 'colorBox';
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {D: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, w: $elm$core$Maybe$Nothing, cu: 0, bX: $elm$core$Maybe$Nothing, n: defaultEnd, R: $author$project$Anim$Internal$Builder$Animate, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$init = _Utils_Tuple2(
	{
		N: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$motionCmd,
			$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$motionMsg,
			_List_fromArray(
				[
					A3(
					$author$project$Anim$Property$CustomColor$init,
					$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName,
					$author$project$Anim$Property$CustomColor$BackgroundColor,
					A3($author$project$Anim$Extra$Color$rgb, 118, 118, 118))
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate, model.N);
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color1 = A3($author$project$Anim$Extra$Color$rgb, 255, 87, 51);
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor1 = $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color1));
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color2 = A3($author$project$Anim$Extra$Color$rgb, 40, 167, 69);
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor2 = $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color2));
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color3 = A3($author$project$Anim$Extra$Color$rgb, 111, 66, 193);
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor3 = $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color3));
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color4 = A3($author$project$Anim$Extra$Color$rgb, 255, 193, 7);
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor4 = $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox(
	$author$project$Anim$Property$CustomColor$to($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color4));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, animationMsg, model.N);
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor1));
			...
			case 2:
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor2));
			...
			case 3:
				var _v4 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor3));
			...
			default:
				var _v5 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName),
						$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor4));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color1 = {$: 1};
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color2 = {$: 2};
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color3 = {$: 3};
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color4 = {$: 4};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$view = function (model) {
	var button = F3(
	...
	var color1Button = A3(button, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color1, 'Color 1', $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color1);
	var color2Button = A3(button, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color2, 'Color 2', $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color2);
	var color3Button = A3(button, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color3, 'Color 3', $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color3);
	var color4Button = A3(button, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$color4, 'Color 4', $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$Color4);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName, model.N),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$init;
		},
		fO: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$update,
		gd: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'InterruptingAnimations':{'SingleProperty':{'Main':{'init':$author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$main(
