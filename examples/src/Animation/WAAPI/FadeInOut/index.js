...
var $author$project$Animation$WAAPI$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		fN: $author$project$Animation$WAAPI$FadeInOut$Main$subscriptions,
		gb: $author$project$Animation$WAAPI$FadeInOut$Main$update,
		gc: $author$project$Animation$WAAPI$FadeInOut$Main$view
	});
