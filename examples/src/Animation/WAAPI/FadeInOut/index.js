...
var $author$project$Animation$WAAPI$FadeInOut$Main$animGroup = 'fadeAnim';
...
var $author$project$Animation$WAAPI$FadeInOut$Main$motionCmd = _Platform_outgoingPort('motionCmd', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Animation$WAAPI$FadeInOut$Main$motionMsg = _Platform_incomingPort('motionMsg', $elm$json$Json$Decode$value);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Animation$WAAPI$FadeInOut$Main$init = _Utils_Tuple2(
	{
		aa: A3(
			$author$project$Anim$Engine$WAAPI$init,
			$author$project$Animation$WAAPI$FadeInOut$Main$motionCmd,
			$author$project$Animation$WAAPI$FadeInOut$Main$motionMsg,
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$FadeInOut$Main$animGroup, 0)
				]))
	},
	$elm$core$Platform$Cmd$none);
var $author$project$Animation$WAAPI$FadeInOut$Main$GotWaapiMsg = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Animation$WAAPI$FadeInOut$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$FadeInOut$Main$GotWaapiMsg, model.aa);
};
...
var $author$project$Animation$WAAPI$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$FadeInOut$Main$fadeIn = $author$project$Animation$WAAPI$FadeInOut$Main$fadeTo(1);
var $author$project$Animation$WAAPI$FadeInOut$Main$fadeOut = $author$project$Animation$WAAPI$FadeInOut$Main$fadeTo(0);
...
var $author$project$Animation$WAAPI$FadeInOut$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$FadeInOut$Main$animGroup),
						$author$project$Animation$WAAPI$FadeInOut$Main$fadeIn));
			...
			default:
				var _v3 = A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$WAAPI$for($author$project$Animation$WAAPI$FadeInOut$Main$animGroup),
						$author$project$Animation$WAAPI$FadeInOut$Main$fadeOut));
...
var $author$project$Animation$WAAPI$FadeInOut$Main$TriggerFadeIn = {$: 1};
var $author$project$Animation$WAAPI$FadeInOut$Main$TriggerFadeOut = {$: 2};
...
var $author$project$Animation$WAAPI$FadeInOut$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$FadeInOut$Main$TriggerFadeIn),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Animation$WAAPI$FadeInOut$Main$TriggerFadeOut),
								$elm$html$Html$Attributes$class('ui-action-button primary')
							]),
						_List_fromArray(
							[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$FadeInOut$Main$animGroup, model.aa),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		eZ: function (_v0) {
			return $author$project$Animation$WAAPI$FadeInOut$Main$init;
		},
		fO: $author$project$Animation$WAAPI$FadeInOut$Main$subscriptions,
		gc: $author$project$Animation$WAAPI$FadeInOut$Main$update,
		gd: $author$project$Animation$WAAPI$FadeInOut$Main$view
	});
_Platform_export({'Animation':{'WAAPI':{'FadeInOut':{'Main':{'init':$author$project$Animation$WAAPI$FadeInOut$Main$main(
