...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ey: 'hidden', d$: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ey: 'mozHidden', d$: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ey: 'msHidden', d$: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ey: 'webkitHidden', d$: 'webkitvisibilitychange' }
		: { ey: 'hidden', d$: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cI: fragment, cP: host, c6: path, c8: port_, dc: protocol, dd: query};
	});
			...
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'offset',
						$elm$json$Json$Encode$float(sample.c_)),
						_Utils_Tuple2(
						'value',
						$elm$json$Json$Encode$float(sample.dp))
					]));
		},
		samples);
};
	...
	function (s, durationMs) {
		...
		return A2(
			...
			function (i) {
				...
				return {
					c_: offset,
					dp: A2($author$project$Shared$Spring$valueAt, motion, offset * durationMs)
				};
			},
			A2($elm$core$List$range, 0, n - 1));
	});
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	ed: $author$project$Anim$Internal$Property$Rotate$default,
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	ed: $author$project$Anim$Internal$Property$Scale$default,
	et: $elm$core$Basics$identity,
	bT: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	ed: $author$project$Anim$Internal$Property$Translate$default,
	et: $elm$core$Basics$identity,
	bT: F2(
		function (factor, _v2) {
			var coords = _v2;
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.L, dimensions.cL);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'delay',
												$elm$json$Json$Encode$int(config.t))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.v, config.bH, config.bm))))))));
			case 1:
				var cssName = property.a;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.bn));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.bn));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v9 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.bn));
						var startX = _v9.a;
						var startY = _v9.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v10 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.bn));
			...
			default:
				var config = property.a;
				var _v14 = $author$project$Anim$Internal$Property$Translate$toTriple(config.m);
				var endX = _v14.a;
				var endY = _v14.b;
				var endZ = _v14.c;
				return $elm$json$Json$Encode$object(
...
var $author$project$Anim$Internal$Builder$getAnimTarget = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.n.bp);
	});
...
var $author$project$Anim$Internal$Property$Size$default = {cL: 0, L: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.dh / 100;
	var l = hslValue.cU / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cL / 60, 2) - 1));
	var _v0 = (hslValue.cL < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cL < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cL < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cL < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cL < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cy: rgba_.cy, cK: rgba_.cK, de: rgba_.de};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cL: hsla_.cL, cU: hsla_.cU, dh: hsla_.dh});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cy: $elm$core$Basics$round(rgba_.b3 * 255),
				cK: $elm$core$Basics$round(rgba_.cb * 255),
				de: $elm$core$Basics$round(rgba_.cl * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.de - rgb1.de;
		var dg = rgb2.cK - rgb1.cK;
		var db = rgb2.cy - rgb1.cy;
	...
	function (globalData, animGroupName, property) {
		...
		switch (property.$) {
			...
			case 4:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, U: $author$project$Anim$Internal$Unit$default, V: $author$project$Anim$Internal$Property$Rotate$default, W: $author$project$Anim$Internal$Property$Rotate$distance, X: $author$project$Anim$Internal$Property$Rotate$duration, h: globalData.h, Y: globalData, af: $author$project$Anim$Internal$Property$Rotate$speed, ah: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, U: $author$project$Anim$Internal$Unit$default, V: $author$project$Anim$Internal$Property$Scale$default, W: $author$project$Anim$Internal$Property$Scale$distance, X: $author$project$Anim$Internal$Property$Scale$duration, h: globalData.h, Y: globalData, af: $author$project$Anim$Internal$Property$Scale$speed, ah: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{C: config, U: $author$project$Anim$Internal$Unit$default, V: $author$project$Anim$Internal$Property$Skew$default, W: $author$project$Anim$Internal$Property$Skew$distance, X: $author$project$Anim$Internal$Property$Skew$duration, h: globalData.h, Y: globalData, af: $author$project$Anim$Internal$Property$Skew$speed, ah: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
	...
	var historicalControlledAxesForGroup = function (groupName) {
		...
		if (_v7.$ === 1) {
			...
			return A3(
				...
				F2(
					function (entry, acc) {
						return A2(mergeAxisSets, acc, entry.C.b5);
					}),
				$elm$core$Dict$empty,
		...
		function (_v0) {
			...
			return _Utils_Tuple2(
				...
				$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeProcessedAnimGroupConfig(animGroupName)(
					...
					$elm$core$Maybe$Just(emitProgress))(config.i)(config.d)(config.e)(config.f)(config.b5)(config.b5)(playback.r)(playback.w)(config.q));
		},
		$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.cc));
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, Q: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {H: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, S: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, Z: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, bs: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {by: $elm$core$Maybe$Nothing, g: false, bV: $elm$core$Maybe$Nothing, bp: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, M: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bS: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, b9: 0, bH: $elm$core$Maybe$Nothing, m: defaultEnd, K: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bX: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.bS);
	});
		...
		if (_v0.$ === 1) {
			...
			if (_Utils_eq(cx, $elm$core$Maybe$Nothing) && (_Utils_eq(cy, $elm$core$Maybe$Nothing) && _Utils_eq(cz, $elm$core$Maybe$Nothing))) {
				...
				return _Utils_update(
					config,
					{
						b9: A2($author$project$Anim$Internal$Property$Scale$distance, startForDistance, clampedEnd),
						m: clampedEnd,
						bn: clampedStart
					});
			}
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						b9: A2(calcDistance, startVal, end),
						m: end
					});
			}
		}
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{ct: startAlpha, cy: rgb_.cy, cK: rgb_.cK, de: rgb_.de});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{ct: startAlpha, cL: hsl_.cL, cU: hsl_.cU, dh: hsl_.dh});
			default:
				return newColor;
		}
	});
...
var $author$project$Anim$Internal$Builder$Scale$fromX = F2(
	function (scaleX, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Scale$getZ, $author$project$Anim$Internal$Builder$Scale$default, config.bn);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Scale$getY, $author$project$Anim$Internal$Builder$Scale$default, config.bn);
		return A4(
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					b9: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
...
var $author$project$Anim$Internal$Builder$Property$setEnd = F4(
	function (default_, distanceFn, newEnd, config) {
		...
		return _Utils_update(
			config,
			{
				b9: A2(distanceFn, startVal, newEnd),
				m: newEnd,
...
var $author$project$Animation$ScrollTimeline$Main$cards = _List_fromArray(
	[
		{aG: 'The timeline starts at 0% at the top of the page and reaches 100% at the bottom.', aI: '#6366f1', aP: '01', aY: 'Top to bottom'},
		{aG: 'The same timeline drives both size and color, so one scroll gesture controls the whole bar.', aI: '#8b5cf6', aP: '02', aY: 'One scroll, two effects'},
		{aG: 'Short red bar means early in the page, long green bar means you are near the end.', aI: '#a78bfa', aP: '03', aY: 'Read progress at a glance'},
		{aG: 'Call ScrollTimeline.animate once in init, then the browser keeps everything in sync while you scroll.', aI: '#7c3aed', aP: '04', aY: 'Simple trigger'},
		{aG: 'Attach ScrollTimeline.attributes to any element and map scroll progress to the properties you want.', aI: '#5b21b6', aP: '05', aY: 'Easy to reuse'}
	]);
...
var $author$project$Animation$ScrollTimeline$Main$main = $elm$browser$Browser$element(
	{
		...
		fW: $author$project$Animation$ScrollTimeline$Main$view
	});
