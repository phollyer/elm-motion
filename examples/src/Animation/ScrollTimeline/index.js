	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{ct: x0, cy: (v0 + ((zeta * omega0) * x0)) / omegaD, aa: omega0, bK: omegaD, bv: zeta});
		} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.K, dimensions.cL);
};
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.v, config.bG, config.bm))))))));
			case 1:
				var cssName = property.a;
...
var $author$project$Anim$Internal$Property$Size$default = {cL: 0, K: 0};
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aJ: $author$project$Anim$Internal$Builder$CssUnitStore$empty, p: $elm$core$Maybe$Nothing, d: $elm$core$Dict$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bc: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {T: $author$project$Anim$Internal$Builder$CssUnitStore$empty, h: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, R: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, ax: $elm$core$Maybe$Nothing, Z: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, bY: $elm$core$Set$empty, at: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {bx: $elm$core$Maybe$Nothing, g: false, bU: $elm$core$Maybe$Nothing, bp: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, j: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {al: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aU: $elm$core$Dict$empty, bR: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {z: $author$project$Anim$Internal$Unit$emptyCssUnitAxes, t: $elm$core$Maybe$Nothing, b9: 0, bG: $elm$core$Maybe$Nothing, m: defaultEnd, J: $author$project$Anim$Internal$Builder$Animate, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bW: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.s.bR);
	});
